...
public class CCom011Action extends DispatchAction {
	/*
	 * Java Pattern 에서 지원하는 logger를 사용할 수 있도록 객체를 선언
	 */
	private Logger logger = Logger.getLogger(CCom011Action.class);
     ...
     * </p>
     */
    public ActionForward repPumbunPop(ActionMapping mapping, ActionForm form,
	...
	public ActionForward searchOnPop(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			dao = new CCom011DAO();
			list = dao.searchOnPop(form, mi, true, userId);
