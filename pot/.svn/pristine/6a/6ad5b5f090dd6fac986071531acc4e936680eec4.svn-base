 ...
 *************************************************************************/
 ...
 var strFlg         = dialogArguments[5]; //행사기간 사용유무
    ...
    /**
        ...
        */
        ...
        {   
            ...
            initEmEdit(EM_EVENT_S_DT, "YYYYMMDD", PK); // 조회 시작기간    
            initEmEdit(EM_EVENT_E_DT, "YYYYMMDD", PK); // 조회 종료기간
            
            // 넘어온 행사 기간이 있을경우 조회조건에 셋팅
            var addConds = addCondition.split("#G#");
            if(addConds.length > 2){
                EM_EVENT_S_DT.Text = addConds[0];
                EM_EVENT_E_DT.Text = addConds[1];
            }else{
        ...
        function gridCreate1(){
            ...
            var hdrProperies = '<FC>ID="EVENT_CD"    name="행사코드" width=100,   edit=none,  align="left" </FC>'
                            ...
                            + '<FC>ID="EVENT_S_DT"    name="행사시작일"   width=75,  edit=none,   align="center"  Show='+showBoolean+'</FC>'
                            + '<FC>ID="EVENT_E_DT"    name="행사종료일"   width=75,  edit=none,   align="center"  Show='+showBoolean+'</FC>';
 ...
 *************************************************************************/ 
  ...
  */
  ...
  { 
      ...
      TR_MAIN.Action="/pot/ccom210.cc?goTo=searchOnPop";
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0"
							class="s_table">
							<tr>
								<th width="50" class="point">코드/명</th>
