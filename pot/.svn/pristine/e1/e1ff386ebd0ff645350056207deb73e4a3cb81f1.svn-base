...
public class CCom016Action extends DispatchAction {
	 ...
	 * 
	 */
	public ActionForward searchVenInfo(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		...
		try {
			...
			helper.setDataSetHeader(dSet, "H_VENMST_INFO");
			dao = new CCom016DAO();		
			list = dao.searchVenInfo(form);
