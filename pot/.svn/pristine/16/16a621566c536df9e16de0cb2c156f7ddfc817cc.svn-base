...
{     	
    ...
    DS_I_COND.setDataHeader  ('PUMBUN_CD:STRING(6),PUMBUN_NM:STRING(40),AUTH_GB:STRING(1),ADD_CONDITION:STRING(200),USE_YN:STRING(1)');
    DS_I_COND.ClearData();
    DS_I_COND.Addrow();
    ...
    DS_I_COND.NameValue(DS_I_COND.RowPosition, "USE_YN") = "Y";
 ...
 *************************************************************************/ 
  ...
  */
  ...
  { 
      ...
      TR_MAIN.Action="/pot/ccom012.cc?goTo=searchOnPop2";
            ...
            <td>
	            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table">
	              <tr>
	                ...
	                <td>
	                  <comment id="_NSID_"> 
	                    <object id=LC_O_USE_YN classid=<%= Util.CLSID_LUXECOMBO %> width=70 tabindex=1 align="absmiddle">
	                    </object>
	                  </comment>
	                  <script>_ws_(_NSID_);</script>
	                </td>
	              ...
	              <tr>
	                ...
	                <td  colspan="3">
	                <comment id="_NSID_">
	                    <object id=EM_PUMBUN_NM classid=<%=Util.CLSID_EMEDIT%> height=20 width=200 onKeyDown="if(event.keyCode == 13) btn_Search();" >
	                    </object>
	                </comment><script>_ws_(_NSID_);</script>
	                </td>
	              </tr>
