 ...
 *************************************************************************/
 ...
 var styleCd        = dialogArguments[1];
 var styleNm        = dialogArguments[2];
...
{     	
    ...
    // EMedit 초기화
    initEmEdit(EM_STYLE_CD, "CODE^54^#", NORMAL);
    initEmEdit(EM_STYLE_NAME, "GEN^40", NORMAL);

    // Input Data Set Header 초기화 
    DS_I_COND.setDataHeader  ('STYLE_CD:STRING(54),STYLE_NAME:STRING(40),AUTH_GB:STRING(1),ADD_CONDITION:STRING(200)');
    DS_I_COND.ClearData();
    DS_I_COND.Addrow();

    DS_I_COND.NameValue(DS_I_COND.RowPosition, "STYLE_CD") = styleCd; 
    DS_I_COND.NameValue(DS_I_COND.RowPosition, "STYLE_NAME") = styleNm;
    ...
    EM_STYLE_CD.Focus();
    if(styleCd.length > 0 || styleNm.length > 0   ){
        btn_Search();
    }
} 

function gridCreate1(){
    var hdrProperies = '<FC>ID="STYLE_CD"     name="스타일코드"       width=100,   edit=none,   align=left</FC>'
                     + '<FC>ID="STYLE_NAME"   name="스타일명"         width=180,   edit=none,   align=left  </FC>'
    ...
    if( multiGb == "M"){
        ...
        hdrProperies = '<FC>ID="SEL"          name="선택"              width=30,   align=center, EditStyle="CheckBox"</FC>'
                     + '<FC>ID="STYLE_CD"     name="스타일코드"       width=100,   edit=none,   align=left</FC>'
                     + '<FC>ID="STYLE_NAME"   name="스타일명"         width=150,   edit=none,   align=left  </FC>'
                     + '<FC>ID="PUMBUN_CD"    name="브랜드코드"         width=80,    edit=none,   align=left show=false </FC>'
                     + '<FC>ID="PUMMOK_CD"    name="품목코드"         width=80,    edit=none,   align=left show=false </FC>';
    }
 ...
 *************************************************************************/ 
  ...
  */
  ...
  { 
      ...
      TR_MAIN.Action="/pot/ccom006.cc?goTo=searchOnPop";
        ...
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="" class="title">
              ...
              <span id="title1" class="PL03">스타일코드 </span>
            </td>
        ...
        <td class="popT01 PB03"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="o_table">
          <tr>
            <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table">
              <tr>
                <th width="70">스타일코드</th>
                <td >
                <comment id="_NSID_">
                    <object id=EM_STYLE_CD classid=<%=Util.CLSID_EMEDIT%> height=20 width=230 onKeyDown="if(event.keyCode == 13) btn_Search();" >
                    </object>
              ...
              <tr>
                ...
                <td>
                <comment id="_NSID_">
                    <object id=EM_STYLE_NAME classid=<%=Util.CLSID_EMEDIT%> height=20 width=230 onKeyDown="if(event.keyCode == 13) btn_Search();" >
                    </object>
                </comment><script>_ws_(_NSID_);</script>
                </td>
              </tr>
