...
public class CCom015Action extends DispatchAction {
	/*
	 * Java Pattern 에서 지원하는 logger를 사용할 수 있도록 객체를 선언
	 */
	private Logger logger = Logger.getLogger(CCom015Action.class);
     ...
     * </p>
     */
    public ActionForward repVenPop(ActionMapping mapping, ActionForm form,
	...
	public ActionForward searchOnPop(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			helper.setDataSetHeader(dSet[1], "H_VENMST");
