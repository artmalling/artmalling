...
function gridCreate(){
    ...
    var hdrProperies1 = '<FC>id={currow}         width=30   align=center	edit=none    	    name="NO"         	</FC>'
		     		  + '<FC>id=CHK       	 	 width=30    		  		edit={if(HP_NO="" ,"FALSE","TRUE")} editstyle=checkbox  HeadCheckShow=true	</FC>'
		     	      + '<FC>id=USER_ID          width=75                   edit=none			name="사용자ID"     </FC>'
...
*/
    ...
    var hdrProperies2 = '<FC>id={currow}         width=30   align=center	edit=none    	    name="NO"         	</FC>'
					  + '<FC>id=CHK       	 	 width=30    		  		editstyle=checkbox  editstyle=checkbox  HeadCheckShow=true</FC>'
                      + '<FC>id=USER_ID          width=75                   edit=none			name="사용자ID"     </FC>'
                      + '<FC>id=USER_NAME        width=95                   edit=none			name="성명"         </FC>' 
                      + '<FC>id=HP_NO        	 width=100                  edit=none			name="핸드폰NO"     </FC>' 
                      ;
...
function btn_Search() { 
    ...
    TR_MAIN.Action="/pot/tcom402.tc?goTo="+goTo+parameters;  
...
{ 
	...
	for (var i=DS_O_RECV.CountRow; i>=1; i--)
	{
	    ...
	    {
	       if( DS_O_USER.NameValueRow("USER_ID",  DS_O_RECV.NameValue(i, "USER_ID") ) == 0 ) 
	       {
	    	   DS_O_USER.AddRow();
...
{     
	...
	{
	    if(DS_O_USER.NameValue(i,"CHK") == "T") maxCntChk +=1;
	}
	...
	*/
	...
	for (var i=DS_O_USER.CountRow; i>=1; i--)
	{
	    if(DS_O_USER.NameValue(i,"CHK") == "T")
	    {
	       ...
	       if( DS_O_RECV.NameValueRow("USER_ID",  DS_O_USER.NameValue(i, "USER_ID") ) == 0 ) 
	       { 
	    		/*
	...
	if(cntRow == 0) showMessage(EXCLAMATION, OK, "USER-1000", "추가 할 대상이 없습니다.");
	/*
	if(errChk != "Y")
	{
	    if  (cntRow >0)   
...
function sendSmsList()
{
	...
	for (var i=1; i<=DS_O_RECV.CountRow; i++)
	{
	    if(DS_O_RECV.NameValue(i,"CHK") == "T")
	    {
	       if( objDs.NameValueRow("USER_ID",  DS_O_RECV.NameValue(i, "USER_ID") ) == 0 ) 
	       {  
	    		objDs.AddRow();
...
<table width="800" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td>
            	...
            	<td width="414">
            		<table border="0" align="right" cellpadding="0" cellspacing="0">
              		<tr>
                		...
                		<td><img src="./imgs/btn/cancel.gif" width="50" height="22" onClick="btn_Cancle();" /></td>
          	...
          	<tr><td>
          		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table">
              		<tr>
                		...
                		<td> 
		                   <comment id="_NSID_">
		                     <object id=EM_USER_NAME classid=<%=Util.CLSID_EMEDIT%>   width=100 tabindex=1></object>
          	...
          	<tr>
          		<td >
	            	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="g_table">
		            	<tr><td>
							<comment id="_NSID_"><OBJECT id=GD_USER_LIST width=100% height="277" classid=<%=Util.CLSID_GRID%>>
            	...
            	<td class="PL03">
            		<img src="./imgs/btn/before.gif" width="19" height="18" onClick="moveLeft();"><br>
              		<img src="./imgs/btn/next.gif"   width="19" height="18" vspace="2" onClick="moveRight();"></td>
            	<td class="PL03">
	            	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="g_table">
		            	<tr><td>
							<comment id="_NSID_"><OBJECT id=GD_RECV_LIST width=100% height="277" classid=<%=Util.CLSID_GRID%>>
		...
		<tr><td class="center PT05 PB03">
			<img src="./imgs/btn/sms_send.gif" width="132" height="22" onClick="sendSmsList();">
		</td></tr>
 	</table>
 	</td>
    <td class="pop06" ></td>
