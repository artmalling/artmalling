...
function doInit(){
	...
	initEmEdit(EM_P_NAME    , "GEN^100"     , PK);        // 작성자
	initEmEdit(EM_TEL1      , "CODE^3^0" 	, PK);      	// 전화번호
	initEmEdit(EM_TEL2      , "CODE^4^0" 	, PK);      	// 전화번호
	initEmEdit(EM_TEL3      , "CODE^4^0" 	, PK);     	// 전화번호
	initEmEdit(EM_FILE_NM	, "GEN"			, PK);		// 첨부파일
	initTxtAreaEdit(TEXT_CONTENT, PK);               		// 내용
	initComboStyle(LC_O_NOTI_FLAG, DS_O_NOTI_FLAG,  "CODE^0^30,NAME^0^80",  1, READ);     //게시분류
								...
								<td>
									<table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table">
										...
										<tr>
											...
											<td width=130 >
												<comment id="_NSID_">
													<object id=LC_O_NOTI_FLAG classid=<%= Util.CLSID_LUXECOMBO %> height=100 width=130 align="absmiddle" tabindex=1>
													</object>
												</comment>
												<script>_ws_(_NSID_);</script>
											</td>
											...
											<td>
												<comment id="_NSID_">
													<object id=EM_S_DATE width="80" align="absmiddle" classid="<%=Util.CLSID_EMEDIT%>">
												...
												~
												<comment id="_NSID_">
													<object id=EM_E_DATE width="80" align="absmiddle" classid="<%=Util.CLSID_EMEDIT%>">
														<param name="ReadOnly"      value="true">
													</object>
												</comment>
												<script> _ws_(_NSID_);</script>
										...
										<tr>
											...
											<td width="130">
												<comment id="_NSID_">
													<object id=EM_P_NAME width="130" align="absmiddle" classid="<%=Util.CLSID_EMEDIT%>">
														<param name="ReadOnly"      value="true">
													</object>
												</comment>
												<script> _ws_(_NSID_);</script>
											...
											<td>
												<comment id="_NSID_">
													<object id=EM_TEL1 width="40" align="absmiddle" classid="<%=Util.CLSID_EMEDIT%>">
														<param name="ReadOnly"      value="true">
													</object>
												</comment>
												<script> _ws_(_NSID_);</script>
												-
												<comment id="_NSID_">
													<object id=EM_TEL2 width="40" align="absmiddle" classid="<%=Util.CLSID_EMEDIT%>">
														<param name="ReadOnly"      value="true">
													</object>
												</comment>
												<script> _ws_(_NSID_);</script>
												-
												<comment id="_NSID_">
													<object id=EM_TEL3 width="40" align="absmiddle" classid="<%=Util.CLSID_EMEDIT%>">
														<param name="ReadOnly"      value="true">
													</object>
												</comment>
												<script> _ws_(_NSID_);</script>
										...
										<tr>
											...
											<td colspan =3>
												<comment id="_NSID_">
													<object id=EM_P_TITLE width="560" align="absmiddle" classid="<%=Util.CLSID_EMEDIT%>">
														<param name="ReadOnly"      value="true">
													</object>
												</comment>
												<script> _ws_(_NSID_);</script>
										...
										<tr>
											...
											<td colspan="3">
												...
												<comment id="_NSID_">
													<object id=TEXT_CONTENT width="100%" height="450" align="absmiddle" classid="<%=Util.CLSID_TEXTAREA%>">
														<param name="ReadOnly"      value="true">
										...
										<tr>
											...
											<td colspan =3>
												<comment id="_NSID_">
													<object id=EM_FILE_NM classid=<%=Util.CLSID_EMEDIT%> height=20 width=430 >
														<param name="Enable" value="false">
													</object>
												</comment>
												<script>_ws_(_NSID_);</script>
