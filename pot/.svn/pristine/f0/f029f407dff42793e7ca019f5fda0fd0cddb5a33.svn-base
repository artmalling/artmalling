...
{     	
    ...
    initEmEdit(EM_VEN_NAME, "GEN^40", NORMAL);
    initEmEdit(EM_PUMBUN_NAME, "GEN^40", NORMAL);

    // Input Data Set Header 초기화 
    DS_I_COND.setDataHeader  ('SKU_CD:STRING(13),SKU_NAME:STRING(40),AUTH_GB:STRING(1),ADD_CONDITION:STRING(200),VEN_NAME:STRING(40),PUMBUN_NAME:STRING(40)');
    DS_I_COND.ClearData();
    DS_I_COND.Addrow();
    ...
    DS_I_COND.NameValue(DS_I_COND.RowPosition, "VEN_NAME") = venNm;
    DS_I_COND.NameValue(DS_I_COND.RowPosition, "PUMBUN_NAME") = pumbunNm;
...
{ 
    ...
    TR_MAIN.Action="/pot/ccom004.cc?goTo=searchOnPop";
          ...
          <tr>
            <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table">
              ...
              <tr>
                ...
                <td>
                <comment id="_NSID_">
                    <object id=EM_VEN_NAME classid=<%=Util.CLSID_EMEDIT%> height=20 width=240 onKeyDown="if(event.keyCode == 13) btn_Search();" >
                    </object>
                </comment><script>_ws_(_NSID_);</script>
                </td>
              </tr>
              <tr>
                ...
                <td>
                <comment id="_NSID_">
                    <object id=EM_PUMBUN_NAME classid=<%=Util.CLSID_EMEDIT%> height=20 width=240 onKeyDown="if(event.keyCode == 13) btn_Search();" >
                    </object>
                </comment><script>_ws_(_NSID_);</script>
                </td>
              </tr>
