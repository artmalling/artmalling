 ...
 *************************************************************************/
 ...
 var eventThmeCd    = dialogArguments[1];
 var eventThmeNm    = dialogArguments[2];
...
{     	
    ...
    // EMedit 초기화
    initEmEdit(EM_EVENT_THME_CD, "CODE^4^#", NORMAL);
    initEmEdit(EM_EVENT_THME_NAME, "GEN^40", NORMAL);

    // Input Data Set Header 초기화 
    DS_I_COND.setDataHeader  ('EVENT_THME_CD:STRING(4),EVENT_THME_NAME:STRING(40),ADD_CONDITION:STRING(200)');
    DS_I_COND.ClearData();
    DS_I_COND.Addrow();

    DS_I_COND.NameValue(DS_I_COND.RowPosition, "EVENT_THME_CD") = eventThmeCd; 
    DS_I_COND.NameValue(DS_I_COND.RowPosition, "EVENT_THME_NAME") = eventThmeNm; 
    DS_I_COND.NameValue(DS_I_COND.RowPosition, "ADD_CONDITION") = addCondition;

    EM_EVENT_THME_CD.Focus();
    if(eventThmeCd.length > 0 || eventThmeNm.length > 0   ){
        btn_Search();
    }
} 

function gridCreate1(){
    var hdrProperies = '<FC>ID="EVENT_THME_CD"        name="행사테마코드"       width=100,   edit=none,   align=center</FC>'
                     + '<FC>ID="EVENT_THME_NAME"      name="행사테마명"         width=180,  edit=none,   align=left  </FC>'
                     + '<FC>ID="EVENT_L_CD"           name="대"                 width=110,   edit=none,   align=left,  show=false  </FC>'
                     + '<FC>ID="EVENT_M_CD"           name="중"                 width=110,   edit=none,   align=left,  show=false  </FC>'
                     + '<FC>ID="EVENT_S_CD"           name="소"                 width=80,   edit=none,   align=left show=false</FC>';
    if( multiGb == "M"){
        hdrProperies = '<FC>ID="SEL"                 name="선택"           width=30,   align=center, EditStyle="CheckBox"</FC>'
                     + '<FC>ID="EVENT_THME_CD"        name="행사테마코드"       width=100,   edit=none,   align=center</FC>'
                     + '<FC>ID="EVENT_THME_NAME"      name="행사테마명"         width=180,  edit=none,   align=left  </FC>'
                     + '<FC>ID="EVENT_L_CD"           name="대"                 width=110,   edit=none,   align=left,  show=false  </FC>'
                     + '<FC>ID="EVENT_M_CD"           name="중"                 width=110,   edit=none,   align=left,  show=false  </FC>'
                     + '<FC>ID="EVENT_S_CD"           name="소"                 width=80,   edit=none,   align=left show=false</FC>';
 ...
 *************************************************************************/ 
  ...
  */
  ...
  { 
      ...
      TR_MAIN.Action="/pot/ccom014.cc?goTo=searchOnPop";
        ...
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="" class="title">
              ...
              <span id="title1" class="PL03">행사테마</span>
            </td>
        ...
        <td class="popT01 PB03"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="o_table">
          <tr>
            <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table">
              <tr>
                <th width="80">행사테마코드</th>
                <td >
                <comment id="_NSID_">
                    <object id=EM_EVENT_THME_CD classid=<%=Util.CLSID_EMEDIT%> height=20 width=110 onKeyDown="if(event.keyCode == 13) btn_Search();" >
                    </object>
              ...
              <tr>
                ...
                <td>
                <comment id="_NSID_">
                    <object id=EM_EVENT_THME_NAME classid=<%=Util.CLSID_EMEDIT%> height=20 width=225 onKeyDown="if(event.keyCode == 13) btn_Search();" >
                    </object>
                </comment><script>_ws_(_NSID_);</script>
                </td>
              </tr>
