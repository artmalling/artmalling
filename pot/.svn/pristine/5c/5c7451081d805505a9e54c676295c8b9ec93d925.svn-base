...
function doInit(){
    ...
    // EMedit에 초기화
    initEmEdit(EM_VRTN_CD,   "00",          NORMAL);      //카드발급사코드
    initEmEdit(EM_VRTN_NM,   "GEN^20",      NORMAL);      //카드발급사이름
}

function gridCreate1(){
    var hdrProperies = '<FC>id={currow}        name="NO"               width=30    align=center</FC>'
                     + '<FC>id=CODE            name="VAN사반송코드"      width=100    align=center</FC>'
                     + '<FC>id=NAME            name="VAN사반송코드명"    width=200   align=left</FC>';
...
function showMaster(){
    ...
    var action     = "O";     
    var parameters = "&strVrtnCd="+encodeURIComponent(EM_VRTN_CD.text)+
                     "&strVrtnNm="+encodeURIComponent(EM_VRTN_NM.text);
    
    TR_MAIN.Action="/<%=dir%>/ccom028.cc?goTo="+goTo+parameters;  
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td width="396" class="title"><img
                            ...
                            align="absmiddle" class="popR05 PL03" /> VAN사 반송코드 조회</td>
                        <td>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0"
                    ...
                    <tr>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0"
                            class="s_table">
                            <tr>
                                <th width="100">VAN사반송코드</th>
                                <td><comment id="_NSID_"> <object id=EM_VRTN_CD
                                    classid=<%=Util.CLSID_EMEDIT%>
                                    onkeyup="javascript:checkByteStr(EM_VRTN_CD, 2, '', '', '');"
                                    width=250 tabindex=1 align="absmiddle"></object> </comment><script> _ws_(_NSID_);</script></td>
                            </tr>
                            <tr>
                                <th width="100">VAN사반송코드명</th>
                                <td><comment id="_NSID_"> <object id=EM_VRTN_NM
                                    classid=<%=Util.CLSID_EMEDIT%> onkeyup="javascript:checkByteStr(EM_VRTN_NM, 20, '', '', '');"
                                    width=250 tabindex=1 align="absmiddle"></object> </comment><script> _ws_(_NSID_);</script></td>
