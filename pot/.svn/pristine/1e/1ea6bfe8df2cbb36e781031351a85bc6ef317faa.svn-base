...
public class CCom022DAO extends AbstractDAO {
    /*
    ...
    public List searchOnPop(ActionForm form, MultiInput mi, boolean codeLikeGb , String userId, String orgFlag ) throws Exception {
		...
		if( !mi.getString("MNG_NM1").equals("") ){
            sql.put(svc.getQuery("SEL_BTYPESKUMST_WHERE_MNG_NM1"));
            sql.setString(++i, mi.getString("MNG_NM1"));
        }
		...
		if( !mi.getString("MNG_NM2").equals("") ){
            sql.put(svc.getQuery("SEL_BTYPESKUMST_WHERE_MNG_NM2"));
            sql.setString(++i, mi.getString("MNG_NM2"));
        }
		...
		if( !mi.getString("MNG_NM3").equals("") ){
            sql.put(svc.getQuery("SEL_BTYPESKUMST_WHERE_MNG_NM3"));
            sql.setString(++i, mi.getString("MNG_NM3"));
        }
		...
		if( !mi.getString("MNG_NM4").equals("") ){
            sql.put(svc.getQuery("SEL_BTYPESKUMST_WHERE_MNG_NM4"));
            sql.setString(++i, mi.getString("MNG_NM4"));
        }
		...
		if( !mi.getString("MNG_NM5").equals("") ){
            sql.put(svc.getQuery("SEL_BTYPESKUMST_WHERE_MNG_NM5"));
            sql.setString(++i, mi.getString("MNG_NM5"));
        }
