...
public class CCom022Action extends DispatchAction {
	/*
	 * Java Pattern 에서 지원하는 logger를 사용할 수 있도록 객체를 선언
	 */
	private Logger logger = Logger.getLogger(CCom022Action.class);
     ...
     * </p>
     */
    public ActionForward skuBTypePop(ActionMapping mapping, ActionForm form,
	...
	public ActionForward searchOnPop(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			helper.setDataSetHeader(dSet[0], "H_BTYPESKUMST_COND");
			helper.setDataSetHeader(dSet[1], "H_BTYPESKUMST");
	...
	public ActionForward searchOnWithoutPop(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			dao = new CCom022DAO();
			list = dao.searchOnWithoutPop(form, mi, true, userId, orgFlag);
