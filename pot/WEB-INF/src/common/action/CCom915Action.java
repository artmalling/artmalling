...
public class CCom915Action extends DispatchAction {
	/*
	 * Java Pattern 에서 지원하는 logger를 사용할 수 있도록 객체를 선언
	 */
	private Logger logger = Logger.getLogger(CCom915Action.class);
	...
	public ActionForward searchOnWithoutPordPop(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			dao = new CCom915DAO();
			list = dao.searchOnPop(form, mi, false, userId, orgFlag);
