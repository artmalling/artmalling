...
public class CCom008Action extends DispatchAction {
	/*
	 * Java Pattern 에서 지원하는 logger를 사용할 수 있도록 객체를 선언
	 */
	private Logger logger = Logger.getLogger(CCom008Action.class);
     ...
     * </p>
     */
    public ActionForward orgCornerOutPop(ActionMapping mapping, ActionForm form,
