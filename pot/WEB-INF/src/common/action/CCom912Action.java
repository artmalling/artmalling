...
import common.dao.CCom009DAO;
import common.dao.CCom912DAO;
...
public class CCom912Action extends DispatchAction {
	/*
	 * Java Pattern 에서 지원하는 logger를 사용할 수 있도록 객체를 선언
	 */
	private Logger logger = Logger.getLogger(CCom912Action.class);
	 ...
	 * 
	 */
	public ActionForward searchOnPop22(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		...
		System.out.println("----------------------------------searchOnWithoutPop----------------------------- " );
		...
		try {
			...
			helper.setDataSetHeader(dSet[1], "H_ORGMST");
