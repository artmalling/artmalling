...
public class CCom012Action extends DispatchAction {
     ...
     * </p>
     */
    public ActionForward strPbnPop(ActionMapping mapping, ActionForm form,
    ...
    /**
     * <p>
     * 점별 품번 팝업(조회조건에 사용유무 추가)
     * </p>
     */
    public ActionForward strPbnPop2(ActionMapping mapping, ActionForm form,
            HttpServletRequest request, HttpServletResponse response)
            throws Exception {
		GauceHelper2 helper = null;
		String strGoTo = form.getParam("goTo"); // 분기할곳
	...
	public ActionForward searchOnPop(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			helper.setDataSetHeader(dSet[1], "H_STRPBN");
	...
	/**
	 * <p>
	 * 팝업에서 조회(조회조건에 사용유무 추가)
	 * </p>
	 * 
	 */
	public ActionForward searchOnPop2(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		List list = null;
		GauceHelper2 helper = null;
		...
		try {
			...
			dao = new CCom012DAO();
			list = dao.searchOnPop2(form, mi, true, userId, orgFlag);
	 ...
	 * 
	 */
	public ActionForward searchPumbunInfo(ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		List list = null;
		GauceHelper2 helper = null;
		...
		try {
			...
			helper.setDataSetHeader(dSet, "H_PBNMST_INFO");

			dao = new CCom012DAO();
			list = dao.searchPbnInfo(form);
