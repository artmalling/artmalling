...
<%
    ...
    // 게시판
	List tempList    		= null;
    List noticeListMark 	= (List) request.getAttribute("noticeMark"); 
...
{
	this.location.href = "/pot/tcom001.tc?goTo=showNotiMark&iCurrRow="+curr_page_all;
}
...
<%     
     for(int i=0; i <  plRowRange; i++){ 
         if(i < noticeListMark.size()) {
       	  tempList  = (List) noticeListMark.get(i);
