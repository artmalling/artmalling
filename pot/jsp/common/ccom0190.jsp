 ...
 *************************************************************************/
 ...
 var posNo          = dialogArguments[1];
 var posNm          = dialogArguments[2];
...
{     	
    ...
    DS_I_COND.setDataHeader  ('POS_NO:STRING(4),POS_NAME:STRING(20),ADD_CONDITION:STRING(200)');
    DS_I_COND.ClearData();
    DS_I_COND.Addrow();

    DS_I_COND.NameValue(DS_I_COND.RowPosition, "POS_NO") = posNo; 
    DS_I_COND.NameValue(DS_I_COND.RowPosition, "POS_NAME") = posNm; 
    DS_I_COND.NameValue(DS_I_COND.RowPosition, "ADD_CONDITION") = addCondition;

    EM_POS_NO.Focus();
    if(posNo.length > 0 || posNm.length > 0   ){
        btn_Search();
    }
} 

function gridCreate1(){
    var hdrProperies = '<FC>ID="POS_NO"     name="POS번호"       width=100,   edit=none,   align=center</FC>'
                     + '<FC>ID="POS_NAME"   name="POS명"         width=180,  edit=none,   align=left  </FC>';
    if( multiGb == "M"){
        hdrProperies = '<FC>ID="SEL"        name="선택"          width=30,   align=center, EditStyle="CheckBox"</FC>'
                     + '<FC>ID="POS_NO"     name="POS번호"       width=100,   edit=none,   align=left</FC>'
                     + '<FC>ID="POS_NAME"   name="POS명"         width=180,  edit=none,   align=left  </FC>';
    }                 
 ...
 *************************************************************************/ 
  ...
  */
  ...
  { 
      ...
      TR_MAIN.Action="/pot/ccom019.cc?goTo=searchOnPop";
