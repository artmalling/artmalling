...
{     	
    ...
    // EMedit 초기화
    initEmEdit(EM_PUMMOK_CD, "CODE^8^#", NORMAL);
    initEmEdit(EM_PUMMOK_NM, "GEN^40", NORMAL);

    // Input Data Set Header 초기화 
    DS_I_COND.setDataHeader  ('PUMMOK_CD:STRING(8),PUMMOK_NM:STRING(40),ADD_CONDITION:STRING(200)');
    DS_I_COND.ClearData();
    DS_I_COND.Addrow();
    ...
    EM_PUMMOK_CD.Focus();
    if(pummokCd.length > 0 ||pummokNm.length > 0   ){
        btn_Search();
    }
} 
    
function gridCreate1(){
    var hdrProperies = '<FC>ID="PUMMOK_CD"    name="품목코드"  width=80,   edit=none,   align=center</FC>'
 ...
 *************************************************************************/ 
  ...
  */
  ...
  { 
      ...
      TR_MAIN.Action="/pot/ccom009.cc?goTo=searchOnPop";
        ...
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="" class="title">
              ...
              <span id="title1" class="PL03">품목</span>
            </td>
          ...
          <tr>
            <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table">
              ...
              <tr>
                ...
                <td>
                <comment id="_NSID_">
                    <object id=EM_PUMMOK_NM classid=<%=Util.CLSID_EMEDIT%> height=20 width=245 onKeyDown="if(event.keyCode == 13) btn_Search();" >
                    </object>
                </comment><script>_ws_(_NSID_);</script>
                </td>
              </tr>
