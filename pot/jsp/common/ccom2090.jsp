...
{       
    ...
    // EMedit 초기화
    initEmEdit(EM_SEL_CODE,    "GEN^13", NORMAL);
...
function gridCreate(mGbn){
    ...
    if (mGbn == "M") {
        ...
        hdrProperies = ''
            ...
            + '                                         WIDTH=30   EDIT=NONE    ALIGN=CENTER</FC>'
            + '<FC>ID=CODE          NAME="사원번호"'         
            + '                                         WIDTH=90   EDIT=NONE    ALIGN=LEFT</FC>'
            + '<FC>ID=NAME          NAME="사원명"'        
