...
<html>
<head>
<title>바이어(SM)사원 코드 -POPUP</title>
...
function gridCreate1(){
    ...
    var hdrProperies = '<FC>ID="EMP_NO"       name="사원코드"       width=60,   edit=none,   align=center</FC>'
                     + '<FC>ID="EMP_NAME"     name="사원명"         width=60,   edit=none,   align=center  </FC>'
                     + '<FC>ID="BUYER_CD"     name="바이어(SM)코드"       width=100,   edit=none,   align=center</FC>'
                     + '<FC>ID="BUYER_NAME"   name="바이어(SM)명"         width=120,   edit=none,   align=left  </FC>'
    ...
    if( multiGb == "M"){
    	hdrProperies = '<FC>ID="SEL"          name="선택"              width=30,   align=center, EditStyle="CheckBox"</FC>'
    		         + '<FC>ID="EMP_NO"       name="사원코드"     width=60,   edit=none,   align=center</FC>'
                     + '<FC>ID="EMP_NAME"     name="사원명"       width=60,   edit=none,   align=center  </FC>'
                     + '<FC>ID="BUYER_CD"     name="바이어(SM)코드"     width=100,   edit=none,   align=center</FC>'
                     + '<FC>ID="BUYER_NAME"   name="바이어(SM)명"       width=120,   edit=none,   align=left  </FC>'
                     + '<FC>ID="PUMBUN_CD"    name="정부구분"            width=80,    edit=none,   align=left show=false </FC>';
...
{ 
    ...
    TR_MAIN.Action="/pot/ccom031.cc?goTo=searchOnPop";
        ...
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="" class="title">
              ...
              <span id="title1" class="PL03">바이어(SM)사원 코드 </span>
            </td>
