 ...
 *************************************************************************/
 ...
 var argVenFlag     = dialogArguments[5];
...
{       
    ...
    DS_I_CONDITION.setDataHeader  ('CODE:STRING(20),NAME:STRING(40),STR_CD:STRING(2),VEN_FLAG:STRING(2),ADD_CONDITION:STRING(200)');
...
function gridCreate(mGbn){
    ...
    if (mGbn == "M") {
        hdrProperies = ''
            ...
            + '<FC>ID=CODE          NAME="협력사 코드"  WIDTH=110   EDIT=NONE    ALIGN=CENTER</FC>'
            + '<FC>ID=NAME          NAME="협력사명"     WIDTH=150  EDIT=NONE    ALIGN=LEFT</FC>';
    } else {
        hdrProperies = ''
            + '<FC>ID={CURROW}      NAME="NO"  WIDTH=30   EDIT=NONE    ALIGN=CENTER</FC>'
            + '<FC>ID=CODE          NAME="협력사 코드"  WIDTH=110   EDIT=NONE    ALIGN=CENTER</FC>'
 ...
 */
 ...
 { 
       ...
       DS_I_CONDITION.NameValue(DS_I_CONDITION.RowPosition, "VEN_FLAG") = argVenFlag; 
