...
function doInit(){
    ...
    // EMedit에 초기화
    initEmEdit(EM_CCOMP_CD,   "00",          NORMAL);      //카드발급사코드
    initEmEdit(EM_CCOMP_NM,   "GEN^20",      NORMAL);      //카드발급사이름
}

function gridCreate1(){
    var hdrProperies = '<FC>id={currow}        name="NO"               	width=30    align=center</FC>'
                     + '<FC>id=CODE            name="코드"     			width=50	align=center</FC>'
                     + '<FC>id=NAME            name="발급사명"       	width=80   align=left</FC>'
                     + '<FC>id=BIN_NO          name="카드빈"      		width=70   align=center</FC>'
                     + '<FC>id=VCARD_NAME      name="카드종류"       	width=100   align=left</FC>';                     
...
function showMaster(){
    ...
    var action     = "O";     
    var parameters = "&strCcompCd="+encodeURIComponent(EM_CCOMP_CD.text)+
                     "&strCcompNm="+encodeURIComponent(EM_CCOMP_NM.text);
    
    TR_MAIN.Action="/<%=dir%>/ccom030.cc?goTo="+goTo+parameters;  
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="396" class="title"><img
							...
							align="absmiddle" class="popR05 PL03" /> 카드발급사 조회</td>
						<td>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0"
							class="s_table">
							<tr>
								<th width="100">카드발급사코드</th>
								<td><comment id="_NSID_"> <object id=EM_CCOMP_CD
									classid=<%=Util.CLSID_EMEDIT%>
									onkeyup="javascript:checkByteStr(EM_CCOMP_CD, 2, '', '', '');"
									width=250 tabindex=1 align="absmiddle"></object> </comment><script> _ws_(_NSID_);</script></td>
							</tr>
							<tr>
								<th width="100">카드발급사명</th>
								<td><comment id="_NSID_"> <object id=EM_CCOMP_NM
									classid=<%=Util.CLSID_EMEDIT%> onkeyup="javascript:checkByteStr(EM_CCOMP_NM, 20, '', '', '');"
									width=250 tabindex=1 align="absmiddle"></object> </comment><script> _ws_(_NSID_);</script></td>
