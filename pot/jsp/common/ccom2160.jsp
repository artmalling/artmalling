<!-- 
/*******************************************************************************
 * 시스템명 : 사은행사 제휴카드사 협력사별 제휴카드 정보 팝업
 * 작 성 일 : 2010.05.02
 * 작 성 자 : 김성미
 * 수 정 자 : 
 * 파 일 명 : ccom2160.jsp
 ...
 *************************************************************************/
 ...
 var argStrCd       = dialogArguments[2];
...
{       
    ...
    // 초기화
    initEmEdit(EM_SEL_CODE,    "NUMBER3^2",  NORMAL);
...
function gridCreate(mGbn){
    ...
    if (mGbn == "M") {
        hdrProperies = ''
            + '<FC>ID={CURROW}       NAME="NO"           WIDTH=30        EDIT=NONE   ALIGN=CENTER</FC>'
            + '<FC>ID=CHK            NAME=""             WIDTH=30        EDIT=ANY    ALIGN=CENTER    EDITSTYLE=CHECKBOX  HEADCHECKSHOW=TRUE</FC>'
            + '<FC>ID=CODE       NAME="카드사코드"    WIDTH=70     EDIT=NONE   ALIGN=CENTER</FC>'
            + '<FC>ID=NAME       NAME="카드사명"      WIDTH=80PX      EDIT=NONE   ALIGN=LEFT</FC>'
            + '<FC>ID=VEN_CD         NAME="협력사 코드"    WIDTH=70     EDIT=NONE   ALIGN=CENTER</FC>'
            + '<FC>ID=VEN_NM         NAME="협력사명"      WIDTH=80PX       EDIT=NONE   ALIGN=LEFT</FC>';
    } else {
        hdrProperies = ''
            + '<FC>ID={CURROW}      NAME="NO"   WIDTH=30        EDIT=NONE   ALIGN=CENTER</FC>'
            + '<FC>ID=CODE       NAME="카드사코드"    WIDTH=70     EDIT=NONE   ALIGN=CENTER</FC>'
 ...
 *************************************************************************/ 
  ...
  */
  ...
  { 
        ...
        DS_I_CONDITION.NameValue(DS_I_CONDITION.RowPosition, "STR_CD")      = argStrCd;    
        DS_I_CONDITION.NameValue(DS_I_CONDITION.RowPosition, "CARD_COMP")   = EM_SEL_CODE.Text;
        DS_I_CONDITION.NameValue(DS_I_CONDITION.RowPosition, "CARD_COMP_NM")   = EM_SEL_NAME.Text;
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0"
                    ...
                    <tr>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <th width="70">제휴카드사명</th>
                                <td><comment id="_NSID_"> <object id=EM_SEL_NAME
                                    classid=<%=Util.CLSID_EMEDIT%> height=20 width=220
                                    onKeyDown="if(event.keyCode == 13) btn_Search();"> </object> </comment><script>_ws_(_NSID_);</script>
                                </td>
                            </tr>
                        </table>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0"
                    ...
                    <tr>
                        <td><!-- 마스터 --> <comment id="_NSID_"><OBJECT
                            id=GD_SEARCH height="280px" width="100%"
