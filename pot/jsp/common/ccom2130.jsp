 ...
 *************************************************************************/
 ...
 var argVenTbGnb    = dialogArguments[4];
 var argSearchGb    = dialogArguments[5];
...
if(argVenTbGnb == "1"){
	strTitle = "제휴협력사 조회";
}else if(argVenTbGnb == "2" || argVenTbGnb == "4"){
	strTitle = "가맹점 조회";
}else{
	strTitle = "위탁 협력사 조회";
}
...
{       
    ...
    title1
    // EMedit 초기화
    initEmEdit(EM_SEL_CODE,    "GEN^6", NORMAL);
...
function gridCreate(mGbn){
    ...
    if (mGbn == "M") {
        hdrProperies = ''
            ...
            if(argVenTbGnb == "1"){
            	hdrProperies +=  '<FC>ID=CODE          NAME="제휴협력사 코드" WIDTH=110   EDIT=NONE    ALIGN=CENTER</FC>';
            	hdrProperies += '<FC>ID=NAME          NAME="제휴협력사 명"   WIDTH=150  EDIT=NONE    ALIGN=LEFT</FC>';
            }else if(argVenTbGnb == "2" || argVenTbGnb == "4"){
            	hdrProperies += '<FC>ID=CODE          NAME="가맹점코드"     WIDTH=110   EDIT=NONE    ALIGN=CENTER</FC>';
            	hdrProperies += '<FC>ID=NAME          NAME="가맹점명"       WIDTH=150  EDIT=NONE    ALIGN=LEFT</FC>';
            }else{
            	hdrProperies += '<FC>ID=CODE          NAME="위탁 협력사 코드"  WIDTH=110   EDIT=NONE    ALIGN=CENTER</FC>';
            	hdrProperies += '<FC>ID=NAME          NAME="위탁 협력사명"     WIDTH=150  EDIT=NONE    ALIGN=LEFT</FC>';
            }
 ...
 */
 ...
 { 
       ...
       DS_I_CONDITION.NameValue(DS_I_CONDITION.RowPosition, "TBGBN")= argVenTbGnb; 
       DS_I_CONDITION.NameValue(DS_I_CONDITION.RowPosition, "SEARCHGB")= argSearchGb; 
