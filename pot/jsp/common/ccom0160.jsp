...
{     	
    ...
    // EMedit 초기화
    initEmEdit(EM_VEN_CD, "CODE^6^0", NORMAL);
    initEmEdit(EM_VEN_NAME, "GEN^40", NORMAL);

    // Input Data Set Header 초기화 
    DS_I_COND.setDataHeader  ('VEN_CD:STRING(6),VEN_NAME:STRING(40),ADD_CONDITION:STRING(200)');
    DS_I_COND.ClearData();
    DS_I_COND.Addrow();

    DS_I_COND.NameValue(DS_I_COND.RowPosition, "VEN_CD") = venCd; 
...
function gridCreate1(){
    var hdrProperies = '<FC>ID="VEN_CD"         name="협력사코드"       width=100,   edit=none,   align=center</FC>'
                     + '<FC>ID="VEN_NAME"       name="협력사명"         width=180,  edit=none,   align=left  </FC>'
                     + '<FC>ID="VEN_SHORT_NAME" name="협력사약명"       width=110,   edit=none,   align=left,  show=false  </FC>'
                     + '<FC>ID="COMP_NO"        name="사업자번호"       width=110,   edit=none,   align=left,  show=false  </FC>'
                     + '<FC>ID="REP_VEN_CD"     name="대표협력사코드"   width=110,   edit=none,   align=left,  show=false  </FC>'
                     + '<FC>ID="STR_CD"         name="점코드"          width=80,   edit=none,   align=left show=false</FC>'
                     + '<FC>ID="PAY_CYC"        name="지불주기"        width=110,   edit=none,   align=left,  show=false  </FC>'
                     + '<FC>ID="PAY_WAY"        name="지불방법"        width=110,   edit=none,   align=left,  show=false  </FC>'
                     + '<FC>ID="RUND_FLAG"      name="반올림구분"      width=80,   edit=none,   align=left show=false</FC>'
                     + '<FC>ID="PAY_HOLI_FLAG"  name="지불시기구분"    width=110,   edit=none,   align=left,  show=false  </FC>';
    if( multiGb == "M"){
        hdrProperies = '<FC>ID="SEL"            name="선택"            width=30,   align=center, EditStyle="CheckBox"</FC>'
                     + '<FC>ID="VEN_CD"         name="협력사코드"       width=100,   edit=none,   align=center</FC>'
                     + '<FC>ID="VEN_NAME"       name="협력사명"         width=180,  edit=none,   align=left  </FC>'
                     + '<FC>ID="VEN_SHORT_NAME" name="협력사약명"       width=110,   edit=none,   align=left,  show=false  </FC>'
                     + '<FC>ID="COMP_NO"        name="사업자번호"       width=110,   edit=none,   align=left,  show=false  </FC>'
                     + '<FC>ID="REP_VEN_CD"     name="대표협력사코드"   width=110,   edit=none,   align=left,  show=false  </FC>'
 ...
 *************************************************************************/ 
  ...
  */
  ...
  { 
      ...
      TR_MAIN.Action="/pot/ccom016.cc?goTo=searchOnPop";
        ...
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="" class="title">
              ...
              <span id="title1" class="PL03">협력사</span>
            </td>
          ...
          <tr>
            <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table">
              <tr>
                ...
                <td >
                <comment id="_NSID_">
                    <object id=EM_VEN_CD classid=<%=Util.CLSID_EMEDIT%> height=20 width=110 onKeyDown="if(event.keyCode == 13) btn_Search();" >
                    </object>
              ...
              <tr>
                ...
                <td>
                <comment id="_NSID_">
                    <object id=EM_VEN_NAME classid=<%=Util.CLSID_EMEDIT%> height=20 width=235 onKeyDown="if(event.keyCode == 13) btn_Search();" >
                    </object>
                </comment><script>_ws_(_NSID_);</script>
                </td>
              </tr>
