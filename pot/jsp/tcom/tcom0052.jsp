...
{ 
    ...
    getEtcCode("DS_O_MINUTE", "D", "TC04", "N");
...
function bookReq()
{
	...
	var inputDate = EM_S_DATE.Text+LC_O_HOUR.BindColVal+LC_O_MINUTE.BindColVal;

	if (nowDate > inputDate)
	{
	    showMessage(STOPSIGN, OK, "USER-1000", "예약일시는 현재일시보다 커야합니다.");  
	    EM_S_DATE.Focus();
	    return;
	}
	
	opener.sendSMS(inputDate);
}
      	...
      	<tr><td> 
			...
			<tr><td>
				...
				<tr>
	          	...
	          	<tr>
	          		<td colspan="2" align="center"><input type="button" value ="예약전송요청" class="s_table" style="cursor:pointer" onClick="bookReq();">
	          	</tr>
	        	</table>
	        </td></tr>
	        </table>
