...
<script language="javascript">
    ...
    var onlyTxt  = dialogArguments[4];
    var strPid   = dialogArguments[5];
 ...
 */
    ...
    function doInit(){
        ...
        if(onlyTxt){
            tbrdo_ItemDiv.CodeValue = "3";
            tbrdo_ItemDiv.Enable    = false;
        }
        //alert(strPid);
    }
    function on_Close(){
    ...
    function on_Save(){
        ...
        switch(strExcelFileType){
            case "1" :
                ...
                objGrid.SetExcelTitle(1, TITLE);        //타이틀 설정    
                ...
                objGrid.SetExcelTitle(1, TITLE);

                if (typeof(strCond)!= "undefined" && typeof(strCond)=="string"){
                    var strToken = strCond.split("^");
                    for (var i=0; i<strToken.length; i++){
                        objGrid.SetExcelTitle(1, 'value:'+strToken[i]+";");
                    }
                }

                objGrid.GridtoExcel("Sheet1",strTitle,29);
            ...
            case "2" :
                ...
                objGrid.GridtoExcel("Sheet1",strTitle,0);
                objGrid.SetExcelTitle(0, "");
                break;
            case "3" :
                // 2010년 03월 28일 추가           
                ...
                objGrid.ExportFileEx(strTitle + '.txt', false, 1, false);
                break;
            default :
                break;
        }
          ...
          <tr>
            <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table">
              <tr>
                 <td align=center>
                <comment id="_NSID_">
                <object id="tbrdo_ItemDiv" classid="<%=Util.CLSID_RADIO%>" height="22px" width="250px">
                       <param name="Cols"       value="3">
                       <param name="Format"     value="1^엑셀저장,2^엑셀열기,3^텍스트저장">
