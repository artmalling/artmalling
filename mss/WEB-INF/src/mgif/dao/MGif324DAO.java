...
public class MGif324DAO extends AbstractDAO {
	 ...
	 * @throws Exception
	 */
	public List getSALE_SLIP(ActionForm form) throws Exception {
		...
		strQuery = svc.getQuery("SEL_SALE_SLIP") + "\n";
		sql.put(strQuery);
	...
	*/
	...
	try {
		...
		svc = (Service) form.getService();		
	        ...
	        strSaleFlag =  form.getParam("strSaleFlag");	
			...
			System.out.println("strSaleFlag----------2 = " + strSaleFlag);
			
//			if (strSaleFlag.equals("01")) {
//				sql.setString(++i, "10");      //정상취소
//			} else if(strSaleFlag.equals("02")) {
//				sql.setString(++i, "11");      //특판취소
//			} else {						   
//				sql.setString(++i, "13");      //교환취소
//			}
			sql.setString(++i, strSaleFlag);    //정상, 특판, 교환취소
			sql.setString(++i, form.getParam("strStrCd"));
			sql.setString(++i, form.getParam("strSaleDt"));
			sql.setString(++i, strSlipNo); 
