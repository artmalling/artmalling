...
public class MGif621DAO extends AbstractDAO {
    ...
    public int ifsSend(ActionForm form, MultiInput mi, String strID)
    	...
    	public int save(ActionForm form, String userId)
    			throws Exception {
    		...
    		try {
    			...
    			int i = 1;            
    			psql.put("DPS.PR_DUZON_IF_PS_GIFT", 5);
    			     
                psql.setString(i++, form.getParam("strStrCd")); 	// 점코드
                psql.setString(i++, form.getParam("strSReqDt"));   // 판매일자
