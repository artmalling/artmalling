...
public class MCae426DAO extends AbstractDAO {
	 ...
	 * @throws Exception
	 */
	public List getCardEventInfo(ActionForm form, String userId) throws Exception {
		...
		String strStrCd = String2.nvl(form.getParam("strStrCd"));
		String strEventCd = String2.nvl(form.getParam("strEventCd"));
		String strCardCustId = String2.nvl(form.getParam("strCardCustId"));
		String strEventCyc = String2.nvl(form.getParam("strEventCyc"));
		String strAllBrand = "";
		...
		if (strEventCyc.equals("P")) {
			sql.put(svc.getQuery("SEL_CHECK_CARD_EVENT_P"));
			sql.setString(i++, strStrCd);
			sql.setString(i++, strEventCd);
			sql.setString(i++, strCardCustId);
			sql.setString(i++, strCardCustId);
		} else {
			sql.put(svc.getQuery("SEL_CHECK_CARD_EVENT"));
			sql.setString(i++, strStrCd);
			sql.setString(i++, strEventCd);
			sql.setString(i++, strCardCustId);
			sql.setString(i++, strCardCustId);
