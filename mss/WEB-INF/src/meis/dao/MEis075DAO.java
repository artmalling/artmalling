 ...
 * @caused by
 */
public class MEis075DAO extends AbstractDAO {
	 ...
	 * @throws Exception
	 */
	public List searchSaleAndManageRslt(ActionForm form, boolean chartFlag) throws Exception {
		...
		try {
			//파라미터 값 가져오기
			strRsltY = String2.trimToEmpty(form.getParam("strRsltY")); //경영계획년도
			...
			strLoc = "SEL_SALE_AND_MANAGE_RSLT";
			if(chartFlag) strLoc = "SEL_SALE_AND_MANAGE_RSLT_CHART";
