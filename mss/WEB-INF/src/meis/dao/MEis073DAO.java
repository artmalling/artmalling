 ...
 * @caused by
 */
public class MEis073DAO extends AbstractDAO {
	 ...
	 * @throws Exception
	 */
	public List<Map> searchSalesRslt(ActionForm form) throws Exception {
		List<Map> ret        = null;
		SqlWrapper sql  = null;
		Service svc     = null;
		String strLoc   = null;
		...
		try {
			...
			if(strOrgLevel.equals("1")) {
				strLoc = "SEL_SALES_RSLT_STR";
			//팀
			} else if(strOrgLevel.equals("3")) {
				strLoc = "SEL_SALES_RSLT_TEAM";
			//PC
			} else if(strOrgLevel.equals("4")) {
				strLoc = "SEL_SALES_RSLT_PC";
			}
