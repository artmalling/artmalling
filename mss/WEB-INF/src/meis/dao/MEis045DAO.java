 ...
 * @caused by
 */
public class MEis045DAO extends AbstractDAO {
	 ...
	 * @throws Exception
	 */
	public List searchProfitAndLossPlan(ActionForm form, boolean chartFlag) throws Exception {
		...
		try {
			...
			strLoc = "SEL_PROFIT_AND_LOSS_PLAN";
			if(chartFlag) strLoc = "SEL_PROFIT_AND_LOSS_PLAN_CHART";
