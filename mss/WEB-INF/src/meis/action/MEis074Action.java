 ...
 * @caused by
 */
public class MEis074Action extends DispatchAction {

	/*
	 * Java Pattern 에서 지원하는 logger를 사용할 수 있도록 객체를 선언
	 */
	private Logger logger = Logger.getLogger(MEis074Action.class);
	
	/** 
	 * <p>월별조직별손익실적조회 화면로딩</p>
	 */
	 ...
	 * <p>손익실적조회</p>
	 */
	public ActionForward searchProfitAndLossRslt(ActionMapping mapping, ActionForm form,
										HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			list    = dao.searchProfitAndLossRslt(form, false);
			helper.setDataSetHeader(dSet, "H_SEL_PROFIT_AND_LOSS_RSLT");
	...
	public ActionForward chartCall(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			dao     = new MEis074DAO();
			list    = dao.searchProfitAndLossRslt(form, true);
