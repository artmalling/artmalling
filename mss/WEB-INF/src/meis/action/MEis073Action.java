 ...
 * @caused by
 */
public class MEis073Action extends DispatchAction {

	/*
	 * Java Pattern 에서 지원하는 logger를 사용할 수 있도록 객체를 선언
	 */
	private Logger logger = Logger.getLogger(MEis073Action.class);
	 ...
	 * <p>매출실적조회</p>
	 */
	public ActionForward searchSalesRslt(ActionMapping mapping, ActionForm form,
										HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			list    = dao.searchSalesRslt(form);
			helper.setDataSetHeader(dSet, "H_SEL_SALES_RSLT");
