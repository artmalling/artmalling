...
function gridCreate(){
		...
		gd_tab1Header += '<FC>id=ORG_NAME                  		width=120 align=left  name="조직명" SubSumText=' + subSumText + ' SubBgColor=' + subSumBgColor + '   </FC>';
		
		gd_tab1Header += '<G>name="매출액(단위:백만)"';
		subSumText = "{ROUND(SUBSUM(PLAN_SALES_AMT)/" + amtUnit + ",0)}";
		gd_tab1Header += '	<C>id=PLAN_SALES_AMT     value={ROUND(PLAN_SALES_AMT/' + amtUnit + ',0)}     subsumtext=' + subSumText + '	width=80 align=right  name="계획" SubBgColor=' + subSumBgColor + ' </C>';
		subSumText = "{ROUND(SUBSUM(RSLT_SALES_AMT)/" + amtUnit + ",0)}";
		gd_tab1Header += '	<C>id=RSLT_SALES_AMT     value={ROUND(RSLT_SALES_AMT/' + amtUnit + ',0)}     subsumtext=' + subSumText + ' 		width=80 align=right  name="실적" SubBgColor=' + subSumBgColor + ' </C>';
		subSumText = "{ DECODE(SUBSUM(PLAN_SALES_AMT),0,0, SUBSUM(RSLT_SALES_AMT)/SUBSUM(PLAN_SALES_AMT)*100)  }";
		gd_tab1Header += '	<C>id=SALES_AMT_ACHIEVE_RATE 	decao="2" value={SALES_AMT_ACHIEVE_RATE}   subsumtext=' + subSumText + '	width=60 align=right  name="달성율" SubBgColor=' + subSumBgColor + ' </C>';
		subSumText = "{ROUND(SUBSUM(PRE_RSLT_SALES_AMT)/" + amtUnit + ",0)}";
		gd_tab1Header += '	<C>id=PRE_RSLT_SALES_AMT     value={ROUND(PRE_RSLT_SALES_AMT/' + amtUnit + ',0)}  		width=80 align=right  name="전년실적" SubBgColor=' + subSumBgColor + '  </C>';
		subSumText = "{ DECODE(SUBSUM(RSLT_SALES_AMT),0,0, ROUND((SUBSUM(RSLT_SALES_AMT) - SUBSUM(PRE_RSLT_SALES_AMT))/SUBSUM(RSLT_SALES_AMT)*100,2))  }";
		gd_tab1Header += '	<C>id=SALES_AMT_GROWTH_RATE  decao="2"   value={SALES_AMT_GROWTH_RATE}  	subsumtext=' + subSumText + '	width=60 align=right  name="신장율" SubBgColor=' + subSumBgColor + ' </C>';
		gd_tab1Header += '</G>';
		
		gd_tab1Header += '<G>name="매출이익액(단위:백만)"';
		subSumText = "{ROUND(SUBSUM(PLAN_SALES_PROFIT_AMT)/" + amtUnit + ",0)}";
		gd_tab1Header += '	<C>id=PLAN_SALES_PROFIT_AMT    value={ROUND(PLAN_SALES_PROFIT_AMT/' + amtUnit + ',0)}  subsumtext=' + subSumText + '   width=80 align=right  name="계획" SubBgColor=' + subSumBgColor + ' </C>';
		subSumText = "{ROUND(SUBSUM(RSLT_SALES_PROFIT_AMT)/" + amtUnit + ",0)}";
		gd_tab1Header += '	<C>id=RSLT_SALES_PROFIT_AMT    value={ROUND(RSLT_SALES_PROFIT_AMT/' + amtUnit + ',0)}  subsumtext=' + subSumText + '     width=80 align=right  name="실적" SubBgColor=' + subSumBgColor + ' </C>';
		subSumText = "{ DECODE(SUBSUM(PLAN_SALES_PROFIT_AMT),0,0, ROUND(SUBSUM(RSLT_SALES_PROFIT_AMT)/SUBSUM(PLAN_SALES_PROFIT_AMT)*100,2))  }";
		gd_tab1Header += '	<C>id=SALES_PROFIT_AMT_ACHIEVE_RATE	decao="2"   value={SALES_PROFIT_AMT_ACHIEVE_RATE}  	subsumtext=' + subSumText + '	width=60 align=right  name="달성율" SubBgColor=' + subSumBgColor + ' </C>';
		subSumText = "{ROUND(SUBSUM(PRE_RSLT_SALES_PROFIT_AMT)/" + amtUnit + ",0)}";
		gd_tab1Header += '	<C>id=PRE_RSLT_SALES_PROFIT_AMT  value={ROUND(PRE_RSLT_SALES_PROFIT_AMT/' + amtUnit + ',0)}  subsumtext=' + subSumText + '   width=80 align=right  name="전년실적" SubBgColor=' + subSumBgColor + ' </C>';
		subSumText = "{ DECODE(SUBSUM(RSLT_SALES_PROFIT_AMT),0,0, ROUND((SUBSUM(RSLT_SALES_PROFIT_AMT) - SUBSUM(PRE_RSLT_SALES_PROFIT_AMT))/SUBSUM(RSLT_SALES_PROFIT_AMT)*100,2))  }";
		gd_tab1Header += '	<C>id=SALES_PROFIT_AMT_GROWTH_RATE	decao="2"   value={SALES_PROFIT_AMT_GROWTH_RATE}  	subsumtext=' + subSumText + '  width=60 align=right  name="신장율" SubBgColor=' + subSumBgColor + ' </C>';
		gd_tab1Header += '</G>';  
		...
		gd_tab1Header += '	<C>id=PLAN_PROFIT_RATE     decao="2"   value={PLAN_PROFIT_RATE}   subsumtext=' + subSumText + '   	width=80 align=right  name="계획" SubBgColor=' + subSumBgColor + ' </C>';
		subSumText = "{ DECODE(SUBSUM(RSLT_SALES_AMT),0,0, ROUND(SUBSUM(RSLT_SALES_PROFIT_AMT)/SUBSUM(RSLT_SALES_AMT)*100,2)  ) }";
		gd_tab1Header += '	<C>id=RSLT_PROFIT_RATE     decao="2"   value={RSLT_PROFIT_RATE}   subsumtext=' + subSumText + '      	width=80 align=right  name="실적" SubBgColor=' + subSumBgColor + ' </C>';
		subSumText = "{ DECODE(DECODE(SUBSUM(PLAN_SALES_AMT),0,0, ROUND(SUBSUM(PLAN_SALES_PROFIT_AMT)/SUBSUM(PLAN_SALES_AMT)*100,2)),0,0, ROUND(DECODE(SUBSUM(RSLT_SALES_AMT),0,0, ROUND(SUBSUM(RSLT_SALES_PROFIT_AMT)/SUBSUM(RSLT_SALES_AMT)*100,2)  )/DECODE(SUBSUM(PLAN_SALES_AMT),0,0, ROUND(SUBSUM(PLAN_SALES_PROFIT_AMT)/SUBSUM(PLAN_SALES_AMT)*100,2))*100,2))  }";
		gd_tab1Header += '	<C>id=PROFIT_RATE_ACHIEVE_RATE  decao="2"   value={PROFIT_RATE_ACHIEVE_RATE}   subsumtext=' + subSumText + '  	width=60 align=right  name="달성율" SubBgColor=' + subSumBgColor + ' </C>';
		subSumText = "{ DECODE(SUBSUM(PRE_RSLT_SALES_AMT),0,0, ROUND(SUBSUM(PRE_RSLT_SALES_PROFIT_AMT)/SUBSUM(PRE_RSLT_SALES_AMT)*100,2 ))  }";
		gd_tab1Header += '	<C>id=PRE_RSLT_PROFIT_RATE   decao="2"   value={PRE_RSLT_PROFIT_RATE}   subsumtext=' + subSumText + '    	width=80 align=right  name="전년실적" SubBgColor=' + subSumBgColor + ' </C>';
		subSumText = "{ DECODE(SUBSUM(RSLT_SALES_AMT),0,0, ROUND(SUBSUM(RSLT_SALES_PROFIT_AMT)/SUBSUM(RSLT_SALES_AMT)*100,2)  ) - DECODE(SUBSUM(PRE_RSLT_SALES_AMT),0,0, ROUND(SUBSUM(PRE_RSLT_SALES_PROFIT_AMT)/SUBSUM(PRE_RSLT_SALES_AMT)*100,2 )) }";
		gd_tab1Header += '	<C>id=PROFIT_RATE_DIFFERENT   decao="2"   value={PROFIT_RATE_DIFFERENT}   subsumtext=' + subSumText + ' 		width=60 align=right  name="증감차" SubBgColor=' + subSumBgColor + ' </C>';
		gd_tab1Header += '</G>';              
    ...
    subSumText = '{decode(curlevel,9999,"합계",1,"소계")}';
    gd_tab2Header += '<FC>id=ORG_NAME      value={ORG_NAME} subsumtext=' + subSumText + '   width=150 align=left     name="조직명"   SubBgColor=' + subSumBgColor + ' </FC>';

    gd_tab2Header += '<G>name="매출"';
    subSumText = '{DECODE(MAX(PLAN_SALES_AMT_TOT),0,0, ROUND(SUBSUM(PLAN_SALES_AMT)/MAX(PLAN_SALES_AMT_TOT)*100,2) )}';
	gd_tab2Header += '	<C>id=PLAN_SALES_RATE decao="2"  value={PLAN_SALES_RATE}  subsumtext=' + subSumText + '     width=80 align=right  name="계획구성비" SubBgColor=' + subSumBgColor + ' </C>';
	subSumText = '{DECODE(MAX(RSLT_SALES_AMT_TOT),0,0, ROUND(SUBSUM(RSLT_SALES_AMT)/MAX(RSLT_SALES_AMT_TOT)*100,2) )}';
	gd_tab2Header += '	<C>id=RSLT_SALES_RATE   decao="2"  value={RSLT_SALES_RATE}  subsumtext=' + subSumText + '   width=80 align=right  name="실적구성비" SubBgColor=' + subSumBgColor + ' </C>';
	subSumText = '{DECODE(MAX(RSLT_SALES_AMT_TOT),0,0, ROUND(SUBSUM(RSLT_SALES_AMT)/MAX(RSLT_SALES_AMT_TOT)*100,2) ) - DECODE(MAX(PLAN_SALES_AMT_TOT),0,0, ROUND(SUBSUM(PLAN_SALES_AMT)/MAX(PLAN_SALES_AMT_TOT)*100,2) )}';
	gd_tab2Header += '	<C>id=SALES_ACHIEVE_DIFF  decao="2"  value={SALES_ACHIEVE_DIFF}  subsumtext=' + subSumText + '    width=80 align=right  name="달성차" SubBgColor=' + subSumBgColor + ' </C>';
	subSumText = '{DECODE(MAX(PRE_RSLT_SALES_AMT_TOT),0,0, ROUND(SUBSUM(PRE_RSLT_SALES_AMT)/MAX(PRE_RSLT_SALES_AMT_TOT)*100,2) )}';
	gd_tab2Header += '	<C>id=PRE_RSLT_SALES_RATE  decao="2"  value={PRE_RSLT_SALES_RATE}  subsumtext=' + subSumText + '    width=80 align=right  name="전년실적" SubBgColor=' + subSumBgColor + ' </C>';
	subSumText = '{ DECODE(MAX(RSLT_SALES_AMT_TOT),0,0, ROUND(SUBSUM(RSLT_SALES_AMT)/MAX(RSLT_SALES_AMT_TOT)*100,2) ) -  DECODE(MAX(PRE_RSLT_SALES_AMT_TOT),0,0, ROUND(SUBSUM(PRE_RSLT_SALES_AMT)/MAX(PRE_RSLT_SALES_AMT_TOT)*100,2) ) }';
	gd_tab2Header += '	<C>id=SALES_INC_DEC_DIFF   decao="2"  value={SALES_INC_DEC_DIFF}  subsumtext=' + subSumText + '   width=80 align=right  name="증감차" SubBgColor=' + subSumBgColor + ' </C>';
	gd_tab2Header += '</G>';			             
    
	gd_tab2Header += '<G>name="매출이익"';
	subSumText = '{DECODE(MAX(PLAN_SALES_PROFIT_AMT_TOT),0,0, ROUND(SUBSUM(PLAN_SALES_PROFIT_AMT)/MAX(PLAN_SALES_PROFIT_AMT_TOT)*100,2) )}';
	gd_tab2Header += '	<C>id=PLAN_SALES_PROFIT_RATE   decao="2"  value={PLAN_SALES_PROFIT_RATE}  subsumtext=' + subSumText + '   width=80 align=right  name="계획구성비" SubBgColor=' + subSumBgColor + ' </C>';
	subSumText = '{DECODE(MAX(RSLT_SALES_PROFIT_AMT_TOT),0,0, ROUND(SUBSUM(RSLT_SALES_PROFIT_AMT)/MAX(RSLT_SALES_PROFIT_AMT_TOT)*100,2) )}';
	gd_tab2Header += '	<C>id=RSLT_SALES_PROFIT_RATE  decao="2"  value={RSLT_SALES_PROFIT_RATE}  subsumtext=' + subSumText + '    width=80 align=right  name="실적구성비" SubBgColor=' + subSumBgColor + ' </C>';
	subSumText = '{DECODE(MAX(RSLT_SALES_PROFIT_AMT_TOT),0,0, ROUND(SUBSUM(RSLT_SALES_PROFIT_AMT)/MAX(RSLT_SALES_PROFIT_AMT_TOT)*100,2) ) - DECODE(MAX(PLAN_SALES_PROFIT_AMT_TOT),0,0, ROUND(SUBSUM(PLAN_SALES_PROFIT_AMT)/MAX(PLAN_SALES_PROFIT_AMT_TOT)*100,2) )}';
	gd_tab2Header += '	<C>id=SALES_PROFIT_ACHIEVE_DIFF   decao="2"  value={SALES_PROFIT_ACHIEVE_DIFF}  subsumtext=' + subSumText + '   width=80 align=right  name="달성차" SubBgColor=' + subSumBgColor + ' </C>';
	subSumText = '{DECODE(MAX(PRE_RSLT_SALES_PROFIT_AMT_TOT),0,0, ROUND(SUBSUM(PRE_RSLT_SALES_PROFIT_AMT)/MAX(PRE_RSLT_SALES_PROFIT_AMT_TOT)*100,2) )}';
	gd_tab2Header += '	<C>id=PRE_RSLT_SALES_PROFIT_RATE  decao="2"  value={PRE_RSLT_SALES_PROFIT_RATE}  subsumtext=' + subSumText + '    width=80 align=right  name="전년실적" SubBgColor=' + subSumBgColor + ' </C>';
	subSumText = '{ DECODE(MAX(RSLT_SALES_PROFIT_AMT_TOT),0,0, ROUND(SUBSUM(RSLT_SALES_PROFIT_AMT)/MAX(RSLT_SALES_PROFIT_AMT_TOT)*100,2) ) -  DECODE(MAX(PRE_RSLT_SALES_PROFIT_AMT_TOT),0,0, ROUND(SUBSUM(PRE_RSLT_SALES_PROFIT_AMT)/MAX(PRE_RSLT_SALES_PROFIT_AMT_TOT)*100,2) ) }';
	gd_tab2Header += '	<C>id=SALES_PROFIT_INC_DEC_DIFF   decao="2"  value={SALES_PROFIT_INC_DEC_DIFF}  subsumtext=' + subSumText + '   width=80 align=right  name="증감차" SubBgColor=' + subSumBgColor + ' </C>';
	gd_tab2Header += '</G>';			             
	...
	subSumText = '{ MAX(BIZ_RSLT_YM) }';
	gd_tab2Header += '<C>id=BIZ_RSLT_YM   show="false"   value={BIZ_RSLT_YM}              width=60 align=center   name="BIZ_RSLT_YM"	 subsumtext=' + subSumText + '	</C>';
	...
	subSumText = '{ MAX(SUM_GB) }';
	gd_tab2Header += '<C>id=SUM_GB     show="false"    value={SUM_GB}           width=60 align=center   name="SUM_GB"	subsumtext=' + subSumText + ' 	</C>';
    ...
    var gd_tab3Header  = '<FC>id={currow}       width=25 align=center 	name="NO" 				SubBgColor=' + subSumBgColor + ' </FC>';
    	...
    	subSumText = '{decode(curlevel,9999,"합계",1,"소계")}';
    	gd_tab3Header += '<FC>id=BIZ_CD_NM   subsumtext=' + subSumText + '   width=80 align=left     name="대분류;항목명"   	SubBgColor=' + subSumBgColor + ' </FC>';
    	gd_tab3Header += '<G>name="손익실적"';
    	...
    	subSumText = "{ROUND(SUBSUM(RSLT_AMT)/" + amtUnit + ",0)}";
    	gd_tab3Header += '<C>id=RSLT_AMT    value={ROUND(RSLT_AMT/' + amtUnit + ',0)}  subsumtext=' + subSumText + ' 	width=100 align=right  	name="실적" 				SubBgColor=' + subSumBgColor + ' </C>';
    	subSumText = '{ DECODE(SUBSUM(PLAN_AMT),0,0, ROUND(SUBSUM(RSLT_AMT)/SUBSUM(PLAN_AMT)*100,2)  ) }';
    	gd_tab3Header += '<C>id=ACHIEVE_RATE	decao="2"  subsumtext=' + subSumText + '   width=100 align=right  	name="달성율" 			SubBgColor=' + subSumBgColor + ' </C>';
    	subSumText = "{ROUND(SUBSUM(PRE_RSLT_AMT)/" + amtUnit + ",0)}";
    	gd_tab3Header += '<C>id=PRE_RSLT_AMT  value={ROUND(RSLT_AMT/' + amtUnit + ',0)}  subsumtext=' + subSumText + '  width=100 align=right  	name="전년실적" 			SubBgColor=' + subSumBgColor + ' </C>';
    	subSumText = '{ DECODE(SUBSUM(PRE_RSLT_AMT),0,0, ROUND((SUBSUM(RSLT_AMT) - SUBSUM(PRE_RSLT_AMT) )/SUBSUM(PRE_RSLT_AMT)*100,2)  ) }';
    ...
    var gd_tab3ExcelHeader  = '<FC>id={currow}		width=25 align=center	name="NO" 				BgColor={decode(GROUP_ID,1,"#BDDBEF")}</FC>';
    	...
    	gd_tab3ExcelHeader += '<G>name="손익실적"';
    	gd_tab3ExcelHeader += '<C>id=PLAN_AMT     	width=100 align=right  	name="계획" 				BgColor={decode(GROUP_ID,1,"#BDDBEF")}</C>';
    	gd_tab3ExcelHeader += '<C>id=RSLT_AMT     	width=100 align=right  	name="실적" 				BgColor={decode(GROUP_ID,1,"#BDDBEF")}</C>';
    	gd_tab3ExcelHeader += '<C>id=ACHIEVE_RATE  	width=100 align=right  	name="달성율" 			BgColor={decode(GROUP_ID,1,"#BDDBEF")}</C>';
	...
	var gd_tab4_MHeader  = '<FC>id={currow}		width=25 align=center 	name="NO" 					SubBgColor=' + subSumBgColor + ' </FC>';
		...
		subSumText = "{ROUND(SUBSUM(RSLT_AMT)/" + amtUnit + ",0)}";
		gd_tab4_MHeader += '<C>id=RSLT_AMT  value={ROUND(RSLT_AMT/' + amtUnit + ',0)}  subsumtext=' + subSumText + '   	width=100 align=right  name="실적" 					SubBgColor=' + subSumBgColor + ' </C>';
		subSumText = '{ DECODE(SUBSUM(RSLT_AMT),0,0, ROUND((SUBSUM(RSLT_AMT) - SUBSUM(PLAN_AMT))/SUBSUM(RSLT_AMT)*100,2)  )  }';
		gd_tab4_MHeader += '<C>id=DEC_RATIO  decao="2"  subsumtext=' + subSumText + '   width=100 align=right  name="절감율" 				SubBgColor=' + subSumBgColor + ' </C>';
		subSumText = "{ROUND(SUBSUM(PRE_RSLT_AMT)/" + amtUnit + ",0)}";
		...
		subSumText = '{ DECODE(SUBSUM(RSLT_AMT),0,0, ROUND((SUBSUM(RSLT_AMT)-SUBSUM(PRE_RSLT_AMT))/SUBSUM(RSLT_AMT)*100,2) ) }';
	...
	subSumText = '{decode(curlevel,9999,"합계",1,"소계")}';
	gd_tab4_SHeader += '<FC>id=BIZ_CD_NM  subsumtext=' + subSumText + '  width=80 align=left     name="판관비;수분류항목명"	SubBgColor=' + subSumBgColor + ' </FC>';
	gd_tab4_SHeader += '<G>name="판관비실적"';
	subSumText = "{ROUND(SUBSUM(PLAN_AMT)/" + amtUnit + ",0)}";
	...
	subSumText = "{ROUND(SUBSUM(RSLT_AMT)/" + amtUnit + ",0)}";
	gd_tab4_SHeader += '<C>id=RSLT_AMT  value={ROUND(RSLT_AMT/' + amtUnit + ',0)} subsumtext=' + subSumText + '   	width=100 align=right  name="실적" 					SubBgColor=' + subSumBgColor + ' </C>';
	subSumText = '{ DECODE(SUBSUM(RSLT_AMT),0,0, ROUND((SUBSUM(RSLT_AMT)-SUBSUM(PLAN_AMT))/SUBSUM(RSLT_AMT)*100,2)   ) }';
	gd_tab4_SHeader += '<C>id=DEC_RATIO  decao="2"  subsumtext=' + subSumText + '   width=100 align=right  name="절감율" 				SubBgColor=' + subSumBgColor + ' </C>';
	subSumText = "{ROUND(SUBSUM(PRE_RSLT_AMT)/" + amtUnit + ",0)}";
	...
	var gd_tab4ExcelHeader = '<FC>id={currow}       width=25 align=center 	name="NO" 					BgColor={decode(GROUP_ID,"11","#BDDBEF", "01", "#FFD0D0")}</FC>';   
		...
		gd_tab4ExcelHeader += '<G>name="판관비실적"';
		...
		gd_tab4ExcelHeader += '<C>id=RSLT_AMT   value={ROUND(RSLT_AMT/' + amtUnit + ',0)}  	width=100 align=right  	name="실적" 					BgColor={decode(GROUP_ID,"11","#BDDBEF", "01", "#FFD0D0")}</C>';
		gd_tab4ExcelHeader += '<C>id=DEC_RATIO     	width=100 align=right  	name="절감율" 				BgColor={decode(GROUP_ID,"11","#BDDBEF", "01", "#FFD0D0")}</C>';
...
function gridCreate_bak(){
		...
		gd_tab1Header += '	<C>id=RSLT_SALES_AMT           		width=80 align=right  name="실적" BgColor={decode(SUM_GUBUN,0,"#BDDBEF",1,"#FFD0D0")} </C>';
		gd_tab1Header += '	<C>id=SALES_AMT_ACHIEVE_RATE   		width=60 align=right  name="달성율" BgColor={decode(SUM_GUBUN,0,"#BDDBEF",1,"#FFD0D0")}</C>';
		gd_tab1Header += '	<C>id=PRE_RSLT_SALES_AMT       		width=80 align=right  name="전년실적" BgColor={decode(SUM_GUBUN,0,"#BDDBEF",1,"#FFD0D0")} </C>';
		gd_tab1Header += '	<C>id=SALES_AMT_GROWTH_RATE    		width=60 align=right  name="신장율" BgColor={decode(SUM_GUBUN,0,"#BDDBEF",1,"#FFD0D0")}</C>';
		gd_tab1Header += '</G>';
		gd_tab1Header += '<G>name="매출이익액(단위:백만)"';
		gd_tab1Header += '	<C>id=PLAN_SALES_PROFIT_AMT         width=80 align=right  name="계획" BgColor={decode(SUM_GUBUN,0,"#BDDBEF",1,"#FFD0D0")} </C>';
		gd_tab1Header += '	<C>id=RSLT_SALES_PROFIT_AMT         width=80 align=right  name="실적" BgColor={decode(SUM_GUBUN,0,"#BDDBEF",1,"#FFD0D0")} </C>';
		gd_tab1Header += '	<C>id=SALES_PROFIT_AMT_ACHIEVE_RATE	width=60 align=right  name="달성율" BgColor={decode(SUM_GUBUN,0,"#BDDBEF",1,"#FFD0D0")}</C>';
		gd_tab1Header += '	<C>id=PRE_RSLT_SALES_PROFIT_AMT     width=80 align=right  name="전년실적" BgColor={decode(SUM_GUBUN,0,"#BDDBEF",1,"#FFD0D0")} </C>';
		gd_tab1Header += '	<C>id=SALES_PROFIT_AMT_GROWTH_RATE  width=60 align=right  name="신장율" BgColor={decode(SUM_GUBUN,0,"#BDDBEF",1,"#FFD0D0")}</C>';
		gd_tab1Header += '</G>';  
		gd_tab1Header += '<G>name="매출이익율(%)"';
		gd_tab1Header += '	<C>id=PLAN_PROFIT_RATE           	width=80 align=right  name="계획" BgColor={decode(SUM_GUBUN,0,"#BDDBEF",1,"#FFD0D0")} </C>';
		gd_tab1Header += '	<C>id=RSLT_PROFIT_RATE           	width=80 align=right  name="실적" BgColor={decode(SUM_GUBUN,0,"#BDDBEF",1,"#FFD0D0")} </C>';
		gd_tab1Header += '	<C>id=PROFIT_RATE_ACHIEVE_RATE   	width=60 align=right  name="달성율" BgColor={decode(SUM_GUBUN,0,"#BDDBEF",1,"#FFD0D0")}</C>';
		gd_tab1Header += '	<C>id=PRE_RSLT_PROFIT_RATE       	width=80 align=right  name="전년실적" BgColor={decode(SUM_GUBUN,0,"#BDDBEF",1,"#FFD0D0")} </C>';
		gd_tab1Header += '	<C>id=PROFIT_RATE_DIFFERENT    		width=60 align=right  name="증감차" BgColor={decode(SUM_GUBUN,0,"#BDDBEF",1,"#FFD0D0")}</C>';
		gd_tab1Header += '</G>';              
	...
	gd_tab2Header += '<G>name="매출"';
	gd_tab2Header += '	<C>id=PLAN_SALES_RATE      width=80 align=right  name="계획구성비" BgColor={decode(SUM_GUBUN,0,"#BDDBEF",1,"#FFD0D0")}</C>';
	gd_tab2Header += '	<C>id=RSLT_SALES_RATE      width=80 align=right  name="실적구성비" BgColor={decode(SUM_GUBUN,0,"#BDDBEF",1,"#FFD0D0")}</C>';
	gd_tab2Header += '	<C>id=SALES_ACHIEVE_DIFF      width=80 align=right  name="달성차" BgColor={decode(SUM_GUBUN,0,"#BDDBEF",1,"#FFD0D0")}</C>';
	gd_tab2Header += '	<C>id=PRE_RSLT_SALES_RATE      width=80 align=right  name="전년실적" BgColor={decode(SUM_GUBUN,0,"#BDDBEF",1,"#FFD0D0")}</C>';
	gd_tab2Header += '	<C>id=SALES_INC_DEC_DIFF      width=80 align=right  name="증감차" BgColor={decode(SUM_GUBUN,0,"#BDDBEF",1,"#FFD0D0")}</C>';
	gd_tab2Header += '</G>';			             
    gd_tab2Header += '<G>name="매출이익"';
	gd_tab2Header += '	<C>id=PLAN_SALES_PROFIT_RATE      width=80 align=right  name="계획구성비" BgColor={decode(SUM_GUBUN,0,"#BDDBEF",1,"#FFD0D0")}</C>';
	gd_tab2Header += '	<C>id=RSLT_SALES_PROFIT_RATE      width=80 align=right  name="실적구성비" BgColor={decode(SUM_GUBUN,0,"#BDDBEF",1,"#FFD0D0")}</C>';
	gd_tab2Header += '	<C>id=SALES_PROFIT_ACHIEVE_DIFF      width=80 align=right  name="달성차" BgColor={decode(SUM_GUBUN,0,"#BDDBEF",1,"#FFD0D0")}</C>';
	gd_tab2Header += '	<C>id=PRE_RSLT_SALES_PROFIT_RATE      width=80 align=right  name="전년실적" BgColor={decode(SUM_GUBUN,0,"#BDDBEF",1,"#FFD0D0")}</C>';
	gd_tab2Header += '	<C>id=SALES_PROFIT_INC_DEC_DIFF      width=80 align=right  name="증감차" BgColor={decode(SUM_GUBUN,0,"#BDDBEF",1,"#FFD0D0")}</C>';
	gd_tab2Header += '</G>';			             
    ...
    var gd_tab3Header  = '<FC>id={currow}       width=25 align=center 	name="NO" 				BgColor={decode(GROUP_ID,1,"#BDDBEF")}</FC>';
    	...
    	gd_tab3Header += '<C>id=RSLT_AMT     	width=100 align=right  	name="실적" 				BgColor={decode(GROUP_ID,1,"#BDDBEF")}</C>';
    	gd_tab3Header += '<C>id=ACHIEVE_RATE    width=100 align=right  	name="달성율" 			BgColor={decode(GROUP_ID,1,"#BDDBEF")}</C>';
	...
	var gd_tab4_MHeader  = '<FC>id={currow}		width=25 align=center 	name="NO" 					BgColor={decode(GROUP_ID,1,"#BDDBEF")}</FC>';
		...
		gd_tab4_MHeader += '<C>id=RSLT_AMT     	width=100 align=right  name="실적" 					BgColor={decode(GROUP_ID,1,"#BDDBEF")}</C>';
		gd_tab4_MHeader += '<C>id=DEC_RATIO     width=100 align=right  name="절감율" 				BgColor={decode(GROUP_ID,1,"#BDDBEF")}</C>';
	...
	gd_tab4_SHeader += '<FC>id=BIZ_CD_NM    width=80 align=left     name="판관비;수분류항목명"	BgColor={decode(GROUP_ID,1,"#BDDBEF")}</FC>';
	gd_tab4_SHeader += '<G>name="판관비실적"';
	gd_tab4_SHeader += '<C>id=PLAN_AMT     	width=100 align=right  name="계획" 					BgColor={decode(GROUP_ID,1,"#BDDBEF")}</C>';
	gd_tab4_SHeader += '<C>id=RSLT_AMT     	width=100 align=right  name="실적" 					BgColor={decode(GROUP_ID,1,"#BDDBEF")}</C>';
	gd_tab4_SHeader += '<C>id=DEC_RATIO     width=100 align=right  name="절감율" 				BgColor={decode(GROUP_ID,1,"#BDDBEF")}</C>';
	...
	var gd_tab4ExcelHeader = '<FC>id={currow}       width=25 align=center 	name="NO" 					BgColor={decode(GROUP_ID,"11","#BDDBEF", "01", "#FFD0D0")}</FC>';   
		...
		gd_tab4ExcelHeader += '<C>id=RSLT_AMT     	width=100 align=right  	name="실적" 					BgColor={decode(GROUP_ID,"11","#BDDBEF", "01", "#FFD0D0")}</C>';
		gd_tab4ExcelHeader += '<C>id=DEC_RATIO     	width=100 align=right  	name="절감율" 				BgColor={decode(GROUP_ID,"11","#BDDBEF", "01", "#FFD0D0")}</C>';
...
function btn_Search() {
	...
	var parameters = "&strStrCd=" + LC_STR_CD.BindColVal 	//점코드
    			   ...
    			   + "&strSumGb=" + RD_SUM_GB.CodeValue		//누계구분
					;
	var dataSetObj = null;
	...
	dataSetObj.DataID   = "/mss/meis072.me?goTo="+goTo+parameters;
...
function sub_SearchTAB4_S(row) {
	...
	var strRsltYm 	= DS_TAB4_M.NameString(row,"BIZ_RSLT_YM");
	...
	var strSumGb	= DS_TAB4_M.NameString(row,"SUM_GB");
	
	var goTo = "searchTAB4_S";
	var action     = "O";
	var parameters  = "&strRsltYm=" + strRsltYm; //년
		...
		parameters += "&strSumGb=" + strSumGb; 

	DS_TAB4_S.DataID   = "/mss/meis072.me?goTo="+goTo+parameters;
...
function btn_ExcelDownload() {
	...
	if(tabIdx == 1) {
		...
		if(RD_SUM_GB.CodeValue == "1") {
			parameters += " , 경영실적년월= "  	+lo_RsltYm;
		} else {
			parameters += " , 경영실적년월= "  	+lo_RsltYm.substring(0, 4) + "01" + " ~ " +lo_RsltYm;
		}
		
		var ExcelTitle = "매출실적분석";
...
function btn_Print() {
    ...
    var params = "&strStrCd="      + LC_STR_CD.BindColVal //점코드
               + "&strRsltYm="     + EM_RSLT_YM.text
               + "&strOrgLevel=1"
               + "&strSumGb="      + RD_SUM_GB.CodeValue
               + "&SUM_GB="        + RD_SUM_GB.CodeValue
               + "&BIZ_RSLT_YM="   + EM_RSLT_YM.text
    ...
    window.open("/mss/meis072.me?goTo=print"+params,"OZREPORT", 1000, 700);
}
...
function UpdateChart() {	
	...
	if(tabIdx == 1) {
		...
		for(var i = 1; i <= DS_TAB1.CountColumn; i++) {
			var colName =  DS_TAB1.ColumnID(i);
			var value = GD_TAB1.VirtualString2(rowIdx,colName,1);
		...
		IFRAME_TAB1_CHART_SALES_AMT.location.href = "/mss/meis072.me?goTo="+goTo+parameters+"&CHART_GUBUN=" + CHART_GUBUN;

		//매출이익액 차트 호출
		CHART_GUBUN = "SALES_RROFIT_AMT";
		IFRAME_TAB1_CHART_SALES_PROFIT_AMT.location.href = "/mss/meis072.me?goTo="+goTo+parameters+"&CHART_GUBUN=" + CHART_GUBUN;
		
		//매출이익율 차트 호출
		CHART_GUBUN = "SALES_RROFIT_RATE";
		IFRAME_TAB1_CHART_SALES_PROFIT_RATE.location.href = "/mss/meis072.me?goTo="+goTo+parameters+"&CHART_GUBUN=" + CHART_GUBUN;
	...
	//TAB2용 차트	 
		...
		for(var i = 1; i <= DS_TAB2.CountColumn; i++) {
			var colName =  DS_TAB2.ColumnID(i);
			var value = GD_TAB2.VirtualString2(rowIdx,colName,1);
			if(colName == "ORG_NAME") value = encodeURIComponent(value);
			parameters += "&" + colName + "=" + value;
		}		
		...
		IFRAME_TAB2_CHART_SALES_RATIO.location.href = "/mss/meis072.me?goTo="+goTo+parameters+"&CHART_GUBUN=" + CHART_GUBUN;

		//매출이익구성비차트호출
		CHART_GUBUN = "SALES_PROFIT_RATIO";
		IFRAME_TAB2_CHART_SALES_PROFIT_RATIO.location.href = "/mss/meis072.me?goTo="+goTo+parameters+"&CHART_GUBUN=" + CHART_GUBUN;
	...
	//TAB3용 차트	
		...
		var goTo = "chartTAB3";
		var parameters  = "&strStrCd=" 	+ LC_STR_CD.BindColVal; 	//점코드
			parameters += "&strRsltYm=" + EM_RSLT_YM.text;    		//경영실적년월
			parameters += "&strSumGb=" 	+ RD_SUM_GB.CodeValue		//누계구분
			parameters += "&strDeptCd=" + DS_TEAM_CD_TAB3.NameString(LC_TEAM_CD_TAB3.index + 1, "DEPT_CD");
			parameters += "&strTeamCd=" + LC_TEAM_CD_TAB3.BindColVal;
			parameters += "&strPcCd=" 	+ LC_PC_CD_TAB3.BindColVal;
			parameters += "&dsCnt=" 	+ DS_TAB3.CountRow;
		
			IFRAME_TAB3_INC_DEC_RATIO.location.href = "/mss/meis072.me?goTo="+goTo+parameters;
	...
	//TAB4용 차트	
		...
		var parameters  = "&strStrCd=" + LC_STR_CD.BindColVal; //점코드
			...
			IFRAME_TAB4_SALE_MANAGE_AMT.location.href = "/mss/meis072.me?goTo="+goTo+parameters;	
	}
                    ...
                    <td>
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table">
                            <tr>
                                ...
                                <th width="80" class="point">누계구분</th>
                                <td>
			                        <comment id="_NSID_">
			                        <object id=RD_SUM_GB classid=<%=Util.CLSID_RADIO%> tabindex=1 
			                                style="height:20; width:150">
			                            <param name=Cols    value="3">
			                            <param name=Format  value="1^당월,2^누계">
    ...
    <tr>
        <td class="PT01 PB03">
			<div id=TB_NORMAL width="100%" height=485 TitleWidth=120
				...
				<menu TitleName="매출실적분석"      	DivId="tr_tab1"	ClickFunc="fn_changeTab"	 />
				<menu TitleName="매출구성분석"		DivId="tr_tab2" ClickFunc="fn_changeTab"	 />
				<menu TitleName="손익분석" 			DivId="tr_tab3" ClickFunc="fn_changeTab"	 />
                    ...
                    <td class="PT05">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td class="BD4A">
                                    <comment id="_NSID_">
                                    <object id=GD_TAB2 width="100%" height=185 classid=<%=Util.CLSID_GRID%>>
			            ...
			            <table width="100%" height="230" border="0" cellpadding="0" cellspacing="0" class="s_table">
			                <tr>
			                    <td class="BD4A" width="50%">
			                    	<!-- 매출액 차트 -->
									<iframe id="IFRAME_TAB2_CHART_SALES_RATIO" width="400" height="225" style="overflow:hidden;" 
											src=""></iframe>
			                    </td>
			                    <td class="BD4A" width="50%">
			                    	<!-- 매출이익액 차트 -->
									<iframe id="IFRAME_TAB2_CHART_SALES_PROFIT_RATIO" width="400" height="225" style="overflow:hidden;" 
											src=""></iframe>
			                    </td>
			                </tr>
			            </table>                
