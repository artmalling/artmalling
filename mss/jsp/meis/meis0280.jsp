<!-- 
/*******************************************************************************
 * 시스템명 : 경영실적 > 기초자료> 항목별비용계획조회
 * 작 성 일 : 2011.05.30
 * 작 성 자 : 이정식
 * 수 정 자 : 
 * 파 일 명 : meis0280.jsp
 * 버    전 : 1.0 (버전은 1.0부터 시작하며 0.1씩 증가)
 * 개    요 : 계정별/조직별/년월별로 비용계획을 조회한다.
 * 이    력 :
 *        2011.05.30 (이정식) 신규작성
 ******************************************************************************/
-->
...
function gridCreate(){
	var hdrProperies = '<FC>id={currow} width=25 align=center name="NO"</FC>'
		             + '<FC>id=BIZ_CD   width=80 align=center name="실적항목"</FC>'
		             + '<C>id=BIZ_NM    width=80 align=left   name="항목명"  SumText="합계"</C>'
		             + '<C>id=PLAN_AMT  width=80 align=right  name="금액"    SumText=@sum</C>'
                     ;
    ...
    var hdrProperies1 = '<FC>id={currow} width=25 align=center name="NO"</FC>'
                      ...
                      + '<C>id=DEPT_NM   width=80 align=left   name="팀" </C>'
                      + '<C>id=TEAM_NM   width=80 align=left   name="파트" </C>'
                      + '<C>id=PC_NM     width=80 align=left   name="PC" </C>'
                      + '<C>id=PLAN_AMT  width=80 align=right  name="금액" SumText=@sum</C>'
                      ;
    ...
    var hdrProperies2 = '<C>id=MONTH    width=40 align=center name="월" SumText="합계"</C>'
                      + '<C>id=PLAN_AMT width=70 align=right  name="금액" SumText=@sum</C>'
                      ;
    ...
    var hdrProperies3 = '<C>id={currow}   width=35  align=center name="NO"</C>'
    	              ...
    	              + '<C>id=STR_NM     width=70  align=left   name="점명"  </C>'
    	              + '<C>id=BIZ_CD     width=70  align=center name="계정항목" </C>'
    	              + '<C>id=BIZ_NM     width=95  align=left   name="항목명"  </C>'
    	              + '<C>id=ORG_CD     width=85  align=center name="조직코드" </C>'
    	              + '<C>id=ORG_NM     width=95  align=left   name="조직명" </C>'
    	              + '<C>id=PLAN_YM    width=60  align=center name="년월" mask="XXXX/XX"</C>'
    	              + '<C>id=AMT        width=80  align=right  name="금액" </C>'
                      ;
...
function btn_Search() {
    ...
    lo_StrCd = LC_STR_CD.BindColVal;
    lo_StrNm = LC_STR_CD.Text;
    DS_BIZ.DataID   = "/mss/meis028.me?goTo="+goTo+parameters;
...
function subQuery(row){
    ...
    DS_ORG.DataID  = "/mss/meis028.me?goTo="+goTo+parameters;
...
function subQuery2(row){
    ...
    DS_MONTH.DataID  = "/mss/meis028.me?goTo="+goTo+parameters;
...
function btn_Excel() {
    ...
    DS_EXCEL.DataID = "/mss/meis028.me?goTo="+goTo+parameters;
    DS_EXCEL.Reset();
}
            ...
            <td class="PT03"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr valign="top">
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="BD4A" >
                  <tr>
                    <td>
                      <comment id="_NSID_"><object id=GD_BIZ width="100%" height=502 classid=<%=Util.CLSID_GRID%>>
