...
<%    
    ...
    String strRsltYm  = request.getParameter("strRsltYm");
%>
<html>
<head>
<title>월별경영실적지침관리(전월지침)</title>
...
function doInit(){
    ...
    registerUsingDataset("meis0641","DS_BIZ_MST" );
}
...
function btn_Search() {
    ...
    DS_BIZ_MST.DataID = "/mss/meis064.me?goTo=searchPre&strRsltYm=<%=strRsltYm%>"; 
    DS_BIZ_MST.Reset();
}
...
function subQuery(row){
    ...
    var parameters    = "&strRsltYm=<%=strRsltYm%>"
...
function btn_Apply(){
    ...
    TR_MAIN.Action   = "/mss/meis064.me?goTo=copyBizMst&strRsltYm=<%=strRsltYm%>"; 
        ...
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="" class="title">
              ...
              <SPAN id="title1" class="PL03">월별경영실적지침관리(전월지침) </SPAN>
            </td>
            <td class="right PB02">
