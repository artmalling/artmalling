...
<html>
<head>
<title>월별경영실적지침관리 EXCEL UPLOAD</title>
...
function doInit(){
    ...
    registerUsingDataset("meis0642","DS_BIZ_CD" );
...
function btn_Apply(){
    ...
    TR_MAIN.Action   = "/mss/meis064.me?goTo=uploadExcel";  
...
function checkValidation() {
	TR_MAIN.Action   = "/mss/meis064.me?goTo=checkValidation&strRsltYm=<%=strRsltYm%>";
        ...
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="" class="title">
              ...
              <SPAN id="title1" class="PL03">월별경영실적지침관리 EXCEL UPLOAD </SPAN>
            </td>
            <td align="right">
