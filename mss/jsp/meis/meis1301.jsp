...
<%
    ...
    String reportname = "상품군별매출실적";
    String strStrCd = String2.trimToEmpty(request.getParameter("strStrCd"));
    String strSaleYY = String2.trimToEmpty(request.getParameter("strSaleYY"));
    System.out.println(strSaleYY);
    //odi 파라미터
    String[][] params  = new String[][]{
        {"STR_CD=" + strStrCd, "SALE_YY=" + strSaleYY}
    };
