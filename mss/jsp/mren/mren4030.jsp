<!-- 
/*******************************************************************************
 * 시스템명 : 경영지원 > 임대관리 > 관리비청구/입금관리 > 세금계산서조회/수정/삭제
 * 작 성 일 : 2010.05.03
 * 작 성 자 : 김경은
 * 수 정 자 : 
 * 파 일 명 : mren4030.jsp
...
//     initComboStyle(LC_TAX_INV_TYPE, DS_O_TAX_INV_TYPE, "CODE^0^30,NAME^0^80", 1, NORMAL);    // 세금계산서종류
 ...
 function gridCreate1(){
     var hdrProperies = '<FC>id=SEL               name="선택"               width=50    align=center HeadCheckShow=true EditStyle=CheckBox  BgColor={if(ETAX_STAT_NM = "승인","orange","white") }</FC>'
                      + '<FC>id={currow}          name="NO"                 width=30    align=center  BgColor={if(ETAX_STAT_NM = "승인","orange","white") }</FC>'
                      + '<FC>id=TAX_INV_FLAG      name="매입/매출"          width=60     Edit=none align=left  BgColor={if(ETAX_STAT_NM = "승인","orange","white") }</FC>'
 ...
 function gridCreate2(){
     var hdrProperies = '<FC>id={currow}          name="NO"            width=30    Edit=none align=center</FC>'
                      ...
                      + '<FC>id=TAX_ITEM_VAT_AMT  name="세액"          width=80    Edit=none align=right</FC>'
...
function btn_Delete() {
    ...
    if(showMessage(Question, YESNO, "USER-1023") == 1){  
        ...
        TR_MAIN.Action="/mss/mren403.mr?goTo=delete&strFlag=delete"; 
...
function btn_Save() {
    ...
    if( showMessage(QUESTION, YESNO, "USER-1010") == 1 ){    // validation 체크
        TR_SAVE.Action="/mss/mren403.mr?goTo=save&strFlag=save"; 
...
//     GR_MASTER.Editable                 = flag;
  ...
  */
  function getList(){
     ...
     TR_MAIN.Action  = "/mss/mren403.mr?goTo="+goTo+parameters;  
 ...
 */
 function getMaster(){
    ...
    TR_S_MAIN.Action  = "/mss/mren403.mr?goTo="+goTo+parameters;  
 ...
 function checkValidation(Gubun) {
      ...
      if(Gubun == "Save"){
          ...
          */
          ...
          if(strEtaxStat != "0" && strEtaxStat != "S" && strEtaxStat != "E"){
 ...
 */
 ...
 function getCharName(strVenCd) {
     ...
     TR_DETAIL.Action="/mss/mren403.mr?goTo="+goTo+parameters;  
...
<script language=JavaScript for=TR_SAVE event=onSuccess>
    for(i=0;i<TR_SAVE.SrvErrCount('UserMsg');i++) {
        showMessage(INFORMATION, OK, "USER-1000", "저장되었습니다.");
        btn_Search();
        var idx = DS_O_LIST.ValueRow(16,TR_SAVE.SrvErrMsg('UserMsg',i));
        ...
        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table">
          ...
          <tr>
             ...
             <td colspan="3">
               ...
               <img src="/<%=dir%>/imgs/btn/detail_search_s.gif" id="IMG_VEN" class="PR03" align="absmiddle" onclick="getVenInfo(EM_S_VEN_CD, EM_S_VEN_NM, true);" />
               <comment id="_NSID_"> 
                            ...
                            <tr valign="top">
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="BD4A">
                                    <tr>
                                        <td>
                                          <comment id="_NSID_"> 
                                              <OBJECT id=GR_MASTER width=100% height=92 classid=<%=Util.CLSID_GRID%>>
