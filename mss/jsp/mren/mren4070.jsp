 ...
 */
 ...
 function doInit(){
     ...
     DS_O_ATTRIBUTE.setDataHeader('<gauce:dataset name="H_ATTRIBUTE"/>');
...
function btn_Save() {
    ...
    if( showMessage(QUESTION, YESNO, "USER-1010") == 1 ){    // validation 체크
        TR_MAIN.Action="/mss/mren407.mr?goTo=save&strFlag=save"; 
...
//     enableControl(LC_CHARGE_FLAG       , flag);
  ...
  */
  function getList(){
     ...
     TR_MAIN.Action  = "/mss/mren407.mr?goTo="+goTo+parameters;  
 ...
 */
 function getMaster(){
    ...
    TR_S_MAIN.Action  = "/mss/mren407.mr?goTo="+goTo+parameters;  
 ...
 function checkValidation(Gubun, btnFlag) {
      ...
      if(Gubun == "Search"){   
    	  if(LC_S_STR_CD.BindColVal == "" || LC_S_STR_CD.BindColVal == ""){
              showMessage(INFORMATION, OK, "USER-1002", "점코드");
              LC_S_STR_CD.Focus();
              return false;
          }
                  ...
                  if(btnFlag == "1"){       // 전송
                      ...
                      if(strTaxInvFlag == "1"){          // 매입
                          if(strEtaxStat != "N" && strEtaxStat != "G" && strEtaxStat != "K" && strEtaxStat != "O"){
                              DS_O_LIST.RowPosition = i;
                              showMessage(EXCLAMATION, OK, "USER-1100");
                              return false;
                          }
 ...
 */
 ...
 function getCharName(strVenCd) {
     ...
     TR_DETAIL.Action="/mss/mren407.mr?goTo="+goTo+parameters;  
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table">
                           ...
                           <tr>
                            ...
                            <tr>
                                ...
                                <td colspan="5">
                                    <comment id="_NSID_"> 
                                        <object id=EM_REMARK classid=<%=Util.CLSID_EMEDIT%> width=500 tabindex=1 align="absmiddle"> </object> 
                                    </comment><script> _ws_(_NSID_);</script>
                                </td>
                            </tr>
