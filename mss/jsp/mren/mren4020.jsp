<!-- 
/*******************************************************************************
 * 시스템명 : 경영지원 > 임대관리 > 관리비청구/입금관리 >세금계산서관리
 * 작 성 일 : 2010.06.09
 * 작 성 자 : 김유완
 * 수 정 자 : 
 * 파 일 명 : MREN402.jsp
...
function doInit() {
    ...
    registerUsingDataset("mren402","DS_IO_MASTER" );
}
...
function gridCreate() {
    var hdrProperies = ''
        ...
        + '<FC>ID=TAX_TYPE          NAME=항목'        
        + '                                         WIDTH=70    ALIGN=CENTER    SHOW=FALSE</FC>'
        + '<FC>ID=TAX_TYPE_NM       NAME=항목'        
        + '                                         WIDTH=70    ALIGN=CENTER    EDIT="NONE"</FC>'
        + '<FC>ID=TAX_GB            NAME=계산서구분'        
        + '                                         WIDTH=80    ALIGN=CENTER    EDIT="NONE"     EDITSTYLE=LOOKUP    DATA="DS_TAX_GB:CODE:NAME"</FC>'
...
function btn_Search() {
    if (DS_IO_MASTER.IsUpdated) {//변경데이터 있을 시 확인
        ...
        if (ret == "1") {
            ...
            TR_MAIN.Action = "/mss/mren402.mr?goTo=" + goTo + parameters;
...
function btn_Save() {
	if (DS_IO_MASTER.IsUpdated) {//변경 데이터가 있을때만 저장
		...
		TR_SAVE.Action = "/mss/mren402.mr?goTo=" + goTo + parameters;
            ...
            <tr>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        ...
                        <td width="100"><comment id="_NSID_"><object id=EM_S_CAL_YM
                    ...
                    <tr>
                        <th>구분</th>
                        <td colspan="5"><comment id="_NSID_"> <object id=LC_S_TAX_TYPE
                            classid=<%=Util.CLSID_LUXECOMBO%> width="110"
                            tabindex=1 align="absmiddle">
                            <param name=CBData value="%^전체,1^관리비,3^임대료">
