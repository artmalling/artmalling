...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}         name="NO"              width=30   align=center SubBgColor=#99FFCC</FC>'
                     + '<FC>id=STRNM            name="점"              width=80    SubSumText="점별소계" SumText="총합계" align=left SubBgColor=#99FFCC</FC>'
                     + '<FC>id=TAKE_DT          name="일자"            width=80     SubBgColor=#99FFCC align=center MASK="XXXX/XX/XX" </FC>'
...
function getSearch(){
	...
	TR_MAIN.Action = "/mss/mpro203.mp?goTo=" + goTo + paraments + "&userid=" + encodeURIComponent(userid);
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr valign="top">
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0"  class="BD4A">
          <tr>
            <td width="100%">
            <comment id="_NSID_"><OBJECT id=GD_MASTER width=100% height=502 classid=<%=Util.CLSID_GRID%> tabindex=1 >
