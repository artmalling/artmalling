...
function doInit(){
   ...
   DS_O_PROC_STAT.ResetStatus();
    ...
    registerUsingDataset("mpro107","DS_IO_MASTER" );
    LC_S_STR.Focus();
}
...
function btn_Search(flag) {
    ...
    if(EM_S_SEARCH_DT.Text.length == 0){   // 조회시작일
        ...
        showMessage(EXCLAMATION , OK, "USER-1075");
        EM_S_SEARCH_DT.focus();
        return;
    }
    ...
    TR_MAIN.Action="/mss/mpro107.mp?goTo="+goTo+parameters;  
 ...
 *************************************************************************/
 ...
 function openHisPop()
 {
     ...
     var returnVal = window.showModalDialog("/mss/mpro107.mp?goTo=openHisPop",
                                            arrArg,
...
function setObject()
{
    ...
    RD_PROC_STAT.DisabledColumn = "Disabler";


	enableControl(IMG_FRST_PROM_DT, false);
	enableControl(IMG_IN_DELI_DT, false);
	enableControl(IMG_COUR_POST_NO, false);
	enableControl(IMG_CHANGE_PROMISE, false);
                    ...
                    <tr>
                        <td><table width="100%">
                            <tr>
                                ...
                                <td align="right"><img src="/<%=dir%>/imgs/btn/change_promise.gif" id="IMG_CHANGE_PROMISE" onClick="javascript:openHisPop();" align="absmiddle"/>
                                </td>
                            </tr>
                        </table></td>
                    </tr>
