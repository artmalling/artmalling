<!-- 
/*******************************************************************************
 * 시스템명 : 경영지원 > 사은행사관리 > 사은품지급정산 > 전자세금계산서 전송
 * 작 성 일 : 2011.04.26
 * 작 성 자 : 김경은
 * 수 정 자 : 
 * 파 일 명 : mcae6060.jsp
...
function btn_Save() {
    ...
    if( showMessage(QUESTION, YESNO, "USER-1010") == 1 ){    // validation 체크
        TR_MAIN.Action="/mss/mcae606.mc?goTo=save&strFlag=save"; 
...
//     enableControl(LC_CHARGE_FLAG       , flag);
  ...
  */
  function getList(){
     ...
     TR_MAIN.Action  = "/mss/mcae606.mc?goTo="+goTo+parameters;  
 ...
 */
 function getMaster(){
    ...
    TR_S_MAIN.Action  = "/mss/mcae606.mc?goTo="+goTo+parameters;  
 ...
 */
 ...
 function getCharName(strVenCd) {
     ...
     TR_DETAIL.Action="/mss/mcae606.mc?goTo="+goTo+parameters;  
