...
function doInit(){
	...
	//Master 그리드 세로크기자동조정  2013-07-17
	 var obj   = document.getElementById("GD_EVTSKUPRSNT_LIST"); 
	...
	DS_O_SKU_PAY_LIST.setDataHeader('<gauce:dataset	name="H_SKU_PAY_LIST"/>');
	DS_O_EVTSKUPRSNT_LIST.setDataHeader('<gauce:dataset	name="H_EVTSKUPRSNT_LIST"/>');
	...
	initEmEdit(EM_CANCEL_DT,     "TODAY", READ);											//취소일자
	initEmEdit(EM_CANCEL_NM,     "GEN",   READ);											//취소자

	//initEmEdit(EM_RECEIPT_NO, "GEN^24",	NORMAL);											//영수증번호
    initEmEdit(EM_RECEIPT_NO,    "000000000000000000000000", NORMAL);         //영수증번호
	initEmEdit(EM_PRSNT_GRP,  "GEN^24",	NORMAL);											//지급그룹번호
	...
	EM_CANCEL_NM.Text =	strUserNM;            //취소자
...
function gridCreate7(){
	var	hdrProperies ='<FC>id={currow}		name="NO"			width=30	align=center</FC>'
					...
					+ '<FC>id=SALE_DT		name="판매일자"		width=90	align=center	edit=none	mask="XXXX/XX/XX"</FC>'
					+ '<FC>id=RECEIPT_NO    name="영수증번호"	width=210	align=center	edit=none	show=false  </FC>'
					+ '<FC>id=F_RECEIPT_NO  name="영수증번호"	width=220	align=center	edit=none	</FC>'
					+ '<FC>id=SALE_AMT_TAX	name="매출금액"		width=110	align=right		edit=none	sumtext=@sum</FC>';
...
function gridCreate(){
	var	hdrProperies ='<FC>id={currow}		    name="NO"				width=30	align=center</FC>'				
					+ '<FC>id=PRSNT_FLAG        name="PRSNT_FLAG"		width=80	align=left		edit=none   show=false  </FC>'
					+ '<FC>id=EVENT_NM	        name="사은행사"			width=150	align=left      edit=none	</FC>'
					...
					+ '<FC>id=GIFTCARD_NO       name="지급상품권번호"  	width=150	align=center   	edit=none   </FC>'
					;

	initGridStyle(GD_SKU_PAY_LIST, "common", hdrProperies,	true);
}
...
function gridCreate8(){
	var	hdrProperies ='<FC>id={currow}		    name="NO"				width=30	align=center</FC>'				
					...
					+ '<FC>id=TRG_NAME		    name="대상범위"			width=80	align=left		edit=none   </FC>'
					+ '<FC>id=SKU_NAME		    name="지급품명"			width=120	align=left		edit=none   </FC>'
					+ '<FC>id=PRSNT_AMT  	    name="지급품금액"		width=90	align=rigth		edit=none   </FC>'
					+ '<FC>id=RTN_GIFTCARD_NO	name="회수상품권번호"  	width=150	align=center	edit={if(SKU_GB = "2", "true", "false")}	 </FC>'
	...
	initGridStyle(GD_EVTSKUPRSNT_LIST, "common", hdrProperies,	true);
}
...
function gridCreate6(){
	var	hdrProperies ='<FC>id={currow}		name="NO"			    width=30	align=center</FC>'
					+ '<FC>id=STR_CD		name="점"		        width=80	align=left		edit=none	show=false  </FC>'
					+ '<FC>id=EVENT_CD	    name="사은행사"		    width=100	align=left		edit=none	</FC>'
					+ '<FC>id=DBL_PAID_YN   name="중복지급"		    width=55	align=center	edit=none	EditStyle=CheckBox    show=false </FC>'
					+ '<FC>id=CARD_PUBLISH  name="카드사"		    width=100	align=left		edit=none	</FC>'
					+ '<FC>id=SALE_AMT_TAX	name="매출금액"		    width=80	align=right		edit=none	</FC>'
					+ '<FC>id=RECEIPT_CNT	name="RECEIPT_CNT"		width=80	align=right		edit=none	show=false  </FC>'
					+ '<FC>id=F_RECEIPT_NO	name="F_RECEIPT_NO"		width=80	align=right		edit=none	show=false  </FC>'
					;
...
function gridCreate2(){
	var	hdrProperies ='<FC>id={currow}		name="NO"				width=30	align=center</FC>'
					+ '<FC>id=CHK			name="선택"				width=30	edit={if(CHK="F","true","false")}  align=center	EditStyle=CheckBox	HeadCheckShow="false"</FC>'
					+ '<FC>id=EVENT_CD	    name="사은행사"			width=100	align=center    edit=none	</FC>'
					+ '<FC>id=SKU_GB	    name="사은품종류"		width=65	align=center    edit=none	</FC>'					
					+ '<FC>id=TRG_NAME		name="대상범위"			width=80	align=left		edit=none   </FC>'
					+ '<FC>id=SKU_NAME		name="지급품명"			width=120	align=left		edit=none   </FC>'
					+ '<FC>id=BUY_COST_PRC	name="지급품금액"		width=90	align=rigth		edit=none   </FC>'
					+ '<FC>id=GIFTCARD_NO   name="상품권번호"   	width=100	edit={if(CHK="T",if(SKU_GB = "2", "true", "false"),"false")}   align=center   	</FC>'
					+ '<FC>id=GIFTCERT_AMT	name="상품권금액"   	width=90	align=rigth		edit=none	show=false  </FC>'
					+ '<FC>id=RECEIPT_CNT	name="RECEIPT_CNT"		width=80	align=right		edit=none	show=false  </FC>'
					+ '<FC>id=F_RECEIPT_NO	name="F_RECEIPT_NO"		width=80	align=right		edit=none	show=false  </FC>'
					;
...
function btn_New() {
	...
	DS_O_SKU_PAY_LIST.ClearData();    // 지급품내역조회
	DS_O_EVTSKUPRSNT_LIST.ClearData();    // 사은품지급내역 조회 및 회수처리
...
function btn_Save() {
	...
	if (DS_O_RECEIPT_ADD.CountRow == 0){
		//저장할 내용이 없습니다
		showMessage(EXCLAMATION , OK, "USER-1000", "취소할 내역이 없습니다.");
		return;
	}
	
	//지급품정보내역
	if (DS_O_SKU_PAY_LIST.CountRow == 0 || DS_O_EVTSKUPRSNT_LIST.CountRow == 0){
		//저장할 내용이 없습니다
		showMessage(EXCLAMATION , OK, "USER-1000", "지급한 내역이 없습니다.");
		return;
	}
	...
	// 지급내역 데이터 체크 시작
	for(var i=1;i<=DS_O_EVTSKUPRSNT_LIST.CountRow;i++){
		
		strSKU_GB = DS_O_EVTSKUPRSNT_LIST.NameValue(i, "SKU_GB");		//사은품종료 =2:상품권
           
        if (strSKU_GB =="2"){             	
            strGiftCardNo = DS_O_EVTSKUPRSNT_LIST.NameValue(i, "RTN_GIFTCARD_NO");		// 회수상품권번호
            nBUY_COST_PRC  = DS_O_EVTSKUPRSNT_LIST.NameValue(i, "PRSNT_AMT");	// 지급품금액
            nGiftCertAmt  = DS_O_EVTSKUPRSNT_LIST.NameValue(i, "GIFTCERT_AMT");	// 상품권 금액
            strGiftCardList = DS_O_EVTSKUPRSNT_LIST.NameValue(i, "GIFTCARD_LIST");		// 상품권번호LIST
            
            if(strGiftCardList.length == 0){
				showMessage(INFORMATION, OK, "USER-1000", "회수상품권번호를 입력하세요.");
            	setFocusGrid(GD_EVTSKUPRSNT_LIST, DS_O_EVTSKUPRSNT_LIST, i, "RTN_GIFTCARD_NO");
                return false;
    		}
...
//            	if (chkGiftCardNo("DS_O_EVTSKUPRSNT_LIST", i) == false) {
//                   	setFocusGrid(GD_EVTSKUPRSNT_LIST, DS_O_EVTSKUPRSNT_LIST, i, "RTN_GIFTCARD_NO");
//                    return false;
//            	}
...
//             // 중복체크(상품권번호)
//             if(gfnCheckDup(DS_O_EVTSKUPRSNT_LIST, strGiftCardNo, "RTN_GIFTCARD_NO") > 1){
//             	DS_O_EVTSKUPRSNT_LIST.Rowposition = i;
//                 showMessage(INFORMATION, Ok, "USER-1000", "중복된 상품권번호(" + strGiftCardNo + ")가 존재합니다.");
//             	setFocusGrid(GD_EVTSKUPRSNT_LIST, DS_O_EVTSKUPRSNT_LIST, i, "GIFTCARD_NO");
//                 return false;
//             }
        }
	}
	...
	for(var	i=1;i<=DS_O_EVTSKUPRSNT_LIST.CountRow;i++){		
		...
		DS_O_EVTSKUPRSNT_LIST.UserStatus(i) = 1;
		
	}	
		

    // 저장할 내용이 없습니다.
    /* if (!DS_O_EVTSKUPRSNT_LIST.IsUpdated){
        showMessage(INFORMATION, OK, "USER-1028");
        return false;
    }
 */
	var strStrCd     = LC_STR.BindColVal;
	var strPRSNT_GRP = EM_PRSNT_GRP.Text;
	var strPRSNT_DT  = EM_PRSNT_DT.Text;         //지급일자	
	var strCALCEL_DT = EM_CANCEL_DT.Text;        //취소일자
	
	//alert(encodeURIComponent(strPRSNT_GRP));

	if (showMessage(QUESTION , YESNO, "USER-1010") != 1) return;
	
	var strParams = "&strStrCd="			+ encodeURIComponent(strStrCd)
	              + "&strPRSNT_GRP="		+ encodeURIComponent(strPRSNT_GRP)
	  			  + "&strPRSNT_DT="			+ encodeURIComponent(strPRSNT_DT)
	  			  + "&strCALCEL_DT="		+ encodeURIComponent(strCALCEL_DT)
				  ;
	
	TR_MAIN.Action="/mss/mcae435.mc?goTo=save"+strParams; 
	TR_MAIN.KeyValue="SERVLET(I:DS_O_EVTSKUPRSNT_LIST=DS_O_EVTSKUPRSNT_LIST)";  
	TR_MAIN.Post();
...
function getPbSaleInfo(){
	...
	TR_MAIN.Action="/mss/mcae435.mc?goTo=getPbSaleInfo_all"+parameters; 
...
function getSaleInfo(){
	...
	TR_MAIN.Action="/mss/mcae435.mc?goTo=getPbSaleInfo"+parameters; 
...
function getSaleInfo_Per(){
	...
	TR_MAIN.Action="/mss/mcae435.mc?goTo=getPbSaleInfo_Per"+parameters; 
	TR_MAIN.KeyValue="SERVLET(O:DS_O_PB_EVENT=DS_O_PB_EVENT, O:DS_O_PAID_EVENT=DS_O_PAID_EVENT, I:DS_O_RECEIPT_ADD=DS_O_RECEIPT_ADD)"; //조회는 O	
	TR_MAIN.Post();
...
function getSaleInfo2(){
	...
	TR_MAIN.Action="/mss/mcae435.mc?goTo=getSaleInfo2"+parameters; 
...
function getSkuPayList() {
		
	DS_O_SKU_PAY_LIST.ClearData();
	...
	TR_MAIN.Action="/mss/mcae435.mc?goTo=getSkuPayList"+parameters;	 
	TR_MAIN.KeyValue="SERVLET(O:DS_O_SKU_PAY_LIST=DS_O_SKU_PAY_LIST)";	    //조회는 O
	TR_MAIN.Post();
	

// 	for(var	i=1;i<=DS_O_SKU_PAY_LIST.CountRow;i++){			
// 		DS_O_SKU_PAY_LIST.UserStatus(i) = 1;
// 	}
 ...
 *	작 성 자 : 
 *	작 성 일 : 2016.11.25
 *	개	  요 : 사은품지급내역조회 및 회수처리
 *	return값 : void
 */

function getEVTSKUPRSNTList() {
		
	DS_O_EVTSKUPRSNT_LIST.ClearData();
	...
	TR_MAIN.Action="/mss/mcae435.mc?goTo=getEVTSKUPRSNTList"+parameters;	 
	TR_MAIN.KeyValue="SERVLET(O:DS_O_EVTSKUPRSNT_LIST=DS_O_EVTSKUPRSNT_LIST)";	    //조회는 O
	TR_MAIN.Post();
...
function getSkuList() {
	...
	TR_MAIN.Action="/mss/mcae435.mc?goTo=getSkuList"+parameters;	 
...
function chkGiftCardNo(strDataSet, strRow){
	...
	var strGiftCardNo = eval(strDataSet).NameValue(strRow, "RTN_GIFTCARD_NO");

	var goTo		= "chkGiftCardNo";
	var	action		= "O";
	var parameters	= "&strGiftCardNo="+ encodeURIComponent(strGiftCardNo);
	
	TR_MAIN3.Action="/mss/mcae435.mc?goTo="+goTo+parameters;  
...
/*
	...
	TR_MAIN2.Action="/mss/mcae435.mc?goTo="+goTo;
...
// 		showMessage(EXCLAMATION ,	OK,	"USER-1000", "등록일자보다 영수증 매출일자가 큰영수증은 등록 할 수 없습니다.");
// 		return;
// 	}
...
//     }	
	...
	DS_O_RECEIPT_ADD.ClearData();      // 영수증내역
	DS_O_SKU_PAY_LIST.ClearData();     //지급품내역조회
	DS_O_EVTSKUPRSNT_LIST.clearData();   //사은품지급내역조회 및 회수처리
	
	//영수증으로 지급된 모든 영수증 조회한다. 
	...
	TR_MAIN.Action="/mss/mcae435.mc?goTo=getRECEIPT_GRP"+parameters; 
	TR_MAIN.KeyValue="SERVLET(O:DS_O_RECEIPT=DS_O_RECEIPT)"; //조회는 O	
	TR_MAIN.Post();
	
	// 영수증 정보 ADD
	if (DS_O_RECEIPT.CountRow > 0){
		EM_PRSNT_GRP.Text = DS_O_RECEIPT.NameValue(1,"PRSNT_GRP");
		EM_PRSNT_DT.Text = DS_O_RECEIPT.NameValue(1,"PRSNT_DT");
		EM_PRSNT_CHAR_NM.Text = DS_O_RECEIPT.NameValue(1,"REG_ID");   //지급자
		
		var parameters = "&strStrCd="    + encodeURIComponent(strStrCd)
					   + "&strPRSNT_GRP="   + encodeURIComponent(EM_PRSNT_GRP.Text)
						;	

		TR_MAIN.Action="/mss/mcae435.mc?goTo=getRECEIPT_list"+parameters; 
		TR_MAIN.KeyValue="SERVLET(O:DS_O_RECEIPT_ADD=DS_O_RECEIPT_ADD)"; //조회는 O	
		TR_MAIN.Post();
...
<!-- 회수list 의 회수상품권번호 데이터셋 값 변경 후 -->
<script language="javascript"  for=DS_O_EVTSKUPRSNT_LIST event=OnColumnChanged(row,colid)>
	//중복불가 지급내역 선택시
	if(DS_O_EVTSKUPRSNT_LIST.NameValue(row,"RTN_GIFTCARD_NO").length == 0) {
		//DS_O_EVTSKUPRSNT_LIST.NameValue(row, "GIFTCERT_AMT") = 0;
		return;
	}
	
	switch(colid){
		case 'RTN_GIFTCARD_NO':     // 상품권 번호 조회	
			if(DS_O_EVTSKUPRSNT_LIST.NameValue(row,"RTN_GIFTCARD_NO").length != 12){
				
			}else{
	    		var iItemCd = DS_O_EVTSKUPRSNT_LIST.NameValue(row,"RTN_GIFTCARD_NO");
	    		var iGIFTCERT_AMT = DS_O_EVTSKUPRSNT_LIST.NameValue(row,"GIFTCERT_AMT");
	    		var iGIFTCARD_CNT = 0;
	    		var strGIFTCARD_LIST = DS_O_EVTSKUPRSNT_LIST.NameValue(row,"GIFTCARD_LIST");
	    		
	    		var intcol = 0;
	    		
				for(var irow=1;irow<=DS_O_EVTSKUPRSNT_LIST.CountRow;irow++){
	    			
	    			iGIFTCARD_CNT = DS_O_EVTSKUPRSNT_LIST.NameValue(irow,"GIFTCARD_CNT");
	    			intcol = 0;
		    		for(var i=1;i<=iGIFTCARD_CNT;i++){
		    			var strGIFTCARD_NO = DS_O_EVTSKUPRSNT_LIST.NameValue(irow,"GIFTCARD_LIST").substring(intcol,12 + intcol);
	    		...
	    		if (chkGiftCardNo("DS_O_EVTSKUPRSNT_LIST", row)) {
	    		
	    			DS_O_EVTSKUPRSNT_LIST.NameValue(row,"GIFTCARD_CNT") = DS_O_EVTSKUPRSNT_LIST.NameValue(row,"GIFTCARD_CNT") + 1;
	    			DS_O_EVTSKUPRSNT_LIST.NameValue(row,"GIFTCERT_AMT") = DS_O_EVTSKUPRSNT_LIST.NameValue(row,"GIFTCERT_AMT") + iGIFTCERT_AMT;
	    			DS_O_EVTSKUPRSNT_LIST.NameValue(row,"GIFTCARD_LIST") = DS_O_EVTSKUPRSNT_LIST.NameValue(row,"RTN_GIFTCARD_NO") + strGIFTCARD_LIST;
	    			DS_O_EVTSKUPRSNT_LIST.NameValue(row,"RTN_GIFTCARD_NO") = "";
	    		}
			}
			break;
	}
...
<!-- 회수list 의 회수상품권번호  그리드 값 변경 후 -->
<script language="javascript"  for=GD_EVTSKUPRSNT_LIST event=CanColumnPosChange(Row,Colid)>
	...
	switch(Colid){
		case 'RTN_GIFTCARD_NO':     // 상품권 번호 조회	
			if(DS_O_EVTSKUPRSNT_LIST.NameValue(Row,"RTN_GIFTCARD_NO").length != 12){
	    		...
	    		var iItemCd = DS_O_EVTSKUPRSNT_LIST.NameValue(Row,"RTN_GIFTCARD_NO");
	    	    for(var k=i+1; k<=DS_O_EVTSKUPRSNT_LIST.CountRow; k++) {
	    	    	if (Row != k) {
	    	    		var kItemCd = DS_O_EVTSKUPRSNT_LIST.NameValue(k,"RTN_GIFTCARD_NO");
	    		        if (iItemCd==kItemCd) {
	    		            showMessage(STOPSIGN, OK, "USER-1000", k +"번째행의  상품권번호와 중복됩니다.");

	    					//setFocusGrid(GD_EVTSKUPRSNT_LIST, DS_O_EVTSKUPRSNT_LIST, Row , "GIFTCARD_NO");
	    		            return false;
	    		        }
	    	    	}
	    	    }
	    	    
	    		//if (chkGiftCardNo("DS_O_EVTSKUPRSNT_LIST", Row) == false) {
	    		//
	    		//	return false;
	       		//};					
			}	
	...
	switch(colid){
		case 'GIFTCARD_NO':     // 상품권 번호 조회	
			if(DS_IO_SKU_LIST_ALL.NameValue(row,"GIFTCARD_NO").length != 12){
	    		...
	    		chkGiftCardNo("DS_IO_SKU_LIST_ALL", row);					
			}
			break;
	}
</script>
	...
	switch(colid){
		case 'GIFTCARD_NO':     // 상품권 번호 조회	
			if(DS_IO_SKU_LIST.NameValue(row,"GIFTCARD_NO").length != 12){
	    		...
	    		chkGiftCardNo("DS_IO_SKU_LIST", row);					
			}
			break;
	}
</script>
	...
	switch(colid){
		case 'GIFTCARD_NO':     // 상품권 번호 조회	
			if(DS_IO_SKU_LIST_CARD.NameValue(row,"GIFTCARD_NO").length != 12){
	    		...
	    		chkGiftCardNo("DS_IO_SKU_LIST_CARD", row);					
			}
			break;
	}
</script>
...
<comment id="_NSID_"><object id="DS_O_SKU_PAY_LIST"	    classid=<%=Util.CLSID_DATASET%>></object></comment><script>_ws_(_NSID_);</script>
<comment id="_NSID_"><object id="DS_O_EVTSKUPRSNT_LIST"	classid=<%=Util.CLSID_DATASET%>></object></comment><script>_ws_(_NSID_);</script>
					...
					<tr>
						<th	class="point" width="90">영수증번호</th>
							<td	width="210">
								...
								<comment id="_NSID_"> 
									<object style="display:none;"  id=EM_PRSNT_GRP classid=<%=Util.CLSID_EMEDIT%>	width="50"
										tabindex=1 align="absmiddle"> </object>
								</comment><script>_ws_(_NSID_);</script>
							</td>	
						...
						<th	width="90"	class="point">취소일자</th>
							<td width="120">
								<comment id="_NSID_">
									<object	id=EM_CANCEL_DT classid=<%=Util.CLSID_EMEDIT%> width="90" tabindex=1 align="absmiddle"></object>
								</comment><script>_ws_(_NSID_);</script>
							</td>
						<th	width="90" class="point">취소자</th>
							<td >
								<comment id="_NSID_">
									<object	id=EM_CANCEL_NM	classid=<%=Util.CLSID_EMEDIT%> width="90" tabindex=1 align="absmiddle"></object>
								</comment><script>_ws_(_NSID_);</script>
							</td>
					</tr>
				</table>
						...
						<table width="100%"	border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<table width="100%"	border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td	class="sub_title">
											<img src="/<%=dir%>/imgs/comm/ring_blue.gif" align="absmiddle" class="PR03" />지급품내역조회
										</td>
									</tr>
								</table>
								</td>
							...
							<tr>
								...
								<table width="100%"	border="0" cellspacing="0" cellpadding="0" class="BD4A">
									<tr>
										<td><comment id="_NSID_"><OBJECT id=GD_SKU_PAY_LIST
											width=100% height=350 classid=<%=Util.CLSID_GRID%>>
											<param name="DataID" value="DS_O_SKU_PAY_LIST">
										</OBJECT></comment><script>_ws_(_NSID_);</script></td>
									</tr>
								</table>
								</td>
						...
						<table width="100%"	border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<table width="100%"	border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td	class="sub_title">
											<img src="/<%=dir%>/imgs/comm/ring_blue.gif" align="absmiddle" class="PR03" />사은품지급내역 및 회수처리
										</td>
									</tr>
								</table>
								</td>
							...
							<tr>
								...
								<table width="100%"	border="0" cellspacing="0" cellpadding="0" class="BD4A">
									<tr>
										<td><comment id="_NSID_"><OBJECT id=GD_EVTSKUPRSNT_LIST
											width=100% height=350 classid=<%=Util.CLSID_GRID%>>
											<param name="DataID" value="DS_O_EVTSKUPRSNT_LIST">
										</OBJECT></comment><script>_ws_(_NSID_);</script></td>
									</tr>
								</table>
								</td>
