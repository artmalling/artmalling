...
function btn_Save() {
	...
	TR_MAIN.Action="/mss/mcae415.mc?goTo=save"+strParams; 
...
function getEventCombo(){
	...
	TR_MAIN.Action="/mss/mcae415.mc?goTo=getEventCombo"+parameters;	
...
function getEventInfo() {
	...
	TR_MAIN.Action="/mss/mcae415.mc?goTo=getEventInfo"+parameters;  
...
function getCardInfo()	{
	...
	TR_CARDINFO.Action="/mss/mcae415.mc?goTo=getCardInfo"+parameters;
...
function getSaleInfo2(){
	...
	TR_MAIN.Action="/mss/mcae415.mc?goTo=getSaleInfo2"+parameters; 
 ...
 */
	...
	function getSkuList() {
		...
		var parameters = "&strStrCd="  + encodeURIComponent(strStrCd)
					   + "&strEventCd="+ encodeURIComponent(strEventCd);
		TR_MAIN.Action="/mss/mcae415.mc?goTo=getSkuList"+parameters;	 
...
function getSkuInfo() {
	...
	TR_MAIN.Action="/mss/mcae415.mc?goTo=getSkuInfo"+parameters;	 
...
function chkGiftCardNo(strRow){
	...
	TR_MAIN3.Action="/mss/mcae415.mc?goTo="+goTo+parameters;  
...
function getGiftCardNo() {
	...
	TR_MAIN2.Action="/mss/mcae415.mc?goTo="+goTo;
