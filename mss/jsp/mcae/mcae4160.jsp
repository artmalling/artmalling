...
function btn_Save() {
	...
	TR_MAIN.Action="/mss/mcae416.mc?goTo=save"+strParams; 
...
function getEventCombo(){
	...
	TR_MAIN.Action="/mss/mcae416.mc?goTo=getEventCombo"+parameters;	
...
function getEventInfo() {
	...
	TR_MAIN.Action="/mss/mcae416.mc?goTo=getEventInfo"+parameters;  
...
/* 	if(DS_O_EVENT_INFO.NameValue(1,"EVENT_TYPE") != "03"){
	...
	TR_CARDINFO.Action="/mss/mcae416.mc?goTo=getCardInfo"+parameters;
...
/*	if(DS_O_CARD_INFO.NameValue(1,"RTN_CD")	!= "0"){
		...
		TR_MAIN.Action="/mss/mcae416.mc?goTo=getSaleInfo"+parameters; 
...
function getSaleInfo2(){
	...
	TR_MAIN.Action="/mss/mcae416.mc?goTo=getSaleInfo2"+parameters; 
 ...
 */
	...
	function getSkuList() {
		...
		TR_MAIN.Action="/mss/mcae416.mc?goTo=getSkuList"+parameters;	 
...
function getSkuInfo() {
	...
	TR_MAIN.Action="/mss/mcae416.mc?goTo=getSkuInfo"+parameters;	 
...
function chkGiftCardNo(strRow){
	...
	TR_MAIN3.Action="/mss/mcae416.mc?goTo="+goTo+parameters;  
...
function getGiftCardNo() {
	...
	TR_MAIN2.Action="/mss/mcae416.mc?goTo="+goTo;
