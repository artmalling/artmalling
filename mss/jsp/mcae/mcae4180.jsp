<!-- 
/*******************************************************************************
 * 시스템명	: 경영지원 > 사은행사관리 >	사은품 지급/취소 > 사은품지급내역건별조회
 * 작 성 일	: 2011.01.18
 * 작 성 자	: 김슬기
 * 수 정 자	: 
 * 파 일 명	: MCAE4180.jsp
...
function gridCreate2(){
	var	hdrProperies2 ='<FC>id={currow}			 name="NO"			    width=30	align=center   </FC>'
					...
					+ '<FC>id=PRSNT_NO			 name="지급번호"		width=60	align=center   suppress=2       </FC>'
					+ '<FC>id=CUST_ID			 name="회원ID"		    width=100	align=center   </FC>'
					+ '<FC>id=CUST_NM			 name="회원명"		    width=80	align=center   </FC>'
					+ '<FC>id=EVENT_GIFT_TYPE	 name="사은품구분"	    width=100	align=center   </FC>'
					+ '<FC>id=SKU_CD			 name="사은품코드"	    width=110	align=center   </FC>'
					+ '<FC>id=SKU_NAME			 name="사은품명"		width=150	align=left     </FC>'
					+ '<FC>id=PRSNT_FLAG_NAME	 name="지급구분"		width=90	align=center   </FC>'
					+ '<FC>id=PRSNT_TIME		 name="지급시간"		width=80	align=center   Mask="XX:XX:XX"    </FC>'
					+ '<FC>id=PRSNT_QTY			 name="지급수량"		width=70	align=right    sumtext=@sum      </FC>'
					+ '<FC>id=PRSNT_AMT			 name="지급금액"		width=80	align=right    sumtext=@sum      </FC>'
					+ '<FC>id=SALE_AMT			 name="승인금액"		width=80	align=right    sumtext=@sum      </FC>'
					+ '<FC>id=CARD_YN			 name="결재유형"		width=80	align=center   </FC>'
					+ '<FC>id=RECP_NO			 name="영수증번호"      width=150	align=center   </FC>'
					+ '<FC>id=GIFTCARD_NO		 name="상품권번호"	    width=250	align=center   suppress=1        </FC>';     //20140306_마케팅 김도하사원요청 결재유형,영수증번호,상품권번호 추가-강연식
					//결재 유형은 카드결재가 있을 경우 무조건 카드결재로 출력
...
function btn_Search() {
	...
	TR_MAIN.Action="/mss/mcae418.mc?goTo="+goTo+parameters;	 
...
function openPop(){
	...
	var	returnVal =	window.showModalDialog("/mss/mcae418.mc?goTo=openPop",
										   arrArg,
