...
function btn_Save()	{
	...
	TR_MAIN.Action="/mss/mcae425.mc?goTo=save"+strParams; 
...
function getCardCombo() {
	...
	TR_MAIN.Action="/mss/mcae425.mc?goTo=getCardCombo"+parameters;  
 ...
 function getEventInfo() {
	  ...
	  // 조회조건 셋팅
	   ...
	   TR_MAIN.Action ="/mss/mcae425.mc?goTo=getEventInfo"+parameters;  
 ...
 function getSaleInfo()	{
	   ...
	   TR_MAIN.Action="/mss/mcae425.mc?goTo=getSaleInfo"+parameters; 
	   ...
	   if(DS_IO_SALE_CHK.NameValue(1,"CNT")	== "0" ){
		   ...
		   showMessage(EXCLAMATION , OK, "USER-1000", "지급대상	영수증이 아닙니다.1");
		   EM_RECEIPT_NO.Text =	"";
	   }else{
 ...
 function getSaleInfo3(){
	...
	var parameters	=	"&strStrCd="	+ encodeURIComponent(strStrCd)
 	...
 	TR_MAIN.Action="/mss/mcae425.mc?goTo=getSaleInfo3"+parameters; 
 ...
 function getSkuList() {
	...
	// 20150220 제휴카드로 두번이상 지급됨 지급품 조회할때 체크로직 추가
	  ...
	  // 조회조건 셋팅
	   ...
	   TR_MAIN.Action="/mss/mcae425.mc?goTo=getSkuList"+parameters;	 
 ...
 function getSkuInfo() {
 	...
 	TR_MAIN.Action="/mss/mcae425.mc?goTo=getSkuInfo"+parameters;	 
...
function getGiftCardNo() {
	...
	TR_MAIN2.Action="/mss/mcae425.mc?goTo="+goTo;  
