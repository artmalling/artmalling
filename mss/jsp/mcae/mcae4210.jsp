<!-- 
/*******************************************************************************
 * 시스템명 : 경영지원 > 사은행사관리 > 사은품 지급/취소 > 사은품지급내역건별조회(쿠폰)
 * 작 성 일 : 2011.01.18
 * 작 성 자 : 김슬기
 * 수 정 자 : 
 * 파 일 명 : MCAE4210.jsp
...
function btn_Search() {
    ...
    TR_MAIN.Action="/mss/mcae421.mc?goTo="+goTo+parameters;  
...
function openPop(){
    ...
    var returnVal = window.showModalDialog("/mss/mcae421.mc?goTo=openPop",
                                           arrArg,
