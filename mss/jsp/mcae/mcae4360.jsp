<!-- 
/*******************************************************************************
 * 시스템명	: 경영지원 > 사은행사관리 >	사은품 지급/취소 > 사은품사후지급등록
 * 작 성 일	: 2016.11.15
 * 작 성 자	: KHJ
 * 수 정 자	: 
 * 파 일 명	: MCAE4360.jsp
...
function doInit(){
	...
	//chkExcp(true);
	strToday = getTodayDB("DS_O_RESULT");           //오늘날짜	
	strYesterday = addDate("d", -1, strToday, "");  //어제일자
...
//                 }
	...
	TR_MAIN.Action="/mss/mcae436.mc?goTo=save"+strParams; 
...
function getEventCombo(){
	...
	TR_MAIN.Action="/mss/mcae436.mc?goTo=getEventCombo"+parameters;	
...
;
	...
	TR_MAIN.Action="/mss/mcae436.mc?goTo=getEventInfo"+parameters;  
...
function getPbSaleInfo(){
	...
	TR_MAIN.Action="/mss/mcae436.mc?goTo=getPbSaleInfo_all"+parameters; 
...
function getSaleInfo(){
	...
	TR_MAIN.Action="/mss/mcae436.mc?goTo=getPbSaleInfo"+parameters; 
...
function getSaleInfo_Per(){
	...
	TR_MAIN.Action="/mss/mcae436.mc?goTo=getPbSaleInfo_Per"+parameters; 
	TR_MAIN.KeyValue="SERVLET(O:DS_O_PB_EVENT=DS_O_PB_EVENT, O:DS_O_PAID_EVENT=DS_O_PAID_EVENT, I:DS_O_RECEIPT_ADD=DS_O_RECEIPT_ADD)"; //조회는 O	
	TR_MAIN.Post();
...
function getSaleInfo2(){
	...
	TR_MAIN.Action="/mss/mcae436.mc?goTo=getSaleInfo2"+parameters; 
...
function getSkuList() {
	...
	TR_MAIN.Action="/mss/mcae436.mc?goTo=getSkuList"+parameters;	 
...
function chkGiftCardNo(strDataSet, strRow){
	...
	TR_MAIN3.Action="/mss/mcae436.mc?goTo="+goTo+parameters;  
...
/*
	...
	TR_MAIN2.Action="/mss/mcae436.mc?goTo="+goTo;
...
function dataClear() {
	...
	if (strYesterday < strPrsntDt) {
		showMessage(EXCLAMATION ,	OK,	"USER-1000", "지급일자는 오늘일자 보다 작아야 합니다.");
...
//OnKillFocus()>
	...
	TR_MAIN.Action="/mss/mcae436.mc?goTo=getRECEIPT_list"+parameters; 
			...
			<tr>
				...
				<table width="100%"	border="0" cellpadding="0" cellspacing="0" class="s_table">
					<tr>
						...
						<th	width="90"	class="point">지급기준일자</th>
							<td width="120">
								<comment id="_NSID_">
