...
function gridCreate2(){ 
    var hdrProperies2 ='<FC>id={currow}          name="NO"             width=30    align=center  </FC>'
                    ...
                    + '<FC>id=SKU_NAME           name="사은품명"       width=130   align=left    </FC>'
                    ...
                    + '<FC>id=CARD_DATA          name="카드번호"       width=140   align=center  </FC>'
                    + '<FC>id=PAY_AMT            name="승인금액"       width=80    align=right   sumtext=@sum</FC>'
                    + '<FC>id=APPR_NO            name="승인번호"       width=80    align=center  </FC>'
                    + '<FC>id=RECP_NO            name="영수증"         width=150   align=center  </FC>'
                    + '<FC>id=GIFTCARD_NO        name="상품권"         width=140   align=center  suppress=1   </FC>';
...
function btn_Search() {
    ...
    TR_MAIN.Action="/mss/mcae419.mc?goTo="+goTo+parameters;  
...
function openPop(){
    ...
    var returnVal = window.showModalDialog("/mss/mcae419.mc?goTo=openPop",
                                           arrArg,
