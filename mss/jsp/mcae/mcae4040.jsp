 ...
 */
 function gridCreate1(){ 
    var hdrProperies ='<FC>id={currow}          name="NO"          	width=30   	align=center</FC>'
                    ...
                    + '<FC>id=STK_DT        	name="지급일자"        width=110  	align=center Mask="XXXX/XX/XX" </FC>'
                    + '<FC>id=SKU_CD        	name="사은단품코드"     width=130  	align=center </FC>'
                    + '<FC>id=SKU_NAME          name="사은품명"      	width=170  	align=left 	 </FC>'
                    + '<FC>id=NQTY    			name="지급수량"   	  	width=80  	align=right	sumtext="@sum"</FC>'
                    + '<FC>id=CPRSNT_QTY        name="지급취소수량"    	width=80  	align=right	sumtext="@sum"</FC>'
                    + '<FC>id=RE_QTY       		name="소계"    		width=80  	align=right	sumtext="@sum"</FC>';
 ...
 */
 function btn_Search() { 
    ...
    TR_MAIN.Action="/mss/mcae404.mc?goTo="+goTo+parameters;  
