...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}    name="NO"         width=25   align=center</FC>'
                     + '<FC>id=YYYYMM      name="정산년월"     width=70 mask="XXXX/XX"  align=center</FC>'
    ...
    var hdrProperies1 = '<FC>id={currow}    name="NO"         width=25   align=center</FC>'
        + '<FC>id=YYYYMM      name="정산년월" sumtext="합계"    width=80  mask="XXXX/XX"   align=center</FC>'
...
function btn_Search() {
    ...
    TR_MAIN.Action="/mss/mgif601.mg?goTo=getTotal"+parameters;  
...
function btn_Save() {
	// 저장할 데이터 없는 경우
	   ...
	   TR_MAIN.Action="/mss/mgif601.mg?goTo=save"+parameters;  
...
function btn_Conf() {
    ...
    if (showMessage(QUESTION , YESNO, "USER-1010") != 1) return;
    TR_MAIN.Action="/mss/mgif601.mg?goTo=confirm"; 
...
function getDetail(){
	 ...
	 TR_S_MAIN.Action="/mss/mgif601.mg?goTo=getDetail"+parameters;  
      ...
      <tr>
        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table">
          <tr>
            ...
            <th width="100" class="point">정산년월</th>
            <td>
               <comment id="_NSID_">
                 <object id=EM_CAL_YM classid=<%=Util.CLSID_EMEDIT%> onblur="checkDateTypeYM(this);" width=148 tabindex=1 align="absmiddle">
