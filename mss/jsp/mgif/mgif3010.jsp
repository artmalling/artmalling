...
function doInit(){
    ...
    registerUsingDataset("mgif301", "DS_IO_MASTER");   
}
...
function btn_Save() {
 ...
 // 마감체크 (common.js) : 월마감
    ...
    TR_MAIN.Action="/mss/mgif301.mg?goTo=save"+strParam;  
...
function getSaleInfo(){
    ...
    var parameters = "&strGiftSNo=" + encodeURIComponent(EM_GIFT_S_NO.Text) 
                   ...
                   + "&strStrCd="   + encodeURIComponent(LC_STR.BindColVal) ; 
    TR_MAIN.Action   = "/mss/mgif301.mg?goTo=" + goTo + parameters;
