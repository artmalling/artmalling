...
function gridCreate1(){ 
	var hdrProperies = '<COLUMNINFO>' 
        ...
        + '           <HEADER  left="270" top="20" right="370" bottom="40" text="본부입고수량" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        ...
        + '           <HEADER  left="270" top="40" right="370" bottom="60" text="본부입고금액" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        ...
        + '           <HEADER left="480" top="0" right="1090" bottom="20" text="출고" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        + '       </COLUMN>'
        ...
        + '           <HEADER  left="980" top="20" right="1090" bottom="40" text="재무강제불출수량" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        + '           <VIEW left="980" top="0" right="1090" bottom="20" align="RightCenter"  borderstyle="Line" bordercolor="#dddddd"  displayformat="#,##0"/>'
        ...
        + '           <HEADER  left="980" top="40" right="1090" bottom="60" text="재무강제불출금액" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        + '           <VIEW left="980" top="20" right="1090" bottom="40" align="RightCenter"  borderstyle="Line" bordercolor="#dddddd"  bgcolor="#EDF4F8"  displayformat="#,##0"/>'
        + '           <VIEWSUMMARY text="@GFSUM(ACC_POUT_AMT)"  bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0" />'  
        + '       </COLUMN>'  
        + '       <COLUMN id="POUT_QTY"  refcolid="POUT_QTY" >'
        + '           <HEADER left="1090" top="0" right="1190" bottom="30" text="DESK불출수량" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        + '           <VIEW left="1090" top="0" right="1190" bottom="20" align="RightCenter" borderstyle="Line" bordercolor="#dddddd"  displayformat="#,##0"/>'
        + '         <VIEWSUMMARY text="@GFSUM(POUT_QTY)"  bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0" />' 
        + '       </COLUMN>' 
        + '       <COLUMN id="POUT_AMT"  refcolid="POUT_AMT" >'
        + '           <HEADER left="1090" top="30" right="1190" bottom="60" text="DESK불출금액" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        + '           <VIEW left="1090" top="20" right="1190" bottom="40" align="RightCenter" borderstyle="Line" bordercolor="#dddddd"   bgcolor="#EDF4F8" displayformat="#,##0"/>'
        + '         <VIEWSUMMARY text="@GFSUM(POUT_AMT)"  bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0" />' 
        + '       </COLUMN>'   
        + '       <COLUMN id="RFD"  refcolid="">'
        + '           <HEADER left="1190" top="0" right="1680" bottom="20" text="회수" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        + '       </COLUMN>'
        + '       <COLUMN id="NOR_DRAWL_QTY"  refcolid="NOR_DRAWL_QTY">'
        + '           <HEADER  left="1190" top="20" right="1270" bottom="40" text="정상수량" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        + '           <VIEW left="1190" top="0" right="1270" bottom="20" align="RightCenter"  borderstyle="Line" bordercolor="#dddddd"  displayformat="#,##0"/>'
        ...
        + '           <HEADER   left="1190" top="40" right="1270" bottom="60" text="정상금액" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        + '           <VIEW left="1190" top="20" right="1270" bottom="40" align="RightCenter"  borderstyle="Line" bordercolor="#dddddd"  bgcolor="#EDF4F8"  displayformat="#,##0"/>'
        ...
        + '           <HEADER  left="1270" top="20" right="1370" bottom="40" text="가맹점수량" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        + '           <VIEW left="1270" top="0" right="1370" bottom="20" align="RightCenter"  borderstyle="Line" bordercolor="#dddddd"  displayformat="#,##0"/>'
        ...
        + '           <HEADER   left="1270" top="40" right="1370" bottom="60" text="가맹점금액" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        + '           <VIEW left="1270" top="20" right="1370" bottom="40" align="RightCenter"  borderstyle="Line" bordercolor="#dddddd"  bgcolor="#EDF4F8"  displayformat="#,##0"/>'
        ...
        + '           <HEADER  left="1370" top="20" right="1450" bottom="40" text="교환수량" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        + '           <VIEW left="1370" top="0" right="1450" bottom="20" align="RightCenter"  borderstyle="Line" bordercolor="#dddddd"  displayformat="#,##0"/>'
        ...
        + '           <HEADER   left="1370" top="40" right="1450" bottom="60" text="교환금액" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        + '           <VIEW left="1370" top="20" right="1450" bottom="40" align="RightCenter"  borderstyle="Line" bordercolor="#dddddd"  bgcolor="#EDF4F8"  displayformat="#,##0"/>'
        ...
        + '           <HEADER  left="1450" top="20" right="1580" bottom="40" text="판매반품회수수량" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        + '           <VIEW left="1450" top="0" right="1580" bottom="20" align="RightCenter"  borderstyle="Line" bordercolor="#dddddd"  displayformat="#,##0"/>'
        ...
        + '           <HEADER   left="1450" top="40" right="1580" bottom="60" text="판매반품회수금액" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        + '           <VIEW left="1450" top="20" right="1580" bottom="40" align="RightCenter"  borderstyle="Line" bordercolor="#dddddd"  bgcolor="#EDF4F8"  displayformat="#,##0"/>'
        ...
        + '           <HEADER  left="1580" top="20" right="1680" bottom="40" text="재사용수량" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        + '           <VIEW left="1580" top="0" right="1680" bottom="20" align="RightCenter"  borderstyle="Line" bordercolor="#dddddd"  displayformat="#,##0"/>'
        ...
        + '           <HEADER   left="1580" top="40" right="1680" bottom="60" text="재사용금액" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        + '           <VIEW left="1580" top="20" right="1680" bottom="40" align="RightCenter"  borderstyle="Line" bordercolor="#dddddd"  bgcolor="#EDF4F8"  displayformat="#,##0"/>'
        ...
        + '           <HEADER left="1680" top="0" right="1790" bottom="30" text="금고재고수량" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        + '           <VIEW left="1680" top="0" right="1790" bottom="20" align="RightCenter" borderstyle="Line" bordercolor="#dddddd"  displayformat="#,##0"/>'
        ...
        + '           <HEADER left="1680" top="30" right="1790" bottom="60" text="금고재고금액" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        + '           <VIEW left="1680" top="20" right="1790" bottom="40" align="RightCenter" borderstyle="Line" bordercolor="#dddddd"   bgcolor="#EDF4F8" displayformat="#,##0"/>'
        + '         <VIEWSUMMARY text="@GFSUM(STBOX_PREV_AMT)"  bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0" />' 
        + '       </COLUMN>'   
        + '       <COLUMN id="QTY"  refcolid="QTY" >'
        + '           <HEADER left="1790" top="0" right="1890" bottom="30" text="현재고수량" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        + '           <VIEW left="1790" top="0" right="1890" bottom="20" align="RightCenter" borderstyle="Line" bordercolor="#dddddd"  displayformat="#,##0"/>'
        + '         <VIEWSUMMARY text="@GFSUM(QTY)"  bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0" />' 
        + '       </COLUMN>' 
        + '       <COLUMN id="AMT"  refcolid="AMT" >'
        + '           <HEADER left="1790" top="30" right="1890" bottom="60" text="현재고금액" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        + '           <VIEW left="1790" top="20" right="1890" bottom="40" align="RightCenter" borderstyle="Line" bordercolor="#dddddd"   bgcolor="#EDF4F8" displayformat="#,##0"/>'
        ...
        + '           <HEADER left="1890" top="0" right="2010" bottom="30" text="기초미회수내역수량" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        + '           <VIEW left="1890" top="0" right="2010" bottom="20" align="RightCenter" borderstyle="Line" bordercolor="#dddddd"  displayformat="#,##0"/>'
        ...
        + '           <HEADER left="1890" top="30" right="2010" bottom="60" text="기초미회수내역금액" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        + '           <VIEW left="1890" top="20" right="2010" bottom="40" align="RightCenter" borderstyle="Line" bordercolor="#dddddd"   bgcolor="#EDF4F8" displayformat="#,##0"/>'
        ...
        + '           <HEADER left="2010" top="0" right="2120" bottom="30" text="기간미회수수량" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        + '           <VIEW left="2010" top="0" right="2120" bottom="20" align="RightCenter" borderstyle="Line" bordercolor="#dddddd"  displayformat="#,##0"/>'
        ...
        + '           <HEADER left="2010" top="30" right="2120" bottom="60" text="기간미회수금액" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        + '           <VIEW left="2010" top="20" right="2120" bottom="40" align="RightCenter" borderstyle="Line" bordercolor="#dddddd"   bgcolor="#EDF4F8" displayformat="#,##0"/>'
        ...
        + '           <HEADER left="2120" top="0" right="2230" bottom="30" text="누적미회수수량" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        + '           <VIEW left="2120" top="0" right="2230" bottom="20" align="RightCenter" borderstyle="Line" bordercolor="#dddddd"  displayformat="#,##0"/>'
        ...
        + '           <HEADER left="2120" top="30" right="2230" bottom="60" text="누적수내역금액" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        + '           <VIEW left="2120" top="20" right="2230" bottom="40" align="RightCenter" borderstyle="Line" bordercolor="#dddddd"   bgcolor="#EDF4F8" displayformat="#,##0"/>'
