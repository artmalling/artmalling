...
function doInit(){
    ...
    registerUsingDataset("mgif107", "DS_IO_MASTER,DS_IO_DETAIL");  
}
...
function btn_Search() {
    ...
    var parameters = "&strStrCd="   + encodeURIComponent(strStrCd)
                   ...
                   ;
    TR_MAIN.Action="/mss/mgif107.mg?goTo="+goTo+parameters;  
...
function btn_Save() {
    ...
    TR_MAIN.Action="/mss/mgif107.mg?goTo=save";  
...
function btn_Excel() {
	...
	searchSetWait("B");
    TR_MAIN.Action="/mss/mgif107.mg?goTo=getExcel";  
    TR_MAIN.KeyValue="SERVLET(I:DS_IO_MASTER=DS_IO_MASTER,O:DS_O_EXCEL=DS_O_EXCEL)"; //조회는 O
    TR_MAIN.Post();
    
    if(DS_O_EXCEL.CountRow > 0) openExcel2(GD_EXCEL, "상품권 발행의뢰", "", true, true);
...
function btn_Print() {
  ...
  // }
   ...
   // alert(strReqSlipNo);
    ...
    window.open("/mss/mgif107.mg?goTo=print"+params, "OZREPORT", 1000, 700);
}
 ...
 *************************************************************************/
 ...
 function getReqDtl (strReqDt,strStrCd,strReqSlipNo) {
    ...
    TR_MAIN1.Action="/mss/mgif107.mg?goTo="+goTo+parameters;  
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0"
		...
		<tr>
			<td><comment id="_NSID_"><OBJECT id=GD_DETAIL
				width=100% height=260 classid=<%=Util.CLSID_GRID%>>
