...
function gridCreate1(){
	var	hdrProperies = '<COLUMNINFO>' 
		...
		+ '			<HEADER				left="60"	top="0"		right="140"	bottom="20"	text="전월이월"			bgcolor="#eaeef4"	borderstyle="Line"	bordercolor="#dddddd"/>'
		+ '		</COLUMN>'		
		+ '		<COLUMN id="PREV_QTY" refcolid="PREV_QTY" >'
		+ '			<HEADER fix="true"	left="60"	top="20"	right="140"	bottom="40"	text="이월수량"			bgcolor="#eaeef4"	borderstyle="Line"	bordercolor="#dddddd"/>'
		+ '			<VIEW				left="60"	top="0"		right="140"	bottom="20"	align="RightCenter"							borderstyle="Line"	bordercolor="#dddddd"	displayformat="#,##0"/>'
		+ '			<VIEWSUMMARY text="@GFSUM(PREV_QTY)"		bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0"	/>'
		+ '		</COLUMN>'
		+ '		<COLUMN id="PREV_AMT" refcolid="PREV_AMT">'
		+ '			<HEADER				left="60"	top="40"	right="140"	bottom="60"	text="이월금액"			bgcolor="#eaeef4"	borderstyle="Line"	bordercolor="#dddddd"/>'
		+ '			<VIEW				left="60"	top="20"	right="140"	bottom="40"	align="RightCenter"		bgcolor="#EDF4F8"	borderstyle="Line"	bordercolor="#dddddd"	displayformat="#,##0"/>'
		+ '			<VIEWSUMMARY text="@GFSUM(PREV_AMT)"		bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0"	/>'
		+ '		</COLUMN>'		
		+ '		<COLUMN id="IN" refcolid="">'
		+ '			<HEADER				left="140"	top="0"		right="400"	bottom="20"	text="입고"				bgcolor="#eaeef4"	borderstyle="Line"	bordercolor="#dddddd"/>'
		+ '		</COLUMN>'
		+ '		<COLUMN id="IN_QTY" refcolid="IN_QTY">'
		+ '			<HEADER				left="140"	top="20"	right="220"	bottom="40"	text="발행입고수량"		bgcolor="#eaeef4"	borderstyle="Line"	bordercolor="#dddddd"/>'
		+ '			<VIEW				left="140"	top="0"		right="220"	bottom="20"	align="RightCenter"							borderstyle="Line"	bordercolor="#dddddd"	displayformat="#,##0"/>'
		+ '			<VIEWSUMMARY text="@GFSUM(IN_QTY)"			bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0"/>'
		+ '		</COLUMN>'
		+ '		<COLUMN id="IN_AMT" refcolid="IN_AMT">'
		+ '			<HEADER				left="140"	top="40"	right="220"	bottom="60"	text="발행입고금액"		bgcolor="#eaeef4"	borderstyle="Line"	bordercolor="#dddddd"/>'
		+ '			<VIEW				left="140"	top="20"	right="220"	bottom="40"	align="RightCenter"		bgcolor="#EDF4F8"	borderstyle="Line"	bordercolor="#dddddd"	displayformat="#,##0"/>'
		+ '			<VIEWSUMMARY text="@GFSUM(IN_AMT)"			bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0"/>'
		+ '		</COLUMN>'
		+ '		<COLUMN id="RFD_IN_QTY" refcolid="RFD_IN_QTY">'
		+ '			<HEADER				left="220"	top="20"	right="300"	bottom="40"	text="지점반품수량"		bgcolor="#eaeef4"	borderstyle="Line"	bordercolor="#dddddd"/>'
		+ '			<VIEW				left="220"	top="0"		right="300"	bottom="20"	align="RightCenter"							borderstyle="Line"	bordercolor="#dddddd"	displayformat="#,##0"/>'
		...
		+ '			<HEADER				left="220"	top="40"	right="300"	bottom="60"	text="지점반품금액"		bgcolor="#eaeef4"	borderstyle="Line"	bordercolor="#dddddd"/>'
		+ '			<VIEW				left="220"	top="20"	right="300"	bottom="40"	align="RightCenter"		bgcolor="#EDF4F8"	borderstyle="Line"	bordercolor="#dddddd"	displayformat="#,##0"/>'
		...
		+ '			<HEADER				left="300"	top="20"	right="380"	bottom="40"	text="위탁반품수량"		bgcolor="#eaeef4"	borderstyle="Line"	bordercolor="#dddddd"/>'
		+ '			<VIEW				left="300"	top="0"		right="380"	bottom="20"	align="RightCenter"							borderstyle="Line"	bordercolor="#dddddd"	displayformat="#,##0"/>'
		...
		+ '			<HEADER				left="300"	top="40"	right="380"	bottom="60"	text="위탁반품금액"		bgcolor="#eaeef4"	borderstyle="Line"	bordercolor="#dddddd"/>'
		+ '			<VIEW				left="300"	top="20"	right="380"	bottom="40"	align="RightCenter"		bgcolor="#EDF4F8"	borderstyle="Line"	bordercolor="#dddddd"	displayformat="#,##0"/>'
		...
		+ '			<VIEW				left="380"	top="20"	right="460"	bottom="40"	align="RightCenter"		bgcolor="#EDF4F8"	borderstyle="Line"	bordercolor="#dddddd"	displayformat="#,##0"/>'
		...
		+ '			<VIEW				left="460"	top="20"	right="540"	bottom="40"	align="RightCenter"		bgcolor="#EDF4F8"	borderstyle="Line"	bordercolor="#dddddd"	displayformat="#,##0"/>'
		...
		+ '			<VIEW				left="540"	top="20"	right="620"	bottom="40"	align="RightCenter"		bgcolor="#EDF4F8"	borderstyle="Line"	bordercolor="#dddddd"	displayformat="#,##0"/>'
		...
		+ '			<VIEW				left="620"	top="20"	right="700"	bottom="40"	align="RightCenter"		bgcolor="#EDF4F8"	borderstyle="Line"	bordercolor="#dddddd"	displayformat="#,##0"/>'
		...
		+ '			<VIEW				left="700"	top="20"	right="780"	bottom="40"	align="RightCenter"		bgcolor="#EDF4F8"	borderstyle="Line"	bordercolor="#dddddd"	displayformat="#,##0"/>'
		...
		+ '			<VIEW				left="780"	top="20"	right="900"	bottom="40"	align="RightCenter"		bgcolor="#EDF4F8"	borderstyle="Line"	bordercolor="#dddddd"	displayformat="#,##0"/>'
...
//alert(strSaleSlip);
	...
	TR_MAIN.Action	 = "/mss/mgif405.mg?goTo=" + goTo +	parameters;
...
function getEtcCodeSub_Type() {
	...
	TR_MAIN.Action = "/mss/mgif405.mg?goTo=" + goTo; 
				...
				<td class="PT01	PB03"><table width="100%" border="0"
						...
						<tr>
							<td><table width="100%" border="0" cellpadding="0"
									...
									<tr>
										<th width="80" class="point">발행점</th>
										...
										<td><comment id="_NSID_"> <object
												id=EM_STK_S_DT classid=<%=Util.CLSID_EMEDIT%> width=120
											...
											onclick="javascript:openCal('G',EM_STK_S_DT)"
											align="absmiddle" /> ~ <comment id="_NSID_"> <object
												id=EM_STK_E_DT classid=<%=Util.CLSID_EMEDIT%> width=120
												tabindex=1 align="absmiddle"
												onblur="javascript:checkDateTypeYMD(this);"> </object></comment>
											<script>_ws_(_NSID_);</script> <img
											src="/<%=dir%>/imgs/btn/date.gif"
											onclick="javascript:openCal('G',EM_STK_E_DT)"
											align="absmiddle" /></td>
									</tr>
									<tr>
										...
										<td width="150"><comment id="_NSID_"> <object
												...
												height=100 tabindex=1 width=140 align="absmiddle">
											</object> </comment>
											<script>_ws_(_NSID_);</script></td>
										<th width="80">금종</th>
										<td><comment id="_NSID_"> <object
												id=LC_GIFT_AMT_TYPE classid=<%=Util.CLSID_LUXECOMBO%>
												height=100 tabindex=1 width=140 align="absmiddle">
											</object> </comment>
											<script>_ws_(_NSID_);</script></td>
									</tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<tr>
							<td><comment id="_NSID_"> <object id=GD_MASTER
									width=100% height=477 classid=<%=Util.CLSID_MGRID%> tabindex=1>
