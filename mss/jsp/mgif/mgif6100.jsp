<!-- 
/*******************************************************************************
 * 시스템명 : 상품권관리 > 정산관리> 제휴쿠폰 정산관리
 * 작 성 일 : 2011.04.28
 * 작 성 자 : 이정식
 * 수 정 자 : 
 * 파 일 명 : mgif6100.jsp
 * 버    전 : 1.0 (버전은 1.0부터 시작하며 0.1씩 증가)
 * 개    요 : 제휴 쿠폰의 결제내역을 정산한다.
 * 이    력 :
 *        2011.04.28 (이정식) 신규작성
 ******************************************************************************/
-->
...
function doInit(){
    ...
    registerUsingDataset("mgfi6100","DS_PAY_DTL" );
}
...
function gridCreate(){
	//결제내역 그리드
	    var hdrProperies = '<C>id={currow}           width=30  align=center name="NO"</C>'
	                     ...
	                     + '<C>id=PAY_TYPE_NM     show=false        width=80  align=left edit=none name="정산구분"</C>'
	    ...
	    var hdrProperies1 = '<C>id={currow}         width=35   align=center name="NO"</C>'
	                      ...
	                      + '<C>id=CAL_FLAG    show=false     width=80  align=left  name="정산구분" </C>'
...
function btn_Search() {
    ...
    TR_MAIN.Action   = "/mss/mgif610.mg?goTo="+goTo+parameters;
...
function btn_Save() {
   ...
   if( getCloseCheck('DS_CLOSECHECK',LC_STR_CD.BindColVal,EM_CAL_YM.Text,'MGIF','47','0','M') == 'TRUE'){
    ...
    TR_MAIN.Action   = "/mss/mgif610.mg?goTo=save";
