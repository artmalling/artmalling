...
function doInit(){
    ...
    registerUsingDataset("mgif105", "DS_IO_STRMST,DS_IO_VENFEEINF");  
}

function gridCreate1(){
    var hdrProperies = '<FC>id={currow}    name="NO"         width=25   align=center</FC>'
                     + '<FC>id=STR_NAME      name="본사점"     width=70   align=left</FC>'
...
function btn_Search() {
    ...
    btnSearchClick = true;
    TR_MAIN.Action="/mss/mgif105.mg?goTo="+goTo+parameters;  
...
function btn_Save() {
    ...
    btnSaveClick = true;
    TR_MAIN.Action="/mss/mgif105.mg?goTo=save";
