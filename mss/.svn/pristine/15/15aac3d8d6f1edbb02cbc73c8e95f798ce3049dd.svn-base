...
function gridCreate(){
	...
	var hdrProperiesD = '<FC>id={currow}     		name="NO"          	width=25   align=center</FC>'
					    ...
					    + '<FC>id=ERR_MSG     		name="이상메시지"     width=400   align=left  </FC>'
					    ;
...
function btn_Search() {
	if(LC_STR_CD.BindColVal.length == 0){ 
     ...
     TR_MAIN.Action="/mss/mgif320.mg?goTo="+goTo+parameters;  
...
function btn_Print() {
	 ...
	 var parameters = "&strStrCd="  + LC_STR_CD.BindColVal 				//점코드
					...
					;
	 window.open("/mss/mgif320.mg?goTo=print"+parameters, "OZREPORT", 1000, 700);     
}

/*************************************************************************
 * 3. 함수
 *************************************************************************/
function getDrawlDtl(strStrCd,strDrawlYmdFrom,strDrawlYmdTo){
    ...
    TR_MAIN1.Action="/mss/mgif320.mg?goTo="+goTo+parameters;  
