<!-- 
/*******************************************************************************
 * 시스템명 : 경영지원 > 사은행사관리 > 사은품 지급/취소 > 사은품지급내역건별조회(카드)
 * 작 성 일 : 2011.01.18
 * 작 성 자 : 김슬기
 * 수 정 자 : 
 * 파 일 명 : MCAE4300.jsp
...
function gridCreate2(){ 
    var hdrProperies2 ='<FC>id={currow}          name="NO"           width=30   align=center SubBgColor=#FFFFE0</FC>'
    				+ '<FC>id=ID  		         name="아이디"        width=60   align=center suppress="1" SubBgColor=#FFFFE0 </FC>'
			        + '<FC>id=PRSNT_DT           name="지급일"   	     width=100  align=center Mask="XXXX/XX/XX" SubBgColor=#FFFFE0 </FC>'
			        + '<FC>id=PRSNT_NO           name="지급번호"       width=60   align=center SubBgColor=#FFFFE0 </FC>'
			        + '<FC>id=PRSNT_TIME         name="지급시간"       width=80   align=center Mask="XX:XX:XX" SubBgColor=#FFFFE0 </FC>'
			        + '<FC>id=CUST_ID            name="회원카드"       width=100  align=center SubBgColor=#FFFFE0 </FC>'
			        + '<FC>id=CUST_NM            name="회원명"    	 width=80    align=center SubBgColor=#FFFFE0</FC>'
			        + '<FC>id=EVENT_NAME         name="행사명"        width=140  align=left SubBgColor=#FFFFE0 </FC>'
			        + '<FC>id=CARD_NO            name="카드번호"       width=140   align=center SubBgColor=#FFFFE0 </FC>'
			        + '<FC>id=APP_NO             name="승인번호"       width=80   align=center SubBgColor=#FFFFE0 </FC>'
			        + '<FC>id=REMARK             name="사유"          width=80   align=center SubBgColor=#FFFFE0 </FC>'
			        + '<FC>id=RECP_NO            name="영수증"         width=200   align=center SubBgColor=#FFFFE0</FC>'
			        + '<FC>id=SALE_AMT           name="매출금액"       width=80   align=right  sumtext=@sum subsumtext={subsum(SALE_AMT)}      SubBgColor=#FFFFE0</FC>'
			        + '<FC>id=PRSNT_AMT          name="지급금액"       width=80   align=right  sumtext=@sum subsumtext={subsum(PRSNT_AMT)}      SubBgColor=#FFFFE0</FC>'
			        + '<FC>id=GIFTCARD_NO        name="상품권"        width=200   align=center SubBgColor=#FFFFE0 </FC>'
			        + '<FC>id=R_ID            	 name="등록자"        width=100  align=center SubBgColor=#FFFFE0 </FC>';
                     
    initGridStyle(GD_DETAIL, "common", hdrProperies2, false);
    GD_DETAIL.ViewSummary = "1";
    
    DS_DETAIL.SubSumExpr  = "1:ID"; 
    GD_DETAIL.ColumnProp("PRSNT_DT", "subsumtext")    =  "행사관 합계";
}
...
function btn_Search() {
    ...
    TR_MAIN.Action="/mss/mcae430.mc?goTo="+goTo+parameters;  
...
function openPop(){
    ...
    var returnVal = window.showModalDialog("/mss/mcae430.mc?goTo=openPop",
                                           arrArg,
