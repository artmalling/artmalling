 ...
 * @caused   by 
 */
public class MCae609DAO extends AbstractDAO {
    ...
    public int save(ActionForm form, MultiInput mi[], HttpServletRequest request) throws Exception {
        ...
        String strType = form.getParam("strType"); 
        String IntCnt = form.getParam("IntCnt"); 
    ...
    public int delete(ActionForm form, MultiInput mi[], HttpServletRequest request) throws Exception {
		int 	   ret   = 0;
		MultiInput mi1   = mi[0];
    	SqlWrapper sql   = null;
        Service    svc   = null;
        ...
        String strKEY_DATA = form.getParam("strKEY_DATA"); // 카드번호
        String strseq_no = form.getParam("strseq_no"); 
        ...
        try {
			...
			sql.put(svc.getQuery("DEL_MST"));
			
			sql.setString(i++, "99");
			
			sql.setString(i++, sessionInfo.getUSER_ID());
			
			sql.setString(i++, strKEY_DATA);
			
			sql.setString(i++, strseq_no);
     ...
     * 
     */
	public List check_cnt(ActionForm form) throws Exception {
		List ret = null;
		SqlWrapper sql = null;
		Service svc = null;
		String strQuery = "";
