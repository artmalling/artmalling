...
function btn_Save() {
    ...
    if( showMessage(QUESTION, YESNO, "USER-1010") == 1 ){    // validation 체크
        TR_MAIN.Action="/mss/mgif617.mg?goTo=save&strFlag=save"; 
...
//     enableControl(LC_CHARGE_FLAG       , flag);
  ...
  */
  function getList(){
     ...
     TR_MAIN.Action  = "/mss/mgif617.mg?goTo="+goTo+parameters;  
 ...
 */
 function getMaster(){
    ...
    TR_S_MAIN.Action  = "/mss/mgif617.mg?goTo="+goTo+parameters;  
          ...
          for(var i = 1; i <= DS_O_LIST.CountRow; i++){
              if(DS_O_LIST.NameValue(i, "SEL") == "T"){
                  ...
                  if(btnFlag == "1"){
                      ...
                      if(strEtaxStat != "N" && strEtaxStat != "G"){
                          DS_O_LIST.RowPosition = i;
 ...
 */
 ...
 function getCharName(strVenCd) {
     ...
     TR_DETAIL.Action="/mss/mgif617.mg?goTo="+goTo+parameters;  
      ...
      <tr>
        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table">
          ...
          <tr>
            ...
            <td colspan="3">
                  <comment id="_NSID_">
                      <object id=EM_S_SALE_S_DT classid=<%=Util.CLSID_EMEDIT%>  width=90 tabindex=1 align="absmiddle">
                      </object>
                  </comment>
                  <script> _ws_(_NSID_);</script>
                  ~
                  <comment id="_NSID_">
                      <object id=EM_S_SALE_E_DT classid=<%=Util.CLSID_EMEDIT%>  width=91 tabindex=1 align="absmiddle">
                      </object>
                  </comment>
                  <script> _ws_(_NSID_);</script>
            </td>            
