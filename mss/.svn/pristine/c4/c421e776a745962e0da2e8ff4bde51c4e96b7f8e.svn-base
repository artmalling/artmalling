<!-- 
/*******************************************************************************
 * 시스템명 : 경영지원 > 사은행사관리 > 사은품재고관리 > 사은품 불량등록
 * 작 성 일 : 2011.01.18
 * 작 성 자 : 김슬기
 * 수 정 자 : 
 * 파 일 명 : MCAE5010.jsp
...
function doInit(){
    ...
    initEmEdit(EM_INFRR_DT,     "YYYYMMDD", NORMAL);          //등록일자
    ...
    initEmEdit(EM_REMARK,       "GEN^50", NORMAL);              //비고 
    ...
    EM_INFRR_DT.Text        = getTodayFormat("YYYYMMDD");     //등록일자
...
function gridCreate1(){
    var hdrProperies ='<FC>id={currow}    name="NO"              width=30    align=center</FC>'
                    ...
                    + '<FC>id=INFRR_DT    name="등록일자"          width=80   align=center Mask="XXXX/XX/XX" </FC>'
                    + '<FC>id=SLIP_NO     name="순번"             width=50   align=center </FC>'
                    + '<FC>id=REMARK             name="비고"     width=80   align=LEFT  Show=false </FC>';
...
function gridCreate2(){
    var hdrProperies2 ='<FC>id={currow}          name="NO"         width=30   align=center Edit=none</FC>'
                    ...
                    + '<FC>id=SKU_GB             name="*사은품구분"   width=90   align=LEFT EDITSTYLE=COMBO   DATA="1:물품"  Show=false </FC>'
                    + '<FC>id=SKU_CD             name="*사은품코드"   width=200   align=LEFT EDITSTYLE=LOOKUP   DATA="DS_SKU_CD:SKU_CD:SKU_NAME" </FC>'
                    + '<FC>id=BUY_COST_PRC       name="단가"        width=80   align=right Edit=none </FC>'
                    + '<FC>id=INFRR_QTY          name="*수량"        width=70   align=right  Edit=Numeric </FC>'
                    + '<FC>id=AMT                name="지급금액"     width=90   align=right Edit=none </FC>';
...
function btn_Search() { 
    ...
    TR_MAIN.Action="/mss/mcae501.mc?goTo="+goTo+parameters;  
...
function btn_Save() {
     ...
     if(DS_MASTER.RowStatus(DS_MASTER.RowPosition)== "1") {
	     if(EM_INFRR_DT.Text < strToday) {
	         showMessage(INFORMATION, OK, "USER-1000", "등록일자는 오늘날짜보다 <br>작을 수 없습니다.");
     ...
     if(DS_MASTER.NameValue(DS_MASTER.RowPosition,"EVENT_S_DT") > EM_INFRR_DT.Text && DS_MASTER.NameValue(DS_MASTER.RowPosition,"EVENT_E_DT") < EM_INFRR_DT.Text) {
         showMessage(INFORMATION, OK, "USER-1000", "등록일자가 행사기간에 포함되지 않습니다.");
         setTimeout("EM_INFRR_DT.Focus();",50);
         return;
    }
    ...
    var strInfrrDt = EM_INFRR_DT.Text;          // 등록일자
...
function addRow() {
   ...
   if(DS_MASTER.NameValue(DS_MASTER.RowPosition,"EVENT_S_DT") <= EM_INFRR_DT.Text && DS_MASTER.NameValue(DS_MASTER.RowPosition,"EVENT_E_DT") >= EM_INFRR_DT.Text) {
       ...
       showMessage(INFORMATION, OK, "USER-1000", "등록일자가 행사기간에 속하지 않습니다.");
       setTimeout("EM_INFRR_DT.Focus();",50);
       return; 
   }
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0"
                            ...
                            <tr>
                                <td><comment id="_NSID_"><OBJECT id=GD_MASTER
                                    width=100% height=785 classid=<%=Util.CLSID_GRID%>>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td class="sub_title"><img
                                    ...
                                    align="absmiddle" class="PR03" />불량등록 마스터</td>
                            </tr>
                        </table>
                        </td>
                    </tr>
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        ...
                                        <img src="/<%=dir%>/imgs/btn/detail_search_s.gif"
                                            ...
                                            id=EM_I_EVENT_NAME classid=<%=Util.CLSID_EMEDIT%> width=121
                                            tabindex=1 align="absmiddle"> </object> </comment><script>_ws_(_NSID_);</script>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><comment id="_NSID_"> <object id=EM_REMARK
                                            classid=<%= Util.CLSID_EMEDIT %> width=228 tabindex=1 onkeyup="javascript:checkByteStr(this, 200, 'Y');"
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td class="sub_title"><img
                                            ...
                                            height="12" align="absmiddle" class="PR03" />불량등록 상세</td>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                    ...
                                    <tr>
                                        <td><comment id="_NSID_"><OBJECT id=GD_DETAIL
                                            width=100% height=670 classid=<%=Util.CLSID_GRID%>>
