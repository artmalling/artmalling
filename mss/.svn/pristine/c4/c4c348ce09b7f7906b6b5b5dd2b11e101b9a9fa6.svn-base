<!-- 
/*******************************************************************************
 * 시스템명 : 경영지원 > 사은행사관리 > 사은품 지급/취소 > 사은품지급내역건별조회(리콜)
 * 작 성 일 : 2011.01.18
 * 작 성 자 : 김슬기
 * 수 정 자 : 
 * 파 일 명 : MCAE4200.jsp
...
function gridCreate1(){ 
    var hdrProperies ='<FC>id={currow}          name="NO"          width=40   align=center</FC>'
                    ...
                    + '<FC>id=EVENT_CD          name="행사코드"       width=100  align=left show=true</FC>'
...
function btn_Search() {
    ...
    TR_MAIN.Action="/mss/mcae420.mc?goTo="+goTo+parameters;  
...
function openPop(){
    ...
    var returnVal = window.showModalDialog("/mss/mcae420.mc?goTo=openPop",
                                           arrArg,
