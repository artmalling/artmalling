...
function btn_Search() {
    ...
    TR_MAIN.Action="/mss/mgif619.mg?goTo=getTotal"+parameters;  
...
function btn_Save() {
	// 저장할 데이터 없는 경우
	   ...
	   TR_MAIN.Action="/mss/mgif619.mg?goTo=save"+parameters;  
...
function btn_Conf() {
    ...
    if (showMessage(QUESTION , YESNO, "USER-1010") != 1) return;
    TR_MAIN.Action="/mss/mgif619.mg?goTo=confirm"; 
...
function getDetail(){
	 ...
	 TR_S_MAIN.Action="/mss/mgif619.mg?goTo=getDetail"+parameters;  
