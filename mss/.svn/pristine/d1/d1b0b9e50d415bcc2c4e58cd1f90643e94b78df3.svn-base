...
function doInit(){
    ...
    getStore("DS_STR_CD", "Y", "", "Y");         //점콤보 가져오기 ( gauce.js )
    //LC_STR_CD.Index= 0;
    //LC_STR_CD.Focus();
...
function btn_Search() {
    ...
    IFrame.location.href="/mss/jsp/meis/meis2201.jsp?"+parameters;
}
...
function btn_Print() {
    ...
    var parameters = "&strStrCd="  + LC_STR_CD.BindColVal //점코드
                   + "&strSaleYmd=" + EM_COND_DT.text      //조회일자
                   ;
    window.open("/mss/jsp/meis/meis2201.jsp?"+parameters,"OZPRINT", 1000, 700);	 
}
