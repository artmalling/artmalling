<!-- 
/*******************************************************************************
 * 시스템명 : 경영지원 > 사은행사관리 > 사은품 지급/취소 > 사은품지급등록(제휴카드)
 * 작 성 일 : 2011.05.27
 * 작 성 자 : 김성미
 * 수 정 자 : 
 * 파 일 명 : MCAE4090.jsp
...
function btn_Save() {
	 // 저장할 데이터 없는 경우
	   ...
	   TR_MAIN.Action="/mss/mcae409.mc?goTo=save"+strParams; 
 ...
 *************************************************************************/
 ...
 function getCardCombo() {
      ...
      // 조회조건 셋팅
       ...
       TR_MAIN.Action="/mss/mcae409.mc?goTo=getCardCombo"+parameters;  
 ...
 function getEventInfo() {
	  ...
	  // 조회조건 셋팅
	   ...
	   TR_MAIN.Action="/mss/mcae409.mc?goTo=getEventInfo"+parameters;  
 ...
 function getSaleInfo() {
	  ...
	  // 조회조건 셋팅
       ...
       var strStrCd       = LC_STR.BindColVal;   //strReceiptNo.substring(1,3);
      ...
      if(strSaleDt != strToday){
       ...
       TR_MAIN.Action="/mss/mcae409.mc?goTo=getSaleInfo"+parameters; 
 ...
 function getSkuList() {
      ...
      // 조회조건 셋팅
       ...
       TR_MAIN.Action="/mss/mcae409.mc?goTo=getSkuList"+parameters;  
...
<script language=JavaScript for=EM_RECEIPT_NO event=OnKillFocus()>
	...
	if(this.Text.length == 24){
        ...
        if(this.Text.substring(7,8) != "1"
            ...
            showMessage(EXCLAMATION , OK, "USER-1000", "당사 발행 영수증이 아닙니다.(포스체크)");
            EM_RECEIPT_NO.Text = "";
            setTimeout("EM_RECEIPT_NO.Focus()",50);
            return;
        }
...
if(EM_RECEIPT_NO.Text == undefined) return;
					...
					<tr>
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0"
							...
							<tr>
		                        ...
		                        <td width="140"><comment id="_NSID_"> <object
		                            id=LC_CARD_COMBO classid=<%=Util.CLSID_LUXECOMBO%> height=100
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
                            ...
                            <tr>
                                <td><comment id="_NSID_"><OBJECT id=GD_SALE_INFO
                                    width=100% height=347 classid=<%=Util.CLSID_GRID%>>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<tr>
								<td><comment id="_NSID_"><OBJECT id=GD_SKU_LIST
									width=100% height=270 classid=<%=Util.CLSID_GRID%>>
