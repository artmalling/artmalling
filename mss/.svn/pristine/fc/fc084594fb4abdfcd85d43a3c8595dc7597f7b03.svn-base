<!-- 
/*******************************************************************************
 * 시스템명 : 영업지원 > 상품권관리 > 상품권입출고 > 점내 불출내역 조회 - 출력
 * 작 성 일 : 2011.04.20
 * 작 성 자 : 
 * 수 정 자 : 
 * 파 일 명 : mgif2121.jsp
...
<%
    ...
    String reportname = "불출 내역 조회";

    String strStrCd = String2.trimToEmpty(request.getParameter("strStrCd"));
    String strConfDt = String2.trimToEmpty(request.getParameter("strConfDt"));
    String strConfSlipNo = String2.trimToEmpty(request.getParameter("strConfSlipNo"));    

    //odi 파라미터
    String[][] params  = new String[][]{
        {"STR_CD=" + strStrCd, "CONF_DT=" + strConfDt, "CONF_SLIP_NO=" + strConfSlipNo}
    };
