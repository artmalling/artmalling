<!-- 
/*******************************************************************************
 * 시스템명	: 경영지원 > 상품권	관리 > 상품권재고관리  > 상품권	이력조회(특판불출)
 * 작 성 일	: 2011.03.11
 * 작 성 자	: 신익수
 * 수 정 자	: 
 * 파 일 명	: mgif4110.jsp
...
function btn_Search() {
	...
	TR_MAIN.Action="/mss/mgif411.mg?goTo="+goTo+parameters;	 
 ...
 *************************************************************************/
 ...
 function getGiftTypeCd	() {
	 TR_MAIN.Action	   = "/mss/mgif411.mg?goTo=getGiftTypeCd";
...
function getGiftMst(strGiftCardNo) {
	...
	TR_MAIN1.Action="/mss/mgif411.mg?goTo="+goTo+parameters;  
...
function getSaleMst(strGiftCardNo) {
	...
	TR_MAIN2.Action="/mss/mgif411.mg?goTo="+goTo+parameters;  
...
function getGiftDrawl(strGiftCardNo){
	...
	TR_MAIN3.Action="/mss/mgif411.mg?goTo="+goTo+parameters;  
...
function getGiftReuse(strGiftCardNo){
	...
	TR_MAIN4.Action="/mss/mgif411.mg?goTo="+goTo+parameters;  
...
function getReceipt(strGiftCardNo){
	...
	TR_MAIN5.Action="/mss/mgif411.mg?goTo="+goTo+parameters;  
 ...
 function receiptPopUp(strStrCd,strSaleDt,strPosNo,strTranNo){
		...
		var returnVal = window.showModalDialog("/mss/mgif411.mg?goTo=receiptPopUp",
						arrArg,
						...
						<td	class="PL05">
							<table width="100%"	border="0" cellspacing="0" cellpadding="0" class="BD4A">
								<tr>
									<td	width="100%" >
										<comment id="_NSID_">
											<object	id="GD_MASTER3"	width="100%" height="310" classid="<%=Util.CLSID_GRID%>">
