...
public class MGif218DAO extends AbstractDAO {
	 ...
	 * @throws Exception
	 */
	public List getConfsps(ActionForm form) throws Exception {
		...
		String strSGiftNo = String2.nvl(form.getParam("strSGiftNo"));		//반납유형
		String strEGiftNo = String2.nvl(form.getParam("strEGiftNo"));		//반납유형
		...
		connect("pot");
		strQuery = svc.getQuery("SEL_GIFT_INSERT_SPS") + "\n";
		...
		sql.setString(i++, strPoutType);
		sql.setString(i++, strPoutType);
		sql.setString(i++, strSGiftNo);
		sql.setString(i++, strEGiftNo);
		sql.setString(i++, strStrCd);
		sql.setString(i++, strPoutDt);
	...
	public int save(ActionForm form, MultiInput mi, String userId)
		...
		String strStrCd 	= String2.nvl(form.getParam("strStrCd"));			//반납유형
		String strPoutDt 	= String2.nvl(form.getParam("strPoutDt"));			//반납일자
		String strOrgCd     = String2.nvl(form.getParam("strOrgCd")); 	//반납부서
