...
public class MGif310DAO extends AbstractDAO {
	...
	public int delete(ActionForm form, MultiInput mi, String userId)
		...
		try {
			...
			while(mi.next()){
				sql.close();
				i = 1;
				sql.put(svc.getQuery("DEL_GIFTDRAWL")); 
				sql.setString(i++, mi.getString("DRAWL_DT"));
				sql.setString(i++, mi.getString("DRAWL_STR"));
				sql.setString(i++, mi.getString("DRAWL_SLIP_NO"));
				sql.setString(i++, mi.getString("DRAWL_SEQ_NO"));
				res = update(sql);
				...
				sql.close();
				i = 1;
				sql.put(svc.getQuery("UPD_GIFTMST_D")); 
				sql.setString(i++, mi.getString("GIFTCARD_NO"));
				sql.setString(i++, mi.getString("GIFTCARD_NO"));
				sql.setString(i++, mi.getString("GIFTCARD_NO"));
				sql.setString(i++, mi.getString("GIFTCARD_NO"));
