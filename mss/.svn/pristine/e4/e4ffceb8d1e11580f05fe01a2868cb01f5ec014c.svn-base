<!-- 
/*******************************************************************************
 * 시스템명 : 경영실적 > 경영실적> 월별조직별마감실적조회
 * 작 성 일 : 2011.07.05
 * 작 성 자 : 최재형
 * 수 정 자 : 
 * 파 일 명 : meis0630.jsp
 * 버    전 : 1.0 (버전은 1.0부터 시작하며 0.1씩 증가)
 * 개    요 : 실적항목별/조직별로 마감실적를 조회한다.
 * 이    력 :
 *        2011.07.05 (최재형) 신규작성
 ******************************************************************************/
-->
...
function gridCreate(){
	...
	hdrProperies += '<C>id=BIZ_CD   width=60 align=center name="실적항목"</C>';
	hdrProperies += '<C>id=BIZ_CD_NM    width=80 align=left   name="항목명"  SumText="합계"</C>';
	hdrProperies += '<C>id=RSLT_AMT  width=100 align=right  name="금액"    SumText=@sum</C>';
	...
	hdrProperies1 += '<FC>id=ORG_FLAG width=100 align=left name="조직구분" EditStyle=Lookup data="DS_ORG_FLAG:CODE:NAME"</FC>';
	hdrProperies1 += '<FC>id=ORG_CD   width=80 align=center name="조직코드" </FC>';
	hdrProperies1 += '<FC>id=ORG_NAME width=80 align=left   name="조직명" SumText="합계"</FC>';
	hdrProperies1 += '<C>id=DEPT_NM   width=80 align=left   name="팀" </C>';
	hdrProperies1 += '<C>id=TEAM_NM   width=80 align=left   name="파트" </C>';
	hdrProperies1 += '<C>id=PC_NM     width=80 align=left   name="PC" </C>';
	hdrProperies1 += '<C>id=RSLT_AMT  width=80 align=right  name="금액" SumText=@sum</C>';
	...
	hdrProperies3 += '<C>id=RSLT_AMT        width=80  align=right  name="금액" </C>';
...
function btn_Search() {
    ...
    lo_StrCd = LC_STR_CD.BindColVal;
    lo_StrNm = LC_STR_CD.Text;
    DS_BIZ.DataID   = "/mss/meis063.me?goTo="+goTo+parameters;
...
function subQuery(row){
    ...
    DS_ORG.DataID  = "/mss/meis063.me?goTo="+goTo+parameters;
...
function btn_Excel() {
    ...
    DS_EXCEL.DataID = "/mss/meis063.me?goTo="+goTo+parameters;
    DS_EXCEL.Reset();
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr valign="top">
        <td width="39%" class="PT02 PR10">
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table">
                <tr>
                    <td>
                        <comment id="_NSID_">
                        <object id=GD_BIZ width="100%" height=510 classid=<%=Util.CLSID_GRID%>>
        ...
        <td width="*">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
            	<tr>
            		<td class="sub_title PT05 PB05"><img src="/<%=dir%>/imgs/comm/ring_blue.gif"  class="PR03" align="absmiddle"/> 조직별 내역
            		</td>
            	</tr>
                    ...
                    <td>
                    	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table">
                    		<tr>
                    			<td>
                        			<comment id="_NSID_">
                        			<object id=GD_ORG width="100%" height=490 classid=<%=Util.CLSID_GRID%>>
