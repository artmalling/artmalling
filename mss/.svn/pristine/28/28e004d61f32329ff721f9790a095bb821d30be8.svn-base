<!-- 
/*******************************************************************************
 * 시스템명 : 경영지원 > 사은행사관리 > 사은품 지급/취소 > 리콜행사분석
 * 작 성 일 : 2011.01.18
 * 작 성 자 : 김슬기
 * 수 정 자 : 
 * 파 일 명 : MCAE4230.jsp
...
function gridCreate1(){ 
    var hdrProperies ='<FC>id={currow}          name="NO"          width=40   align=center</FC>'
                    ...
                    + '<FC>id=TRG_CNT           name="대상회원수"      width=80  align=righe</FC>'
                    + '<FC>id=PRSNT_ETC         name="지급/취소:전체건수"   width=130  align=center</FC>'
...
function btn_Search() {
    ...
    TR_MAIN.Action="/mss/mcae423.mc?goTo="+goTo+parameters;  
...
function openPop(){
    ...
    var returnVal = window.showModalDialog("/mss/mcae423.mc?goTo=openPop",
                                           arrArg,
