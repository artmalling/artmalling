 ...
 *        2012.05.17 (홍종영) MCAE106 복사  신규 생성
 *                           쿠폰행사구분,사은품 한정수랑 추가 
 ******************************************************************************/
-->
...
function doInit(){
	...
	initComboStyle(LC_RECALL_CPN_EVENT_TYPE,DS_O_RECALL_CPN_EVENT_TYPE, "CODE^0^30,NAME^0^100", 1, READ);  //쿠폰행사구분
	...
	getEtcCode("DS_O_RECALL_CPN_EVENT_TYPE", "D", "M205", "N");
...
function btn_Search() {
	...
	TR_MAIN.Action="/mss/mcae108.mc?goTo="+goTo+parameters;	 
...
function btn_Save()	{
	 ...
	 //	사은행사 마스터	정보 필수입력사항
	  ...
	  DS_IO_STREVT_COPY.ImportData(strData);
	   ...
	   TR_MAIN.Action="/mss/mcae108.mc?goTo=save&strAllBrand="+encodeURIComponent(CHK_ALLBRAND.checked); 
 ...
 *************************************************************************/
 ...
 function setObject() {
        ...
        //		쿠폰행사인 경우
		if(DS_O_EVTMST.NameValue(DS_O_EVTMST.RowPosition,"EVENT_TYPE") == "8"){ // 쿠폰행사
			LC_CARD_ONLY_YN.BindColVal = "N"; // 신용카드 ONLLY : N
...
if(DS_O_EVTMST.NameValue(DS_O_EVTMST.RowPosition, "EVENT_TYPE")	== "8"){
...
<script language=JavaScript for=LC_EVENT_TYPE event=OnSelChange()>
    if(  this.BindColVal == '03' && this.Enable ){ // 보너스카드 고객 행사
    ...
    setComboData(LC_RECALL_CPN_EVENT_TYPE,""); 
    enableControl(LC_RECP_ADD_YN, true);
	...
	<div id="testdiv" class="testdiv">
		...
		<table width="100%"	border="0" cellspacing="0" cellpadding="0">
			...
			<tr	valign="top">
				...
				<tr>
                    <th width="80" class="point">쿠폰행사구분</th>
                    <td>
                      <comment id="_NSID_">
