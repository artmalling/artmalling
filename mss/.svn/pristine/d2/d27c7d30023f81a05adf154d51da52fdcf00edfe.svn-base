<!-- 
/*******************************************************************************
 * 시스템명 : 상품권관리 > 상품권 입/출고> 상품권반납등록(특판)
 * 작 성 일 : 2011.01.18
 * 작 성 자 : 
 * 수 정 자 : 
 * 파 일 명 : mgif2180.jsp
...
function doInit(){
    ...
    LC_POUT_TYPE.BindColVal  = "6"; /*특판강제불출*/ 
    LC_POUT_TYPE.Enable = false;
    
    LC_REQ_STR.focus();
    
    registerUsingDataset("mgif218","DS_IO_CONF");
} 
...
function btn_Save() {
    ...
    if(EM_I_ORG_CD.Text == "") {
    	showMessage(INFORMATION, OK, "USER-1000", "반납부서를 반드시 입력 하셔야 합니다.");
    ...
    **/
    ...
    var parameters = "&strPoutType="+ encodeURIComponent(strPoutType)
				   ...
				   + "&strOrgCd="   + encodeURIComponent(strOrgCd)  //반납부서
				    ;
				    
    TR_MAIN.Action="/mss/mgif218.mg?goTo=save"+parameters;  
 ...
 *************************************************************************/
 ...
 function getConf (strFlag) {
    ...
    var parameters = "&strGiftNo="  + encodeURIComponent(strGiftNo)
                   ...
                   + "&strPoutDt="  + encodeURIComponent(strPoutDt)
                   ;
    TR_MAIN.Action="/mss/mgif218.mg?goTo="+goTo+parameters;  
    ...
    if(strFlag.id == "EM_GIFT_S_NO"){
        ...
        var parameters = "&strSGiftNo="  + encodeURIComponent(DS_IO_CONF.NameValue(DS_IO_CONF.CountRow, "GIFT_S_NO"))
                       ...
                       ;
        TR_MAIN.Action="/mss/mgif218.mg?goTo=getCnt"+parameters;  
 ...
 function getConfsps (strFlag) {
	    ...
	    var parameters = "&strSGiftNo=" + encodeURIComponent(EM_GIFT_S_NO.Text)
				       + "&strEGiftNo=" + encodeURIComponent(EM_GIFT_E_NO.Text)   
				       + "&strPoutType="+ encodeURIComponent(strPoutType)
	                   + "&strStrCd="   + encodeURIComponent(strStrCd)
	                   + "&strPoutDt="  + encodeURIComponent(strPoutDt)
	                   ;
	    ...
	    */
        ...
        var data = DS_IO_CONF_S.ExportData(1,DS_IO_CONF_S.CountRow,false); 
	    DS_IO_CONF.ImportData(data);
        ...
        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table">
          <tr>
            ...
            <td width="160">
     		...
     		<th width="80" class="point">반납부서</th>
             <td>              
                 <comment id="_NSID_">
         ...
         <td colspan=5>
                 ...
                 <img src="/<%=dir%>/imgs/btn/detail_search_s.gif" align="absmiddle"  id=EventImg  
                      onclick="javascript:mssEventMstPop('SEL_STR_EVENT_POP',EM_O_EVENT_CD,EM_O_EVENT_NAME,LC_REQ_STR.BindColVal, '4');"  class="PR03"/> 
                 <comment id="_NSID_">
