...
function doInit(){
   ...
   // LC_GIFT_TYPE_CD.Index = 0;
    ...
    registerUsingDataset("mgif106", "DS_IO_MASTER,DS_IO_DETAIL");  

}

function gridCreate1(){
    var hdrProperies = '<FC>id={currow}    name="NO"         width=25   align=center</FC>'
    	             + '<FC>id=STR_CD      name="점"  EditStyle=Lookup   Data="DS_O_STR:CODE:NAME"   width=50 align=left</FC>'
...
function btn_Search() {
	...
	TR_MAIN.Action="/mss/mgif106.mg?goTo=getMaster"+strParams;  
...
function btn_Save() {
    ...
    TR_MAIN.Action="/mss/mgif106.mg?goTo=save"+strParams;
 ...
 *************************************************************************/
 ...
 function getGiftTypeCd() {
    TR_MAIN.Action="/mss/mgif106.mg?goTo=getGiftTypeCd";  
 ...
 function getDetail() {
     ...
     TR_DTL.Action="/mss/mgif106.mg?goTo=getDetail"+strParams;  
 ...
 function getNewDetail(){
     ...
     TR_DTL.Action="/mss/mgif106.mg?goTo=getNewDetail"+strParams;  
     TR_DTL.KeyValue="SERVLET(O:DS_IO_DETAIL=DS_IO_DETAIL)"; //조회는 O
     TR_DTL.Post();
...
<script language=JavaScript for=DS_IO_DETAIL
 ...
 switch(colid){
      case "REQ_QTY" :
    	  ...
    	  // MARIO
    	  var strGiftNo = this.NameValue(row, "GIFT_S_NO").substring(0,7);
						...
						<table width="100%" border="1" cellspacing="0" cellpadding="0"
							...
							<tr>
								<td><comment id="_NSID_"><OBJECT id=GD_DETAIL
									width=100% height=436 classid=<%=Util.CLSID_GRID%>>
