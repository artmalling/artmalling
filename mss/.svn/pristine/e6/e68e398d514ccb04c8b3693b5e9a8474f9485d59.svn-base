...
function gridCreate1(){
    var hdrProperies ='<FC>id={currow}  name="NO"          width=30    align=center</FC>'
                    ...
                    + '<FC>id=JGCANCLE  name="지급취소건수"   width=95   align=right sumtext=@sum </FC>'
                    + '<FC>id=MCALCLE   name="미회수 건수"    width=95   align=right  sumtext=@sum </FC>'
                    + '<FG>id=STR_NAME  name="회수 수량"      align=center >' 
                    + '<FC>id=DRAWSQTY  name="상품권"        width=90   align=right  sumtext=@sum </FC>'
                    + '<FC>id=DRAWMQTY  name="물품"          width=90   align=right  sumtext=@sum </FC>'
                    + '</FG>' 
                    + '<FC>id=PAY_AMT   name="대납;회수금액"   width=100  align=right  sumtext=@sum </FC>'
                    ;
...
function btn_Search() {
    ...
    TR_MAIN.Action="/mss/mcae407.mc?goTo="+goTo+parameters;  
