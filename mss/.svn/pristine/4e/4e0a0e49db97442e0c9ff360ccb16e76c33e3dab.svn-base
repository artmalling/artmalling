...
function gridCreate1(){ 
	var hdrProperies = '<COLUMNINFO>' 
        ...
        + '           <HEADER left="60" top="0" right="160" bottom="20" text="입고" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        + '       </COLUMN>'
        + '       <COLUMN id="IN_QTY"  refcolid="IN_QTY">'
        + '           <HEADER left="60" top="20" right="160" bottom="40" text="입고수량" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        ...
        + '           <HEADER left="60" top="40" right="160" bottom="60" text="입고금액" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        ...
        + '           <HEADER left="160" top="0" right="780" bottom="20" text="출고" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        + '       </COLUMN>'
        + '       <COLUMN id="SALE_QTY"  refcolid="SALE_QTY">'
        + '           <HEADER left="160" top="20" right="270" bottom="40" text="판매수량" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        ...
        + '           <HEADER left="160" top="40" right="270" bottom="60" text="판매금액" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        ...
        + '           <HEADER  left="270" top="20" right="370" bottom="40" text="교환수량" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        ...
        + '           <HEADER  left="270" top="40" right="370" bottom="60" text="교환금액" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        ...
        + '           <HEADER left="370" top="20" right="480" bottom="40" text="POS준비금수량" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        ...
        + '           <HEADER left="370" top="40" right="480" bottom="60" text="POS준비금금액" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        ...
        + '           <HEADER  left="480" top="20" right="580" bottom="40" text="사은행사수량" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        ...
        + '           <HEADER   left="480" top="40" right="580" bottom="60" text="사은행사금액" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        ...
        + '           <HEADER  left="580" top="20" right="680" bottom="40" text="재무강제불출수량" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        ...
        + '           <HEADER  left="580" top="40" right="680" bottom="60" text="재무강제불출금액" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        ...
        + '       </COLUMN>'
        + '       <COLUMN id="SUM_Q"  refcolid="SUM_Q">'
        + '           <HEADER  left="680" top="20" right="780" bottom="40" text="계 수량" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        + '           <VIEW left="680" top="0" right="780" bottom="20" align="RightCenter"  borderstyle="Line" bordercolor="#dddddd"  displayformat="#,##0"/>'
        + '           <VIEWSUMMARY text="@GFSUM(SUM_Q)"  bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0" />'  
        + '       </COLUMN>'
        + '       <COLUMN id="SUM_A"  refcolid="SUM_A">'
        + '           <HEADER  left="680" top="40" right="780" bottom="60" text="계 금액" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        ...
        + '           <VIEWSUMMARY text="@GFSUM(SUM_A)"  bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0" />'  
        + '       </COLUMN>'
        + '       <COLUMN id="PREV_3"  refcolid="">'
        + '           <HEADER left="780" top="0" right="880" bottom="20" text="현재고" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        + '       </COLUMN>'
        + '       <COLUMN id="QTY"  refcolid="QTY">'
        + '           <HEADER  left="780" top="20" right="880" bottom="40" text="현재고수량" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
        ...
        + '           <HEADER  left="780" top="40" right="880" bottom="60" text="현재고금액" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
 ...
 */
 function btn_Search() {
	...
	//alert(strSaleSlip);
	    ...
	    TR_MAIN.Action   = "/mss/mgif409.mg?goTo=" + goTo + parameters;
...
function btn_Print() {
	...
	window.open("/mss/jsp/mgif/mgif4091.jsp?"+parameters,"OZPRINT", 1000, 700);	 
}
...
function getEtcCodeSub_Type() {
    ...
    TR_MAIN.Action = "/mss/mgif409.mg?goTo=" + goTo; 
