<!-- 
/*******************************************************************************
 * 시스템명 : 상품권관리 > 상품권 입고/출고> 상품권 특판 강제불출
 * 작 성 일 : 2012.08.16
 * 작 성 자 : 강진
 * 수 정 자 : 
 * 파 일 명 : mgif2170.jsp
...
function btn_New() {
    ...
    //var strOrgName  = EM_I_ORG_NAME.Text;           // 신청부서

    EM_I_ORG_CD.Text = "";
    EM_I_ORG_NAME.Text = "";
    
    //EM_I_ORG_CD.Text = strOrgCd;
    //EM_I_ORG_NAME.Text = strOrgName;
...
function btn_Save() {
    ...
    if(EM_I_ORG_CD.Text == "") {
    	showMessage(INFORMATION, OK, "USER-1000", "불출부서를 반드시 입력 하셔야 합니다.");
    ...
    var parameters = "&strStoreCd="    + encodeURIComponent(LC_STR_CD.BindColVal)      //점코드
				    ...
				    + "&strOrgCd="     + encodeURIComponent(strOrgCd)  //불출부서
				    ;
    TR_MAIN.Action   = "/mss/mgif217.mg?goTo=save" + parameters;
...
*/    
	...
	var strGiftCardNo = EM_GIFT_E_NO.Text;
   	...
   	DS_O_RESULT.DataID   = "/mss/mgif217.mg?goTo="+goTo+parameters;
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>	
						<th width="80">불출유형</th>
						<td class="point" width="230"><comment id="_NSID_"> <object id=LC_POUT_TYPE
							classid=<%= Util.CLSID_LUXECOMBO %> width=220 align="absmiddle"></object>
						</comment><script>_ws_(_NSID_);</script></td>
		            <th width="80" class="point">불출부서</th>
                    <td>              
                        <comment id="_NSID_">
