 ...
 * @caused by
 */
public class MEis046DAO extends AbstractDAO {
	 ...
	 * @throws Exception
	 */
	public List searchSaleAndManagePlan(ActionForm form, boolean chartFlag) throws Exception {
		...
		try {
			...
			strLoc = "SEL_SALE_AND_MANAGE_PLAN";
			if(chartFlag) strLoc = "SEL_SALE_AND_MANAGE_PLAN_CHART";
