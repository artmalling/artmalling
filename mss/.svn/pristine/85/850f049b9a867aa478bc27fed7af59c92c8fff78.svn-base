...
public class MPro105DAO extends AbstractDAO {
        ...
        try {
            ...
            while (mi.next()) {  	
                ...
                if (mi.IS_INSERT()) {
                    ...
                    sql.setString(++i, mi.getString("CALL_FLAG"));
                	...
                	sql.setString(3, mi.getString("CALL_FLAG"));
                	sql.setString(4, mi.getString("CALL_DESC"));
                	sql.setString(5, userID);
                	sql.setString(6, mi.getString("CALL_SEQ_NO"));
                	sql.setString(7, mi.getString("EM_CALL_DT"));
