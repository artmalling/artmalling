<!-- 
/*******************************************************************************
 * 시스템명 : 경영실적 > 기준정보> 경영계획 배부 기준안 관리
 * 작 성 일 : 2011.05.12
 * 작 성 자 : 이정식
 * 수 정 자 : 
 * 파 일 명 : meis0040.jsp
 * 버    전 : 1.0 (버전은 1.0부터 시작하며 0.1씩 증가)
 * 개    요 : 경영계획 1,2,차 배부 기준안을 등록 관리한다.
 * 이    력 :
 *        2011.05.12 (이정식) 신규작성
 ******************************************************************************/
-->
...
function doInit(){
    ...
    registerUsingDataset("meis0040","DS_DIV,DS_DIV1,DS_DIV2,DS_DIV3" );
}
...
function btn_Search() {
    ...
    DS_DIV.DataID  = "/mss/meis004.me?goTo="+goTo+parameters;
...
function subQuery(row){
	if(DS_DIV.NameValue(row, "DIV_CD") != ""){
	    ...
	    DS_DIV1.DataID = "/mss/meis004.me?goTo="+goTo+parameters;
...
function subQuery1(row){
    ...
    DS_DIV2.DataID = "/mss/meis004.me?goTo="+goTo+parameters;
...
function subQuery2(row){
    ...
    DS_DIV3.DataID = "/mss/meis004.me?goTo="+goTo+parameters;
...
function btn_Save() {
    ...
    TR_MAIN.Action   = "/mss/meis004.me?goTo=save";  
...
function getPreData(flag){
    ...
    DS_COPY.DataID   = "/mss/meis004.me?goTo="+goTo+parameters;
      ...
      <tr>
        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table">
          <tr>
            ...
            <td>
              <comment id="_NSID_">
                <object id=EM_DIV_YM classid=<%=Util.CLSID_EMEDIT%> width=80 onblur="checkDateTypeYM(this);" align="absmiddle"></object>
              </comment><script> _ws_(_NSID_);</script>
