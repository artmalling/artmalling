<!-- 
/*******************************************************************************
 * 시스템명 : 상품권관리 > 상품권 마스터 관리> 제휴사 마스터 관리
 * 작 성 일 : 2011.01.21
 * 작 성 자 : 
 * 수 정 자 : 
 * 파 일 명 : mgif1030.jsp
...
function doInit(){
    ...
    registerUsingDataset("mgif103", "DS_IO_STRMST,DS_IO_VENFEEINF");  
}
...
function gridCreate1(){
    ...
    var hdrProperies1 = '<FC>id={currow}    name="NO"   edit=none      width=30   align=center</FC>'
        + '<FC>id=APP_DT      name="적용일자"  edit={if(SysStatus = "I", "true", "false")}   width=110 mask="XXXX/XX/XX" EditLimit=8 edit=numeric EditStyle=Popup align=center</FC>'
        + '<FC>id=JGIFT_PAY_FEE_RATE    name="제휴상품권 수수료율" edit=RealNumeric edit={if(APP_DT <= TODAY, "false", "true")}  width=140  align=right</FC>'
        + '<FC>id=JCPN_PAY_FEE_RATE    name="쿠폰지급 수수료율"   edit=RealNumeric  edit={if(APP_DT <= TODAY, "false", "true")}   width=140  align=right</FC>'
        + '<FC>id=JCPN_REC_FEE_RATE    name="쿠폰수취 수수료율" edit=RealNumeric  edit={if(APP_DT <= TODAY, "false", "true")}  width=140  align=right</FC>';
...
function btn_Search() {
    ...
    TR_MAIN.Action="/mss/mgif103.mg?goTo="+goTo+parameters;  
...
function btn_Save() {
    ...
    TR_MAIN.Action="/mss/mgif103.mg?goTo=save";
 ...
 *************************************************************************/
 ...
 function setGiftVenFlag() {
	 ...
	 DS_O_GIFT_VEN_FLAG.NameValue(DS_O_GIFT_VEN_FLAG.CountRow, "CODE") = "1";
	 DS_O_GIFT_VEN_FLAG.NameValue(DS_O_GIFT_VEN_FLAG.CountRow, "NAME") = "제휴협력사";
	 DS_O_GIFT_VEN_FLAG.AddRow();
 ...
 function getVenCd(){
     ...
     getMssEvtVenPop( EM_S_VEN_CD, EM_S_VEN_NM, 'S', '1', '', LC_S_STR.BindColVal, '')
 }
--></script>
</head>
...
if((colid == "JGIFT_PAY_FEE_RATE" || colid == "JCPN_PAY_FEE_RATE" || colid == "JCPN_REC_FEE_RATE")
        && DS_IO_VENFEEINFO.NameValue(row, colid) != ""){
...
if(this.Text.length > 0){
    ...
    getMssEvtVenNonPop( "DS_O_RESULT", EM_S_VEN_CD, EM_S_VEN_NM, "E", "Y", "1", '', LC_S_STR.BindColVal, LC_S_BUY_SALE_FLAG.BindColVal);
}
return true;
</script>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr valign="top">
        <td width="230">
            ...
            <tr>
            <td>
            <comment id="_NSID_"><OBJECT id=GD_STRMST width=390 height=796 classid=<%=Util.CLSID_GRID%>>
        ...
        <td class="PL05">
          ...
          <tr height=18>
            <td colspan=2>
               <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td class="sub_title"><img src="/<%=dir%>/imgs/comm/ring_blue.gif" width="11" height="12" align="absmiddle" class="PR03"/>제휴사 마스터 정보</td>
              </tr>
            </table>
           </td>
          </tr>
          ...
          <!-- colgroup 설정부  시작 -->
           <colgroup>
	           <col width="120px"> <!-- 첫번재 헹 -->
	           <col width="150px"> <!-- 두번째 행 -->
	           <col width="110px"> <!-- 세번째 행 -->
	           <col width="">      <!-- 네번째 행 -->
           </colgroup>
          <!-- colgroup 설정부  끝 -->
                  ...
                  <tr>
                   ...
                   <th>점</th>
                    <td colspan=3>
                        <comment id="_NSID_">
                          <object id=EM_STR_NM classid=<%=Util.CLSID_EMEDIT%>   width=150 tabindex=1 align="absmiddle">
                          </object>
                      </comment><script>_ws_(_NSID_);</script>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td width="150">
                        <comment id="_NSID_">
                          <object id=EM_VEN_CD classid=<%=Util.CLSID_EMEDIT%>   width=150 tabindex=1 align="absmiddle">
                          </object>
                      </comment><script>_ws_(_NSID_);</script>
                    </td>
                    <th>협력사명</th>
                    <td>
                        <comment id="_NSID_">
                          <object id=EM_VEN_NM classid=<%=Util.CLSID_EMEDIT%>   width=150 tabindex=1 align="absmiddle">
                          </object>
                      </comment><script>_ws_(_NSID_);</script>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                        <comment id="_NSID_">
                          <object id=EM_BIZ_TYPE_NM classid=<%=Util.CLSID_EMEDIT%>   width=150 tabindex=1 align="absmiddle">
                          </object>
                      </comment><script>_ws_(_NSID_);</script>
                    </td>
                    <th>사업자번호</th>
                    <td>
                        <comment id="_NSID_">
                          <object id=EM_COMP_NO classid=<%=Util.CLSID_EMEDIT%>   width=150 tabindex=1 align="absmiddle">
                          </object>
                      </comment><script>_ws_(_NSID_);</script>
                    </td>
                  </tr>
                    ...
                    <td>
                        <comment id="_NSID_">
                          <object id=EM_COMP_NAME classid=<%=Util.CLSID_EMEDIT%>   width=150 tabindex=1 align="absmiddle">
                          </object>
                      </comment><script>_ws_(_NSID_);</script>
                    </td>
                    <th width="110">대표자명</th>
                    <td>
                        <comment id="_NSID_">
                          <object id=EM_REP_NAME classid=<%=Util.CLSID_EMEDIT%>   width=150 tabindex=1 align="absmiddle">
                          </object>
                      </comment><script>_ws_(_NSID_);</script>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                        <comment id="_NSID_">
                          <object id=EM_BIZ_STAT classid=<%=Util.CLSID_EMEDIT%>   width=150 tabindex=1 align="absmiddle">
                          </object>
                      </comment><script>_ws_(_NSID_);</script>
                    </td>
                    <th>종목</th>
                    <td>
                        <comment id="_NSID_">
                          <object id=EM_BIZ_CAT classid=<%=Util.CLSID_EMEDIT%>   width=150 tabindex=1 align="absmiddle">
                          </object>
                      </comment><script>_ws_(_NSID_);</script>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td colspan="3">
                        <comment id="_NSID_">
                          <object id=EM_ADDR classid=<%=Util.CLSID_EMEDIT%>   width=434 tabindex=1 align="absmiddle">
                          </object>
                      </comment><script>_ws_(_NSID_);</script>
                    </td>
                  </tr>
                   <tr>
                    ...
                    <td colspan="3">
                        <comment id="_NSID_">
                          <object id=EM_ADDR_DTL classid=<%=Util.CLSID_EMEDIT%>   width=434 tabindex=1 align="absmiddle">
                          </object>
                      </comment><script>_ws_(_NSID_);</script>
                    </td>
                  </tr>
                  ...
                  <th>전화번호</th>
                    <td>
                        <comment id="_NSID_">
                          <object id=EM_PHONE_NO classid=<%=Util.CLSID_EMEDIT%>   width=150 tabindex=1 align="absmiddle">
                          </object>
                      </comment><script>_ws_(_NSID_);</script>
                    </td>
                    <th>FAX번호</th>
                    <td>
                        <comment id="_NSID_">
                          <object id=EM_FAX_NO classid=<%=Util.CLSID_EMEDIT%>   width=150 tabindex=1 align="absmiddle">
                          </object>
                      </comment><script>_ws_(_NSID_);</script>
                    </td>
                  </tr>
                  <tr>
                   <th>지불일자</th>
                    <td>
                        <comment id="_NSID_">
                          <object id=EM_PAY_DT_FLAG classid=<%=Util.CLSID_EMEDIT%>   width=150 tabindex=1 align="absmiddle">
                          </object>
                      </comment><script>_ws_(_NSID_);</script>
                    </td>
                    <th>지불방법</th>
                    <td>
                        <comment id="_NSID_">
                          <object id=EM_PAY_WAY classid=<%=Util.CLSID_EMEDIT%>   width=150 tabindex=1 align="absmiddle">
                          </object>
                      </comment><script>_ws_(_NSID_);</script>
                    </td>
                  </tr>
