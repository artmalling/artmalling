...
var strOrgCd    = dialogArguments[0];
var sdate   = dialogArguments[1];
...
function doInit(){
    ...
    initEmEdit(EM_SEL_DATE, "YYYYMMDD", READ);                  //선택일자
...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}     name="NO"             width=30   align=center</FC>'
                     + '<FC>id=STR_CD            name="점"             width=60   align=left EditStyle=Lookup   Data="DS_O_STR:CODE:NAME" </FC>'
                     ...
                     + '<FC>id=PROM_TYPE            name="약속유형"       width=60   align=left EditStyle=Lookup   Data="DS_O_PROM_TYPE:CODE:NAME" </FC>'
...
function getDetailSearch(){
	...
	EM_SEL_DATE.Text = sdate;
        
    var goTo       = "getDetailPopup";    
    var action     = "O";     
    var parameters =   "&strOrgCd=" + encodeURIComponent(strOrgCd)
                     + "&selDate="  + encodeURIComponent(sdate);
    
    TR_MAIN.Action="/mss/mpro201.mp?goTo="+goTo+parameters;  
...
<!--* E. 본문시작                                                                                                                                                               *-->
<!--*************************************************************************-->
<body onLoad="doInit();" class="PL05 PT05 PR05">
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">  
  <tr valign=top>
    <td class="PB03">        
     <table width="100%" border="0" cellspacing="0" cellpadding="0">        
        <tr><td width="260" class="PB03 PT10">
        <table border="0" cellspacing="0" cellpadding="0" class="s_table">
            <TR>
                <th width="90" >선택일자</th>
                <td>
                      <comment id="_NSID_">
                          <object id=EM_SEL_DATE classid=<%=Util.CLSID_EMEDIT%> width=170 tabindex=1 align="absmiddle">
                          </object>
                      </comment>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0"  class="BD4A">
                   <tr>
                       <td width="100%">
                           <comment id="_NSID_"><OBJECT id=GD_MASTER width=100% height=605 classid=<%=Util.CLSID_GRID%>>
