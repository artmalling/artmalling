<!-- 
/*******************************************************************************
 * 시스템명 : 경영지원 > 상품권관리 > 상품권 판매/회수 > 자사상품권 회수 리스트 - 출력
 * 작 성 일 : 2011.04.20
 * 작 성 자 : 
 * 수 정 자 : 
 * 파 일 명 : mgif3171.jsp
...
<%
    ...
    */
    ...
    String reportname = "상품권 회수 리스트";
    
    String strStrCd = String2.trimToEmpty(request.getParameter("strStrCd"));
    String strDrawlYmdFrom = String2.trimToEmpty(request.getParameter("strDrawlYmdFrom"));
    String strDrawlYmdTo = String2.trimToEmpty(request.getParameter("strDrawlYmdTo"));

    //odi 파라미터
    String[][] params  = new String[][]{
        {"STR_CD=" + strStrCd, "SALE_S_YMD=" + strDrawlYmdFrom, "SALE_E_YMD=" + strDrawlYmdTo}
    };
