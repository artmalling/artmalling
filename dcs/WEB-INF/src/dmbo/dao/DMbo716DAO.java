...
public class DMbo716DAO extends AbstractDAO {
    ...
    public List searchCust(ActionForm form, GauceDataSet dSet) throws Exception {
        ...
        int i=1;
    	strQuery = " SELECT DECODE(COUNT(CARD_NO), 0, '1', NVL(MAX(CUST_ID),'2')) AS CUST_ID FROM DCS.DM_CARD WHERE CARD_NO  = DCS.SC_Crypto_FUN('ENC', ?) ";
