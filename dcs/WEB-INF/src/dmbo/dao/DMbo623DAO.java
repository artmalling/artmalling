...
public class DMbo623DAO extends AbstractDAO {
    ...
    public int saveData(ActionForm form,MultiInput input) throws Exception {
        ...
        try {
            ...
            while (input.next()) 
            {
                ...
                String CARD_NO_ENC =  String2.nvl(input.getString("CARD_NO"));
                String SS_NO_ENC   =  String2.nvl(input.getString("SS_NO"));
                ...
                if (1 != result) {
                    throw new Exception("EXCEL UPLOAD 미확정 자료 등록시 장애가 발생하였습니다.");
                }
            }
  ...
  public int dataCheck(ActionForm form, MultiInput mi) throws Exception {
        ...
        try {
            ...
            int i = 1;
            psql.put("DCS.PR_DMBO623_CHECK", 2);    
            psql.registerOutParameter(i++, DataTypes.INTEGER); //O_RETURN
            psql.registerOutParameter(i++, DataTypes.VARCHAR); //O_MESSAGE
