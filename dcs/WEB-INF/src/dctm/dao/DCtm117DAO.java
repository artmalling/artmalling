 ...
 * @caused   by 
 */
public class DCtm117DAO extends AbstractDAO {
	...
	public int saveData(ActionForm form, GauceDataSet dSet, HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            psql.put("DCS.PR_DM_CARD_ADD", 6);             
            i=1; 

            System.out.println("START --0  :  " + dSet.getDataRow(0).getColumnValue(0).toString());
            System.out.println("START --1  :  " + dSet.getDataRow(0).getColumnValue(1).toString());
            System.out.println("START --2  :  " + dSet.getDataRow(0).getColumnValue(2).toString());
            System.out.println("START --3  :  " + dSet.getDataRow(0).getColumnValue(3).toString());
            System.out.println("START --4  :  " + dSet.getDataRow(0).getColumnValue(4).toString());
            
            
            psql.setInt(i++, Integer.parseInt(dSet.getDataRow(0).getColumnValue(2).toString()));
            //psql.setString(i++, dSet.getDataRow(0).getColumnValue(2).toString());
            psql.setString(i++, dSet.getDataRow(0).getColumnValue(1).toString());
            psql.setString(i++, dSet.getDataRow(0).getColumnValue(3).toString());
        	...
        	System.out.println(prs.getInt(5));
        	System.out.println(prs.getString(6));
	...
	public int saveData(ActionForm form, GauceDataSet dSet, HttpServletRequest request) throws Exception {
        ...
        try {
	        ...
	        for (int j = 0; j < Integer.parseInt(dSet.getDataRow(0).getColumnValue(2).toString()); j++) {
	            ...
	            strCard_no = util.encryptedStr(strCard_no);
				sql.close();
				sql = new SqlWrapper();
	            //해당값을 저장하도록 한다.
	            //DCS.DM_PRE_CARD_NO 입력.
	...
	*/
	...
	public int delData(ActionForm form, GauceDataSet dSet, HttpServletRequest request) throws Exception {
        ...
        try {
			...
			psql.put("DCS.PR_DCTM117_DELETE", 6);
