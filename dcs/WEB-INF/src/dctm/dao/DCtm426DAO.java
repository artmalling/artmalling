...
public class DCtm426DAO extends AbstractDAO {
	...
	public List getMaster(ActionForm form, String userId, String org_flag) throws Exception {
		...
		String strDSName= String2.nvl(form.getParam("strDSName"));
	
		sql = new SqlWrapper();     
		svc = (Service) form.getService();
		connect("pot");
		
		if (strDSName.equals("DS_IO_MASTER"))
			sql.put(svc.getQuery("SEL_MASTER"));
		else
			sql.put(svc.getQuery("SEL_MASTER_GUBUN"));
		/*
