<!-- 
 * 시스템명 : 포인트카드 > 제휴카드사 > 실적조회 > 월단위 포인트 현황 조회
 * 작  성  일  : 2010.05.19
 * 작  성  자  : 장형욱
 * 수  정  자  : 
 * 파  일  명  : dacc1020.jsp
...
function doInit(){
    ...
    initComboStyle(LC_CARD_S,DS_CARD, "CODE^0^75,NAME^0^75", 1, NORMAL);    //상태
...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}        name="NO"            width=30    align=center</FC>'
                     ...
                     + '<FC>id=BRCH_NAME       name="가맹점명"        width=150  align=left SumText="합계"</FC>'
                     + '<FC>id=CARD_COMP       name="제휴신용카드사"   width=130  align=left show=false </FC>'
                     + '<FC>id=CARD_NAME       name="제휴신용카드사명"  width=130   align=left </FC>'
                     + '<FC>id=ADD_COUNT       name="적립건수"        width=90   align=right SumText=@sum</FC>'
                     + '<FC>id=ADD_POINT       name="적립포인트"      width=95   align=right SumText=@sum</FC>'
                     + '<FC>id=BRCH_DVD_POINT  name="적립분담금"    width=95   align=right SumText=@sum</FC>'
                     + '<FC>id=CARD_DVD_POINT  name="카드사분담금"    width=95   align=right SumText=@sum</FC>'
                     + '<FC>id=ADD_FEE_AMT     name="적립수수료"      width=95   align=right SumText=@sum</FC>';
...
function btn_Search() {
    ...
    TR_MAIN.Action  = "/dcs/dacc102.da?goTo="+goTo+parameters;  
 ...
 */ 
 function btn_Excel() {
    var parameters = "조회년월="          + EM_S_DT_S.text
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td width="135"><comment id="_NSID_"> <object
							...
							onclick="javascript:openCal('M',EM_S_DT_S)" /></td>
						<th width="80">가맹점명</th>
						...
						<td><comment id="_NSID_"> <object id=LC_CARD_S
							classid=<%=Util.CLSID_LUXECOMBO%> height=100 width=150 tabindex=1></object>
