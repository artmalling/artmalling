...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}     name="NO"           width=30    align=center</FC>'
        + '<FC>id=YYYYMM  					name="년월"			width=80    align=center align=center mask="XXXX/XX" SumText="합계"</FC>'
        ...
        + '<FC>id=PRE_CUST_SALE_AMT   		name="전월매출"   	width=120   align=right SumText=@sum</FC>'
        ...
        + '<FC>id=PRE_NCUST_SALE_AMT  		name="전월매출"   	width=120   align=right SumText=@sum</FC>'
...
function showMaster(){
    ...
    TR_MAIN.Action  ="/dcs/dbri303.db?goTo="+goTo+parameters;  
