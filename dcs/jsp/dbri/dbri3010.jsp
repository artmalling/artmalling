...
function gridCreate1(){
     ...
     var hdrProperies = '<FC>id={currow}      		name="NO"             	width=30    align=center</FC>'
                      + '<FC>id=ENTR_YYYYMM  		name="년월"				width=90    align=center mask="XXXX/XX" SumText="합계"</FC>'
                      + '<FC>id=ENTR_CNT       		name="당월;신규회원수"      width=100    align=right SumText=@sum</FC>'
                      + '<FC>id=PRE_ENTR_CNT    	name="전월;신규회원수"      width=100    align=right SumText=@sum</FC>'
                      ...
                      + '<FC>id=ADD_SUM_ENTR_CNT    name="누적회원수"	        width=120    align=right </FC>'
                      + '<FC>id=ENTR_RATE   		name="구성비"   			width=100    align=right </FC>'
                      + '<FC>id=ENTR_TOT_CNT   		name="총회원수"     		width=100    align=right SumText=@sum show=false</FC>';
...
function showMaster(){
    ...
    TR_MAIN.Action  ="/dcs/dbri301.db?goTo="+goTo+parameters;  
