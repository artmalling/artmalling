<!-- 
/*******************************************************************************
 * 시스템명 : 고객관리 > 가맹점관리 > 회원 매출 객단가 현황(월)
 * 작  성  일  : 2012.05.30
 * 작  성  자  : kj
 * 수  정  자  : 
 * 파  일  명  : dbri3040.jsp
...
function gridCreate1(){
     var hdrProperies = '<FC>id={currow}      			name="NO"           width=30    align=center</FC>'
                      + '<FC>id=YYYYMM  				name="년월"			width=60    align=center mask="XXXX/XX" SumText="합계"</FC>'
                      + '<FG> id=TITLE                  name="총매출" 		edit=none 	align=center'  
                      ...
                      + '</FG>'  
                      + '<FG> id=TITLE                  name="회원매출" 		edit=none 	align=center'  
                      + '<FC>id=CUST_SALE_AMT     		name="회원매출"		width=120   align=right SumText=@sum</FC>'
                      + '<FC>id=CUST_SALE_RATE     		name="구성비"   		width=60   align=right </FC>'
                      + '<FC>id=CUST_CNT_YY   			name="객수"   		width=80   align=right </FC>'
                      + '<FC>id=CUST_DANGA   			name="객단가"   		width=80   align=right </FC>'
                      + '</FG>'  
                      + '<FG> id=TITLE                  name="비회원매출" 	edit=none	align=center'  
                      + '<FC>id=NCUST_SALE_AMT    		name="비회원매출"		width=120   align=right SumText=@sum</FC>'
                      + '<FC>id=NCUST_SALE_RATE   		name="구성비"  		width=60   align=right </FC>'
                      + '<FC>id=CUST_CNT_YY_1   		name="객수"			width=80   align=right </FC>'
                      ...
                      + '<FC>id=CUST_SALE_RATE     		name="회원매출구성비"   	width=100    align=right SumText=@sum show=false</FC>';*/
...
function showMaster(){
    ...
    TR_MAIN.Action  ="/dcs/dbri304.db?goTo="+goTo+parameters;  
