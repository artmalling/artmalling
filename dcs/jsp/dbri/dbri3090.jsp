<!-- 
/*******************************************************************************
 * 시스템명 : 고객관리 > 가맹점관리 > 회원 매출 객단가 현황(년)
 * 작  성  일  : 2012.05.30
 * 작  성  자  : kj
 * 수  정  자  : 
 * 파  일  명  : dbri3090.jsp
...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}      			name="NO"           width=30    align=center</FC>'
        + '<FC>id=YYYYMM  				name="년"			width=60    align=center mask="XXXX" SumText="합계"</FC>'
...
function showMaster(){
    ...
    TR_MAIN.Action  ="/dcs/dbri309.db?goTo="+goTo+parameters;  
