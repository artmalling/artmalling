...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}     name="NO"           width=30    align=center</FC>'
        + '<FC>id=YYYYMM  					name="년"			width=80    align=center align=center mask="XXXX" SumText="합계"</FC>'
        ...
        + '<FC>id=PRE_CUST_SALE_AMT   		name="전년매출"   	width=120   align=right SumText=@sum</FC>'
        + '<FC>id=ADD_CUST_SALE_AMT   		name="매출증감액"		width=120   align=right SumText=@sum</FC>'
        + '<FC>id=ADD_CUST_SALE_RATE     	name="매출증감율"    	width=100   align=right </FC>'
        + '</FG>' 
        ...
        + '<FC>id=PRE_NCUST_SALE_AMT  		name="전년매출"   	width=120   align=right SumText=@sum</FC>'
        + '<FC>id=ADD_NCUST_SALE_AMT      	name="매출증감액"    	width=120   align=right SumText=@sum</FC>'
        + '<FC>id=ADD_NCUST_SALE_RATE    	name="매출증감율"		width=100   </FC>'
        + '</FG>' ;
        /**/
        /*+ '<FC>id=TOT_DANGA   			name="총매출 객단가"     	width=100    align=right SumText=@sum show=false</FC>'                      
        + '<FC>id=CUST_DANGA   			name="회원매출 객단가"   	width=100    align=right SumText=@sum show=false</FC>'
        + '<FC>id=NCUST_DANGA   			name="비회원매출 객단가"	width=100    align=right SumText=@sum show=false</FC>';*/    
...
function btn_Excel() {
    ...
    var parameters = "조회시작년월="     + EM_FROM_S_YYYY.Text
    			   + "조회종료년월="     + EM_TO_S_YYYY.Text;
    
    var ExcelTitle = "회원 매출 현황(년)"
...
function showMaster(){
    ...
    TR_MAIN.Action  ="/dcs/dbri308.db?goTo="+goTo+parameters;  
