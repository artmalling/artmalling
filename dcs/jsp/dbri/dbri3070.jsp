<!-- 
/*******************************************************************************
 * 시스템명 : 고객관리 > 가맹점관리 > 지역별 회원 매출 현황(년)
 * 작  성  일  : 2010-02-16
 * 작  성  자  : kj
 * 수  정  자  : 
 * 파  일  명  : dbri3070.jsp
...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}      	name="NO"           width=30    align=center SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}</FC>'
	        + '<FC>id=YYYYMM  		name="년"			width=80    align=center align=center mask="XXXX/XX" suppress=2 SubSumText={decode(curlevel,2,"년 소계","")} SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}</FC>'
	        ...
	        + '<FC>id=BUSI_AREA_NM    name="상권명"     	width=100    align=center SubSumText={decode(curlevel,1,"상권 소계","")} SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}</FC>'
	        + '<FC>id=SALE_AMT    	name="매출액"			width=120    align=right sumtext={subsum(SALE_AMT)} SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}</FC>'
...
function showMaster(){
    ...
    TR_MAIN.Action  ="/dcs/dbri307.db?goTo="+goTo+parameters;  
