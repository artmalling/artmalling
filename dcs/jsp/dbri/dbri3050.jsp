<!-- 
/*******************************************************************************
 * 시스템명 : 고객관리 > 가맹점관리 > 회원 연령별성별 매출 현황(월)
 * 작  성  일  : 2012.05.30
 * 작  성  자  : kj
 * 수  정  자  : 
 * 파  일  명  : dbri3050.jsp
...
function gridCreate1(){
     var hdrProperies = '<FC>id={currow}      	name="NO"             	width=30    align=center SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}</FC>'
	         + '<FC>id=YYYYMM  		name="년월"				width=60    align=center mask="XXXX/XX" SubSumText={decode(curlevel,1,"년월 소계","")} suppress=2 SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}</FC>'
...
function btn_Excel() {
    ...
    var ExcelTitle = "회원 연령별성별 매출 현황(월)"
...
function showMaster(){
    ...
    TR_MAIN.Action  ="/dcs/dbri305.db?goTo="+goTo+parameters;  
