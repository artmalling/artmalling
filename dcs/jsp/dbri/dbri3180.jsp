<!-- 
/*******************************************************************************
 * 시스템명 : 고객관리 > 포인트현황> 회원매출현황(브랜드 상호간)
 * 작 성 일 : 2012.06.25
 * 작 성 자 : kj
 * 수 정 자 : 
 * 파 일 명 : dbri3180.jsp
...
function btn_Search() {
    ...
    if(trim(EM_O_PUMBUN_CD.Text).length == 0 && trim(LC_TEAM_CD.BindColVal)  == '%'){
        showMessage(EXCLAMATION, OK, "USER-1001","파트 또는 브랜드");
    ...
    IFrame.location.href="/dcs/jsp/dbri/dbri3181.jsp?"+parameters;
}
...
function btn_Print() {
    ...
    var parameters = "&strStrCd="   + LC_STR_CD.BindColVal //점코드
				   ...
				   + "&strPcCd="  + LC_PC_CD.BindColVal
                   ;
    window.open("/dcs/jsp/dbri/dbri3181.jsp?"+parameters,"OZPRINT", 1000, 700);	 
}
