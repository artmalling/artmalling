...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}      			name="NO"           	width=30    align=center</FC>'
                     + '<FG> id=TITLE                  	name="매출일자" 			edit=none 	align=center'  
                     + '<FC>id=TOT_SALE_AMT       		name="총매출"       		width=120   align=right SumText=@sum</FC>'
                     + '<FC>id=CUST_CNT_XX   			name="객수"     			width=80    align=right </FC>'
                     + '<FC>id=TOT_DANGA   				name="객단가"     		width=80    align=right </FC>'
                     + '<FC>id=CUST_SALE_AMT     		name="회원매출"			width=120   align=right SumText=@sum</FC>'
                     + '<FC>id=CUST_SALE_RATE     		name="구성비"   			width=60    align=right show=false </FC>'
                     + '<FC>id=CUST_CNT_XZ   			name="객수"   			width=80    align=right </FC>'
                     + '<FC>id=CUST_DANGA   			name="객단가"   			width=80    align=right </FC>'
                     + '<FC>id=NCUST_SALE_AMT    		name="비회원매출"			width=120   align=right SumText=@sum</FC>'
                     + '<FC>id=NCUST_SALE_RATE   		name="구성비"  			width=60    align=right show=false </FC>'
                     + '<FC>id=CUST_CNT_XZ_1   			name="객수"				width=80    align=right </FC>'
                     + '<FC>id=NCUST_DANGA   			name="객단가"				width=80    align=right </FC>'
                     + '</FG>'  
                     + '<FG>id=TITLE                  	name="대비일자" 			edit=none 	align=center'  
                     + '<FC>id=PRE_TOT_SALE_AMT   		name="총매출"   		    width=100   align=right SumText=@sum</FC>'
                     + '<FC>id=CUST_CNT_YY   			name="객수"     		width=80    align=right </FC>'
                     + '<FC>id=PRE_TOT_DANGA   			name="객단가"     		width=80    align=right </FC>'
                     + '<FC>id=PRE_CUST_SALE_AMT     	name="회원매출"			width=120   align=right SumText=@sum</FC>'
                     + '<FC>id=PRE_CUST_SALE_RATE     	name="구성비"   			width=60    align=right show=false </FC>'
                     + '<FC>id=CUST_CNT_YZ   			name="객수"   			width=80    align=right </FC>'
                     + '<FC>id=PRE_CUST_DANGA   		name="객단가"   			width=80    align=right </FC>'
                     + '<FC>id=PRE_NCUST_SALE_AMT    	name="비회원매출"			width=120   align=right SumText=@sum</FC>'
                     + '<FC>id=PRE_NCUST_SALE_RATE   	name="구성비"  			width=60    align=right show=false </FC>'
                     + '<FC>id=CUST_CNT_YZ_1   			name="객수"				width=80    align=right </FC>'
                     + '<FC>id=PRE_NCUST_DANGA   		name="객단가"				width=80    align=right </FC>'
                     + '</FG>'  
                     + '<FC>id=CUST_NCUST_DANGA_RATE   name="회원:비회원;객단가비"			width=80   align=center </FC>'
                     ; 
                     /*+ '<FC>id=PRE_CUST_SALE_AMT   	name="회원전매출"   		width=100    align=right SumText=@sum show=false</FC>'
                     + '<FC>id=PRE_NCUST_SALE_AMT  	name="비회원전매출"   	width=100    align=right SumText=@sum show=false</FC>'
                     + '<FC>id=ADD_CUST_SALE_AMT   	name="회원매출증감"     	width=100    align=right SumText=@sum show=false</FC>'
                     + '<FC>id=ADD_NCUST_SALE_AMT      name="비회원매출증감"    width=100    align=right SumText=@sum show=false</FC>'
                     + '<FC>id=ADD_CUST_SALE_RATE     	name="회원매출증감율"    width=100    align=right SumText=@sum show=false</FC>'
                     + '<FC>id=ADD_NCUST_SALE_RATE    	name="비회원매출증감율"	width=100    align=right SumText=@sum show=false</FC>'
                     + '<FC>id=PRE_TOT_DANGA   			name="대비총매출 객단가"		width=100    align=right show=false</FC>'
			         + '<FC>id=PRE_CUST_DANGA   		name="대비회원매출 객단가"	width=100    align=right show=false</FC>'
			         + '<FC>id=PRE_NCUST_DANGA   		name="대비비회원매출 객단가"	width=100    align=right show=false</FC>';*/			         
...
function showMaster(){
    ...
    TR_MAIN.Action  ="/dcs/dbri314.db?goTo="+goTo+parameters;  
			...
			<tr>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<th width="100" class="point"><input type="checkbox" id=CHK_ILJA onclick="fnChkEnable();">대비일자</th> 
