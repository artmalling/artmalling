...
function gridCreate1(){
    ...
    var hdrProperies = '<FC>id={currow}      	name="NO"             	width=30    align=center</FC>'
			         ...
			         + '<FC>id=CUST_GRADE    	name="회원등급"      		width=100    align=center</FC>'
			         + '<FC>id=CUST_TYPE    	name="회원유형"      		width=100    align=center</FC>'
			         ...
			         + '<FC>id=SALE_CNT     	name="건수"   			width=80    align=center</FC>'
			         + '<FC>id=VISIT_CNT     	name="방문횟수"   			width=80    align=center</FC>'
...
function showMaster(){
    ...
    var parameters  = "&strFromSDate="+ encodeURIComponent(EM_FROM_S_DT.Text);
	    ...
	    parameters +=	"&strStrCd="           + encodeURIComponent(LC_STR_CD.BindColVal);
	    parameters +=	"&strDeptCd="          + encodeURIComponent(LC_DEPT_CD.BindColVal);
	    parameters +=	"&strTeamCd="          + encodeURIComponent(LC_TEAM_CD.BindColVal);
	    parameters +=	"&strPCCd="            + encodeURIComponent(LC_PC_CD.BindColVal);
	    parameters +=	"&strOrgFlag="         + encodeURIComponent(EM_ORG_FLAG.CodeValue);
    ...
    TR_MAIN.Action  ="/dcs/dbri320.db?goTo="+goTo+parameters;  
			...
			<tr>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td width="195"><input type="checkbox" id=CHK_BUSI_AREA1 value="1" tabindex=1 >1차 &nbsp;<input
							type="checkbox" id=CHK_BUSI_AREA2 value="2" tabindex=1 >2차 &nbsp;<input
                            type="checkbox" id=CHK_BUSI_AREA3 value="3" tabindex=1 >3차 &nbsp;
						...
						<td colspan=3><input type="checkbox" id=CHK_SEX_CD1 value="M" tabindex=1 >남 &nbsp;<input
					...
					<tr>
						...
						<th width="80">고객정보</th>
						<td colspan=3><input type="checkbox" id=CHK_EMAIL_YN tabindex=1 >Email &nbsp;<input
					...
					<tr>
						...
						<th>SMS수신여부</th>
						<td>
							<input type="checkbox" id=CHK_SMS_Y value="Y" tabindex=1 >동의 &nbsp;
							<input type="checkbox" id=CHK_SMS_N value="N" tabindex=1 >비동의 &nbsp;
						</td> 
                    	<th>총매출액</th>
						...
						<th>구분</th>
                        <td colspan=3>
			            	<object id="EM_ORG_FLAG" classid=<%=Util.CLSID_RADIO%> tabindex=1>
                    		<param name=Cols    value="2">
                    		<param name=Format  value="1^PC,2^파트">                   
