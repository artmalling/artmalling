<!-- 
/*******************************************************************************
 * 시스템명 : 포인트카드 > 포인트관리 > 포인트일정산 > 가맹점분담금실적조회
 * 작 성 일 : 2010.03.25
 * 작 성 자 : 장형욱
 * 수 정 자 : 
 * 파 일 명 : dmtc4030.jsp
...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}         name="NO"               width=30      align=center</FC>'
                     ...
                     + '<FC>id=APP_POINT        name="총적립포인트"     width=100     align=right SumText=@sum </FC>'
                     + '<FC>id=DCUBE_RATE       name="포인트분담율"     width=98    align=right</FC>'
                     + '<FC>id=DCUBE_DVD_AMT    name="포인트분담"       width="100"  align=right SumText=@sum </FC>'
                     + '<FC>id=BRCH_RATE        name="가맹점분담율"     width="98"  align=right </FC>'
                     + '<FC>id=BRCH_DVD_AMT     name="가맹점분담"       width="100"  align=right SumText=@sum </FC>'
                     + '<FC>id=ADD_FEE_AMT      name="가맹점수수료"     width="100"  align=right SumText=@sum </FC>';
...
function btn_Search() {
    ...
    EXCEL_PARAMS += "-가맹점명=" + EM_BRCH_NAME_S.Text;
	...
	TR_MAIN.Action  = "/dcs/dmtc403.dc?goTo="+goTo+parameters;  
