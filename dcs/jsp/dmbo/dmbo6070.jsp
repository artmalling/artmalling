<!-- 
/*******************************************************************************
 * 시스템명 : 포인트카드 > 멤버쉽운영 > 승인처리 > 상품권 교환 현황표
 * 작  성  일  : 2010.01.14
 * 작  성  자  : 김영진 
 * 수  정  자  : 
 * 파  일  명  : dmbo6070.jsp
...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}     name="NO"               width=30    align=center</FC>'
                     + '<FC>id=BRCH_NAME    name="가맹점명"         width=90    align=left SumText="합계" </FC>'
                     + '<FC>id=PROC_DT      name="일자"             width=100    align=center     mask="XXXX/XX/XX" </FC>'
                     + '<FC>id=CUST_NAME    name="회원명"           width=80    align=center </FC>'
                     + '<FC>id=MOBILE_PH1   name="이동전화"         width=120    align=center</FC>'
                     + '<FC>id=CARD_NO      name="카드번호"         width=180   align=center   mask="XXXX-XXXX-XXXX-XXXX"</FC>'
                     + '<FC>id=CONV_POINT   name="사용포인트"       gte_columntype="number:0:true" gte_Summarytype="number:0:true"	width=80    align=right SumText=@sum </FC>'
                     + '<FC>id=GIFTCD_AMT   name="상품권금액"       gte_columntype="number:0:true" gte_Summarytype="number:0:true"	width=80    align=right SumText=@sum </FC>'
                     + '<FC>id=GIFTCD_NO    name="상품권번호"       width=184   align=left</FC>'
                     + '<FC>id=GIFTCD_NO2   name="상품권번호"       width=250   align=left 		show=false</FC>'
                     + '<FC>id=CNT    		name="상품권수량"       width=80   align=right</FC>';
...
function btn_Print() {
    ...
    window.open("/dcs/dmbo607.do?goTo=print"+parameters,"OZREPORT", 1000, 700);
}
...
function showMaster(){
    ...
    TR_MAIN.Action  ="/dcs/dmbo607.do?goTo="+goTo+parameters;  
