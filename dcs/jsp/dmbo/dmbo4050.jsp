 ...
 */
 ...
 function gridCreate1(){
     var hdrProperies = '<C>id={currow}    name="NO"			width=30    Edit=none  align=center</C>'
                      ...
                      + '<C>id=CUST_NAME		name="성명"    width=80    Edit=none  align=center</C>'
                      ...
                      + '<C>id=EMAIL       name="이메일"      width=100    Edit=none align=left</C>'
                      ...
                      + '<C>id=ENURI_AMT  name="가입일자매출"     width=120    Edit=none sumtext=@sum align=right</C>'
...
function btn_Search() {
    ...
    TR_MAIN.Action  = "/dcs/dmbo405.do?goTo="+goTo+parameters;  
      ...
      <tr>
        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table">
          <tr>
            ...
            <th width="60" class="point" style="display : none">회원구분</th>
