...
//     initEmEdit(EM_SUM_POINT,   "NUMBER^9^0", READ);       //누적+발생포인트
    ...
    registerUsingDataset("dmbo606","DS_I_POINT,DS_I_MASTER");
...
function saveData(){
    ...
    var goTo        = "chkSave";
    var action      = "I";  //조회는 O
    TR_MAIN2.Action  ="/dcs/dmbo606.do?goTo="+goTo;   
 ...
 */
 function realSave(){
    ...
    var goTo        = "save";
    var action      = "I";  //조회는 O
    TR_MAIN.Action  ="/dcs/dmbo606.do?goTo="+goTo;   
...
function showMaster(){
    ...
    TR_MAIN.Action  ="/dcs/dmbo606.do?goTo="+goTo+parameters;  
...
function searchAmt(){
    ...
    TR_MAIN3.Action  ="/dcs/dmbo606.do?goTo="+goTo+parameters;  
