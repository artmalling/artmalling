...
function gridCreate1() {
    var hdrProperies = '<FC>id={currow}     name="NO"           width=30   align=center   BgColor={if(ERR_MSG = "","white","orange")} </FC>'
                     + '<FC>id=MOBILE_EMAIL name="휴대폰 EMAIL"   width=180  align=center   BgColor={if(ERR_MSG = "","white","orange")}</FC>'
                     + '<FC>id=MOBILE_PH1   name="휴대폰1"       width=80  align=center   BgColor={if(ERR_MSG = "","white","orange")}</FC>'
                     + '<FC>id=MOBILE_PH2   name="휴대폰2"       width=80  align=center   BgColor={if(ERR_MSG = "","white","orange")}</FC>'
                     + '<FC>id=MOBILE_PH3   name="휴대폰3"       width=80   align=center   BgColor={if(ERR_MSG = "","white","orange")}</FC>'
                     + '<FC>id=EMAIL1       name="EMAIL1"       width=100   align=center   BgColor={if(ERR_MSG = "","white","orange")}</FC>'
                     + '<FC>id=EMAIL2       name="EMAIL2"       width=100   align=center   BgColor={if(ERR_MSG = "","white","orange")}</FC>'
                     + '<FC>id=FLAG         name="중지구분"      width=60   align=center   BgColor={if(ERR_MSG = "","white","orange")}</FC>'
...
function btn_Search() {
    ...
    TR_SEARCH.Action   = "/dcs/dmbo628.do?goTo=" + goTo + parameters;  
...
function btn_Conf() {
    ...
    var goTo = "confData";
    TR_MASTER.Action  ="/dcs/dmbo628.do?goTo="+goTo;
...
function downFile() {    
    var strPath   = "";    
    var strFileNm = "DMBO628_EXCEL_SMS_form.xls";       
    if( strPath != null  ) {                          
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table">
              <tr>
                ...
                <td>
                 ...
                 -->
                 <a href="/dcs/samplefiles/DMBO628_EXCEL_SMS_form.xls"> <img
