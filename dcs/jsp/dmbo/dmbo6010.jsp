...
//     initEmEdit(EM_SUM_POINT,   "NUMBER^9^0",          READ);       //누적+발생포인트
    ...
    EM_S_DT_S.Text = addDate("D", "0", '<%=strToMonth%>');
...
function showMaster(){
    ...
    TR_MAIN.Action  = "/dcs/dmbo601.do?goTo=" + goTo + parameters;  
...
function gourl(){
    ...
    frame01.Provider('../').OuterWindow.top.leftFrame.urlLink("DCTM112","/dcs/dctm112.dm?goTo=list&strSsNo="+strSsNo,"MCUS","02","회원메모관리");
}
...
function gourlCust(){
    ...
    if(RD_COMP_PERS_FLAG_S.CodeValue == "P"){   //개인회원
    	frame01.Provider('../').OuterWindow.top.leftFrame.urlLink("DCTM203","/dcs/dctm203.dm?goTo=list&strSsNo="+strSsNo,"MCUS","02","개인회원조회/수정");    
    }else{                                      //법인회원
    	frame01.Provider('../').OuterWindow.top.leftFrame.urlLink("DCTM206","/dcs/dctm206.dm?goTo=list&strSsNo="+strSsNo,"MCUS","02","법인회원조회/수정");    
    }
...
<div id="testdiv" class="testdiv">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <!--공통 검색// -->
    <tr>
      <td class="sub_title PT07 PB02"><img src="/<%=dir%>/imgs/comm/ring_blue.gif" width="11" height="12" align="absmiddle" class="PR03"/> 보유카드현황</td>
    </tr>
    <tr valign="top">
      <td class="PB03">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="BD4A">
          <tr>
            <td>
              <comment id="_NSID_">
                <object id=GR_MASTER width="100%" height=140 classid=<%=Util.CLSID_GRID%> tabindex=1>
    ...
    <tr>
      <td class="sub_title PT07 PB02"><img src="/<%=dir%>/imgs/comm/ring_blue.gif" width="11" height="12" align="absmiddle" class="PR03"/> 포인트 적립/사용 이력</td>
    </tr>
    <tr>
      <td class="PT01 PB03">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="o_table">
      ...
      <td class="PB03">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="BD4A">
          <tr>
            <td>
              <comment id="_NSID_">
                <object id=GR_POINT width="100%" height=182 classid=<%=Util.CLSID_GRID%> tabindex=1>
    ...
    <tr>
      <td style="display:none" class="sub_title PT07 PB02" ><img src="/<%=dir%>/imgs/comm/ring_blue.gif" width="11" height="12" align="absmiddle" class="PR03"/> 소멸예정안내</td>
    </tr>
    <tr>
      <td style="display:none" class="PT01 PB03">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="o_table">
          <tr>
            <td>
              <table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table">
      ...
      <td class="PB03">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="BD4A">
          <tr>
            <td>
              <comment id="_NSID_">
                <object id=GR_CLRPOINT width="100%" height=182 classid=<%=Util.CLSID_GRID%> tabindex=1>
