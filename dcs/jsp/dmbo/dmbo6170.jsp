...
function showMaster(){
    ...
    TR_MAIN.Action  = "/dcs/dmbo617.do?goTo=" + goTo + parameters;  
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table">
                ...
                <tr>
                  ...
                  <td width="170">
                    ...
                    <script> _ws_(_NSID_);</script>
                    <comment id="_NSID_">
                      <object id=EM_CARD_NO_S classid=<%=Util.CLSID_EMEDIT%> width=105 tabindex=1 onKeyUp="javascript:getCustInfoSrch(event.keyCode,this,'EM_CARD_NO_S',RD_COMP_PERS_FLAG_S.CodeValue);">
                      </object>       
                    </comment>
                    <script> _ws_(_NSID_);</script>
                  </td>            
