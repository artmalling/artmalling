...
function btn_Search() {
    ...
    EXCEL_PARAMS += "-브랜드=" + EM_O_PUMBUN_CD.Text;
    ...
    parameters      = "&strSdt="      + encodeURIComponent(EM_S_DT_S.text)
    				...
    				+ "&strPumbunCd=" + encodeURIComponent(EM_O_PUMBUN_CD.Text);    				
    				
    TR_MAIN.Action  = "/dcs/dmbo618.do?goTo="+goTo+parameters;  
...
function btn_Print() {
    ...
    window.open("/dcs/dmbo618.do?goTo=print"+parameters,"OZREPORT", 1000, 700);
}
 ...
 *************************************************************************/
 ...
 function doClick(row){
     ...
     TR_DETAIL.Action  = "/dcs/dmbo618.do?goTo="+goTo+parameters;  
			...
			<tr>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<th width="100">가입권유 브랜드</th>
						<td colspan="3">
							<comment id="_NSID_">
		                	<object id=EM_O_PUMBUN_CD classid=<%=Util.CLSID_EMEDIT%> width=55 tabindex=1  align="absmiddle">
		                	</object></comment><script> _ws_(_NSID_);</script>
			                <img src="/<%=dir%>/imgs/btn/detail_search_s.gif" id=IMG_PUMBUN_CD class="PR03" onclick="javascript:setPumbunCdCombo('POP'); EM_O_PUMBUN_CD.Focus();"  align="absmiddle" />
			                <comment id="_NSID_">
