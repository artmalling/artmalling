<!-- 
/*******************************************************************************
 * 시스템명 : 경영지원 > 고객관리 > 포인트운영 > 영수증사후적립(일괄)
 * 작 성 일 : 2016.12.01
 * 작 성 자 : 윤지영
 * 수 정 자 : 
 * 파 일 명 : dmbo6420.jsp
 * 버    전 : 1.0 (버전은 1.0부터 시작하며 0.1씩 증가)
 * 개    요 : 영수증 일괄 사후 적립 처리한다.
 * 이    력 :
 *        2016.12.01 (윤지영) 신규작성 
 ******************************************************************************/
--> 
 ...
 */ 
 function gridCreate1() {  
    var hdrProperies = '<FC>id={currow}        name="NO"         width=30   	align=center  </FC>'  
                     ...
                     + '<FC>id=SALE_TOT_AMT    name="총매출액"      width=110  	align=right   SumText=@sum</FC>'
                     ;
 ...
 */
 function btn_Search(){
	...
	TR_CUST.Action   = "/dcs/dmbo642.do?goTo=searchCust"+ parameters;  
...
function btn_Save() {   
    ...
    var goTo = "save";
    TR_SAVE.Action  ="/dcs/dmbo642.do?goTo="+goTo;
    TR_SAVE.KeyValue="SERVLET(I:DS_O_CUSTDETAIL=DS_O_CUSTDETAIL,I:DS_IO_MASTER=DS_IO_MASTER,I:DS_IO_DETAIL=DS_IO_DETAIL)";
    TR_SAVE.Post();   
}
 ...
 *************************************************************************/
 ...
 function getRecpInfo(){ 
	...
	if(!checkValidation("Search_RecpInfo"))    
 	...
 	TR_MASTER.Action   = "/dcs/dmbo642.do?goTo=searchMaster"+parameters;   
 ...
 function getRecpInfo_dtl(){ 
    ...
    // 영수증번호[24] => (매출일자(8)+000+점코드(2)+POS번호(4)+거래번호(5)+매출구분(1)+"0")
 	...
 	TR_MAIN.Action   = "/dcs/dmbo642.do?goTo=searchDetail"+parameters;   
