 ...
 */
 ...
 function doInit(){
    ...
    registerUsingDataset("dvoc011","DS_IO_MASTER");
 }
 ...
 */
 function btn_Search() {
    ...
    TR_MAIN.Action  = "/dcs/dvoc011.dv?goTo=searchMaster"+parameters;  
 ...
 */
 function btn_Delete() {
     ...
     if(showMessage(QUESTION, YESNO, "USER-1023") == 1){
         ...
         DS_IO_MASTER.DeleteRow(DS_IO_MASTER.RowPosition); 
         TR_SAVE.Action="/dcs/dvoc011.dv?goTo=save"+params;  
 ...
 */
 ...
 function getVocPop() { 
	...
	if(DS_IO_MASTER.CountRow >= 1) { 
		...
		var returnVal = window.showModalDialog(//"/dcs/dvoc011.dv?goTo=getVocPop",
						"/dcs/jsp/dvoc/dvoc0111.jsp?",
						arrArg,
 ...
 */
 ...
 function sendMail() {
	 ...
	 var goTo       	= "sendMail";						// Action 명 
	 var strSendUser 	= "artmalling@artmalling.com";		// 발신자메일주소
	 var strToUser		= "junnyeo@gmail.com";				// 수신자(고객) 메일 주소
	 var strTitle		= "[아트몰링] 답변등록";								// 메일 제목
	 var strContent		= "내용 별거 없음.";								// 내용
	
	 document.frmSendMail.action 				= "/dcs/dvoc011.dv?";
	 document.frmSendMail.goTo.value 			= goTo;
	 document.frmSendMail.strSendUser.value 	= strSendUser;
	 document.frmSendMail.strToUser.value 		= strToUser;
	 document.frmSendMail.strTitle.value 		= strTitle;
	 document.frmSendMail.strContent.value 		= strContent;
...
<!-- 바코드 생성 호출용 폼 -->
<form name="frmSendMail" target="frmHidden">
	<input type="hidden" name="goTo">
	<input type="hidden" name="strSendUser">
	<input type="hidden" name="strToUser">
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td width="140"><comment id="_NSID_"> <object
							...
							width=120 tabindex=1> </object> </comment> <script> _ws_(_NSID_);</script>
