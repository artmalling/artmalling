<!-- 
/*******************************************************************************
 * 시스템명 : 영업지원 > 고객관리 > 회원관리 > 브랜드별회원가입현황조회
 * 작 성 일 : 2012.05.23
 * 작 성 자 : 강진
 * 수 정 자 : 
 * 파 일 명 : dctm4250.jsp
 ...
 */
 ...
 function gridCreate1(){
     var hdrProperies = '<C>id={currow}    			name="NO"				width=30    Edit=none  align=center</C>'
                	  ...
                	  + '<C>id=MEM_CNT				name="카드총발급수"    	width=100   Edit=none  align=right</C>'
                	  + '<C>id=DUP_CNT				name="카드중복발급수"    	width=100   Edit=none  align=right</C>'
                	  + '<C>id=ORI_CNT				name="순가입회원수"    	width=100   Edit=none  align=right</C>'
                	  ;                     
 ...
 */
 function btn_Search() {
	    ...
	    TR_MAIN.Action  = "/dcs/dctm425.dm?goTo="+goTo+parameters;  
...
function btn_Excel() {
	...
	var parameters = "";
		parameters  = "조회구분="+strStrCd                    
			    	...
			    	+ " -브랜드="+ strGbFlag
			    	;
	openExcel2(GR_MASTER, "브랜드별회원가입현황조회", parameters, true );
}
