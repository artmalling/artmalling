<!-- 
/*******************************************************************************
 * 시스템명 : 포인트카드 > 회원관리 > 이력조회 > 생년월변경이력조회 
 * 작 성 일 : 2010.03.21
 * 작 성 자 : 장형욱
 * 수 정 자 : 
 * 파 일 명 : dctm4130.jsp
...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}     name="NO"            width=30    align=center</FC>'
                     ...
                     + '<FC>id=BF_SS_NO     name="변경전 생년월일"  width=120    align=center mask="XXXXXX"</FC>'
                     + '<FC>id=AFT_SS_NO    name="변경후 생년월일"  width=120    align=center mask="XXXXXX"</FC>'
...
function btn_Search() {
    ...
    TR_MAIN.Action  = "/dcs/dctm413.dm?goTo="+goTo+parameters;  
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr valign="top">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			class="BD4A">
			<tr>
				<td><object id=GD_MASTER width="100%" height=358
