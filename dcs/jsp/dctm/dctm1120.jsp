...
// 	initEmEdit(EM_SUM_POINT,   "NUMBER^9^0", READ);       //누적+발생포인트
	...
	registerUsingDataset("dctm112","DS_O_MASTER,DS_IO_DETAIL");
}

function gridCreate1(){
	var hdrProperies = '<FC>id={currow}        name="NO"            width=30    align=center</FC>'
					 + '<FC>id=MEMO_DATE       name="메모일시"      width=150   align=center  mask="XXXX/XX/XX XX:XX:XX"</FC>'
...
function showMaster(){
	...
	TR_MAIN.Action  ="/dcs/dctm112.dm?goTo="+goTo+parameters;
...
function doClick(row){
	...
	TR_DETAIL.Action  = "/dcs/dctm112.dm?goTo="+goTo+parameters;
...
function saveData(){
	...
	var goTo        = "save";
	var action      = "I";  //조회는 O
	TR_MAIN.Action  ="/dcs/dctm112.dm?goTo="+goTo;
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				<td><comment id="_NSID_"> <object id=GR_MASTER
					width="100%" height=274 classid=<%=Util.CLSID_GRID%> tabindex=1>
