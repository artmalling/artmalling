<!-- 
/*******************************************************************************
 * 시스템명 : 포인트카드 > 회원관리 > 이력조회 > 회원명변경이력 조회
 * 작 성 일 : 2010.03.21
 * 작 성 자 : 장형욱
 * 수 정 자 : 
 * 파 일 명 : dctm4120.jsp
...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}     name="NO"            width=30    align=center</FC>'
                     ...
                     + '<FC>id=BF_CUST_NM   name="변경전 회원명"    width=120   align=left</FC>'
                     + '<FC>id=AFT_CUST_NM  name="변경후 회원명"    width=120   align=left</FC>'
...
function btn_Search() {
    ...
    TR_MAIN.Action  = "/dcs/dctm412.dm?goTo="+goTo+parameters;  
