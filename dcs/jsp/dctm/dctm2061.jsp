...
function doInit(){
    ...
    initEmEdit(EM_PRE_SS_NO, "#00-00-00000", NORMAL);                   
    initEmEdit(EM_AFT_SS_NO, "#00-00-00000", PK);
...
function editSsno()
{
    ...
    if(EM_AFT_SS_NO.text.indexOf("B")==-1){
        chk = isSaupNO(EM_AFT_SS_NO.text);
    }
    if(chk==false){
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="396" class="title"><img
							...
							align="absmiddle" class="popR05 PL03" /> 사업자번호 수정</td>
						<td>
