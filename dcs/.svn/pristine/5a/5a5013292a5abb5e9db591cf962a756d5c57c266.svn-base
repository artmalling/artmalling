<!-- 
/*******************************************************************************
 * 시스템명 : 포인트카드 > 멤버쉽운영 > 승인처리 > OK캐쉬백 상품권교환 집계표
 * 작  성  일  : 2010.01.14
 * 작  성  자  : 김영진
 * 수  정  자  : 
 * 파  일  명  : dmbo6400.jsp
...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}         name="NO"              width=30      align=center</FC>'
                     ...
                     + '<FC>id=ERR_GIFT_AMT     name="상품권금액(처리)"       width=113     align=right SumText=@sum </FC>'
...
function btn_Print() {
    ...
    window.open("/dcs/dmbo640.do?goTo=print"+parameters,"OZREPORT", 1000, 700);
    */
}
...
function showMaster(){
    ...
    TR_MAIN.Action  ="/dcs/dmbo640.do?goTo="+goTo+parameters;  
