  ...
  function window_close(args){
    if ((DEBUG || strErrorType == "SERVER" || strMsgCode == "SCRIPT-1001") && args == 2){
     ...
     // 데이타셋 셋팅.
        ...
        //
        //TR_MAIN.Action="/dcs/tcom007.tc?goTo=sendSuggestEmail";
              ...
              <tr valign="middle">
                <td height="25" align="center" valign="middle">
                  <table width="100%" heigth="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td align="center">
                        <img id=BUTTON_ONE src='/dcs/imgs/bg/blank.gif' onClick="window_close(1);" style=" margin-top:4px;">
                        <img id=BUTTON_TWO src='/dcs/imgs/bg/blank.gif' onClick="window_close(2);" style=" margin-top:4px;">
                        <img id=BUTTON_THREE src='/dcs/imgs/bg/blank.gif' onClick="window_close(3);" style=" margin-top:4px;">
                      </td>
                    </tr>
                  </table>
                </td>
...
<script language="JavaScript">
  switch (strIcon.toUpperCase()){
    case INFORMATION :
      ...
      ICON.src = '/dcs/imgs/comm/ms02.gif';
      break;
    case STOPSIGN :
      strHeader = strHeader + "에러";       
      ICON.src = '/dcs/imgs/comm/ms04.gif';
      break;
    case EXCLAMATION :
      strHeader = strHeader + "확인";       
      ICON.src = '/dcs/imgs/comm/ms03.gif';
      break;
    case QUESTION :
      strHeader = strHeader + "질문";       
      ICON.src = '/dcs/imgs/comm/ms01.gif';
      break;
    case NONE :
      strHeader = strHeader + "";     
      IICON.src = '';
  ...
  switch(strButton){
    case OK :
      BUTTON_ONE.src = '/dcs/imgs/btn/confirm.gif';
      break;
    case OKCANCEL :
      BUTTON_ONE.src = '/dcs/imgs/btn/confirm.gif';
      BUTTON_TWO.src = '/dcs/imgs/btn/cancel.gif';
      break;
    case YESNO : 
      BUTTON_ONE.src = '/dcs/imgs/btn/yes.gif';
      BUTTON_TWO.src = '/dcs/imgs/btn/no.gif';
      break;
    case YESNOCANCEL :
      BUTTON_ONE.src = '/dcs/imgs/btn/yes.gif';
      BUTTON_TWO.src = '/dcs/imgs/btn/no.gif';
      BUTTON_THREE.src = '/dcs/imgs/btn/cancel.gif';
      break;
    case RETRYCANCEL :
      BUTTON_ONE.src = '/dcs/imgs/btn/btn_retry.gif';
      BUTTON_TWO.src = '/dcs/imgs/btn/cancel.gif';
      break;
    case ABORTRETRYIGNORE :
      BUTTON_ONE.src = '/dcs/imgs/btn/btn_abort.gif';
      BUTTON_TWO.src = '/dcs/imgs/btn/btn_retry.gif';
      BUTTON_THREE.src = '/dcs/imgs/btn/cancel.gif';
      break;
    default :
       break;
  ...
  if (DEBUG || strErrorType == "SERVER" || strMsgCode == "SCRIPT-1001"){
    ...
    BUTTON_TWO.src = '/dcs/imgs/btn/btn_err_send.gif';
  }
