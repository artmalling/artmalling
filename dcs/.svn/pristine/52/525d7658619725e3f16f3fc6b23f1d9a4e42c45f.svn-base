...
function doInit(){
    ...
    registerUsingDataset("dmbo631","DS_O_MASTER,DS_IO_DETAIL"); 
}
...
function gridCreate1(){      
    var hdrProperies = '<FC>id={currow}        		name="NO"            		width=30    align=center</FC>'
                     ...
                     + '<FC>id=CONV_POINT			name="교환포인트"			width=100   align=right</FC>'
                     + '<FC>id=CONV_GIFT_AMT  		name="교환상품권금액"  		width=100   align=right</FC>'
...
function showMaster(){
    ...
    TR_MAIN.Action  = "/dcs/dmbo631.do?goTo="+goTo+parameters;  
...
function showDetail(){
    ...
    TR_DETAIL.Action  = "/dcs/dmbo631.do?goTo="+goTo+parameters;  
...
function saveDetail(){
    ...
    TR_MAIN.Action  ="/dcs/dmbo631.do?goTo="+goTo;   
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
            ...
            <tr>
                <th width="100" class="point">교환포인트</th>
