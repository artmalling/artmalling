<!-- 
/*******************************************************************************
 * 시스템명 : 포인트카드 > 멤버쉽운영 > 승인처리 > OK캐쉬백 상품권 교환 현황표 출력
 * 작  성  일  : 2010.04.25
 * 작  성  자  : 김영진
 * 수  정  자  : 
 * 파  일  명  : dmbo6391.jsp
...
<%
    ...
    String reportname = "OK캐쉬백 상품권 교환 현황표";
    ...
    url = url + "/dcs/dmbo639.do?goTo=httpstore&strBrchId="+strBrchId+"&strProcSDt="+strProcSDt+"&strProcEDt="+strProcEDt;
