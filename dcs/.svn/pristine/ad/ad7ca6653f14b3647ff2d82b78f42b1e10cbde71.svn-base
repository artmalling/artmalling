...
<link rel="stylesheet" fhref="/dcs/css/mds.css" type="text/css"> 
...
*/
    ...
    document.myForm.action = '/dcs/tcom001.tc?goTo=login';
...
<TR>
    ...
    <TR>
        ...
        <a href="javascript:chk()">
            <IMG SRC="/dcs/imgs/comm/login_08_temp.jpg" WIDTH="61" HEIGHT="45" BORDER=0 ALT="" tabindex="3" 
                      onmouseover="this.src='../imgs/comm/login_08on_temp.jpg'" 
                      onmouseout="this.src='../imgs/comm/login_08_temp.jpg'" style="cursor:hand" ></a>
        </TD>
    </TR>
    <TR>
        <TD><IMG SRC="/dcs/imgs/comm/login_07_temp.jpg" WIDTH="56" HEIGHT="19" BORDER=0 ALT=""></TD>
