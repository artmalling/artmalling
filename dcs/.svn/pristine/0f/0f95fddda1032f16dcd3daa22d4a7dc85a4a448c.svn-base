				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="396" class="title"><img
							...
							align="absmiddle" class="popR05 PL03" /> 회원명 수정</td>
						<td>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0"
							class="s_table">
							<tr>
								<th width="100">변경전 회원명</th>
								<td><comment id="_NSID_"> <object
									id=EM_PRE_CUST_NAME classid=<%=Util.CLSID_EMEDIT%> width=380
									tabindex=1 align="absmiddle"> </object> </comment> <script> _ws_(_NSID_);</script>
								</td>
							</tr>
							<tr>
								<th width="100" class="point">변경후 회원명</th>
								<td><comment id="_NSID_"> <object
									id=EM_AFT_CUST_NAME classid=<%=Util.CLSID_EMEDIT%> width=380
									tabindex=1
