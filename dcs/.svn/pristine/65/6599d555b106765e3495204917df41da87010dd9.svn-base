...
//     initEmEdit(EM_SUM_POINT,   "NUMBER^9^0",          READ);       //누적+발생포인트
    ...
    registerUsingDataset("dctm210","DS_IO_MASTER");
...
function btn_Search() {
    ...
    TR_MAIN.Action  = "/dcs/dctm210.dm?goTo="+goTo+parameters;  
...
function btn_Save() {
    ...
    var goTo        = "saveData";
    var action      = "I";  //조회는 O
    TR_MAIN.Action  ="/dcs/dctm210.dm?goTo="+goTo;   
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr valign="top">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0"
            class="BD4A">
            <tr>
                <td><object id=GD_MASTER width="100%" height=650
