...
function btn_Save() {
    ...
    var goTo = "saveData";
    TR_SAVE.Action  ="/dcs/dmbo602.do?goTo="+goTo;
...
function showMaster(){
    ...
    /*
    alert("EM_Q_BRCH_ID.Text.substring===="+EM_Q_BRCH_ID.Text.substring(2,3));
    alert("EM_Q_RECP_NO.Text.substring===="+EM_Q_RECP_NO.Text.substring(7,8));
    */
    /*
    if ( EM_Q_BRCH_ID.Text.substring(2,3) != EM_Q_RECP_NO.Text.substring(7,8) ) {
    ...
    */
    ...
    TR_MASTER.Action   = "/dcs/dmbo602.do?goTo=" + goTo + parameters;  
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<img id="IMG_BRCH" src="/<%=dir%>/imgs/btn/detail_search_s.gif"
							...
							<comment 	id="_NSID_"> <object id=EM_Q_BRCH_NAME
							classid=<%=Util.CLSID_EMEDIT%> width=70 tabindex=1
							align="absmiddle"></object> </comment><script> _ws_(_NSID_);</script></td>
						<th width="80" class="point">영수증번호</th>
						<td><comment id="_NSID_"> <object id=EM_Q_RECP_NO
							classid=<%=Util.CLSID_EMEDIT%> width=172 tabindex=1></object> </comment> <script> _ws_(_NSID_);</script>
						</td>
					</tr>
					<tr>
						<th width="57">카드번호</th>
						<td width="170"><comment id="_NSID_"> <object
							...
							<script> _ws_(_NSID_);</script><comment id="_NSID_"> <object
							id=EM_CARD_NO_S classid=<%=Util.CLSID_EMEDIT%> width="105"
							tabindex=1 align="absmiddle"></object> </comment> <script> _ws_(_NSID_);</script>
						</td>
