<!-- 
/*******************************************************************************
 * 시스템명 : 고객관리 > 가맹점관리 > 회원 연령별성별 매출 현황(년)
 * 작  성  일  : 2012.05.30
 * 작  성  자  : kj
 * 수  정  자  : 
 * 파  일  명  : dbri3100.jsp
...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}      	name="NO"             	width=30    align=center SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}</FC>'
        + '<FC>id=YYYYMM  		name="년"				width=60    align=center mask="XXXX" SubSumText={decode(curlevel,1,"년 소계","")} suppress=2 SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}</FC>'
        + '<FC>id=AGE_NM  		name="년령대"				width=80    align=center suppress=1 SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}</FC>'
        + '<FC>id=SEX_NM  		name="성별"				width=60    align=center SubSumText="" SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}</FC>'
        + '<FC>id=SALE_AMT      name="매출"       		width=120   align=right sumtext={subsum(SALE_AMT)} SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}</FC>'
        + '<FC>id=SEX_RATE     	name="성별/년령대;구성비"  width=80    align=right SubSumText="" SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}</FC>'
        + '<FC>id=RATE    		name="성별/총매출;구성비"	width=80    align=right SubSumText="" SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}</FC>'
        + '<FC>id=PRE_SALE_AMT  name="전년매출"   		width=120   align=right sumtext={subsum(PRE_SALE_AMT)} SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}</FC>'
        ...
        + '<FC>id=ADD_SALE_RATE name="매출;증감율"  		width=60    align=right SubSumText="" SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}</FC>'
	...
	DS_MASTER.SubSumExpr  = "1:YYYYMM" ; 
	GR_MASTER.ColumnProp("YYYYMM", "sumtext")        = "합계";
...
function btn_Excel() {
    ...
    var ExcelTitle = "회원 연령별성별 매출 현황(년)"
...
function showMaster(){
    ...
    TR_MAIN.Action  ="/dcs/dbri310.db?goTo="+goTo+parameters;  
