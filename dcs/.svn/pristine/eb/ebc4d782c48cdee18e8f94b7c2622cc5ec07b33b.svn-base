 ...
 * <p>dClientRest</p>
 * 
 * 1. Parameter array should have length of 20
...
public class dClientRest {
	...
	public String[] sendData ( String[] inputArr ) throws Exception {
        ...
        int serverPort  = Integer.parseInt(BaseProperty.get("dServerRestPort")) ;
		...
		String[] outputArr = new String[20];	
		String outputStr   = null; 
		
		try 
		{
		    if (null != inputArr && inputArr.length == 20) 
		    {
	...
	public String[] PR_DMBO504_OUT ( String outputStr ) throws Exception {
        ...
        outputArr[5]  = outputStr.substring( 34,  54); //RECP_NO         C   20
        outputArr[6]  = outputStr.substring( 54,  64); //REG_ID          C   10
        outputArr[7]  = outputStr.substring( 64, 128); //CARD_ND         C   64
        outputArr[8]  = outputStr.substring(128, 168); //PASSWD          C   40
        outputArr[9]  = outputStr.substring(168, 178); //BRCH_ID         C   10
