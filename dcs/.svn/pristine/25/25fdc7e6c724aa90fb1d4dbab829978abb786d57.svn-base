...
function gridCreate1(){
     var hdrProperies = '<FC>id={currow}      	name="NO"           width=30    align=center</FC>'
                      ...
                      + '<FC>id=SALE_CNT_CUST   name="구매건수"   	width=80    align=right  SumText={subsum(SALE_CNT_CUST)} SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")} </FC>'
                      + '<FC>id=SALE_CUST     	name="구매회원수"   	width=80    align=right  SumText={subsum(SALE_CUST)} 	SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")} </FC>'
                      + '</FG>'
...
function showMaster(){
	...
	//ALERT(parameters);
    TR_MAIN.Action  ="/dcs/dbri321.db?goTo="+goTo+parameters;  
