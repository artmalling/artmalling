<!-- 
/*******************************************************************************
 * 시스템명 : 고객관리 > 가맹점관리 > 지역별 회원 매출 현황(일)
 * 작  성  일  : 2012.05.30
 * 작  성  자  : kj
 * 수  정  자  : 
 * 파  일  명  : dbri3120.jsp
...
function gridCreate1(){
     var hdrProperies = '<FC>id={currow}      	name="NO"           width=30    align=center</FC>'
                      ...
                      + '<FC>id=SALE_AMT    	name="매출액"		width=100   align=right sumtext={subsum(SALE_AMT)} 	SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}</FC>'
                      ...
                      + '<FC>id=PRE_SAEL_AMT   	name="매출액"   	width=100   align=right sumtext={subsum(PRE_SAEL_AMT)} SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}</FC>'
                      + '<FC>id=PRE_SALE_RATE  	name="구성비"   	width=100   align=right SubSumText="" </FC>'
                      + '</FG>' 
                      + '<FC>id=ADD_SAEL_AMT   	name="매출;증감액"	width=100   align=right sumtext={subsum(ADD_SAEL_AMT)} SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}</FC>'
                      + '<FC>id=ADD_SAEL_RATE   name="매출;증감율"  	width=80    align=right SubSumText="" 					SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}</FC>'
    ...
    DS_MASTER.SubSumExpr  = "1:BUSI_AREA" ; 
...
function showMaster(){
    ...
    TR_MAIN.Action  ="/dcs/dbri312.db?goTo="+goTo+parameters;  
