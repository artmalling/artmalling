...
function showMaster(){
    ...
    var parameters  = "&strFromSDate="+ encodeURIComponent(EM_FROM_S_DT.Text);
	    ...
	    parameters +=	(document.getElementById("CHK_SMS_Y").checked == true)? "Y":"N";
	    parameters +=	"&strChkSmsN=";
	    parameters +=	(document.getElementById("CHK_SMS_N").checked == true)? "N":"Y";
	    parameters +=	"&strPumbunCd=" + encodeURIComponent(EM_O_PUMBUN_CD.Text);
