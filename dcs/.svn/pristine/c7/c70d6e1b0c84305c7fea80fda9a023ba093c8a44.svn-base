...
public class DCtm133DAO extends AbstractDAO {
	/*
	 * Java Pattern 에서 지원하는 logger를 사용할 수 있도록 객체를 선언
	 */
	private Logger logger = Logger.getLogger(DCtm133DAO.class);
...
//		String strToDt = String2.nvl(form.getParam("strToDt"));
        ...
        String strFromDt 	= dSet.getDataRow(0).getColumnValue(2).toString(); 
        String strToDt 		= dSet.getDataRow(0).getColumnValue(3).toString(); 
