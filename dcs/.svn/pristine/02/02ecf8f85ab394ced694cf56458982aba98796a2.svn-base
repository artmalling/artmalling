...
<%
    ...
    String reportname = "회원매출현황(브랜드 상호간)";
    ...
    String strPumbun 	= String2.trimToEmpty(request.getParameter("strPumbun"));
    ...
    String[][] params  = new String[][]{
        {"STR_CD=" + strStrCd, "SALE_S_DT=" + strFromDate, "SALE_E_DT=" + strToDate, "PUMBUN_CD=" + strPumbun, "DEPT_CD=" + strDeptCd, "TEAM_CD=" + strTeamCd, "PC_CD=" + strPcCd}
    };
