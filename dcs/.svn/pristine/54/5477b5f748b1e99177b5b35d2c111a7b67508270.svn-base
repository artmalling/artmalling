<!-- 
 * 시스템명 : 포인트카드 > 회원관리 > 이력조회 > 회원가입브랜드 조회
 * 작 성 일 : 2012.05.22
 * 작 성 자 : kj
 * 수 정 자 : 
 * 파 일 명 : dctm4230.jsp
...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}            name="NO"             width=40     align=center</FC>'
			         + '<FC>id=ENTR_PBN        	   name="가입경로 브랜드"  width=100     align=center</FC>'
			         + '<FC>id=ENTR_PBN_NAME       name="브랜드명"        width=100    align=center</FC>'
                     + '<FC>id=ENTR_PATH_CD        name="가입경로코드"    width=82     align=center</FC>'
                     ...
                     + '<FC>id=ENTR_DT             name="가입일자"        width=85     align=center mask="XXXX/XX/XX"</FC>'
                     + '<FC>id=HOME_PH1            name="자택전화"        width=100    align=left </FC>'
                     + '<FC>id=OFFI_PH1            name="회사전화"        width=100    align=left </FC>'
                     + '<FC>id=MOBILE_PH1          name="휴대전화"        width=100    align=left</FC>'
                     + '<FC>id=SMS_YN              name="SMS수신동의"     width=100    align=center</FC>'
                     + '<FC>id=POST_RCV_NM         name="우편물 수령처"    width=100    align=center</FC>'
                     + '<FC>id=OFFI_NM             name="직장명"          width=110    align=left</FC>'
                     + '<FC>id=EMAIL1              name="이메일주소"      width=170    align=left</FC>'
                     + '<FC>id=EMAIL_YN            name="이메일 수신동의"  width=100    align=center</FC>'
                     + '<FC>id=BIRTH_DT            name="생일"            width=85     align=center  mask="XXXX/XX/XX"</FC>'
                     + '<FC>id=LUNAR_NAME          name="생일구분 "        width=70     align=center</FC>'
                     + '<FC>id=MOD_DATE            name="등록일시"        width=140    align=center</FC>';
...
function btn_Search() {
    ...
    TR_MAIN.Action  = "/dcs/dctm423.dm?goTo="+goTo+parameters;  
