...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}       name="NO"        width=30   align=center  </FC>'
                     ...
                     + '<FC>id=CARD_TYPE_NM   name="카드종류"    width=100  align=left    Edit=none</FC>'
                     ...
                     + '<FC>id=POINT          name="누적포인트 "  width=90   align=right   show=false Edit=none</FC>'
                     + '<FC>id=REASON_CD      name="*탈퇴사유"   width=90   align=left    show=false EDITSTYLE=LOOKUP   DATA="DS_REASON_S:CODE:NAME"</FC>'    
...
function btn_Search() {
    ...
    TR_MAIN.Action  = "/dcs/dctm108.dm?goTo="+goTo+parameters;  
...
function btn_Save() {
    ...
    var goTo        = "saveData";
    var action      = "I";  //조회는 O
    TR_MAIN.Action  ="/dcs/dctm108.dm?goTo="+goTo;   
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr valign="top">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			class="BD4A">
			<tr>
				<td><object id=GD_MASTER width="100%" height=316 
