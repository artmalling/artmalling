<!-- 
/*******************************************************************************
 * 시스템명 : 포인트카드 > 포인트정산 > 월별 적립수수료 정산내역
 * 작 성 일 : 2010.05.04
 * 작 성 자 : 장형욱
 * 수 정 자 : 
 * 파 일 명 : dmtc601.jsp
...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}      name="NO"          width=30     align=center</FC>'
                     + '<FC>id=BRCH_NAME     name="가맹점명"      width=196    align=left</FC>'
                     + '<FC>id=FINC_CD       name="회계단위"      width=100    align=left</FC>'
                     + '<FC>id=SUM_YM        name="년월"         width=70     align=center mask="XXXX/XX"</FC>'
                     + '<FC>id=ADD_POINT     name="적립액"        width="100"  align=right</FC>'
                     + '<FC>id=ADD_FEE_AMT   name="적립수수료"     width="100"  align=right</FC>'
                     + '<FC>id=CURR_POINT    name="적립잔액"       width="90"  align=right</FC>'
...
function btn_Search() {
    ...
    TR_MAIN.Action  = "/dcs/dmtc601.dc?goTo="+goTo+parameters;  
