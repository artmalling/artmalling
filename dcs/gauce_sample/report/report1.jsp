...
<%	
	...
	try{
		...
		dSet1.addDataColumn(new GauceDataColumn("year",GauceDataColumn.TB_STRING , 20));
		dSet1.addDataColumn(new GauceDataColumn("amt1",GauceDataColumn.TB_INT , 20));
		dSet1.addDataColumn(new GauceDataColumn("amt2",GauceDataColumn.TB_INT , 20));
		int count = 500;
