...
function doInit(){
    ...
    registerUsingDataset("pcod305","DS_IO_DETAIL, DS_IO_MASTER" );
}
...
function gridCreate2(){
    ...
    var hdrProperies = '<FC>id={currow}       name="NO"         width=30   align=center</FC>'
                     ...
                     + '<FC>id=ORG_STR_CD     name="ORG_STR_CD"       width=82   align=center     edit=none </FC>'
                     + '<FC>id=ORG_PUMBUN_CD  name="ORG_PUMBUN_CD"    width=82   align=center     edit=none </FC>'
                     + '<FC>id=ORG_PUMMOK_CD  name="ORG_PUMMOK_CD"    width=82   align=center     edit=none </FC>'
                     + '<FC>id=ORG_EVENT_FLAG name="ORG_EVENT_FLAG"   width=82   align=center     edit=none </FC>'
                     + '<FC>id=ORG_EVENT_RATE name="ORG_EVENT_RATE"   width=82   align=center     edit=none </FC>'
                     + '<FC>id=ORG_EVENT_CD   name="ORG_EVENT_CD"     width=82   align=center     edit=none </FC>'
                     + '<FC>id=ORG_APP_S_DT   name="ORG_APP_S_DT"     width=82   align=center     edit=none </FC>';
...
function btn_Save() {
    ...
    TR_MAIN.Action="/dps/pcod305.pc?goTo=save"+parameters;
 ...
 */
 function searchMaster(){
    ...
    TR_MAIN.Action="/dps/pcod305.pc?goTo="+goTo+parameters;  
 ...
 */
 function searchDetail(){
     ...
     TR_DETAIL.Action="/dps/pcod305.pc?goTo="+goTo+parameters;  
 ...
 */
 function searchDetail2(){
     ...
     TR_DETAIL2.Action="/dps/pcod305.pc?goTo="+goTo+parameters;  
...
function searchMgInfo(vMgFlag){
	...
	TR_SEARCH.Action   = "/dps/pcod305.pc?goTo=" + goTo + parameters;
...
function searchPumbunCheck(vPumbunCd){
	...
	TR_SEARCH2.Action   = "/dps/pcod305.pc?goTo=" + goTo + parameters;
