...
import common.edi.service.Psal931EDI;
...
public class PSal931DAO extends AbstractDAO {
	/*
	 * Java Pattern 에서 지원하는 logger를 사용할 수 있도록 객체를 선언
	 */
	private Logger logger = Logger.getLogger(PSal931DAO.class);
...
//				List<List<String>> hList = select2List(sql); 
	...
	public int sendData(ActionForm form, HttpServletRequest request) throws Exception {
		...
		String strSendSeq 	= String2.nvl(form.getParam("strSendSeq"));
		int iSendSeq = Integer.parseInt(strSendSeq); 
...
*/
    		...
    		if (sendResult != 0) {    		
    			System.out.println("Psal931:sendResult : " + sendResult);
    			System.out.println("Psal931:sendMessage : " + sendMessage);
...
//		};
		...
		int result = 0;
		try {
			Psal931EDI esvc = new Psal931EDI();
