...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}   name="NO"          width=30     align=center</FC>'
                     + '<FC>id=APPR_DT    name="승인일자"     width=100      align=center mask="XXXX/XX/XX" SumText= "합계"</FC>'
                     + '<FC>id=BCOMP_NM   name="카드매입사"    width=120     align=left</FC>'
                     ...
                     + '<FC>id=PAY_TYPE   name="결제수단"      width=60     align=center</FC>'
                     + '<FC>id=PAY_TYPE_NM   name="결제수단명"  width=100    align=center </FC>'
...
function gridCreate2(){
    var hdrProperies = '<FC>id={currow}   name="NO"           width=30  align=center </FC>'
                     + '<FC>id=RECP_NO    name="POS영수증번호"  width=180  align=center mask="X-XXXXXX-XXXX-XXXXX" SumText= "합계"</FC>'
...
function btn_Search() {  
    ...
    TR_MAIN.Action  = "/dps/psal954.ps?goTo="+goTo+parameters;  
 ...
 *************************************************************************/
 ...
 function doClick(row){
     ...
     var strPayType   = DS_O_MASTER.NameValue(row ,"PAY_TYPE");
     ...
     TR_DETAIL.Action  = "/dps/psal954.ps?goTo="+goTo+parameters;  
