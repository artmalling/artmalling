...
function doInit(){
    ...
    initEmEdit(EM_O_PUMBUN_CD_1, "CODE^6^0", PK);  //복사 브랜드코드(조회)
    initEmEdit(EM_O_PUMBUN_NM_1, "GEN^40", READ);  //복사 브랜드명(조회)
    ...
    registerUsingDataset("pcod610","DS_MASTER" );
...
function btn_Search() {
    ...
    var action         = "O";
    TR_SEARCH.Action   = "/dps/pcod610.pc?goTo="+goTo+"&strSkuType="+lo_SkuType;  
...
function btn_Save() {
    ...
    var parameters = "&strPumbunCd="+encodeURIComponent(EM_O_PUMBUN_CD.Text)+"&strPumbunCd_1="+encodeURIComponent(EM_O_PUMBUN_CD_1.Text);
   
    TR_SAVE.Action="/dps/pcod610.pc?goTo=save"+parameters;
...
function setPumbunCdCombo_1(evnflag){
	
    var codeObj     = EM_O_PUMBUN_CD_1;
    var nameObj     = EM_O_PUMBUN_NM_1;
    var strCd       = LC_O_STR_CD.BindColVal;
...
function getSingeSkuInfo(row,colid){
    ...
    var parameters = "&strStoreCd="  + DS_MASTER.NameValue(row, "STR_CD") //점코드
                   ...
                   ;
    DS_O_SKU_PRC_INFO.DataID = "/dps/pcod610.pc?goTo="+goTo+parameters;
...
<script language=JavaScript for=EM_O_PUMBUN_CD_1 event=onKillFocus()>
    //변경된 내역이 없으면 무시
    if(!this.Modified)
        return;

    setPumbunCdCombo_1("NAME");
</script>
      ...
      <tr>
        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table">
          <tr>
            ...
            <th width="80" class="point">복사브랜드</th>
            <td width="165">
              <comment id="_NSID_">
            ...
            <td >
             ...
             &nbsp&nbsp 생성브랜드<comment id="_NSID_">
                <object id=EM_O_PUMBUN_CD_1 classid=<%=Util.CLSID_EMEDIT%> width=55 tabindex=1 align="absmiddle">
                </object>
              </comment>
              <script> _ws_(_NSID_);</script>
              <img src="/<%=dir%>/imgs/btn/detail_search_s.gif"  class="PR03" onclick="javascript:setPumbunCdCombo_1('POP')"  align="absmiddle" />
              <comment id="_NSID_">
                <object id=EM_O_PUMBUN_NM_1 classid=<%=Util.CLSID_EMEDIT%> width=79  align="absmiddle">
                </object>
              </comment>
              <script> _ws_(_NSID_);</script>
...
<object id=BO_COND classid=<%= Util.CLSID_BIND %>>
    ...
    <param name=BindInfo
        value='            
            ...
            <c>col=PUMBUN_CD_1   ctrl=EM_O_PUMBUN_CD_1   param=Text </c>                         
