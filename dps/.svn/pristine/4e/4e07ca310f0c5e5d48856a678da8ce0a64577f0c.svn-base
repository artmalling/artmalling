...
var strCardCd     = dialogArguments[3];
...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}        width=30    align=right     name="NO"      </FC>'
    	             + '<FC>id=POS_NO          width=50    align=center    name="POS"     suppress="1"</FC>'
                     + '<FC>id=TRAN_NO         width=60    align=center    name="거래번호 " suppress="2"</FC>'
                     + '<FC>id=SEQ_NO          width=40    align=right     name="SEQ "    suppress="3"</FC>'
                     + '<FC>id=CARD_DATA       width=140   align=center    name="카드번호 " suppress="4"</FC>'
                     + '<FC>id=APPR_NO         width=90    align=center    name="승인번호 " </FC>'
                     + '<FC>id=SALE_AMT        width=100   align=right     name="금액 "    </FC>'
                     + '<FG>                                               name="브랜드"'
                     + '<FC>id=PUMBUN_CD       width=60    align=center    name="코드 "    suppress="5"</FC>'
                     + '<FC>id=PUMBUN_NAME     width=100   align=left      name="명 "      suppress="5"</FC>'
                     + '</FG>'
                     + '<FG>                                               name="단품"'
                     + '<FC>id=SKU_CD          width=100   align=center    name="코드 " </FC>'
                     + '<FC>id=SKU_NAME        width=110   align=left      name="명 "  </FC>'
                     + '</FG>'
                     ;
...
function searchDay(){    
    ...
    var parameters = "&strDt="+encodeURIComponent(strDt)
                   ...
                   + "&strCardCd="+encodeURIComponent(strCardCd)
                   ;
        ...
        <td class="PB03"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="" class="title">
              ...
              <span id="title1" class="PL03">카드매출 세부내역</span>
            </td>
          </tr>
        </table></td>
      </tr>
