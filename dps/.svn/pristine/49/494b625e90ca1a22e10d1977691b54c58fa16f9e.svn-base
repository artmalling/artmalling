...
<script LANGUAGE="JavaScript">
	...
	function doInit() {
		...
		initEmEdit(EM_SALE_DT_S, "THISYR", PK); //매출연도
		...
		registerUsingDataset("psal320", "DS_O_MASTER");
	...
	function gridCreate1() {
			...
			var	hdrProperies = '<FC>id={currow}				name="NO"			width=30	align=center	</FC>'
				 + '<FC>id=ORG_CD				name="관코드"			width=100	align=center	suppress=1	show=false</FC>'
				 + '<FC>id=ORG_NAME   			name="관명"			width=100	align=center		suppress=1	</FC>'
				 + '<FC>id=DIV					name="항목코드"		width=100	align=center	show=false</FC>'
				 + '<FC>id=DIV_NAME				name="항목"			width=80	align=center		</FC>'
				 + '<C>id=YYYY99				name="합계"			width=110	align=right		mask="#,###"</C>'
				 + '<C>id=YYYY01				name="1월"			width=110	align=right		</C>'
				 + '<C>id=YYYY02				name="2월"			width=110	align=right		</C>'
				 + '<C>id=YYYY03				name="3월"			width=110	align=right		</C>'
				 + '<C>id=YYYY04				name="4월"			width=110	align=right		</C>'
				 + '<C>id=YYYY05				name="5월"			width=110	align=right		</C>'
				 + '<C>id=YYYY06				name="6월"			width=110	align=right		</C>'
				 + '<C>id=YYYY07				name="7월"			width=110	align=right		</C>'
				 + '<C>id=YYYY08				name="8월"			width=110	align=right		</C>'
				 + '<C>id=YYYY09				name="9월"			width=110	align=right		</C>'
				 + '<C>id=YYYY10				name="10월"			width=110	align=right		</C>'
				 + '<C>id=YYYY11				name="11월"			width=110	align=right		</C>'
				 + '<C>id=YYYY12				name="12월"			width=110	align=right		</C>'
	...
	function btn_Excel() {
		...
		var strTitle = EM_SALE_DT_S.text + "년도 월별 매출실적";
		...
		var parameters = "기준년도 : " + strSaleDtS + " , " + " 단위 : " + EM_UNIT.TEXT;
	...
	function fn_sum(){
		GD_MASTER.ColumnProp('YYYY99','Value')='{decode(DIV_NAME,"이익율",0,"신장율",0,YYYY01+YYYY02+YYYY03+YYYY04+YYYY05+YYYY06+YYYY07+YYYY08+YYYY09+YYYY10+YYYY11+YYYY12)}';
	}
	...
	function search1(){
		...
		var YYYY = EM_SALE_DT_S.text; //시작년월
		var P_YYYY = YYYY - 1;
		...
		var action = "O";
		var parameters = "&YYYY="  + YYYY
					+ "&P_YYYY="     + P_YYYY
					+ "&strEmUnit="     + encodeURIComponent(strEmUnit)

		TR_MAIN.Action = "/dps/psal320.ps?goTo=" + goTo + parameters;
		...
		GD_MASTER.ColumnProp("DIV_NAME","align")="{decode(DIV_NAME,'총매출액','left','전년매출액','left','객수','left','객단가','left','right')}";
						...
						<tr>
							<td>
								<table width="100%" border="0" cellpadding="0" cellspacing="0"
									...
									<tr>
										<th class="point" width="70">기준연도</th>
