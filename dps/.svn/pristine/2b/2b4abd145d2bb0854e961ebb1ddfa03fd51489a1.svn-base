...
function doInit(){
    ...
    giftEnblCntl();                //상품권종류,상품권금종 사용여부 지정
    ...
    registerUsingDataset("pcod501","DS_MASTER,DS_DETAIL" );
...
function gridCreate2(){
    var hdrProperies = '<FC>id={currow}    name="NO"          width=30   align=center</FC>'
                     ...
                     + '<C>id=VEN_NAME     name="협력사명"      width=100 edit="none" align=left</C>'
                     ...
                     //+ '<C>id=SALE_MG_RATE name="*마진율"       width=70  edit="RealNumeric" edit={IF(BIZ_TYPE="1","false",IF(SKU_CD="","true","false"))}  align=right</C>'  //20131209	이성춘 직영이라도 100% 마진을 넣어줘야 집계시 이익율이 100%로 들어감 수정
...
function btn_Search() {
    ...
    bfMasterRow = 0;               
    TR_SUB.Action="/dps/pcod501.pc?goTo="+goTo+parameters;  
...
function btn_Save() {
    ...
    TR_MAIN.Action="/dps/pcod501.pc?goTo=save"+parameters;
...
function searchDetail(){
    ...
    TR_MAIN.Action="/dps/pcod501.pc?goTo="+goTo+parameters;  
...
function btn_send_skuprc_emg(){
	    ...
	    if( showMessage(QUESTION, YESNO, "USER-1204") == 1 ){
	    	...
	    	TR_MAIN.Action = "/dps/pcod501.pc?goTo=sendskuprcemg"+parameters;
...
<script language=JavaScript for=GD_DETAIL event=OnExit(row,colid,oldValue)>
    ...
    switch(colid){
        ...
        case 'SALE_MG_RATE':            
            ...
            // 거래형태[직매입]
            if( bizType == "1"){
                // 판매원가와 판매매가을 등록하면 마진율을 계산		//20131209	이성춘 직영이라도 100% 마진을 넣어줘야 집계시 이익율이 100%로 들어감 수정
    ...
    <td class="PT01 PB03"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="o_table">
      <tr>
        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table">
          <tr>
            <th width="30" class="point">브랜드</th>
            <td width="180">
              <comment id="_NSID_">
                ...
                <tr>
                  <td ><table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table">
                    ...
                    <tr>
                      ...
                      <td>
                        <comment id="_NSID_">
                          <object id=EM_I_REMARK classid=<%=Util.CLSID_EMEDIT%> width=100% tabindex=1 align="absmiddle"></object>
                        </comment><script> _ws_(_NSID_);</script>
                      </td>
                    ...
                    <tr>
                    	<tr>
                    		<td colspan="4"><font color="red"><b>마진율 직영일경우 100%로 꼭 입력하세요.    특정매입은 해당 브랜드마진을 입력&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;↓↓↓</b></td></font>
                    	</tr>
              ...
              <td ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr valign="top">
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="BD4A" >
                    <tr>
                      <td>
                        <comment id="_NSID_"><object id=GD_DETAIL width="100%" height=100 classid=<%=Util.CLSID_GRID%>>
