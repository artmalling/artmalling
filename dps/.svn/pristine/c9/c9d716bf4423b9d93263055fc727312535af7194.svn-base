 ...
 *************************************************************************/
  ...
  function getPayDt() {
	...
	var goTo         = "getPayDt" ;    
 	...
 	var parameters = "&strStrCd="+encodeURIComponent(strStrCd)   
 	 ...
 	 TR_DETAIL.Action="/dps/ppay311.pp?goTo="+goTo+parameters;  
 ...
 function checkValidation(Gubun) {
  ...
  function CloseCheck(){
     ...
     TR_VALCHECK.Action="/dps/ppay311.pp?goTo=valCheck"; 
 ...
 function process(){
	  ...
	  //변경또는 신규 내용을 저장하시겠습니까?
        if( showMessage(QUESTION, YESNO, "USER-1204") == 1 ){    // validation 체크
            TR_MAIN.Action="/dps/ppay311.pp?goTo=save&strFlag=save"; 
