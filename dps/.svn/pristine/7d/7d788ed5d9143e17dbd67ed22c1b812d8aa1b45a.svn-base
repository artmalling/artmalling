<!-- 
/*******************************************************************************
 * 시스템명 : 영업관리 > 재고수불 > 저장품 > 저장품출고확정 
 * 작 성 일 : 2010.06.02
 * 작 성 자 : 정진영
 * 수 정 자 : 
 * 파 일 명 : pstk4040.jsp
 * 버    전 : 1.0 (버전은 1.0부터 시작하며 0.1씩 증가)
 * 개    요 : 저장품 출고/출고반품 확정처리를  한다.
 * 이    력 :
 *        2010.06.02 (정진영) 신규작성
 ******************************************************************************/
-->
...
function doInit(){
    ...
    registerUsingDataset("pstk404","DS_MASTER,DS_DETAIL" );
    LC_O_STR_CD.Focus();
...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}      width=25   align=center name="NO"           </FC>'
                     ...
                     + '<FC>id=SLIP_FLAG     width=61   align=left   name="출고/반품;구분 " EditStyle=Lookup data="DS_SLIP_FLAG:CODE:NAME" </FC>'
...
function gridCreate2(){
    var hdrProperies = '<FC>id={currow}      width=25   align=center  edit=none     sumtext=""   name="NO"          </FC>'
                     ...
                     + '<FC>id=OUT_QTY       width=65   align=right   edit=none     sumtext=@sum name="수량"        </FC>'
                     + '<FC>id=OUT_PRC       width=85   align=right   edit=none     sumtext=@sum name="원가"        </FC>'
...
function btn_Conf() {
    ...
    */
    ...
    btnSaveYn = true;
    TR_MAIN.Action="/dps/pstk404.pt?goTo=conf";  
...
function searchMaster(){
    ...
    TR_SUB.Action="/dps/pstk404.pt?goTo="+goTo+parameters;      
...
function searchDetail(){
    ...
    var parameters = "&strStrCd="+encodeURIComponent(strStrCd)
                   ...
                   + "&strPumbunCd="+encodeURIComponent(strPumbunCd);
    TR_MAIN.Action="/dps/pstk404.pt?goTo="+goTo+parameters;      
