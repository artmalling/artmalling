...
public class POrd208DAO extends AbstractDAO {
	...
	public int conf(ActionForm form, String userId, String org_flag)
		...
		try {
			...
			if("03".equals(strSlipProcStat)){
				...
				sql.setString(14, form.getParam("strStrCd"));
				sql.setString(15, form.getParam("strSlipNo"));
				strConfStat = "00";
			}else{
			...
			*/
			...
			if("C".equals(strSlipFlag)|| "E".equals(strSlipFlag) ){
			    ...
			    if("03".equals(strSlipProcStat)){
					...
					sql.setString(13, userId);
					sql.setString(14, form.getParam("strPStrCd"));
					sql.setString(15, form.getParam("strPSlipNo"));
					strConfStat = "00";
			    }else{
			    	sql.put(svc.getQuery("UPD_MASTER_CONF"));
			    	sql.setString(1, form.getParam("strToday"));
