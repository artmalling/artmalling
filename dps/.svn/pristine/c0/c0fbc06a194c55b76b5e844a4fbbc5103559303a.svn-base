...
import common.edi.service.Psal929EDI;
...
public class PSal929DAO extends AbstractDAO {
	/*
	 * Java Pattern 에서 지원하는 logger를 사용할 수 있도록 객체를 선언
	 */
	private Logger logger = Logger.getLogger(PSal929DAO.class);
...
*/
    		...
    		if (sendResult != 0) {    		
    			System.out.println("Psal929:sendResult : " + sendResult);
    			System.out.println("Psal929:sendMessage : " + sendMessage);
