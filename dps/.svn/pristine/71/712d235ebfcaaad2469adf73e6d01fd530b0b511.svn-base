...
public class POrd111DAO extends AbstractDAO { 
    	
	/**
	 * 규격단품 매가인상하 리스트 내역 조회
	 *       
	 * @param form
	 * @return
	 * @throws Exception
		...
		try {
			...
			while (mi2.next()) {
				...
				if (mi2.IS_INSERT()) { // 저장
                    ...
                    System.out.println("구원가단가 = " + mi2.getString("OLD_COST_PRC"));	
                    System.out.println("구원가금액 = " + mi2.getString("OLD_COST_AMT"));		
                    System.out.println("신원가단가 = " + mi2.getString("NEW_COST_PRC"));	 
                    System.out.println("신원가금액 = " + mi2.getString("NEW_COST_AMT"));					
