<!-- 
/*******************************************************************************
 * 시스템명 : 포인트카드 > 신용카드대금청구 > 청구관리 > 브랜드별수수료조회(일별)
 * 작 성 일 : 2010.06.02
 * 작 성 자 : 장형욱
 * 수 정 자 : 
 * 파 일 명 : psal9420.jsp
...
function gridCreate1(){
    var hdrProperies    = '<FC>id={currow}          name="NO"            width=30   align=center</FC>'
                        ...
                        + '<FC>id=SALE_DT           name="일자"           width=85   align=center mask="XXXX/XX/XX"</FC>'
                        + '<G> name="합계"'
...
function btn_Search() {  
    ...
    TR_MAIN.Action  = "/dps/psal942.ps?goTo="+goTo+parameters;  
