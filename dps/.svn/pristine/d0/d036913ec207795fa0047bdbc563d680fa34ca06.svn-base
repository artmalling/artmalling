...
function gridCreate(){
    ...
    var hdrProperies = '<C>id={currow}    width=30  align=center name="NO"</C>'
                     ...
                     + '<C>id=POS_NO      width=60  align=center name="POS번호"</C>'
                     + '<C>id=COUPON_FLAG width=60  align=left   name="구분"</C>'
    ...
    var hdrProperies1 = '<C>id={currow}    width=35  align=center name="NO"</C>'
    	              + '<C>id=TRAN_NO     width=70  align=center name="거래번호" suppress=1</C>'
                      + '<C>id=SALE_FLAG   width=70  align=center name="매출구분" suppress=2</C>'
                      ...
                      + '<C>id=PLU_CD      width=100 align=center name="적용단품코드"</C>'
...
function btn_Search() {
    ...
    var parameters = "&strStoreCd="      + LC_STR_CD.BindColVal              //점구분코드
                   ...
                   ;
    DS_COU_SAL_MST.DataID = "/dps/psal506.ps?goTo="+goTo+parameters;
...
function subQuery(row){
    ...
    var parameters = "&strStoreCd=" + DS_COU_SAL_MST.NameValue(row,"STR_CD")    //점코드
                   ...
                   + "&strPosNo="   + DS_COU_SAL_MST.NameValue(row,"POS_NO")    //POS번호
                   + "&strCouType=" + DS_COU_SAL_MST.NameValue(row,"COUPON_TYPE") //구분
                   ;
   
    DS_COU_SAL_DTL.DataID = "/dps/psal506.ps?goTo="+goTo+parameters;
