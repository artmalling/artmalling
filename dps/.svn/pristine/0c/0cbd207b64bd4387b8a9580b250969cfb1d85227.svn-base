...
function doInit() {
	...
	initEmEdit(EM_POST_NO_I,            "NUMBER^6^0",  READ);        //우편번호
    ...
    setObjectGD2(false); 
	registerUsingDataset("pcod101", "DS_IO_DETAIL2, DS_O_DETAIL, DS_IO_MASTER")
	newMaster = false;
	// MARIO OUTLET START
...
function gridCreate1() {
	var hdrProperies = '<FC>id={currow}         name="NO"                    width=30   align=center         </FC>'
			         + '<FC>id=VEN_CD           name="협력사코드"              width=70   align=center     Edit=none </FC>'
			         + '<FC>id=VEN_NAME         name="협력사명"                width=90   align=left     Edit=none </FC>'
...
function gridCreate2() {
	var hdrProperies = '<FC>id={currow}             name="NO"              width=30   align=center</FC>'
                     ...
                     + '<FC>id=STR_CD               name="*점"              width=70   align=left     EditStyle=Lookup   Data="DS_STR_CD_I:CODE:NAME"</FC>'
                   ...
                   //+ '<FC>id=PAY_CNT              name="지불회차"         width=70   align=left     EditStyle=Lookup   Data="DS_PAY_CNT_I:CODE:NAME" show=false</FC>'
                     ...
                     + '<FC>id=POS_CAL_FLAG         name="*POS정산구분"      width=90   align=left     EditStyle=Lookup   Data="DS_POS_CAL_FLAG_I:CODE:NAME"</FC>'
...
function gridCreate3() {
	var hdrProperies = '<FC>id={currow}         name="NO"               width=30   align=center </FC>'
                     ...
                     + '<C>id=PHONE2_NO         name="국번"             width=70   align=center    EDIT="NUMERIC"    </C>'
                     + '<C>id=PHONE3_NO         name="번호"             width=70   align=center    EDIT="NUMERIC"    </C>'
                     + '</G>'
                     + '<G> name=휴대전화'
                     + '<C>id=HP1_NO            name="*통신사"           width=70   align=center    EDIT="NUMERIC"    </C>'
                     + '<C>id=HP2_NO            name="*국번"             width=70   align=center    EDIT="NUMERIC"    </C>'
                     + '<C>id=HP3_NO            name="*번호"             width=70   align=center    EDIT="NUMERIC"    </C>'
                     + '</G>'
...
function btn_Save() {
	...
	TR_MAIN.Action = "/dps/pcod101.pc?goTo=save"+parameters;
...
function searchMaster() {
	...
	TR_MAIN.Action   = "/dps/pcod101.pc?goTo=" + goTo + parameters;
...
function searchDetail() {
	...
	TR_DETAIL.Action   = "/dps/pcod101.pc?goTo=" + goTo + parameters;
...
function searchDetail2() {
	...
	var action       = "O";
	var parameters   = "&strVenCd=" + encodeURIComponent(strVenCd);
	TR_DETAIL2.Action   = "/dps/pcod101.pc?goTo=" + goTo + parameters;
...
function btn_Add1() {
	if (DS_IO_MASTER.RowPosition > 0) {
	    ...
	    if(strBIZ_TYPE == "2"){
	    	...
	    	LC_PAY_DT_FLAG_I.BindColVal        =  "03"; //지불일 익월30일후
...
function btn_send_ven_emg(){
	    ...
	    if( showMessage(QUESTION, YESNO, "USER-1204") == 1 ){
	    	...
	    	TR_MAIN.Action = "/dps/pcod101.pc?goTo=sendvenemg"+parameters;
...
function searchComp(vCompNo){
	...
	TR_SEARCH.Action   = "/dps/pcod101.pc?goTo=" + goTo + parameters;
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<tr valign="top">
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0"
									...
									<tr>
										<th width="100" class="point">사업자구분</th>
										<td width="150"><comment id="_NSID_"> <object
									...
									<tr>
										<th width="100" class="point">사용여부</th>
										<td ><comment id="_NSID_"> <object
									...
									<tr>
										<th width="100" class="point">거래시작일</th>
										<td width="150"><comment id="_NSID_"> <object
										...
										<th width="100" class="point">거래종료일</th>
										<td><comment id="_NSID_"> <object
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0"
                            ...
                            <tr valign="top">
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                    class="s_table">
                                    <tr>
                                        <th width="150" class="point">전자세금계산서발행구분</th>
                                        <td width="111"><comment id="_NSID_"> <object
                                            id=LC_ETAX_ISSUE_FLAG_I classid=<%=Util.CLSID_LUXECOMBO%>
                                            tabindex=1 width=90 align="left"> </object> </comment><script>_ws_(_NSID_);</script>
                                        </td>
                                        <th width="150">타사 전자세금계산서ID</th>
                                        <td><comment id="_NSID_"> <object
                                            id=EM_OCOMP_TAX_ID_I classid=<%=Util.CLSID_EMEDIT%> width=90
                                            tabindex=1 align="left"> </object> </comment> <script> _ws_(_NSID_);</script>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                    ...
                                    <tr>
										...
										<td width="150"><comment id="_NSID_"> <object
											...
											tabindex=1 align="left"> </object> </comment> <script> _ws_(_NSID_);</script></td>
										<th id="BUBIN" width="100" style="display:">법인번호</th>
										<th id="JUMIN" width="100" style="display:none">주민번호</th>
										<td><comment id="_NSID_"> <object
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
	                            <th class="point"><b>회계전표발행방법(기본값인 개별발행브랜드별로 입력하세요.)</b></th>
	                                <td><comment id="_NSID_"> <object
...
<comment id="_NSID_"> <object id=BO_MASTER	classid=<%=Util.CLSID_BIND%>>
	...
	<param name=BindInfo
        ...
        <c>Col=ETAX_ISSUE_FLAG      Ctrl=LC_ETAX_ISSUE_FLAG_I       param=BindColVal</c>
        <c>Col=RVS_ISSUE_FLAG       Ctrl=LC_RVS_ISSUE_FLAG_I        param=BindColVal</c>
        <c>Col=OCOMP_TAX_ID         Ctrl=EM_OCOMP_TAX_ID_I          param=Text</c>
