...
function doInit(){
    ...
    registerUsingDataset("psal510","DS_O_MASTER" );
...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}                name="NO"           width=30    align=center    </FC>'
                     ...
                     + '<FC>id=TOT_SALE_AMT            name="총매출"        width=90    align=right    mask="###,###"      sumtext={subsum(TOT_SALE_AMT)}</FC>'
...
function gridCreate2(){
    var hdrProperies = '<FC>id={currow}               name="NO"           width=30    align=center      sumtext="" SubSumText="" SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</FC>'
                     + '<FC>id=SALE_DT                name="일자"          width=80    align=center       suppress=1  SubSumText={decode(curlevel,1,"",2,"일자소계")} mask="XXXX/XX/XX" SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</FC>'
                     + '<FC>id=POS_NO                 name="POS번호"       width=60    align=center        suppress=2   SubSumText={decode(curlevel,2,"",1,"POS소계")} SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</FC>'
                     + '<FC>id=TRAN_NO                name="거래번호"       width=80    align=center           suppress=3   SubSumText=""    SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</FC>'
                     + '<G>                           name="브랜드"'
                     + '<C>id=PUMBUN_CD               name="코드"          width=60    align=center        suppress=4   SubSumText="" SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</C>'
                     + '<C>id=PUMBUN_NAME             name="명"            width=90    align=left           suppress=4   SubSumText=""    SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</C>'
                     + '</G>'
                     + '<FC>id=TRAN_FLAG              name="거래구분"       width=70    align=center             SubSumText="" SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</FC>'
                     + '<FC>id=DC_TYPE                name="DC유형"        width=100    align=left               SubSumText=""  SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</FC>'
                     + '<C>id=SALE_QTY                name="매출수량"      width=70    align=right    mask="###,###"       sumtext=@sum SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</C>'
                     + '<C>id=TOT_SALE_AMT            name="총매출"        width=90    align=right    mask="###,###"       sumtext=@sum SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</C>'
                     + '<C>id=REDU_AMT                name="할인"          width=70    align=right    mask="###,###"      sumtext=@sum SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</C>'
                     + '<C>id=NORM_SALE_AMT           name="매출"          width=90    align=right    mask="###,###"      sumtext=@sum SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</C>'
                     + '<C>id=DC_AMT                  name="에누리"        width=70    align=right    mask="###,###"       sumtext=@sum SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</FC>'
                     + '<C>id=NET_SALE_AMT            name="순매출"        width=90    align=right     mask="###,###"      sumtext=@sum SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</C>'
                     ;        
    ...
    DS_O_DETAIL.SubSumExpr  = "2:SALE_DT, 1:POS_NO" ; 
...
function btn_Search() {
    ...
    TR_MAIN.Action="/dps/psal510.ps?goTo="+goTo+parameters;  
 ...
 */
 function searchDetail(){
     ...
     TR_DETAIL.Action="/dps/psal510.ps?goTo="+goTo+parameters;  
