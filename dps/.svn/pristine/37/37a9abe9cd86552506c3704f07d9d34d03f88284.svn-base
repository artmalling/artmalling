 ...
 *
 */
public class Psal930EDI extends AbstractEDIService{	
	/**
	 * Constructor
	 */
	public Psal930EDI() throws Exception {
		try {
			this.setTranFormDoc("/psal930.edi.xml");
		} catch (Exception e) {
			System.out.println("전문포맷 로드중 실패하였습니다.:"+ "psal930.edi.xml");
			e.printStackTrace();
			throw e;
		}
	}
