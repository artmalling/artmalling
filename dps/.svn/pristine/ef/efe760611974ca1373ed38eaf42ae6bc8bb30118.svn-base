...
public class POrd205DAO extends AbstractDAO { 
	...
	public int conf(ActionForm form, String userId, String org_flag)
		...
		try {
			...
			if("01".equals(strSlipProcStat)){
				...
				sql.setString(6, form.getParam("strStrCd"));
				sql.setString(7, form.getParam("strSlipNo"));
				strConfStat = "00";
			}else{
		    //확정
			...
			*/
			...
			if("C".equals(strSlipFlag)|| "E".equals(strSlipFlag) ){
			    ...
			    if("01".equals(strSlipProcStat)){
				   ...
				   sql.setString(5, userId);
				   sql.setString(6, form.getParam("strPStrCd"));
				   sql.setString(7, form.getParam("strPSlipNo"));
				   strConfStat = "00";
			    }else{
				   sql.put(svc.getQuery("UPD_MASTER_CONF"));
				   sql.setString(1, form.getParam("strToday"));
