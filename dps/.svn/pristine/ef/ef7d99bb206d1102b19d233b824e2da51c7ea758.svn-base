 ...
 */
 ...
 function gridCreate1(){
	 var hdrProperies = '<COLUMNINFO>'
					  ...
					  + '           <HEADER left="0" top="0" right="60" bottom="55" text="브랜드" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
					  ...
					  + '           <HEADER left="60" top="0" right="180" bottom="55" text="브랜드명" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
					  ...
					  + '           <HEADER left="180" top="0" right="230" bottom="55" text="구분" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
					  ...
					  + '           <HEADER fix="true" left="230" top="0" right="310" bottom="55" text="면적" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
					  + '           <VIEW left="230" top="0" right="310" bottom="20" align="RightCenter" borderstyle="Line" bordercolor="#dddddd"  displayformat="#,###.00"/>'
					  + '       </COLUMN>'
					 
					  + '       <COLUMN id="ID_SALE"  refcolid="">'
                      + '           <HEADER left="310" top="0" right="530" bottom="25" text="매출" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
                      + '       </COLUMN>'
                      
					  + '       <COLUMN id="ID_J_NORM_NET_SALE_AMT"  refcolid="J_NORM_NET_SALE_AMT" index="5">'
					  + '           <HEADER left="310" top="25" right="420" bottom="55" text="정상" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
					  + '           <VIEW left="310" top="0" right="420" bottom="20" align="RightCenter" borderstyle="Line" bordercolor="#dddddd"  displayformat="#,#0"/>'
					  + '       </COLUMN>'
					  
					  + '       <COLUMN id="ID_J_EVT_NET_SALE_AMT"  refcolid="J_EVT_NET_SALE_AMT" index="6">'
                      + '           <HEADER left="420" top="25" right="530" bottom="55" text="행사" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
                      + '           <VIEW left="420" top="0" right="530" bottom="20" align="RightCenter" borderstyle="Line" bordercolor="#dddddd"  displayformat="#,##0"/>'
                      + '       </COLUMN>'
                      
                      + '       <COLUMN id="ID_J_SALE_TOT_AMT"  refcolid="J_SALE_TOT_AMT" index="7">'
                      + '           <HEADER left="530" top="0" right="640" bottom="55" text="총매출" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
                      + '           <VIEW left="530" top="0" right="640" bottom="20" align="RightCenter" borderstyle="Line" bordercolor="#dddddd"  displayformat="#,##0"/>'
                      + '       </COLUMN>'
                      
                      + '       <COLUMN id="ID_J_RK"  refcolid="J_RK" index="8">'
                      + '           <HEADER left="640" top="0" right="730" bottom="55" text="순위" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
                      + '           <VIEW left="640" top="0" right="730" bottom="20" align="RightCenter" borderstyle="Line" bordercolor="#dddddd"  displayformat="#,##0"/>'
                      + '       </COLUMN>'
                      
                      + '       <COLUMN id="ID_J_SCORE"  refcolid="">'
                      + '           <HEADER left="730" top="0" right="1000" bottom="25" text="바이어 평가점수 (평가배점 /점)" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
                      + '       </COLUMN>'
                      + '       <COLUMN id="ID_J_ORD_TOT_CNT"  refcolid="J_ORD_TOT_CNT" >'
                      + '           <HEADER left="730" top="25" right="820" bottom="55" text="발주건수" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
                      + '           <VIEW left="730" top="0" right="820" bottom="20" align="RightCenter" borderstyle="Line" bordercolor="#dddddd"  displayformat="#,##0"/>'
                      + '           <VIEWSUMMARY text=""  bgcolor="#b9d9ea" align="RightCenter" />' 
                      + '           <CHILD type="edit" inputtype="num" editable="false"/>'
                      + '       </COLUMN>'
                      + '       <COLUMN id="ID_J_IN_CNT"  refcolid="J_IN_CNT" >'
                      + '           <HEADER left="820" top="25" right="910" bottom="55" text="납품예정일초과;입고수" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
                      + '           <VIEW left="820" top="0" right="910" bottom="20" align="RightCenter"  borderstyle="Line" bordercolor="#dddddd"  displayformat="#,##0"/>'
                      + '           <VIEWSUMMARY text=""  bgcolor="#b9d9ea" align="RightCenter" />' 
                      + '           <CHILD type="edit" inputtype="num" editable="false"/>'
                      + '       </COLUMN>'
                      + '       <COLUMN id="ID_J_EVALU_SCORE"  refcolid="J_EVALU_SCORE">'
                      + '           <HEADER left="910" top="25" right="1000" bottom="55" text="평가점수" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
                      + '           <VIEW left="910" top="0" right="1000" bottom="20" align="RightCenter"  borderstyle="Line" bordercolor="#dddddd" displayformat="#,##0"/>'
                      + '           <VIEWSUMMARY text=""  bgcolor="#b9d9ea" align="RightCenter" />' 
                      + '           <CHILD type="edit" inputtype="num" editable="false"/>'
                      + '       </COLUMN>'
                      ...
                      + '       <COLUMN id="ID_AREA_SIZE"  refcolid="AREA_SIZE" index="4">'
                      + '           <HEADER fix="true" left="230" top="0" right="310" bottom="55" text="면적" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
                      ...
                      + '       <COLUMN id="ID_J_NORM_NET_SALE_AMT"  refcolid="NORM_NET_SALE_AMT" index="5">'
                      + '           <HEADER left="310" top="25" right="420" bottom="55" text="정상" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
                      + '           <VIEW left="310" top="20" right="420" bottom="40" align="RightCenter" borderstyle="Line" bordercolor="#dddddd"  displayformat="#,##0"/>'
                      + '       </COLUMN>'
                      
                      + '       <COLUMN id="ID_EVT_NET_SALE_AMT"  refcolid="EVT_NET_SALE_AMT" index="6">'
                      + '           <HEADER left="420" top="25" right="530" bottom="55" text="행사" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
                      + '           <VIEW left="420" top="20" right="530" bottom="40" align="RightCenter" borderstyle="Line" bordercolor="#dddddd"  displayformat="#,##0"/>'
                      + '       </COLUMN>'
                      
                      + '       <COLUMN id="ID_SALE_TOT_AMT"  refcolid="SALE_TOT_AMT" index="7">'
                      + '           <HEADER left="530" top="0" right="640" bottom="55" text="총매출" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
                      + '           <VIEW left="530" top="20" right="640" bottom="40" align="RightCenter" borderstyle="Line" bordercolor="#dddddd"  displayformat="#,##0"/>'
                      + '       </COLUMN>'
                      
                      + '       <COLUMN id="ID_RK"  refcolid="RK" index="8">'
                      + '           <HEADER left="640" top="0" right="730" bottom="55" text="순위" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
                      + '           <VIEW left="640" top="20" right="730" bottom="40" align="RightCenter" borderstyle="Line" bordercolor="#dddddd"  displayformat="#,##0"/>'
                      + '       </COLUMN>'
                      
                      + '       <COLUMN id="ID_SCORE"  refcolid="">'
                      + '           <HEADER left="730" top="0" right="1000" bottom="25" text="바이어 평가점수 (평가배점 /점)" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
                      + '       </COLUMN>'
                      + '       <COLUMN id="ID_ORD_TOT_CNT"  refcolid="ORD_TOT_CNT" >'
                      + '           <HEADER left="730" top="25" right="820" bottom="55" text="발주건수" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
                      + '           <VIEW left="730" top="20" right="820" bottom="40" align="RightCenter" borderstyle="Line" bordercolor="#dddddd"  displayformat="#,##0"/>'
                      + '           <VIEWSUMMARY text=""  bgcolor="#b9d9ea" align="RightCenter" />' 
                      + '           <CHILD type="edit" inputtype="num" editable="false"/>'
                      + '       </COLUMN>'
                      + '       <COLUMN id="ID_IN_CNT"  refcolid="IN_CNT" >'
                      + '           <HEADER left="820" top="25" right="910" bottom="55" text="납품예정일초과;입고수" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
                      + '           <VIEW left="820" top="20" right="910" bottom="40" align="RightCenter"  borderstyle="Line" bordercolor="#dddddd"  displayformat="#,##0"/>'
                      + '           <VIEWSUMMARY text=""  bgcolor="#b9d9ea" align="RightCenter" />' 
                      + '           <CHILD type="edit" inputtype="num" editable="false"/>'
                      + '       </COLUMN>'
                      + '       <COLUMN id="ID_EVALU_SCORE"  refcolid="EVALU_SCORE">'
                      + '           <HEADER left="910" top="25" right="1000" bottom="55" text="평가점수" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
                      + '           <VIEW left="910" top="20" right="1000" bottom="40" align="RightCenter"  borderstyle="Line" bordercolor="#dddddd" displayformat="#,##0"/>'
                      + '           <VIEWSUMMARY text=""  bgcolor="#b9d9ea" align="RightCenter" />' 
                      ...
                      //+ '           <HEADER left="230" top="0" right="310" bottom="55" text="면적" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
                      //+ '           <VIEW left="230" top="20" right="310" bottom="40" align="RightCenter" borderstyle="Line" bordercolor="#dddddd"  displayformat="#,###.00"/>'
                      //+ '           <CHILD type="edit" inputtype="num"  decimal="2" editable="true"/>'
                      //+ '       </COLUMN>'
                      //
                      //+ '       <COLUMN id="ID_SALE"  refcolid="">'
                      //+ '           <HEADER left="310" top="0" right="510" bottom="25" text="매출" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
                      //+ '       </COLUMN>'
                      //
                      //+ '       <COLUMN id="ID_PUMBUN_GRADE"  refcolid="PUMBUN_GRADE">'
                      //+ '           <HEADER fix="true" left="310" top="25" right="415" bottom="55" text="정상" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
                      //+ '           <VIEW left="310" top="20" right="415" bottom="40" borderstyle="Line" bordercolor="#dddddd"/>'
                      ...
                      //+ '           <HEADER left="415" top="25" right="510" bottom="55" text="행사" align="right" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
                      //+ '           <VIEW left="415" top="20" right="510" bottom="40" align="RightCenter" borderstyle="Line" bordercolor="#dddddd"  displayformat="#,###.00"/>'
                      //+ '           <CHILD type="edit" inputtype="num"  decimal="2" editable="true"/>' 
                      //+ '       </COLUMN>'
                      //
                      //+ '       <COLUMN id="ID_CNT"  refcolid="">'
                      //+ '           <HEADER left="510" top="0" right="780" bottom="25" text="바이어 평가점수(평가배점 /점)" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
                      //+ '       </COLUMN>'
                      //+ '       <COLUMN id="ID_CNT2"  refcolid="CNT2" >'
                      //+ '           <HEADER left="510" top="25" right="600" bottom="55" text="발주건수" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
                      ...
                      //+ '           <HEADER left="600" top="25" right="690" bottom="55" text="납품예정일초과;입고수" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
                      //+ '           <VIEW left="600" top="20" right="690" bottom="40" align="RightCenter"  borderstyle="Line" bordercolor="#dddddd"  displayformat="#,##0"/>'
                      //+ '           <VIEWSUMMARY text=""  bgcolor="#b9d9ea" align="RightCenter" />' 
                      //+ '           <CHILD type="edit" inputtype="num" decimal="0" editable="false"/>'
                      //+ '       </COLUMN>'
                      //+ '       <COLUMN id="ID_EVALU_SCORE"  refcolid="EVALU_SCORE">'
                      //+ '           <HEADER left="690" top="25" right="780" bottom="55" text="평가점수" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#dddddd"/>'
...
function btn_Save() {
    ...
    if( showMessage(QUESTION, YESNO, "USER-1010") == 1 ){    // validation 체크
        TR_MAIN.Action="/dps/psal704.ps?goTo=save&strFlag=save"; 
 ...
 */
 function getMaster(){
    ...
    TR_S_MAIN.Action  = "/dps/psal704.ps?goTo="+goTo+parameters;  
    TR_S_MAIN.KeyValue= "SERVLET("+action+":DS_IO_MASTER=DS_IO_MASTER)"; //조회는 O
    TR_S_MAIN.Post();
    
    getAllotScore();        // 평가배점 조회
    
    if(score == 0){
    	showMessage(EXCLAMATION, OK, "USER-1195", "바이어 평가 배점", "바이어 평가 등록");
        return false;
    }
 }
  ...
  */
   ...
   */
   function confCheck(strStrCd, strEvaluYm){
      ...
      TR_MAIN.Action  = "/dps/psal704.ps?goTo="+goTo+parameters;  
   ...
   */
   function getAllotScore(){
       ...
       if(DS_O_SCORE.CountRow > 0)
   	   ...
   	   GR_MASTER.LayoutInfo("ColumnInfo", "ID_J_SCORE::<HEADER>::text") = "바이어 평가 (평가배점 / "+score+"점)";
       GR_MASTER.LayoutInfo("ColumnInfo", "ID_SCORE::<HEADER>::text") = "바이어  평가 (평가배점 / "+score+"점)";
   }
