...
function doInit(){
    ...
    registerUsingDataset("psal213","DS_O_MASTER" );
    LC_STR_CD.Focus();
}
...
function btn_Search() {
    ...
    TR_MAIN.Action="/dps/psal213.ps?goTo="+goTo+parameters;  
...
function btn_Save() {
    ...
    var goTo       = "save";    
    var action     = "I";  
    TR_SAVE.Action="/dps/psal213.ps?goTo="+goTo+parameters;  
...
function loadExcelData() {
	...
	for(nRow = 1; nRow <= DS_O_EXCELTEMP.CountRow; nRow++){
		...
		DS_O_MASTER.NameValue(nRow, "ITEM_CD")      = DS_O_EXCELTEMP.NameValue(nRow, "SKU_CD");
        ...
        if(DS_HS_EXCEL.CountRow > 0){
        	...
        	DS_O_MASTER.NameValue(nRow, "ITEM_CD")     = DS_HS_EXCEL.NameValue(1, "SKU_CD");
        }
...
function searchExcel(nRow) {
    ...
    var strStrCd        = DS_O_MASTER.NameValue(nRow, "STR_CD");
    var strSkuCd        = DS_O_MASTER.NameValue(nRow, "ITEM_CD");
