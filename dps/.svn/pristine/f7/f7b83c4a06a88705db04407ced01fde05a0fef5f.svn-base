...
function gridCreate(){
    ...
    var hdrProperies1 = '<C>id={currow}    width=35  align=center name="NO"</C>'
				    	...
				    	+ '<C>id=VEN_INFO             width=60  show=false align=center name="업체정보" </C>'
				    	+ '<C>id=POS_ENTRY_MODE       width=100  show=false align=center name="Pos Entry Mode" </C>'
				    	+ '<C>id=TRACK_II             width=180  show=true align=left name="Track II" </C>'
				    	+ '<C>id=FS                   width=40  show=false align=center name="FS" </C>'
				    	+ '<C>id=SALE_FLAG            width=60  show=false align=center name="판매구분" </C>'
				    	...
				    	+ '<C>id=WORKING_KEY_INDEX    width=100  show=false align=center name="Working Key Index" </C>'
				    	...
				    	+ '<C>id=USER_INFO            width=80  show=false align=center name="사용자정보" </C>'
				    	+ '<C>id=BRCH_ID              width=80  show=false align=center name="가맹점ID" </C>'
				    	+ '<C>id=BRCH_NO              width=100  show=true align=center name="가맹점번호" </C>'
				    	+ '<C>id=BRCH_USE_FIELD       width=100  show=false align=center name="가맹점사용필드" </C>'
				    	+ '<C>id=POINT_FLAG           width=80  show=true align=center name="포인트 구분" </C>'
				    	+ '<C>id=KSNET_RESRV          width=100  show=false align=center name="KSNET Reserved" </C>'
				    	+ '<C>id=DONGLE_FLAG          width=80  show=false align=center name="동글구분" </C>'
				    	+ '<C>id=MEDIA_FLAG           width=80  show=false align=center name="매체구분" </C>'
				    	+ '<C>id=MOBILE_FLAG          width=80  show=false align=center name="이통사구분" </C>'
				    	...
				    	+ '<C>id=CARD_TYPE            width=80  show=false align=center name="카드 Type" </C>'
				    	...
				    	+ '<C>id=WORKING_KEY          width=100  show=false align=center name="Working Key" </C>'
				    	...
				    	+ '<C>id=NOTI1                width=100  show=false align=center name="Notice1" </C>'
				    	+ '<C>id=NOTI2                width=100  show=false align=center name="Notice2" </C>'
				    	+ '<C>id=RESRV                width=100  show=false align=center name="Reserved" </C>'
                      ;
...
function btn_Search() {
    ...
    DS_OK_SAL_MST.DataID = "/dps/psal553.ps?goTo="+goTo+parameters;
    DS_OK_SAL_MST.Reset();
}
...
function subQuery(row){
    ...
    DS_OK_SAL_DTL.DataID = "/dps/psal553.ps?goTo="+goTo+parameters;
    DS_OK_SAL_DTL.Reset();
}
