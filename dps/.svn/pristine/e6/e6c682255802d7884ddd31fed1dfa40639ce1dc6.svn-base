<!-- 
/*******************************************************************************
 * 시스템명 : 영업관리 > 발주결재 > 기긴별매입현황집계표(자동전표구분)
 * 작 성 일    : 2010.08.30
 * 작 성 자    : 김경은
 * 수 정 자    : 
 * 파 일 명    : pord4030.jsp
 * 버    전       : 1.0 (버전은 1.0부터 시작하며 0.1씩 증가)
 * 개    요       : 기긴별매입현황집계표(자동전표구분) 
 * 이    력       :
 * 
 ******************************************************************************/
-->
 ...
 */
 ...
 function doInit(){
     ...
     initComboStyle(LC_O_AUTO_SLIP_FLAG, DS_O_AUTO_SLIP_FLAG, "CODE^0^30,NAME^0^80", 1, NORMAL);          // 자동전표구분   

     getStore("DS_STR", "Y", "", "N");                          // 점        
     getEtcCode("DS_O_GJDATE_TYPE", "D", "P214", "N");          // 기준일
     getEtcCode("DS_O_AUTO_SLIP_FLAG", "D", "P204", "Y");       // 자동전표구분

     LC_O_STR.Index            = 0; 
     LC_O_BUMUN.Index          = 0;
     LC_O_TEAM.Index           = 0;
     LC_O_PC.Index             = 0;  
     LC_O_AUTO_SLIP_FLAG.Index = 0;
     LC_O_STR.Focus();
     CHK_1.checked       = true;
 ...
 function gridCreate1(){
     var hdrProperies = '<FC>id={currow}           name="NO"          width=30     edit=none align=center  sumtext=""     </FC>'
                      ...
                      + '<FC>id=PUMBUN_CD          name="브랜드코드"    width=70     edit=none align=center  suppress=4 SubSumText={decode(curlevel,1,"PC소계",2,"파트소계",3,"팀소계")}</FC>'
                      + '<FC>id=PUMBUN_NM          name="브랜드"        width=90     edit=none align=left suppress=4 </FC>'
                      + '<FC>id=SALE_ORG_BM        name="팀코드"    width=80     edit=none align=center suppress=3   show=false</FC>'
                      + '<FC>id=SALE_ORG_BM_NM     name="팀명"      width=80     edit=none align=left suppress=3</FC>'
                      + '<FC>id=SALE_ORG_TEAM      name="파트코드"      width=80     edit=none align=center suppress=2   show=false</FC>'
                      + '<FC>id=SALE_ORG_TEAM_NM   name="파트명"      width=120    edit=none align=left suppress=2</FC>'
                      + '<FC>id=SALE_ORG_PC        name="PC코드"      width=80     edit=none align=center suppress=1 show=false</FC>'
                      + '<FC>id=SALE_ORG_PC_NM     name="PC명"        width=180    edit=none align=left suppress=1</FC>'
                      + '<FC>id=EVENT_CD           name="마진코드"    width=65     edit=none align=center SubSumText= ""</FC>'
                      + '<FC>id=MG_RATE            name="마진율"      width=60     edit=none align=right SubSumText= ""</FC>'
                      + '<FC>id=VEN_CD             name="협력사코드"  width=80     edit=none align=left show=false</FC>'
                      + '<FC>id=VEN_NM             name="협력사"      width=110    edit=none align=left </FC>'
                      + '<FC>id=CHK_QTY            name="수랑"        width=80     edit=none align=right  sumtext=@sum</FC>'
                      + '<FG> name="원가금액"'
                      + '<FC>id=CHK_COST_TAMT      name="공급가"      width=80     edit=none align=right  sumtext=@sum</FC>'
                      + '<FC>id=VAT_AMT            name="부가세"      width=80     edit=none align=right  sumtext=@sum</FC>'
                      + '<FC>id=TOT_AMT            name="합계"        width=80     edit=none align=right  sumtext=@sum</FC>'
                      + '</FG>'
                      + '<FC>id=OLD_SALE_TAMT      name="구매가계"    width=93     edit=none align=right show=false</FC>'
                      + '<FC>id=CHK_SALE_TAMT      name="매가계"      width=80     edit=none align=righ sumtext=@sum</FC>'
                      + '<FC>id=level              name=레벨                          Value={curlevel}    width=50 show=false</FC>';

     initGridStyle(GR_MASTER, "common", hdrProperies, true);     

     GR_MASTER.ViewSummary = "1";      GR_MASTER
...
<comment id="_NSID_">
<object id="DS_O_AUTO_SLIP_FLAG" classid=<%=Util.CLSID_DATASET%>></object>
</comment>
<script>_ws_(_NSID_);</script>
            ...
            <tr>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        ...
                        <td colspan="3">                            
                            <comment id="_NSID_"> 
                              <object id=LC_O_AUTO_SLIP_FLAG classid=<%=Util.CLSID_LUXECOMBO%> width=100 align="absmiddle" tabindex=1> </object> 
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0"
                    ...
                    <tr>
                        <td><comment id="_NSID_"> <OBJECT id=GR_MASTER
                            width=100% height=454 classid=<%=Util.CLSID_GRID%>>
