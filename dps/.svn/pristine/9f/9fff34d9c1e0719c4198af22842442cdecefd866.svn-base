...
function btn_Search() {
    ...
    //var strStrNm        = LC_STR_CD.text;		//점이름		한글깨짐
    ...
    */
    ...
    IFrame.location.href="/dps/jsp/psal/psal5441.jsp?"+parameters;
}
...
function btn_Print() {
	    ...
	    */
	    ...
	    var parameters = "&strStrCd="  + strStrCd              //점코드
	                   ...
	                   ; 
                   ;
    window.open("/dps/jsp/psal/psal5441.jsp?"+parameters,"OZREPORT", 1000, 700);	 
}
