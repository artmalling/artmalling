 ...
 */
 ...
 function doInit(){
     ...
     initEmEdit(EM_STR_PHONENUM,       "GEN^13",      READ);           // 전송자휴대전화
     ...
     initComboStyle(LC_S_FLAG,      DS_S_FLAG,      "CODE^0^30,NAME^0^80", 1, NORMAL);    // 세금계산서구분
     
     
     // 콤보 초기화(입력)
//     initComboStyle(LC_STR,          DS_O_STR_CD,       "CODE^0^30,NAME^0^80", 1, PK);        // 점
//     initComboStyle(EM_BIZ_TYPE,     DS_O_BIZ_TYPE,     "CODE^0^30,NAME^0^80", 1, NORMAL);    // 거래형태
//     initComboStyle(EM_TAX_FLAG,     DS_O_TAX_FLAG,     "CODE^0^30,NAME^0^80", 1, NORMAL);    // 과세구분
     initComboStyle(LC_VEN_CHAR_NAME,DS_O_CHAR_NAME,    "CODE^0^0,NAME^0^80",  1, NORMAL);    // 담당자명
//     initComboStyle(LC_TAX_INV_TYPE, DS_O_TAX_INV_TYPE, "CODE^0^30,NAME^0^80", 1, NORMAL);    // 세금계산서종류
//     initComboStyle(LC_CHARGE_FLAG,  DS_O_CHARGE_FLAG,  "CODE^0^30,NAME^0^80", 1, NORMAL);    // 청구/영수
     ...
     getEtcCodeRefer("DS_S_FLAG",   "D", "P406", "Y");            // 세금계산서구분
 ...
 function gridCreate1(){
     var hdrProperies = '<FC>id={currow}          name="NO"                 width=30    align=center  BgColor={if(ETAX_STAT_NM = "승인","orange","white") }</FC>' 
    	              + '<FC>id=SEL               name="선택"               width=50    align=center HeadCheckShow=true EditStyle=CheckBox  BgColor={if(ETAX_STAT_NM = "승인","orange","white") }</FC>'                      
                      + '<FC>id=TAX_INV_FLAG_NM   name="매입/매출"          width=60     Edit=none align=left  BgColor={if(ETAX_STAT_NM = "승인","orange","white") }</FC>'
                      + '<FC>id=ETAX_STAT_NM      name="상태"               width=100     Edit=none align=left  BgColor={if(ETAX_STAT_NM = "승인","orange","white") }</FC>'
                      + '<FC>id=VEN_NM            name="협력사"             width=80     Edit=none align=left  BgColor={if(ETAX_STAT_NM = "승인","orange","white") }</FC>'
                      + '<FC>id=PUMBUN_CD         name="브랜드코드"           width=80     Edit=none align=left  show="false"  BgColor={if(ETAX_STAT_NM = "승인","orange","white") }</FC>'
                      + '<FC>id=PUMBUN_NM         name="브랜드명"             width=80     Edit=none align=left  BgColor={if(ETAX_STAT_NM = "승인","orange","white") }</FC>'
                      + '<FC>id=BIZ_TYPE          name="거래형태"           width=80     Edit=none align=left  BgColor={if(ETAX_STAT_NM = "승인","orange","white") }</FC>'
                      + '<FC>id=TAX_FLAG          name="과세구분"           width=70     Edit=none align=left  BgColor={if(ETAX_STAT_NM = "승인","orange","white") }</FC>'
                      + '<FC>id=PAY_CYC           name="지불주기"           width=60     Edit=none align=left  BgColor={if(ETAX_STAT_NM = "승인","orange","white") }</FC>'
                      + '<FC>id=PAY_CNT           name="지불회차"           width=70     Edit=none align=left  BgColor={if(ETAX_STAT_NM = "승인","orange","white") }</FC>'
                      + '<FC>id=TAX_ISSUE_DT      name="발행일자"           width=80     Edit=none Mask="XXXX/XX/XX" align=center  BgColor={if(ETAX_STAT_NM = "승인","orange","white") }</FC>'
                      + '<FC>id=TAX_ISSUE_SEQ_NO  name="순번"               width=50     Edit=none align=center  BgColor={if(ETAX_STAT_NM = "승인","orange","white") }</FC>'                      
                      + '<FC>id=EDI_SEQ_NO        name="전자세금계산서 ID"   width=180    Edit=none align=center  BgColor={if(ETAX_STAT_NM = "승인","orange","white") }</FC>';
 ...
 function gridCreate2(){
     var hdrProperies = '<FC>id={currow}          name="NO"            width=30    Edit=none align=center</FC>'
                      ...
                      + '<FC>id=TAX_ITEM_QTY      name="수량"          width=40    Edit=Numeric align=right</FC>'
                      + '<FC>id=TAX_ITEM_UNIT_AMT name="단가"          width=70    Edit=Numeric align=right</FC>'
                      + '<FC>id=TAX_ITEM_SUP_AMT  name="공급가"        width=80    Edit=Numeric align=right</FC>'
...
function btn_Save() {
    ...
    if( showMessage(QUESTION, YESNO, "USER-1010") == 1 ){    // validation 체크
        TR_MAIN.Action="/dps/ppay107.pp?goTo=save&strFlag=save"; 
 ...
 *************************************************************************/
 ...
 function setMasterObject(flag){
     ...
     enableControl(LC_VEN_CHAR_NAME     , flag);
//     enableControl(LC_TAX_INV_TYPE      , flag);
     enableControl(EM_TAX_ISSUE_DT      , flag);
//     enableControl(LC_CHARGE_FLAG       , flag);
     enableControl(EM_VEN_CHAR_EMAIL    , flag);
  ...
  */
  function getAttribute(){
     ...
     var goTo       = "getAttribute" ;    
     var action     = "O";     
     
     TR_MAIN.Action  = "/dps/ppay107.pp?goTo="+goTo;  
     TR_MAIN.KeyValue= "SERVLET("+action+":DS_O_ATTRIBUTE=DS_O_ATTRIBUTE)"; //조회는 O
     TR_MAIN.Post();
     
     if(DS_O_ATTRIBUTE.NameValue(1, "ATTRIBUTE3") == "Y"){
  ...
  */
  function getList(){
     ...
     var strFlag       = LC_S_FLAG.BindColVal;                      // 세금계산서 구분
     ...
     TR_MAIN.Action  = "/dps/ppay107.pp?goTo="+goTo+parameters;  
 ...
 */
 function getMaster(){
    ...
    TR_S_MAIN.Action  = "/dps/ppay107.pp?goTo="+goTo+parameters;  
 ...
 function checkValidation(Gubun, btnFlag) {
      ...
      if(Gubun == "SmileTax"){
    	  for(var i = 1; i <= DS_O_LIST.CountRow; i++){
    		  if(DS_O_LIST.NameValue(i, "SEL") == "T"){
		    	  var strEtaxStat     = DS_O_LIST.NameValue(i, "ETAX_STAT");
		    	  var strVenCharEmail = DS_O_LIST.NameValue(i, "VEN_CHAR_EMAIL");
		    	  var strTaxInvFlag   = DS_O_LIST.NameValue(i, "TAX_INV_FLAG");
		    	  
		    	  if(strVenCharEmail.length <= 0){
		    		  DS_O_LIST.RowPosition = i;
		    		  showMessage(INFORMATION, OK, "USER-1003", "담당자메일");
                      return false;
		    	  }
		          ...
		          if(btnFlag == "1"){       // 전송
		        	  ...
		        	  if(strTaxInvFlag == "1"){          // 매입
			              if(strEtaxStat != "N" && strEtaxStat != "G" && strEtaxStat != "K" && strEtaxStat != "O"){
			            	  DS_O_LIST.RowPosition = i;
			                  showMessage(EXCLAMATION, OK, "USER-1217");
			                  return false;
			              }
		        	  }else if(strTaxInvFlag == "2"){    // 매출
 ...
 */
 ...
 function getCharName(strVenCd) {
     ...
     TR_DETAIL.Action="/dps/ppay107.pp?goTo="+goTo+parameters;  
...
//        LC_VEN_CHAR_NAME.Index = 0;
 ...
 /**
  * setSmileTaxDel(state)
  * 작 성 자 : 김경은
  * 작 성 일 : 2010-04-27
  * 개    요    : 세금계산서 취소요청(3), EMAIL재전송(2), 전송처리(1)한다.
  * return값 : void
  */
  function setSmileTaxDel(){

    // 전송내역이 없을경우
     if (!DS_O_LIST.IsUpdated){
         //저장할 내용이 없습니다
         showMessage(EXCLAMATION, OK, "USER-1000", "선택된 내역이 없습니다.");
         return;
     }
     ...
     TR_MAIN.Action="/mss/mren407.mr?goTo="+goTo;  
     TR_MAIN.KeyValue="SERVLET("+action+":DS_O_LIST=DS_O_LIST)"; //조회는 O
     TR_MAIN.Post();
	...
	// 전송내역이 없을경우
     if (!DS_O_LIST.IsUpdated){
      ...
      if(showMessage(QUESTION, YESNO, messge) == 1 ){   
          ...
          var action       = "I";     
          var parameters   = "&state="+encodeURIComponent(state);
...
<script language=JavaScript for=DS_S_FLAG event=OnFilter(row)>
	switch(LC_S_BIZ_TYPE.BindColVal){
    case "1":
    	if (DS_S_FLAG.NameValue(row,"REFER_CODE") == "0"){
    		return true;
    	}
    	else {
    		return false;
        ...
        break;    
	case "2":
    	if (DS_S_FLAG.NameValue(row,"REFER_CODE") == "1"){
    		return true;
    	}
    	else {
    		return false;
        ...
        break;    
    case "3":
    	if (DS_S_FLAG.NameValue(row,"REFER_CODE") == "2"){
    		return true;
    	}
    	else {
    		return false;
        ...
        break;
    case "4":
    	if (DS_S_FLAG.NameValue(row,"REFER_CODE") == "3"){
    		return true;
    	}
    	else {
    		return false;
...
<comment id="_NSID_">
<object id="DS_S_FLAG" classid=<%=Util.CLSID_DATASET%>>
...
<comment id="_NSID_"><object id="DS_O_ATTRIBUTE"    classid=<%= Util.CLSID_DATASET %>></object></comment><script>_ws_(_NSID_);</script>
      ...
      <tr>
        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table">
          ...
          <tr>
            ...
            <td width="110">
                    <comment id="_NSID_">
                        <object id=LC_S_STR_CD classid=<%= Util.CLSID_LUXECOMBO %> width=108 tabindex=1 align="absmiddle">
                        </object>
                    </comment><script>_ws_(_NSID_);</script>
            </td>
          ...
          <tr>
            ...
            <td>
                    <comment id="_NSID_">
                        <object id=LC_S_BIZ_TYPE classid=<%= Util.CLSID_LUXECOMBO %> width=108 tabindex=1 align="absmiddle">
                        </object>
                    </comment><script>_ws_(_NSID_);</script>
            ...
            <td colspan="2">
                  <comment id="_NSID_">
                      <object id=EM_S_SALE_S_DT classid=<%=Util.CLSID_EMEDIT%>  width=85 tabindex=1 align="absmiddle">
                      </object>
                  </comment>
                  <script> _ws_(_NSID_);</script>
                  ~
                  <comment id="_NSID_">
                      <object id=EM_S_SALE_E_DT classid=<%=Util.CLSID_EMEDIT%>  width=85 tabindex=1 align="absmiddle">
                      </object>
                  </comment>
                  <script> _ws_(_NSID_);</script>
            </td>
          ...
          <tr>
            ...
            <td colspan="3">
                  <comment id="_NSID_">
                      <object id=EM_S_TAX_S_DT classid=<%=Util.CLSID_EMEDIT%>  width=119 tabindex=1 align="absmiddle">
                      </object>
                  </comment><script> _ws_(_NSID_);</script>
                  <img src="/<%=dir%>/imgs/btn/date.gif" id="IMG_TAX_S_DT" onclick="javascript:openCal('G',EM_S_TAX_S_DT)" align="absmiddle" />
                  ~
                  <comment id="_NSID_">
                      <object id=EM_S_TAX_E_DT classid=<%=Util.CLSID_EMEDIT%>  width=119 tabindex=1 align="absmiddle">
                      </object>
                  </comment><script> _ws_(_NSID_);</script>
            ...
            <td colspan="3">
                  <comment id="_NSID_">
                      <object id=EM_S_ETAX_NO classid=<%=Util.CLSID_EMEDIT%>  width=195 tabindex=1 align="absmiddle">
                      </object>
                  </comment><script> _ws_(_NSID_);</script>
            </td>            
          </tr>
          ...
          <tr>
             ...
             <td colspan="3">
               ...
               <comment id="_NSID_"> 
                   <object id=EM_S_VEN_NM classid=<%=Util.CLSID_EMEDIT%> width=182 tabindex=1 align="absmiddle" > </object> 
               </comment><script>_ws_(_NSID_);</script>
             </td>         
            <th>상태</th>
            <td>
            ...
            <td>
                    <comment id="_NSID_">
                        <object id=LC_S_FLAG classid=<%= Util.CLSID_LUXECOMBO %> width=100 tabindex=1 align="absmiddle">
                        </object>
                    </comment><script>_ws_(_NSID_);</script>
            </td>
         </tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr valign="top">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="BD4A">
                    ...
                    <td>
                          <comment id="_NSID_"> 
                              <OBJECT id=GR_LIST width=100% height=428 classid=<%=Util.CLSID_GRID%>>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td class="right" valign="bottom">
                            <img src="/<%=dir%>/imgs/btn/del.gif"          id="IMG_DEL"    width="62" height="18" hspace="2" onclick="javascript:setSmileTaxDel();" />
                    ...
                    <tr>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table">
                            ...
                            <tr>
                                ...
                                <td width="103">
                                    <comment id="_NSID_"> 
                                        <object id=EM_TAX_INV_FLAG_NM classid=<%=Util.CLSID_EMEDIT%> width=100 tabindex=1 align="absmiddle"> </object> 
                                    </comment><script>_ws_(_NSID_);</script>
                                </td>
                                <th width="80">매입매출년월</th>
                                <td width="103">
                                    <comment id="_NSID_"> 
                                        <object id=EM_PAY_YM classid=<%=Util.CLSID_EMEDIT%> width=100 tabindex=1 align="absmiddle"> </object> 
                                    </comment><script>_ws_(_NSID_);</script>
                                </td>
                                <th width="72">지불주기</th>
                                <td>
                                    <comment id="_NSID_"> 
                                        <object id=EM_PAY_CYC classid=<%=Util.CLSID_EMEDIT%> width=100 tabindex=1 align="absmiddle"> </object> 
                                    </comment><script>_ws_(_NSID_);</script>
                                </td>
                            </tr>
                           ...
                           <tr>
                                ...
                                <td>
                                    <comment id="_NSID_"> 
                                        <object id=EM_PAY_CNT classid=<%=Util.CLSID_EMEDIT%> width=100 tabindex=1 align="absmiddle"> </object> 
                                    </comment><script>_ws_(_NSID_);</script>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <comment id="_NSID_"> 
                                        <object id=EM_BIZ_TYPE classid=<%=Util.CLSID_EMEDIT%> width=100 tabindex=1 align="absmiddle"> </object> 
                                    </comment><script> _ws_(_NSID_);</script>
                                </td>   
                                <th>과세구분</th>
                                <td>
                                    <comment id="_NSID_"> 
                                        <object id=EM_TAX_FLAG classid=<%=Util.CLSID_EMEDIT%> width=100 tabindex=1 align="absmiddle"> </object> 
                                    </comment><script> _ws_(_NSID_);</script>
                                </td>
                                <th>대표자명</th>        
                                <td>
                            ...
                            <tr>
                                ...
                                <td colspan="5">
                                    <comment id="_NSID_"> 
                                        <object id=EM_ADDR classid=<%=Util.CLSID_EMEDIT%> width=500 tabindex=1 align="absmiddle"> </object> 
                                    </comment><script> _ws_(_NSID_);</script>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <comment id="_NSID_"> 
                                        <object id=EM_VEN_CHAR_EMAIL classid=<%=Util.CLSID_EMEDIT%> width=295 tabindex=1 align="absmiddle"> </object> 
                                    </comment><script> _ws_(_NSID_);</script>
                                </td>                             
                            </tr>                                
                             
                            <tr>
                                <th>전자세금계산서</BR>발행구분</th>        
                                <td>
                                    <comment id="_NSID_"> 
                                        <object id=EM_ETAX_ISSUE_FLAG_NM classid=<%=Util.CLSID_EMEDIT%> width=100 tabindex=1 align="absmiddle"> </object> 
                                    </comment><script> _ws_(_NSID_);</script>
                                </td> 
                                <th>세금계산서</BR>구분</th>
                                <td>
                                    <comment id="_NSID_"> 
                                        <object id=EM_TAX_ISSUE_FLAG_NM classid=<%=Util.CLSID_EMEDIT%> width=100 tabindex=1 align="absmiddle"> </object> 
                                    </comment><script> _ws_(_NSID_);</script>
                                </td>
                                <th>세금계산서 </BR>종류</th>
                                <td>
                                    <comment id="_NSID_"> 
                                        <object id=EM_TAX_INV_TYPE_NM classid=<%=Util.CLSID_EMEDIT%>  width=100 tabindex=1 align="absmiddle"> </object> 
                                    </comment><script> _ws_(_NSID_);</script>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <comment id="_NSID_"> 
                                        <object id=EM_EDI_SEQ_NO classid=<%=Util.CLSID_EMEDIT%> width=196 tabindex=1 align="absmiddle"> </object> 
                                    </comment><script> _ws_(_NSID_);</script>
                                </td>
                                <th>브랜드명</th>
                                <td>
                                    <comment id="_NSID_"> 
                                        <object id=EM_PUMBUN_NM classid=<%=Util.CLSID_EMEDIT%> width=100 tabindex=1 align="absmiddle"> </object> 
                                    </comment><script> _ws_(_NSID_);</script>
                                </td>
                            </tr><tr>
                                <th>역발행구분</th>
                                <td>
                                    <comment id="_NSID_"> 
                                        <object id=EM_RVS_ISSUE_FLAG_NM classid=<%=Util.CLSID_EMEDIT%> width=100 tabindex=1   align="absmiddle"> </object> 
                                    </comment><script> _ws_(_NSID_);</script>
                                </td>
                                <th>지불방법</th>
                                <td>
                                    <comment id="_NSID_"> 
                                        <object id=EM_PAY_WAY_NM classid=<%=Util.CLSID_EMEDIT%> width=100 tabindex=1 align="absmiddle"> </object> 
                                    </comment><script> _ws_(_NSID_);</script>
                                </td>
                                <th>청구/영수</th>
                                <td>
                                    <comment id="_NSID_"> 
                                        <object id=EM_CHARGE_FLAG_NM classid=<%=Util.CLSID_EMEDIT%> width=100 tabindex=1 align="absmiddle"> </object> 
                                    </comment><script> _ws_(_NSID_);</script>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <comment id="_NSID_"> 
                                        <object id=EM_REMARK classid=<%=Util.CLSID_EMEDIT%> width=305 tabindex=1 align="absmiddle"> </object> 
                                    </comment><script> _ws_(_NSID_);</script>
                                </td>
                                <th>전송자</BR>전화번호</th>
                                <td>
                                    <comment id="_NSID_"> 
                                        <object id=EM_STR_PHONENUM classid=<%=Util.CLSID_EMEDIT%> width=100 tabindex=1 align="absmiddle"> </object> 
                                    </comment><script> _ws_(_NSID_);</script>
                                </td>
                            </tr>
                             ...
                             <tr>
                                ...
                                <td colspan="3">
                                    <comment id="_NSID_"> 
                                        <object id=EM_STR_CHAR_EMAIL classid=<%=Util.CLSID_EMEDIT%> width=295 tabindex=1 align="absmiddle"> </object> 
                                    </comment><script> _ws_(_NSID_);</script>
                                </td>
                            </tr>       
                        </table>
                            ...
                            <tr valign="top">
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="BD4A">
                                    <tr>
                                        <td>
                                          <comment id="_NSID_"> 
                                              <OBJECT id=GR_MASTER width=100% height=72 classid=<%=Util.CLSID_GRID%>>
...
<comment id="_NSID_">
    <object id=BD_MASTER classid=<%=Util.CLSID_BIND%>>
        ...
        <param name=BindInfo        value='
            ...
            <c>Col=STR_PHONENUM         Ctrl=EM_STR_PHONENUM       param=Text</c>
