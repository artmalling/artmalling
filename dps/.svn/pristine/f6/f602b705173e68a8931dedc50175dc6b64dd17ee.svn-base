...
function doInit(){
    ...
    registerUsingDataset("psal511","DS_O_MASTER" );
...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}                name="NO"           width=30    align=center    </FC>'
                     ...
                     + '<FC>id=TRAN_NO                 name="거래번호"       width=50    align=center      suppress=2   </FC>'
                     + '<G>                            name="판매사원"'
                     + '<FC>id=SALE_USER_ID            name="사번"         width=80    align=left      suppress=3     sumtext="합계"</FC>'
                     + '<FC>id=EMP_NAME                name="명"           width=80    align=center      suppress=3    </FC>'
                     + '</G>'
                     + '<FC>id=R_CANCEL                name="취소사유"         width=80    align=left   suppress=4   </FC>'
                     + '<G>                            name="원거래"'
                     + '<FC>id=O_SALE_DT               name="일자"          width=80    align=center       mask="XXXX/XX/XX"</FC>'
                     + '<FC>id=O_POS_NO                name="POS번호"         width=80    align=center      </FC>'
                     + '<FC>id=O_TRAN_NO               name="거래번호"        width=50    align=center      suppress=1   </FC>'
                     + '</G>'
...
function btn_Search() {
    ...
    TR_MAIN.Action="/dps/psal511.ps?goTo="+goTo+parameters;  
 ...
 */
 function searchDetail(){
     ...
     TR_DETAIL.Action="/dps/psal511.ps?goTo="+goTo+parameters;  
