...
public class PSal405DAO extends AbstractDAO {
	...
	public List searchMaster(ActionForm form, String OrgFlag, String userid) throws Exception {
		...
		if(strOrgFlag.equals("1")){
			if(!strPCCd.equals("%") && !strTeamCd.equals("%") && !strDeptCd.equals("%")){
				...
				sql.put(svc.getQuery("SEL_DAYNOREVT_PUMBUN"));
				...
				if(strPCCd.equals("%") && !strTeamCd.equals("%") && !strDeptCd.equals("%") ){
					...
					sql.put(svc.getQuery("SEL_DAYNOREVT_PC"));
					...
					if(strPCCd.equals("%") && strTeamCd.equals("%") && !strDeptCd.equals("%")){
						sql.put(svc.getQuery("SEL_DAYNOREVT_TEAM"));
						...
						if(strPCCd.equals("%") && strTeamCd.equals("%") && strDeptCd.equals("%")){
							sql.put(svc.getQuery("SEL_DAYNOREVT_DEPT"));
			...
			if(!strPCCd.equals("%") && !strTeamCd.equals("%") && !strDeptCd.equals("%")){
				...
				sql.put(svc.getQuery("SEL_DAYNOREVT_PUMBUN2"));
				...
				if(strPCCd.equals("%") && !strTeamCd.equals("%") && !strDeptCd.equals("%") ){
					...
					sql.put(svc.getQuery("SEL_DAYNOREVT_PC2"));
					...
					if(strPCCd.equals("%") && strTeamCd.equals("%") && !strDeptCd.equals("%")){
						sql.put(svc.getQuery("SEL_DAYNOREVT_TEAM2"));
						...
						if(strPCCd.equals("%") && strTeamCd.equals("%") && strDeptCd.equals("%")){
							sql.put(svc.getQuery("SEL_DAYNOREVT_DEPT2"));
