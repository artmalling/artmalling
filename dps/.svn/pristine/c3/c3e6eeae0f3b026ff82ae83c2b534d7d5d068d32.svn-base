 ...
 */
 ...
 function doInit(){
    ...
    registerUsingDataset("pord102","DS_IO_MASTER,DS_IO_DETAIL");
 } 
...
//                      + '<FC>id=NEW_SALE_PRC      name="*단가"        width=80    align=right  edit={IF(BIZ_TYPE="1", IF(SALE_ZERO="Y","true", "false"),"false")} </FC>'    
                      ...
                      + '<FC>id=NEW_SALE_PRC      name="*단가"        width=80    align=right  edit={IF(BIZ_TYPE="1", IF(SALE_ZERO="Y","true", "false"),IF(BIZ_TYPE="2", IF(SALE_ZERO="Y","true", "false"), "false"),"false")} </FC>'                        
...
function btn_Delete() {
    ...
    if(showMessage(Question, YESNO, "USER-1023") == 1){  
        ...
        TR_MAIN.Action="/dps/pord102.po?goTo=save"+params; 
...
function btn_Save() {
    ...
    if( showMessage(QUESTION, YESNO, "USER-1010") == 1 ){    // validation 체크
        ...
        TR_SAVE.Action="/dps/pord102.po?goTo=save&strFlag=save&strBuyerYN="+strBuyerYN; 
...
function getList(){
   ...
   TR_L_MAIN.Action  = "/dps/pord102.po?goTo="+goTo+parameters;  
...
function getDetail(){
   ...
   TR_MAIN.Action="/dps/pord102.po?goTo="+goTo+parameters;  
...
function getSkuInfo(){  
   ...
   TR_S_MAIN.Action   = "/dps/pord102.po?goTo="+goTo+parameters;  
