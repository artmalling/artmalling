...
public class PSal930Action extends DispatchAction {
	/*
	 * Java Pattern 에서 지원하는 logger를 사용할 수 있도록 객체를 선언
	 */
	private Logger logger = Logger.getLogger(PSal930Action.class);
...
//            helper.setDataSetHeader(dsDetail, "H_DETAIL");
    ...
    public ActionForward sendData_first(ActionMapping mapping, ActionForm form,
            HttpServletRequest request, HttpServletResponse response)
            throws Exception {
...
//            helper.setDataSetHeader(dsDetail, "H_DETAIL");
            ...
            recvResult   = dao.sendData_first(form, request);
