...
function doInit(){
    ...
    registerUsingDataset("psal107","DS_IO_DETAIL,DS_O_MASTER" );
...
function btn_Save() {
    ...
    TR_MAIN.Action="/dps/psal107.ps?goTo=save"+parameters;
...
function searchDetail(){
    ...
    TR_DETAIL.Action="/dps/psal107.ps?goTo="+goTo+parameters;  
...
if(row > 0 && old_Row != row  && old_Row > 0){
        //저장되지 않은 내용이 있을경우 경고
    if (DS_IO_DETAIL.IsUpdated ){
         ...
         <tr valign="top">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0"
               ...
               <tr>
                  ...
                  <comment id="_NSID_"> <object
                     id=GD_DETAIL width=100% height=268 classid=<%=Util.CLSID_GRID%>>
