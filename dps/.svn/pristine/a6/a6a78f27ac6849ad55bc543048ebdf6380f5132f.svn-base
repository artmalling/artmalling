<!-- 
/*******************************************************************************
 * 시스템명 : 영업관리 > 재고수불 > 재고실사> 실사재고현황(브랜드별)
 * 작 성 일 : 2010.04.27
 * 작 성 자 : 이재득
 * 수 정 자 : 
 * 파 일 명 : pstk208.jsp
 * 버    전 : 1.0 (버전은 1.0부터 시작하며 0.1씩 증가)
 * 개    요 : 브랜드별 실사재고현황을 조회한다.
 * 이    력 :
 *        2010.04.27 (이재득) 작성
 ******************************************************************************/
-->
...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}          name="NO"              width=30     align=center    edit=none  sumtext=""</FC>'                     
                     ...
                     + '<FC>id=SALE_SALE_AMT     name="금액"            width=110    align=right  edit=none   sumtext=@sum</FC>'
                     + '</FG> ' 
                     + '<FG> name="장부재고" '
                     ...
                     + '<FC>id=LOSS_COST_AMT     name="금액"            width=120    align=right  edit=none   sumtext=@sum</FC>'
                     + '<FC>id=LOSS_RATE         name="율"              width=80    align=right  edit=none     sumtext=@sum</FC>'
                     + '</FG> ' ;                     
...
function gridCreate2(){
    var hdrProperies = '<FC>id={currow}          name="NO"              width=30     align=center    edit=none  sumtext=""</FC>'  
                     + '<FC>id=PUMMOK_CD         name="품목코드"       width=85    align=center  edit=none  SubBgColor=#FFFFE0</FC>'
                     ...
                     + '<FC>id=SRVY_SUM_AMT      name="금액"            width=110    align=right  edit=none   sumtext=@sum  SubBgColor=#FFFFE0</FC>'
                     + '</FG> ' 
                     + '<FG> name="차이" '
                     + '<FC>id=LOSS_QTY          name="수량"            width=70    align=right  edit=none   sumtext=@sum  SubBgColor=#FFFFE0</FC>'
                     + '<FC>id=LOSS_COST_AMT     name="금액"            width=120    align=right  edit=none   sumtext=@sum  SubBgColor=#FFFFE0</FC>'
                     + '<FC>id=LOSS_RATE         name="율"              width=80    align=right  edit=none   sumtext=@sum  SubBgColor=#FFFFE0</FC>'
                     + '</FG> ' ;
...
function btn_Search() { 
    ...
    TR_MAIN.Action="/dps/pstk208.pt?goTo="+goTo+parameters;  
 ...
 **/
 function searchDetail() {
     ...
     var strEventFlag = DS_IO_MASTER.NameValue(DS_IO_MASTER.RowPosition, "EVENT_FLAG");
     var strEventRate = DS_IO_MASTER.NameValue(DS_IO_MASTER.RowPosition, "EVENT_RATE");
     var strMgRate    = DS_IO_MASTER.NameValue(DS_IO_MASTER.RowPosition, "MG_RATE");
     ...
     TR_SUB.Action="/dps/pstk208.pt?goTo="+goTo+parameters;  
