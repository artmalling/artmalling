<!-- 
/*******************************************************************************
 * 시스템명 : 영업관리 > 재고수불 > 재고실사> 단품별재고실사집계표
 * 작 성 일 : 2010.05.06
 * 작 성 자 : 이재득
 * 수 정 자 : 
 * 파 일 명 : pstk212.jsp
 * 버    전 : 1.0 (버전은 1.0부터 시작하며 0.1씩 증가)
 * 개    요 : 단품별 실사재고 집계표 현황을 보여준다.
 * 이    력 :
 *        2010.05.06 (이재득) 작성
 ******************************************************************************/
-->
...
function gridCreate2(){
    var hdrProperies = '<FC>id={currow}          name="NO"             width=30    align=center  edit=none  sumtext=""  SubBgColor=#FFFFE0</FC>'    	                            
                     ...
                     + '<FC>id=PUMMOK_NAME       name="품목명"          width=100    align=left    edit=none  sumtext="" Suppress="1" SubBgColor=#FFFFE0</FC>'
                     + '<FC>id=SKU_CD            name="단품코드"        width=110    align=center  edit=none  sumtext="" SubBgColor=#FFFFE0</FC>'
                     + '<FC>id=SKU_NAME          name="단품명"          width=100    align=left    edit=none  sumtext="" Suppress="2" SubBgColor=#FFFFE0</FC>'                     
                     + '<FG> name="장부재고" '
                     + '<FC>id=STK_QTY           name="수량"           width=70    align=right  edit=none   sumtext=@sum  SubBgColor=#FFFFE0</FC>'
                     + '<FC>id=STK_AMT           name="금액"           width=110    align=right  edit=none   sumtext=@sum  SubBgColor=#FFFFE0</FC>'
                     + '</FG> ' 
                     ...
                     + '<FC>id=SRVY_QTY          name="합계수량"        width=70    align=right  edit=none   sumtext=@sum  SubBgColor=#FFFFE0</FC>'
                     + '<FC>id=SRVY_SALE_AMT     name="합계금액"        width=110    align=right  edit=none   sumtext=@sum  SubBgColor=#FFFFE0</FC>'
                     + '</FG> ' 
                     + '<FG> name="차이" '
                     + '<FC>id=LOSS_QTY          name="수량"            width=70    align=right  edit=none   sumtext=@sum  SubBgColor=#FFFFE0</FC>'
                     + '<FC>id=LOST_AMT          name="금액"            width=110    align=right  edit=none   sumtext=@sum  SubBgColor=#FFFFE0</FC>'
...
function btn_Search() { 
    ...
    TR_MAIN.Action="/dps/pstk212.pt?goTo="+goTo+parameters;  
 ...
 **/
 function searchDetail() {
     ...
     var parameters = "&strStrCd="+encodeURIComponent(strStrCd)
                    ...
                    + "&strPumbunCd="+encodeURIComponent(strPumbunCd)
                    + "&strStkDt="+encodeURIComponent(strStkDt);
     TR_SUB.Action="/dps/pstk212.pt?goTo="+goTo+parameters;  
