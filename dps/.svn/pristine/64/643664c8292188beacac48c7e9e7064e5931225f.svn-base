...
public class PSal442DAO extends AbstractDAO {
	...
	public List searchMaster(ActionForm form, String OrgFlag, String userid) throws Exception {
		...
		connect("pot");
		if(strCreditFlag.equals("%")){
			sql.put(svc.getQuery("SEL_SALE_TOTAL"));
			...
			if(strCreditFlag.equals("01")){
				sql.put(svc.getQuery("SEL_SALE_JUMUN"));
				...
				sql.put(svc.getQuery("SEL_SALE_COD"));
