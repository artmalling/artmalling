...
function doInit(){
  ...
  //콤보 초기화
    ...
    registerUsingDataset("psal470","DS_O_MASTER" );
...
function gridCreate1(){
    var hdrProperies = '<FC> id=level				name=레벨 Value={CurLevel}   show=FALSE</FC>'
                     ...
                     + '<C>id=CUST_CNT1				name="대비객수"			width=60    align=right		mask="###,###"	gte_columntype="number:0:true" gte_Summarytype="number:0:true"	sumtext={subsum(CUST_CNT1)} SubSumText={subsum(CUST_CNT1)} SubBgColor={decode(curlevel,1,"#FFE08C",2,"#CEF279",3,"#B2EBF4",4,"#B5B2FF",5,"#FFA7A7")}</C>'
...
function btn_Search() {
    ...
    TR_MAIN.Action="/dps/psal470.ps?goTo="+goTo+parameters;  
         ...
         <tr>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0"
               ...
               <tr>
                  ...
                  <th width="70">조직구분</th>
					...
					<th width="70" class="point">점</th>
                     ...
                     <td colspan="2"><b>대비실적기간을 직접 지정</b></td>
               ...
               <tr>
                  ...
                  <th class="point" WIDTH="80" >대비일자</th>
                  <td width="220" ><comment id="_NSID_"> <object
                     id=EM_CMPR_DT_S1 classid=<%=Util.CLSID_EMEDIT%> width=72
                     tabindex=1 align="absmiddle"> </object> </comment> <script> _ws_(_NSID_);</script>
                  <img src="/<%=dir%>/imgs/btn/date.gif"
                     onclick="javascript:openCal('G',EM_CMPR_DT_S1)" align="absmiddle" />
                  ~
                     <comment id="_NSID_"> <object
