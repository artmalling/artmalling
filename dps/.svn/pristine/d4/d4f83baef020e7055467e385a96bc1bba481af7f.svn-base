...
public class PSal406DAO extends AbstractDAO {
	...
	public List searchMaster(ActionForm form, String OrgFlag, String userid) throws Exception {
		...
		if(strOrgFlag.equals("1")){
	        if(!strPummokL.equals("%") && !strPummokM.equals("%")){
				...
				sql.put(svc.getQuery("SEL_PBN_PUMMOK_S"));
				...
				if(!strPummokL.equals("%") && strPummokM.equals("%") && strPummokS.equals("%")){
					...
					sql.put(svc.getQuery("SEL_PBN_PUMMOK_M"));
					...
					if(strPummokL.equals("%") && strPummokM.equals("%") &&  strPummokS.equals("%")){
						...
						sql.put(svc.getQuery("SEL_PBN_PUMMOK_L"));
			...
			if(!strPummokL.equals("%") && !strPummokM.equals("%")){
				...
				sql.put(svc.getQuery("SEL_PBN_PUMMOK_S2"));
						sql.setString(i++, strStrCd);
						sql.setString(i++, strDeptCd);
						sql.setString(i++, strTeamCd);
						sql.setString(i++, strPCCd);
				...
				if(!strPummokL.equals("%") && strPummokM.equals("%") && strPummokS.equals("%")){
					...
					sql.put(svc.getQuery("SEL_PBN_PUMMOK_M2"));
					...
					if(strPummokL.equals("%") && strPummokM.equals("%") &&  strPummokS.equals("%")){
						...
						sql.put(svc.getQuery("SEL_PBN_PUMMOK_L2"));
