...
public class PPay313DAO extends AbstractDAO {
	...
	public int save(ActionForm form, MultiInput mi1, String userId)
		...
		try {
			...
			if(mi1.getString("SEND_FLAG").equals("05")){    //임대수수료전송
				...
				i = 1;
				psql.close();
				psql.put("DPS.PR_DUZON_IF_PO_GONGJE_21", 5);
			...
			if(mi1.getString("SEND_FLAG").equals("05")){    //임대수수료전송
				...
				i = 1;
				psql.close();
				psql.put("DPS.PR_DUZON_IF_PO_GONGJE_22", 5);
			...
			if(mi1.getString("SEND_FLAG").equals("05")){    //임대수수료전송
				...
				i = 1;
	            psql.close();
				psql.put("DPS.PR_DUZON_IF_PO_GONGJE_23", 5);
			...
			if(mi1.getString("SEND_FLAG").equals("06")){            //상품대공제전송
				...
				i = 1;
	            psql.close();
				psql.put("DPS.PR_DUZON_IF_PO_SANGPUM_32", 5);
			...
			if(mi1.getString("SEND_FLAG").equals("07")){            //상품대지불전송
				i = 1;
	            psql.close();				
				psql.put("DPS.PR_DUZON_IF_PO_SANGPUM_31", 5);
