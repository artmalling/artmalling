...
public class PCod209DAO extends AbstractDAO {
	...
	public int save(ActionForm form, MultiInput mi, String strID)
		...
		String strEmail 	= String2.nvl(form.getParam("strEmail"));
		
		String strTel_no1 	= String2.nvl(form.getParam("strTel_no1"));
		String strTel_no2 	= String2.nvl(form.getParam("strTel_no2"));
		String strTel_no3 	= String2.nvl(form.getParam("strTel_no3"));
		...
		try {
			...
			while (mi.next()) {
				...
				System.out.println(mi.getString("TEL_NO1"));
				System.out.println(mi.getString("TEL_NO2"));
				System.out.println(mi.getString("TEL_NO3"));
				...
				if (mi.IS_UPDATE()) {
					...
					sql.setString(++i, strEmail);	
					
					sql.setString(++i, strTel_no1);
					sql.setString(++i, strTel_no2);
					sql.setString(++i, strTel_no3);
