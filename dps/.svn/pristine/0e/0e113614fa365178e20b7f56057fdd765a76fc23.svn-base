...
public class PSal109DAO extends AbstractDAO {
	...
	public List searchMaster(ActionForm form, String OrgFlag, String userid) throws Exception {
		...
		connect("pot");
		if(!strPCCd.equals("%") || !strPumbunCd.equals("")){
			sql.put(svc.getQuery("SEL_PLANPUMBUN"));
			...
			if(strPCCd.equals("%") && strPumbunCd.equals("") && !strTeamCd.equals("%")){
