...
public class POrd210DAO extends AbstractDAO {
	...
	public int conf(ActionForm form, String userId, String org_flag)
		...
		try {
			...
			if("05".equals(strSlipProcStat)){
				...
				sql.setString(11, "        ");
				sql.setString(12, null);
				sql.setString(13, "00"); 

				sql.setString(14, "05"); 
				
				sql.setString(15, userId);
				sql.setString(16, form.getParam("strStrCd"));
				sql.setString(17, form.getParam("strSlipNo"));
				strConfStat = "00";
			}else{
			...
			*/
			...
			if("C".equals(strSlipFlag)|| "E".equals(strSlipFlag) ){
			    ...
			    if("05".equals(strSlipProcStat)){
				   ...
				   sql.setString(15, userId);
				   sql.setString(16, form.getParam("strPStrCd"));
				   sql.setString(17, form.getParam("strPSlipNo"));
				   strConfStat = "00";
			    }else{
				   sql.put(svc.getQuery("UPD_MASTER_CONF"));
				   sql.setString(1, form.getParam("strToday"));
