...
public class POrd115DAO extends AbstractDAO {
...
System.out.println("strBuyerYN::"+strBuyerYN+":org_flag:"+org_flag);
				...
				if (mi1.IS_INSERT()) { // 저장
					...
					sql.setString(i++, mi1.getString("VAT_TAMT"));	        /* 부 가세 */  
...
System.out.println("############"+mapSeqNo.get("ORD_SEQ_NO").toString());					
					...
					sql.setString(i++, mi2.getString("VAT_AMT"));	        /* 부 가세 */  
