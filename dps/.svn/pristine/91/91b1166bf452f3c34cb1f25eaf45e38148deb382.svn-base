...
function doInit(){
   ...
   //현재년도 셋팅
    ...
    registerUsingDataset("psal527","DS_MASTER" );
...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}            width=30  name="NO"     Edit=none              align=center</FC>' 
                     ...
                     + '<FC>id=BARCODE             width=90  align=right   Edit=none   name="바코드" align="center"  Edit={IF(PROC_FLAG="N","true","false")} </FC>'
                     + '<FC>id=RECIEVER            width=90  align=center    Edit=none   name="수취인명"  </FC>'
                     + '<FC>id=PUCHASER            width=90  align=center    Edit=none   name="구매자명" </FC>'
                     + '<FC>id=RECIEVER_HP         width=90  align=left    Edit=none   name="수취인;핸드폰번호" </FC>'
                     + '<FC>id=ORDERER_NM          width=90  align=left    Edit=none   name="주문처" </FC>'
                     + '<FC>id=ORDER_NO            width=90  align=left    Edit=none   name="주문번호" </FC>'
                     + '<FC>id=FLOR                width=90  align=center   Edit=none   name="층" </FC>'
                     + '<FC>id=PUMBUN_NAME         width=90  align=left    Edit=none   name="브랜드명" </FC>'
                     + '<FC>id=ORDER_DT            width=90  align=center    Edit=none   name="발주일자" </FC>'
                     + '<FC>id=STOCK_DT            width=90  align=center    Edit=none   name="입고일" </FC>'
                     + '<FC>id=CONF_DT             width=90  align=center    Edit=none   name="확인" </FC>'
                     //+ '<FC>id=NORM_FLAG           width=90  align=left    Edit=none   name="정상/반품" EditStyle="Combo" Data="1:정상,2:반품"</FC>'
                     + '<FC>id=WAYBILL             width=90  align=center    Edit=none   name="운송장" </FC>'
                     + '<FC>id=RELEASE_DT          width=90  align=center    Edit=none   name="출고일" </FC>'
                     + '<FC>id=CS1                 width=90  align=left    Edit=none   name="CS1" </FC>'
                     + '<FC>id=CS2                 width=90  align=left    Edit=none   name="CS2" </FC>'
                     + '<FC>id=BOX_NO              width=90  align=center   Edit=none   name="박스번호" </FC>'
                     + '<FC>id=ORDER_SEQ           width=90  align=center   Edit=none   name="주문순번" </FC>'
                     + '<FC>id=PUMBUN_CD           width=150 align=left    Edit=none   name="브랜드" </FC>'
                     + '<FC>id=COLOR_NM            width=90  align=left    Edit=none   name="색상" </FC>'
                     + '<FC>id=SIZE_NM             width=90  align=left    Edit=none   name="사이즈" </FC>'
                     + '<FC>id=PRICE               width=90  align=right   Edit=none   name="단가"  </FC>'
                     + '<FC>id=QTY                 width=90  align=right   Edit=none   name="수량" sumtext={sum(QTY)} </FC>'
                     + '<FC>id=AMT                 width=90  align=right   Edit=none   name="금액" sumtext={sum(AMT)} </FC>'
                     + '<FC>id=PRODUCT_NM          width=240 align=left    Edit=none   name="상품명" </FC>'
                     + '<FC>id=ETC                 width=90  align=left    Edit=none   name="비고" </FC>'
...
function btn_Delete() {
   /*   var dataSetId = "";
    ...
    GD_MASTER.ColumnProp('SEL','HeadCheck')= "FALSE";
     ...
     var goTo       = "deleteData" ;    
    var parameters = "strCheckType="+strCheckType
...
function errorchk(){
	 ...
	 var i = 0;
	   ...
	   for(i=1; i <= DS_MASTER.CountRow; i++){
		    ...
		    var strPumbunCd        = DS_MASTER.NameValue(i,"PUMBUN_CD");
...
function CloseCheck(){
    ...
    /*  DS_I_SEARCH_TMP.ClearData();
     ...
     TR_VALCHECK.Action="/dps/psal527.ps?goTo=valCheck"+parameters; 
