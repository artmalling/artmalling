 ...
 *************************************************************************/
 ...
 var strStyleType   = dialogArguments[9];       // 스타일타입
...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}            name="NO"          width=30     align=center  sumtext="" </FC>'
                    ...
                    + '<FC>id=ORD_UNIT_CD          name="단위코드"     width=55     align=left show=false</FC>'
                    + '<FC>id=ORD_UNIT_NM          name="단위명"       width=50     align=left </FC>'
                    + '<FC>id=ORD_QTY              name="수량"         width=50     align=right </FC>'
                    + '<FC>id=CHK_QTY              name="검품수량"     width=55     align=right </FC>'
                    + '<FC>id=MG_RATE              name="마진율"       width=55     align=right </FC>'
                    + '<FG>  name ="원가"'
...
function gridCreate2(){
    var hdrProperies = '<FC>id={currow}            name="NO"          width=30     align=center  sumtext="" </FC>'
                    ...
                    + '<FC>id=STR_NM               name="점명"        width=65      align=left show=false</FC>'
                    + '<FC>id=SLIP_NO              name="전표번호"     width=95     align=left </FC>'
                    + '<FC>id=ORD_SEQ_NO           name="전표상세번호" width=65     align=left show=false</FC>'
...
//    alert(strSlipFlag);
    ...
    TR_MAIN.Action="/dps/pord118.po?goTo="+goTo+parameters;  
