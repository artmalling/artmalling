...
public class POrd209DAO extends AbstractDAO {
	...
	public int conf(ActionForm form, String userId, String org_flag)
		...
		try {
			...
			if("04".equals(strSlipProcStat)){
				...
				sql.setString(12, form.getParam("strStrCd"));
				sql.setString(13, form.getParam("strSlipNo"));
				strConfStat = "00";
			}else{
			...
			*/
			...
			if("C".equals(strSlipFlag)|| "E".equals(strSlipFlag) ){
			    ...
			    if("04".equals(strSlipProcStat)){
				   ...
				   sql.setString(11, userId);
				   sql.setString(12, form.getParam("strPStrCd"));
				   sql.setString(13, form.getParam("strPSlipNo"));
				   strConfStat = "00";
			    }else{
				   sql.put(svc.getQuery("UPD_MASTER_CONF"));
				   sql.setString(1, form.getParam("strToday"));
