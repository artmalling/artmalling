...
public class POrd106DAO extends AbstractDAO {
    	
	/**
	 * 신선단품 대출입발주 마스터 내역 조회
	 * 
	 * @param form
	 * @return
	 * @throws Exception
	...
	public int save(ActionForm form, MultiInput mi[], String userId, String org_flag)
		...
		try {
			...
			strBuyerYN = String2.nvl(form.getParam("strBuyerYN"));		// 바이어,SM 여부
			...
			while (mi1.next()) {
				...
				if (mi1.IS_INSERT()) { // 저장
					...
					if("C".equals(mi1.getString("SLIP_FLAG")))
						...
						sql.setString(i++, mi1.getString("PVAT_TAMT"));			/* 부가세 */
