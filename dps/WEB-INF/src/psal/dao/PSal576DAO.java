...
public class PSal576DAO extends AbstractDAO {
	...
	public List searchMaster(ActionForm form, String OrgFlag, String userid) throws Exception {
		...
		String strSaleDtS2 		= String2.nvl(form.getParam("strSaleDtS2"));
		String strSaleDtE2 		= String2.nvl(form.getParam("strSaleDtE2"));
		...
		if(strOrgFlag.equals("1")){
			...
			sql.setString(i++, strSaleDtS2);
			 // 목표일
			sql.setString(i++, strStrCd);
			sql.setString(i++, strSaleDtS.substring(0,6));
			sql.setString(i++, strSaleDtS2.substring(0,6));
			sql.setString(i++, strSaleDtS);
			sql.setString(i++, strSaleDtS2);
	...
	public int saveData(ActionForm form, String OrgFlag, String userid) throws Exception {
		...
		sql2.setString(i++, strSaleDtS.substring(0, 4));
