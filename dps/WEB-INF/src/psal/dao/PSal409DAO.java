...
public class PSal409DAO extends AbstractDAO {
	...
	public List searchMaster(ActionForm form, String OrgFlag, String userid) throws Exception {
		...
		if(!strCardsa.equals("%")) {
			sql.put(svc.getQuery("SEL_CARD_SALE_WHERE1"));
			sql.setString(i++, strCardsa);
		}
		if(!strBcomp.equals("%")) {
			sql.put(svc.getQuery("SEL_CARD_SALE_WHERE2"));
			sql.setString(i++, strBcomp);
		}
		
		sql.put(svc.getQuery("SEL_CARD_SALE1"));
		
		sql.setString(i++, strStrCd);
		
		
		
		if(!strPosFloor.equals("%")) {
			sql.put(svc.getQuery("SEL_CARD_SALE_WHERE3"));
			sql.setString(i++, strPosFloor);
		}
		if(!strPosFlag.equals("%")) {
			sql.put(svc.getQuery("SEL_CARD_SALE_WHERE4"));
			sql.setString(i++, strPosFlag);
		}
		
		sql.put(svc.getQuery("SEL_CARD_SALE2"));
	...
	public List searchDetail(ActionForm form, String OrgFlag, String userid) throws Exception {
		...
		sql.put(svc.getQuery("SEL_CARD_SALE_DATE1"));
		...
		sql.put(svc.getQuery("SEL_CARD_SALE_DATE2"));
