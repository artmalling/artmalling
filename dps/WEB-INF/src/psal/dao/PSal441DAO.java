...
public class PSal441DAO extends AbstractDAO {
	...
	public List searchMaster(ActionForm form, String OrgFlag, String userid) throws Exception {
		...
		if(strOrgFlag.equals("1")){
	    	sql.put(svc.getQuery("SEL_SALE_ETCPUMBUN"));
			...
			sql.put(svc.getQuery("SEL_SALE_ETCPUMBUN2"));
	...
	public List searchDetail(ActionForm form, String OrgFlag, String userid) throws Exception {
		...
		connect("pot");
        if(strOrgFlag.equals("1")){
	    	sql.put(svc.getQuery("SEL_SALE_ETCPUMMOK"));
        	...
        	sql.put(svc.getQuery("SEL_SALE_ETCPUMMOK2"));
