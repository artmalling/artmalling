...
public class PSal801DAO extends AbstractDAO {
	...
	public int save(ActionForm form, MultiInput mi1, String userId)
		...
		try {
            ...
            if(mi1.getString("SEND_FLAG").equals("01")){
            	psql.put("DPS.PR_DUZON_IF_PS_DAY", 5);
			}else if(mi1.getString("SEND_FLAG").equals("02")){
				psql.put("DPS.PR_MAECHULEND_IFS", 5);			
		    // 특정비단품반품재매입자동전표 처리
			} else if (mi1.getString("SEND_FLAG").equals("11")) {
				psql.put("DPS.PR_POAUTOINOUTSLP_PBNPMK", 5);	
			}
