...
import common.edi.service.Psal923EDI;
...
public class PSal923DAO extends AbstractDAO {
	/*
	 * Java Pattern 에서 지원하는 logger를 사용할 수 있도록 객체를 선언
	 */
	private Logger logger = Logger.getLogger(PSal923DAO.class);
...
*/
    		...
    		if (sendResult != 0) {    		
    			System.out.println("Psal923:sendResult : " + sendResult);
    			System.out.println("Psal923:sendMessage : " + sendMessage);
...
//		};
		...
		int result = 0;
		try {
			Psal923EDI esvc = new Psal923EDI();
