 ...
 *
 */
public class Psal931EDI extends AbstractEDIService{	
	/**
	 * Constructor
	 */
	public Psal931EDI() throws Exception {
		try {
			this.setTranFormDoc("/psal931.edi.xml");
		} catch (Exception e) {
			System.out.println("전문포맷 로드중 실패하였습니다.:"+ "psal931.edi.xml");
			e.printStackTrace();
			throw e;
		}
	}
