 ...
 *
 */
public class Psal923EDI extends AbstractEDIService{	
	/**
	 * Constructor
	 */
	public Psal923EDI() throws Exception {
		try {
			this.setTranFormDoc("/psal923.edi.xml");
		} catch (Exception e) {
			System.out.println("전문포맷 로드중 실패하였습니다.:"+ "psal923.edi.xml");
			e.printStackTrace();
			throw e;
		}
	}
