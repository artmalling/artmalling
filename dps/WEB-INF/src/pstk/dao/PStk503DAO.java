...
public class PStk503DAO extends AbstractDAO {
	...
	public int save(ActionForm form, MultiInput mi1, String userId)
		...
		try {
            ...
            if(mi1.getString("SEND_FLAG").equals("08")){
            	psql.put("DPS.PR_MAEIP_IFS", 5);            	
			}else if(mi1.getString("SEND_FLAG").equals("09")){
				psql.put("DPS.PR_SONIK_IFS", 5);				
			}else if(mi1.getString("SEND_FLAG").equals("10")){
				psql.put("DPS.PR_SONIKF_IFS", 5);				
			}
	...
	/**
	 *  매입/수불회계전표생성전  Validation Check 한다.
	 * 
	 * @param form
	 * @param mi1
	 * @param strID
