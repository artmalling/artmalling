 ...
 */
 ...
 function gridCreate1(){
     var hdrProperies = '<FC>id={currow}          name="NO"              width=30     align=center</FC>'
			          + '<FC>id=PAY_DT            name="지불일자"        width=100     align=center mask="XXXX/XX/XX"</FC>'
                      ...
                      + '<FC>id=SALE_COMIS_AMT    name="이익액"           width=90     align=right  sumtext=@sum  </FC>'
                      + '<FC>id=PAY_TRG_AMT       name="지불대상액"        width=90     align=right  sumtext=@sum  </FC>';
 ...
 */
 function getMaster(){
    ...
    TR_MAIN.Action  = "/dps/ppay303.pp?goTo="+goTo+parameters;  
  ...
  function getPayDt() {
	...
	var goTo         = "getPayDt" ;    
 	...
 	var parameters = "&strStrCd="+encodeURIComponent(strStrCd)   
 	 ...
 	 TR_DETAIL.Action="/dps/ppay303.pp?goTo="+goTo+parameters;  
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr valign="top">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="BD4A">
                    ...
                    <td>
                          <comment id="_NSID_"> 
                              <OBJECT id=GR_MASTER width=100% height=428 classid=<%=Util.CLSID_GRID%>>
