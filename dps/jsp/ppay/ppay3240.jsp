 ...
 function checkValidation(Gubun) {
  ...
  function process(){
        ...
        if( showMessage(QUESTION, YESNO, "USER-1204") == 1 ){    // validation 체크
        	TR_SAVE.Action="/dps/ppay324.pp?goTo=save&strFlag=save"; 
        ...
        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table">
          ...
          <tr>
              ...
              <td colspan=2 ><comment id="_NSID_"> <object
                  ...
                  <param name=Format value="%^전체,2^특정,3^임대을,5^임대을B-TYPE">
...
<comment id="_NSID_">
    <object id=BD_SEARCH classid=<%=Util.CLSID_BIND%>>
        ...
        <param name=BindInfo        value='
            ...
            <c>Col=PAY_FLAG            Ctrl=LC_PAY_FLAG           param=BindColVal</c>
