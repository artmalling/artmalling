...
function btn_Delete() {
    ...
    if(showMessage(Question, YESNO, "USER-1023") == 1){  
        ...
        TR_MAIN.Action="/dps/ppay108.pp?goTo=delete&strFlag=delete"; 
...
function btn_Save() {
    ...
    if( showMessage(QUESTION, YESNO, "USER-1010") == 1 ){    // validation 체크
        TR_SAVE.Action="/dps/ppay108.pp?goTo=save&strFlag=save"; 
...
//     GR_MASTER.Editable                 = flag;
  ...
  */
  function getList(){
     ...
     TR_MAIN.Action  = "/dps/ppay108.pp?goTo="+goTo+parameters;  
 ...
 */
 function getMaster(){
    ...
    TR_S_MAIN.Action  = "/dps/ppay108.pp?goTo="+goTo+parameters;  
 ...
 */
 ...
 function getCharName(strVenCd) {
     ...
     TR_DETAIL.Action="/dps/ppay108.pp?goTo="+goTo+parameters;  
