...
function btn_Conf() {
    ...
    //승인취소하려면
    if(DS_LIST.Namevalue(DS_LIST.RowPosition ,"SLIP_PROC_STAT") == "04"){ //바이어확정상태
        //승인(반려)하시겠습니까?
    ...
    for (var i = 0; i < DS_LIST.CountRow; i++)
    {
       if(DS_LIST.NameValue(i + 1, "CHECK1") == "T"){   
          ...
          TR_MAIN.Action="/dps/pord202.po?goTo=conf"+params;
          TR_MAIN.Post();
          k = k+1;
       }   
    }    
...
//    setEventFlagDs();  //행사구분 행사율 데이터셋 복사
    ...
    TR_L_MAIN.Action="/dps/pord202.po?goTo="+goTo+parameters;  
 ...
 */
 function getMaster(){
        ...
        TR_S_MAIN.Action="/dps/pord202.po?goTo="+goTo+parameters;  
