 ...
 */
 ...
 function doInit(){
	//Master 그리드 세로크기자동조정  2013-07-17
     ...
     initEmEdit(EM_S_FLAG_CD,  "000000",    NORMAL);      //구분코드   
     ...
     initComboStyle(LC_O_TAX_FLAG,      DS_O_TAX_FLAG,    "CODE^0^30,NAME^0^80", 1, NORMAL);   //조회용 과면세구분

    getStore("DS_STR", "Y", "", "N");                                                          //점        
    getEtcCode("DS_O_GJDATE_TYPE", "D", "P214", "N");                                          //기준일
    getEtcCode("DS_O_OWN_FLAG",    "D", "P202", "Y");       // 발주주체구분
    getEtcCode("DS_O_TAX_FLAG",    "D", "P004", "Y");       // 발주주체구분
    ...
    registerUsingDataset("pord119","DS_LIST,DS_DETAIL1,DS_DETAIL2,DS_DETAIL3");
 } 
 ...
 function gridCreate(){
     var hdrProperies = '<FC>id={currow}           name="NO"          width=30      align=center  sumtext="" </FC>'
                     ...
                     + '<FC>id=PUMBUN_CD           name="브랜드1"    width=65     align=center show=false</FC>'
                     + '<FC>id=PUMBUN_NM_1         name="브랜드명1"      width=130    align=left show=false</FC>'
                     ...
                     + '<FC>id=PUMBUN_CD_2         name="브랜드1"    width=65     align=center </FC>'
                     + '<FC>id=PUMBUN_NM_2         name="브랜드명1"      width=130    align=left </FC>'
                     ...
                     + '<C>id=PUMBUN_CD_3          name="브랜드1"    width=90     align=center </C>'
                     + '<C>id=PUMBUN_NM_3          name="브랜드명1"      width=130    align=left </C>'
                     + '<C>id=VEN_CD_2             name="협력사"   width=90     align=center </C>'
                     + '<C>id=VEN_NM_2             name="협력사명"     width=100    align=left </C>'
                     + '<C>id=SLIP_FLAG            name="전표구분"     width=65     align=center show=false</C>'
                     + '<C>id=SLIP_FLAG_NM         name="전표구분"     width=65     align=left </C>'
                     ...
                     + '<C>id=PUMBUN_CD_4          name="브랜드2"  width=65     align=left </C>'
 ...
 function gridCreateBuyer(){
     var hdrProperies = '<FC>id={currow}           name="NO"           width=30     align=center  sumtext="" </FC>'
                     ...
                     + '<FC>id=PUMBUN_CD_3         name="브랜드1"    width=90     align=center </FC>'
                     + '<FC>id=PUMBUN_NM_3         name="브랜드명1"      width=130    align=left </FC>'
                     + '<C>id=VEN_CD_2             name="협력사"   width=90     align=center </C>'
                     + '<C>id=VEN_NM_2             name="협력사명"     width=130    align=left </C>'
                     + '<C>id=SLIP_FLAG            name="전표구분"     width=65     align=center show=false</C>'
                     + '<C>id=SLIP_FLAG_NM         name="전표구분"     width=65     align=left </C>'
                     + '<C>id=SLIP_NO              name="전표번호"     width=110     align=center mask="XXXX-X-XXXXXXX"</C>'
                     + '<C>id=ORD_DT               name="발주일"       width=80     align=center mask="XXXX/XX/XX"</C>'
                     ...
                     + '<C>id=PAY_COND_NM          name="지불구분"     width=65     align=left </C>'
                     + '<C>id=PUMBUN_CD_4          name="브랜드2"    width=65     align=left </C>'
                     + '<C>id=PUMBUN_NM_4          name="브랜드명2"      width=130     align=left </C>'
                     + '<C>id=BUYER_NM_2           name="바이어명"     width=100    align=left </C>'
                     + '<C>id=SLIP_PROC_STAT       name="전표상태"     width=65     align=center show=false</C>'
                     + '<C>id=SLIP_PROC_STAT_NM    name="전표상태"     width=65     align=left </C>'
                     + '<C>id=PAIR_STR_CD          name="상대점"       width=65     align=center show=false</C>'
 ...
 function gridCreate1(){
     var hdrProperies = '<FC>id={currow}            name="NO"          width=30     align=center  sumtext="" </FC>'
                     ...
                     + '<FG>  name ="원가"'
                     + '<FC>id=NEW_COST_PRC         name="단가"         width=65     align=right </FC>'
                     + '<FC>id=NEW_COST_AMT         name="금액"         width=65     align=right </FC>'
                     + '</FG>'
                     + '<FG>  name ="매가"'
                     + '<FC>id=NEW_SALE_PRC         name="단가"         width=65     align=right </FC>'
                     + '<FC>id=NEW_SALE_AMT         name="금액"         width=65     align=right </FC>'
                     + '</FG>';
 ...
 function gridCreate2(){
     var hdrProperies = '<FC>id={currow}            name="NO"          width=30     align=center  sumtext="" </FC>'
                     ...
                     + '<FC>id=ORD_QTY              name="수량"         width=65     align=right </FC>'
                     + '<FC>id=CHK_QTY              name="검품수량"     width=65     align=right </FC>'
                     + '<FC>id=RATE                 name="목표이익율"   width=90     align=right </FC>'
                     + '<FG>  name ="원가"'
 ...
 function gridCreate3(){
     var hdrProperies = '<FC>id={currow}            name="NO"          width=30     align=center  sumtext="" </FC>'
                     + '<FC>id=STR_CD               name="점코드"      width=65      align=left show=false</FC>'
                     + '<FC>id=STR_NM               name="점명"        width=65      align=left show=false</FC>'
                     + '<FC>id=SLIP_NO              name="전표번호"     width=95     align=center mask="XXXX-X-XXXXXXX"</FC>'
                     + '<FC>id=ORD_SEQ_NO           name="전표상세번호" width=65     align=left show=false</FC>'
                     ...
                     + '<FC>id=CHK_QTY              name="검품수량"     width=65     align=right </FC>'
                     + '<FG>  name ="구매가"'
                     + '<FC>id=OLD_SALE_PRC         name="단가"         width=65     align=right </FC>'
                     + '<FC>id=OLD_SALE_AMT         name="금액"         width=65     align=right </FC>'
                     + '</FG>'
                     + '<FG>  name ="신매가"'
                     + '<FC>id=N_NEW_SALE_PRC       name="단가"         width=65     align=right </FC>'
                     + '<FC>id=N_NEW_SALE_AMT       name="금액"         width=65     align=right </FC>'
                     + '</FG>'
 ...
 function gridCreate4(){
     var hdrProperies = '<FC>id={currow}            name="NO"          width=30     align=center  sumtext="" </FC>'
                     ...
                     + '<FC>id=SLIP_NO              name="전표번호"     width=95     align=center mask="XXXX-X-XXXXXXX"</FC>'
                     + '<FC>id=ORD_SEQ_NO           name="전표상세번호" width=65     align=left show=false</FC>'
                     + '<FC>id=PUMMOK_SRT_CD        name="단축코드"     width=55     align=center show=false</FC>'
 ...
 function gridCreate5(){
    var hdrProperies = '<FC>id={currow}            name="NO"          width=30     align=center  sumtext="" </FC>'
                     ...
                     + '<FC>id=SLIP_NO              name="전표번호"     width=95     align=center mask="XXXX-X-XXXXXXX"</FC>'
                     + '<FC>id=ORD_SEQ_NO           name="전표상세번호" width=65     align=left show=false</FC>'
                     + '<FC>id=PUMMOK_SRT_CD        name="단축코드"     width=55     align=left show=false</FC>'
...
function btn_Excel() {  
	...
	var ExcelTitle = "발주현황조회"  
	var excel_codeGbn = null;
 ...
 */
 function getList(){
    ...
    var strTaxFlag       = LC_O_TAX_FLAG.BindColVal;
    ...
    var parameters  = "&strStrCd="+encodeURIComponent(strStrCd)     
                    ...
                    ; 
    TR_MAIN.Action="/dps/pord119.po?goTo="+goTo+parameters;  
...
//    alert(strSlipFlag);
    ...
    TR_S_MAIN.Action="/dps/pord119.po?goTo="+goTo+parameters;  
...
//       setTimeout("obj.Focus()",50);
 ...
 function setOutPutValue() {
     ...
     var disTaxFlag        = LC_O_TAX_FLAG.Text;        // 과면세구분    
 ...
 */
 ...
 function getBuyerInfo(){
     ...
     var rtnMap = buyerCharNamePop( EM_S_FLAG_CD, EM_S_FLAG_NM , 'Y', '', tmpOrgFlag, strOrgCd, '1', 'Y','');
...
//        EM_S_FLAG_NM.Text = rtnMap.get("PUMBUN_NAME");
  ...
  function getBuyerNonInfo(){
      ...
      var rtnMap = setBuyerCharNameWithoutPop( "DS_O_RESULT",EM_S_FLAG_CD, EM_S_FLAG_NM , 'Y', '1', '', tmpOrgFlag, strOrgCd, '1', 'Y','');
            ...
            <tr>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        ...
                        <th>과면세구분</th>
                        <td><comment id="_NSID_"> <object
                            id=LC_O_TAX_FLAG classid=<%=Util.CLSID_LUXECOMBO%> height=100
                            width=100 align="absmiddle" tabindex=1> </object> </comment><script>_ws_(_NSID_);</script>
                        </td>
