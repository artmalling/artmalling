 ...
 */
 ...
 function doInit(){
     ...
     //initEmEdit(EM_O_SLIP_NO,  "NUMBER^11^0",     READ);      //출력용 전표번호
    ...
    // EM_O_SLIP_NO.Format      = "0000-0000000";               // 마스크 입힘
...
//    getPc("DS_O_PC", "Y", LC_O_STR.BindColVal, LC_O_BUMUN.BindColVal, LC_O_TEAM.BindColVal, "Y");// PC  
    ...
    registerUsingDataset("pord201","DS_LIST");
 } 
...
function btn_Conf() {
    ...
    //승인 취소하려면
    if(DS_LIST.Namevalue(DS_LIST.RowPosition ,"SLIP_PROC_STAT") == "01"){  
    ...
    for (var i = 0; i < DS_LIST.CountRow; i++)
    {
 	   if(DS_LIST.NameValue(i + 1, "CHECK1") == "T"){  		
           ...
           TR_MAIN.Action="/dps/pord201.po?goTo=conf"+params;
           TR_MAIN.Post();
           k = k+1;
 	   }   
    }    
...
//    setEventFlagDs();  //행사구분 행사율 데이터셋 복사
    ...
    TR_L_MAIN.Action="/dps/pord201.po?goTo="+goTo+parameters;  
 ...
 */
 function getMaster(){
        ...
        TR_S_MAIN.Action="/dps/pord201.po?goTo="+goTo+parameters;  
