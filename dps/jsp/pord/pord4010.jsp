 ...
 */
 ...
 function doInit(){
    ...
    registerUsingDataset("pord401","DS_LIST");
 } 
 ...
 function gridCreate1(){
     var hdrProperies = '<FC>id={currow}           name="NO"          width=30     edit=none align=center  sumtext=""     </FC>'
                      ...
                      + '<FC>id=PUMBUN_NM          name="브랜드"        width=100     edit=none align=left suppress=4 </FC>'
                      + '<FC>id=SALE_ORG_BM        name="팀코드"    width=80     edit=none align=center suppress=3   show=false</FC>'
                      + '<FC>id=SALE_ORG_BM_NM     name="팀명"      width=60     edit=none align=left suppress=3</FC>'
                      + '<FC>id=SALE_ORG_TEAM      name="파트코드"      width=80     edit=none align=center suppress=2   show=false</FC>'
                      + '<FC>id=SALE_ORG_TEAM_NM   name="파트명"      width=80    edit=none align=left suppress=2</FC>'
                      + '<FC>id=SALE_ORG_PC        name="PC코드"      width=80     edit=none align=center suppress=1 show=false</FC>'
                      + '<FC>id=SALE_ORG_PC_NM     name="PC명"        width=80    edit=none align=left suppress=1</FC>'
                      ...
                      + '<FG> name="원가금액"'
                      + '<FC>id=CHK_COST_TAMT      name="공급가"      width=110     edit=none align=right sumtext=@sum</FC>'
                      + '<FC>id=VAT_AMT            name="부가세"      width=100     edit=none align=right sumtext=@sum</FC>'
                      + '<FC>id=TOT_AMT            name="합계"        width=110     edit=none align=right sumtext=@sum</FC>'
                      + '</FG>'
                      + '<FC>id=OLD_SALE_TAMT      name="구매가계"    width=110    edit=none align=right show=false</FC>'
                      + '<FC>id=CHK_SALE_TAMT      name="매가계"      width=110     edit=none align=right sumtext=@sum</FC>'
 ...
 * return값 : void
 */
function btn_Excel() { //2015-01-02 재무팀 최실근 주임 요청(엑셀 추가)
	if(DS_LIST.CountRow <= 0){
	      showMessage(INFORMATION, OK, "USER-1000","다운 할 내용이 없습니다. 조회 후 엑셀다운 하십시오.");
	        return;
	    }
	    var strTitle = "매입현황집계표";
      ...
      if(EM_S_PUMBUN_CD.Text.length < 1) {
	    ...
	    var parameters = "점 - "           + strStrCd
	                   ...
	                   + " ,   검품일 : "    + strDt
	                   + " ,   브랜드 - "      + strPumbunCd
	                   + " ,   거래형태 = "      + g_disPlayBizTypeNM
	                   + " ,   전표구분 = "  +  g_disPlaySlipFlagNM;
...
function btn_Print() {
    ...
    window.open("/dps/pord401.po?goTo=print"+parameters,"OZREPORT", 1000, 700);
...
//    setEventFlagDs();  //행사구분 행사율 데이터셋 복사
    ...
    TR_L_MAIN.Action="/dps/pord401.po?goTo="+goTo+parameters;  
