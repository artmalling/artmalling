<!-- 
/*******************************************************************************
 * 시스템명 : 영업관리 > 발주관리 > 의류단품 점출입발주
 * 작 성 일 : 2010.03.22
 * 작 성 자 : 김 경 은
 * 수 정 자 : 
 * 파 일 명 : pord1100.jsp
 * 버    전 : 1.0 (버전은 1.0부터 시작하며 0.1씩 증가)
 * 개    요 : 규격단품으로 관리하는 상품의 점출입 발주 등록한다.
 * 이    력 :
 * 
 ******************************************************************************/
-->
 ...
 */
 ...
 function doInit(){
    ...
    registerUsingDataset("pord110","DS_IO_MASTER,DS_IO_DETAIL1,DS_IO_DETAIL2");
...
function btn_Delete() {
    ...
    if(showMessage(Question, YESNO, "USER-1023") == 1){  
        ...
        TR_MAIN.Action="/dps/pord110.po?goTo=save"+params; 
...
function btn_Save() {
    ...
    if( showMessage(QUESTION, YESNO, "USER-1010") == 1 ){
	    ...
	    TR_SAVE.Action="/dps/pord110.po?goTo=save&strFlag=save&strBuyerYN="+strBuyerYN; 
 ...
 */
 function getList(){
   ...
   TR_S_MAIN.Action  = "/dps/pord110.po?goTo="+goTo+parameters;  
...
function getDetail(){
   ...
   TR_MAIN.Action="/dps/pord110.po?goTo="+goTo+parameters;  
...
* return값 : void
*/
function getPumbunInfo(gubun, pop){
 ...
 */
 function setStrPbnNmWithoutPopCall(gubun){
    ...
    if(DS_O_RESULT.CountRow == 1){
        ...
        // 점입관련
        EM_P_PUMBUN_CD.Text   = DS_O_RESULT.NameValue(DS_O_RESULT.RowPosition, "PUMBUN_CD");
        EM_P_PUMBUN_NM.Text   = DS_O_RESULT.NameValue(DS_O_RESULT.RowPosition, "PUMBUN_NAME");
 ...
 */
 function getSkuInfo(gubun){ 
    ...
    if(DS_O_SKU_INFO.CountRow > 0){
        DS_DETAIL.NameValue(DS_DETAIL.RowPosition, "SEL")           = 'F';
        ...
        DS_DETAIL.NameValue(DS_DETAIL.RowPosition, "ORD_STK_QTY")   = DS_O_SKU_INFO.NameValue(DS_O_SKU_INFO.RowPosition, "ORD_STK_QTY");     // 재고
        DS_DETAIL.NameValue(DS_DETAIL.RowPosition, "AVG_SALE_QTY")  = DS_O_SKU_INFO.NameValue(DS_O_SKU_INFO.RowPosition, "AVG_SALE_QTY");    // 평균판매량
        DS_DETAIL.NameValue(DS_DETAIL.RowPosition, "AVG_SALE_AMT")  = DS_O_SKU_INFO.NameValue(DS_O_SKU_INFO.RowPosition, "AVG_SALE_PRC");    // 평균판매액
        ...
        if(strBizType == "2")
            ...
            DS_DETAIL.NameValue(DS_DETAIL.RowPosition, "NEW_GAP_RATE")   = DS_O_SKU_INFO.NameValue(DS_O_SKU_INFO.RowPosition, "SALE_MG_RATE");
        return true;
    }else
        return false;
 }
...
function addDetailRow(gubun){
    ...
    if(gubun == "E"){           // 점출
        ...
        setFocusGrid(GR_DETAIL1, DS_IO_DETAIL1,DS_IO_DETAIL1.RowPosition,"SKU_CD");
     }
}
...
function delDetailRow(gubun){
    ...
    setDetailObject(true);
    setGapCalc(DS_IO_DETAIL1.RowPosition);
}
 ...
 */
  ...
  */
  function setGapCalc(row){
      ...
      EM_GAP_RATE.Text     = getRoundDec(roundFlag,((DS_IO_DETAIL1.Sum(21,0,0)/1.1) - DS_IO_DETAIL1.Sum(19,0,0))/(DS_IO_DETAIL1.Sum(21,0,0)/1.1) * 100,2);  // 총차익율
      EM_GAP_TOT_AMT.Text  = getRoundDec(roundFlag,DS_IO_DETAIL1.Sum(21,0,0)/1.1 - DS_IO_DETAIL1.Sum(19,0,0));                     // 차익액합계
...
<!-- PC(조회)  변경시  -->
<script language=JavaScript for=LC_S_PC event=onKillFocus()>
	EM_S_PB_CD.Text  = "";
	EM_S_PB_NM.Text  = "";
</script>
                    ...
                    <tr>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <comment id="_NSID_"> 
                                        <object id=EM_E_PROC_STAT classid=<%=Util.CLSID_EMEDIT%> width=115 align="absmiddle"> </object> 
                                    </comment><script>_ws_(_NSID_);</script>
                                </td>                            
                            </tr>
                            ...
                            <tr valign="top">
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="BD4A">
                                    <tr>
                                        <td>
                                          <comment id="_NSID_"> 
                                              <OBJECT id=GR_DETAIL1 width=100% height=197 classid=<%=Util.CLSID_GRID%>>
