...
function doInit(){
    ...
    registerUsingDataset("psal445","DS_O_MASTER" );
...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}               name="NO"           width=30    align=center    </FC>'
                     ...
                     + '<G>                           name="브랜드"'
                     + '<C>id=PUMBUN_CD               name="코드"          width=60    align=center     </C>'
                     + '<C>id=PUMBUN_NAME             name="명"            width=90    align=left     </C>'
                     + '</G>'
                     + '<G>                           name="품목"'
                     + '<C>id=PUMMOK_CD               name="코드"          width=65    align=center      </C>'
                     + '<C>id=PUMMOK_NAME             name="명"            width=90    align=left      </C>'
                     + '</G>'
                     + '<G>                           name="단품"'
                     + '<C>id=SKU_CD                  name="코드"          width=105    align=center      </C>'
                     + '<C>id=SKU_NAME                name="명"            width=90    align=left      </C>'
                     + '</G>'
                     + '<C>id=CALL_QTY                name="수량"          width=60    align=right     mask="###,###"     sumtext=@sum</C>'
                     + '<C>id=CALL_AMT                name="금액"          width=90    align=right    mask="###,###"     sumtext=@sum</C>'
                     ;
...
function btn_Search() {
    ...
    TR_MAIN.Action="/dps/psal445.ps?goTo="+goTo+parameters;  
