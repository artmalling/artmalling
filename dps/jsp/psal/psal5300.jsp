...
function doInit(){
    ...
    registerUsingDataset("psal530","DS_O_MASTER" );
...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}                name="NO"                width=60    align=center    </FC>'
                     ...
                     + '<FC>id=OKCASHBAG_AMT           name="OK캐쉬백"           gte_columntype="number:0:true" gte_Summarytype="number:0:true"		width=80    align=right    show=false</FC>'// mask="###,###"   sumtext={subsum(OKCASHBAG_AMT)}
                     + '<FC>id=SALE_DT                 name="매출일자"           width=80    align=right     show=false </FC>'
                     ;
...
function btn_Print() {
   ...
   /*  strPayInfo = "월" + strPayCyc +"회, " +  LC_S_PAY_CNT.Text;
    ...
    window.open("/dps/psal530.ps?goTo=print"+parameters,"OZREPORT", 1000, 700);   
}
...
function searchPosNo(strPosNo){
    ...
    TR_DETAIL.Action="/dps/psal530.ps?goTo="+goTo+parameters;  
