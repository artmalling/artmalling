...
function doInit(){
    ...
    */
    ...
    registerUsingDataset("psal460","DS_O_MASTER" );
...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}                name="NO"           width=30    align=center    </FC>'
                     + '<X>                            name="브랜드"'
			         + '<C>id=PUMBUN_CD                name="코드"      width=60    align=center    suppress=1</C>'
			         + '<C>id=PUMBUN_NAME              name="명"        width=100    align=left      suppress=1   sumtext="합계"</C>'
			         + '</X>'
                     + '<X>                            name="품목"'
			         + '<C>id=PUMMOK_CD                name="코드"      width=80    align=center    suppress=2</C>'
			         + '<C>id=PUMMOK_NAME              name="명"        width=100    align=left      suppress=2   sumtext="합계"</C>'
			         + '</X>'
			         + '<X>                            name="매출"'
			         + '<R>'
			         + '<G>                            name="수량"'
...
function btn_Search() {
    ...
    TR_MAIN.Action="/dps/psal460.ps?goTo="+goTo+parameters;  
         ...
         <tr valign="top">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0"
               ...
               <tr>
                  <td width="100%">
                  <comment id="_NSID_"> <object
                     id=GD_MASTER width=100% height=380 classid=<%=Util.CLSID_GRID%> tabindex=1>
