...
function doInit(){
    ...
    registerUsingDataset("psal447","DS_O_MASTER" );
...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}                name="NO"		width=30	align=center	SubSumText="" 		SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1",4,"#FFF29A",5,"#FFF29A")}</FC>'
                     ...
                     + '<FC>id=SALE_DT                 name="일자"		width=110    align=center	mask="XXXX/XX/XX"	SubSumText={decode(curlevel,1,"",5,"일자별소계")} 	SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1",4,"#FFF29A",5,"#FFF29A")}  </FC>'
                     + '<FC>id=TEAM_ORG_NAME           name="파트명"		width=80    align=left		suppress=3			SubSumText={decode(curlevel,4,"",3,"파트별소계")} 	SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1",4,"#FFF29A",5,"#FFF29A")}</FC>'
                     + '<FC>id=PC_ORG_NAME             name="PC명"		width=80    align=left		suppress=2			SubSumText={decode(curlevel,3,"",2,"PC별소계")} 	SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1",4,"#FFF29A",5,"#FFF29A")}</FC>'
                     + '<FG>                           name="브랜드"'
                     + '<FC>id=PUMBUN_CD               name="코드"		width=60    align=center	suppress=1			SubSumText=""		SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1",4,"#FFF29A",5,"#FFF29A")}</FC>'
                     + '<FC>id=PUMBUN_NAME             name="명"		width=80    align=left		suppress=1			SubSumText="합계"	SubSumText={decode(curlevel,2,"",1,"브랜드별소계")} SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1",4,"#FFF29A",5,"#FFF29A")}</FC>'
                     + '</FG>'
                     + '<G>                            name="행사"'
    ...
    DS_O_MASTER.SubSumExpr  = "3:TEAM_ORG_NAME, 2:PC_ORG_NAME, 1:PUMBUN_CD" ; 
...
function btn_Search() {
    ...
    TR_MAIN.Action="/dps/psal447.ps?goTo="+goTo+parameters;  
         ...
         <tr valign="top">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0"
               ...
               <tr>
                  <td width="100%">
                  <comment id="_NSID_"> <object
                     id=GD_MASTER width=100% height=402 classid=<%=Util.CLSID_GRID%> tabindex=1>
