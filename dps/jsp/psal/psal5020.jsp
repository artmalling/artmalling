...
function doInit(){
    ...
    registerUsingDataset("psal502","DS_O_MASTER" );
...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}                name="NO"            width=30    align=center    </FC>'
                     ...
                     + '<FC>id=POS_NO                  name="POS번호"       width=70    align=center    suppress="2"    sumtext="합계"</FC>'
                     + '<FC>id=POS_NAME                name="POS명"         width=80    align=left      suppress="3" </FC>'
                     + '<G>                            name="매출금액"'
                     + '<FC>id=R_CASH_AMT              name="현금"          width=100    align=right    mask="###,###"    sumtext={subsum(R_CASH_AMT)}</FC>'
                     + '<FC>id=R_GIFT_AMT              name="상품권"        width=100    align=right    mask="###,###"    sumtext={subsum(R_GIFT_AMT)}</FC>'
                     + '</G>'
                     + '<G>                            name="준비금"'
                     + '<FC>id=PREP_CASH_AMT              name="현금"          width=100    align=right    mask="###,###"    sumtext={subsum(PREP_CASH_AMT)}</FC>'
                     + '<FC>id=PREP_GIFT_AMT              name="상품권"        width=100    align=right    mask="###,###"    sumtext={subsum(PREP_GIFT_AMT)}</FC>'
                     + '</G>'
                     + '<G>                            name="중간입금"'
                     + '<FC>id=MIDDLE_CASH_AMT         name="현금"          width=100    align=right    mask="###,###"    sumtext={subsum(MIDDLE_CASH_AMT)}</FC>'
                     + '<FC>id=MIDDLE_GIFT_AMT         name="상품권"        width=100    align=right    mask="###,###"    sumtext={subsum(MIDDLE_GIFT_AMT)}</FC>'
                     + '</G>'
                     + '<G>                            name="마감입금"'
                     + '<FC>id=MAGAM_CASH_AMT          name="현금"          width=100    align=right    mask="###,###"    sumtext={subsum(MAGAM_CASH_AMT)}</FC>'
                     + '<FC>id=MAGAM_GIFT_AMT          name="상품권"        width=100    align=right    mask="###,###"    sumtext={subsum(MAGAM_GIFT_AMT)}</FC>'
                     + '</G>'
                     + '<G>                            name="상품권환불액"'
                     + '<FC>id=CASH_GIFT_RTN           name="현금"          width=100    align=right    mask="###,###"    sumtext={subsum(CASH_GIFT_RTN)}</FC>'
                     + '<FC>id=GIFT_GIFT_RTN           name="상품권"        width=100    align=right    mask="###,###"    sumtext={subsum(GIFT_GIFT_RTN)}</FC>'
                     + '</G>'
                     + '<G>                            name="과부족"'
                     + '<FC>id=EXC_CASH_AMT            name="현금"          width=100    align=right    mask="###,###"    sumtext={subsum(EXC_CASH_AMT)}</FC>'
                     + '<FC>id=EXC_GIFT_AMT            name="상품권"        width=100    align=right    mask="###,###"    sumtext={subsum(EXC_GIFT_AMT)}</FC>'
                     + '</G>'
                     + '<C>id=CASH_AMT                 name="현금"          width=100    align=right    mask="###,###"    sumtext={subsum(CASH_AMT)}</C>'
                     + '<C>id=JCARD_AMT                name="제휴"          width=100    align=right     mask="###,###"   sumtext={subsum(JCARD_AMT)}</C>'
                     + '<C>id=OCARD_AMT                name="타사"          width=100    align=right     mask="###,###"   sumtext={subsum(OCARD_AMT)}</C>'
                     + '<C>id=DCARD_AMT                name="직불"          width=100    align=right     mask="###,###"   sumtext={subsum(DCARD_AMT)}</C>'
                     + '<C>id=CCARD_AMT                name="은련"          width=100    align=right     mask="###,###"   sumtext={subsum(CCARD_AMT)}</C>'
                     + '<C>id=POINT_AMT                name="포인트"        width=100    align=right     mask="###,###"   sumtext={subsum(POINT_AMT)}</C>'
                     + '<C>id=OKCASHBAG_AMT            name="OK캐쉬백"      width=100    align=right     mask="###,###"   sumtext={subsum(OKCASHBAG_AMT)}</C>'
                     + '<C>id=GIFT_DRAWL_AMT           name="자사상품권대체"  width=100    align=right     mask="###,###"   sumtext={subsum(GIFT_DRAWL_AMT)}</C>'
                     + '<C>id=JGIFT_AMT                name="제휴상품권대체"  width=100    align=right     mask="###,###"   sumtext={subsum(JGIFT_AMT)}</C>'
                     + '<C>id=OGIFT_DRAWL_AMT          name="타사상품권"     width=100    align=right     mask="###,###"    sumtext={subsum(OGIFT_DRAWL_AMT)}</C>'
                     + '<C>id=COUPON_AMT               name="쿠폰"          width=100    align=right     mask="###,###"    sumtext={subsum(COUPON_AMT)}</C>'
                     + '<C>id=JBOX_SALE_AMT            name="장바구니할인"   width=100    align=right     mask="###,###"   sumtext={subsum(JBOX_SALE_AMT)}</C>'
                     + '<C>id=INCEN_SALE_AMT           name="상품권인센티브"  width=100    align=right     mask="###,###"    sumtext={subsum(INCEN_SALE_AMT)}</C>'
                     + '<C>id=ORD_SALE_AMT             name="주문매출"       width=100    align=right     mask="###,###"    sumtext={subsum(ORD_SALE_AMT)}</C>'
                     + '<C>id=COD_SALE_AMT             name="COD매출"        width=100    align=right     mask="###,###"   sumtext={subsum(COD_SALE_AMT)}</C>'
                     + '<C>id=COD_CAN_AMT              name="COD반품"        width=100    align=right     mask="###,###"   sumtext={subsum(COD_CAN_AMT)}</C>'
                     + '<C>id=SPS_SALE_AMT             name="특판매출"        width=100    align=right     mask="###,###"   sumtext={subsum(SPS_SALE_AMT)}</C>'
                     + '<C>id=SPS_CAN_AMT              name="특판반품"        width=100    align=right     mask="###,###"   sumtext={subsum(SPS_CAN_AMT)}</C>'
                     + '<C>id=USE_SALE_AMT             name="사용매출"        width=100    align=right     mask="###,###"   sumtext={subsum(USE_SALE_AMT)}</C>'
                     + '<C>id=USE_CAN_AMT              name="사용반품"        width=100    align=right     mask="###,###"   sumtext={subsum(USE_CAN_AMT)}</C>'
                     ;
...
function btn_Search() {
    ...
    TR_MAIN.Action="/dps/psal502.ps?goTo="+goTo+parameters;  
...
function searchPosNo(strPosNo){
    ...
    TR_DETAIL.Action="/dps/psal502.ps?goTo="+goTo+parameters;  
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0"
               ...
               <tr>
                  ...
                  <comment id="_NSID_"> <object
                     id=GD_MASTER width=100% height=482 classid=<%=Util.CLSID_GRID%> tabindex=1>
