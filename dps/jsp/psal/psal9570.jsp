...
function doInit(){
    ...
    registerUsingDataset("psal957","DS_O_MASTER" );
    
}


function gridCreate1(){
    var hdrProperies = '<FC>id={currow}               name="NO"               width=30     align=center   bgcolor={IF(CHAIK_49 <> 0 OR CHAIK_99 <> 0 OR CHAIK_189 <> 0 OR CHAIK_699 <> 0, "red" , "#FFFFFF" )}</FC>' 
                     + '<C>id=POS_NO                  name="POS번호"          width=70     align=center   bgcolor={IF(CHAIK_49 <> 0 OR CHAIK_99 <> 0 OR CHAIK_189 <> 0 OR CHAIK_699 <> 0, "red" , "#FFFFFF" )}</FC>'
 					 + '<G>name="총판매내역계"'
                     + '<C>id=AMT_01_49               name="시스템집계 금액"  width=110    align=right    bgcolor={IF(CHAIK_49 <> 0 OR CHAIK_99 <> 0 OR CHAIK_189 <> 0 OR CHAIK_699 <> 0, "red" , "#FFFFFF" )}</FC>'
                     + '<C>id=AMT_02_49               name="POS집계 금액"     width=110    align=right    bgcolor={IF(CHAIK_49 <> 0 OR CHAIK_99 <> 0 OR CHAIK_189 <> 0 OR CHAIK_699 <> 0, "red" , "#FFFFFF" )}</FC>'
                     + '<C>id=CHAIK_49                name="차이 금액"        width=110    align=right    bgcolor={IF(CHAIK_49 <> 0 OR CHAIK_99 <> 0 OR CHAIK_189 <> 0 OR CHAIK_699 <> 0, "red" , "#FFFFFF" )}</FC>'
                     + '</G>'
 					 + '<G>name="결재대상액계"'
                     + '<C>id=AMT_01_99               name="시스템집계 금액"  width=110    align=right    bgcolor={IF(CHAIK_49 <> 0 OR CHAIK_99 <> 0 OR CHAIK_189 <> 0 OR CHAIK_699 <> 0, "red" , "#FFFFFF" )}</FC>'
                     + '<C>id=AMT_02_99               name="POS집계 금액"     width=110    align=right    bgcolor={IF(CHAIK_49 <> 0 OR CHAIK_99 <> 0 OR CHAIK_189 <> 0 OR CHAIK_699 <> 0, "red" , "#FFFFFF" )}</FC>'
                     + '<C>id=CHAIK_99                name="차이 금액"        width=110    align=right    bgcolor={IF(CHAIK_49 <> 0 OR CHAIK_99 <> 0 OR CHAIK_189 <> 0 OR CHAIK_699 <> 0, "red" , "#FFFFFF" )}</FC>'
                     + '</G>'
 					 + '<G>name="결재내역계"'
                     + '<C>id=AMT_01_189              name="시스템집계 금액"  width=110    align=right    bgcolor={IF(CHAIK_49 <> 0 OR CHAIK_99 <> 0 OR CHAIK_189 <> 0 OR CHAIK_699 <> 0, "red" , "#FFFFFF" )}</FC>'
                     + '<C>id=AMT_02_189              name="POS집계 금액"     width=110    align=right    bgcolor={IF(CHAIK_49 <> 0 OR CHAIK_99 <> 0 OR CHAIK_189 <> 0 OR CHAIK_699 <> 0, "red" , "#FFFFFF" )}</FC>'
                     + '<C>id=CHAIK_189               name="차이 금액"        width=110    align=right    bgcolor={IF(CHAIK_49 <> 0 OR CHAIK_99 <> 0 OR CHAIK_189 <> 0 OR CHAIK_699 <> 0, "red" , "#FFFFFF" )}</FC>'
                     + '</G>'
 					 + '<G>name="기타매출계"'
                     + '<C>id=AMT_01_699              name="시스템집계 금액"  width=110    align=right    bgcolor={IF(CHAIK_49 <> 0 OR CHAIK_99 <> 0 OR CHAIK_189 <> 0 OR CHAIK_699 <> 0, "red" , "#FFFFFF" )}</FC>'
                     + '<C>id=AMT_02_699              name="POS집계 금액"     width=110    align=right    bgcolor={IF(CHAIK_49 <> 0 OR CHAIK_99 <> 0 OR CHAIK_189 <> 0 OR CHAIK_699 <> 0, "red" , "#FFFFFF" )}</FC>'
                     + '<C>id=CHAIK_699               name="차이 금액"        width=110    align=right    bgcolor={IF(CHAIK_49 <> 0 OR CHAIK_99 <> 0 OR CHAIK_189 <> 0 OR CHAIK_699 <> 0, "red" , "#FFFFFF" )}</FC>'
                     + '</G>'
                     ;
...
function btn_Search() {
    ...
    TR_MAIN.Action="/dps/psal957.ps?goTo="+goTo+parameters;  
...
function searchPosNoMM(){
    ...
    TR_DETAIL.Action="/dps/psal957.ps?goTo="+goTo+parameters;  
...
if(strGbn == 0){
    ...
    GD_MASTER.ColumnProp('POS_NO','Name')='층';
}
else{
    ...
    GD_MASTER.ColumnProp('POS_NO','Name')='POS번호';
}
</script>
