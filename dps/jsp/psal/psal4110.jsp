...
function doInit(){
    ...
    registerUsingDataset("psal411","DS_O_MASTER" );
...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}                name="NO"            width=30    align=center  show=false   </FC>'
                     ...
                     + '<FC>id=PUMMOK_CD               name="품목코드"        width=70    align=center      suppress=1    </FC>'
                     + '<FC>id=PUMMOK_NAME             name="품목명"          width=80    align=left      suppress=1   </FC>'
                     + '<FC>id=PUMBUN_CD               name="브랜드코드"        width=70    align=center      suppress=2    </FC>'
                     + '<FC>id=PUMBUN_NAME             name="브랜드명"         width=110    align=left      suppress=2   </FC>'
                     + '<FC>id=SKU_CD                  name="단품코드"        width=110    align=center      suppress=3    </FC>'
                     + '<FC>id=SKU_NAME                name="단품명"         width=80    align=left      suppress=3   sumtext="합계"</FC>'
                     + '<C>id=SALE_PRC                 name="판매가"         width=100    align=right    mask="###,###"    </C>'
                     + '<G>                            name="총매출"  '
                     + '<C>id=SALE_QTY                 name="수량"           width=60    align=right     mask="###,###"   sumtext={subsum(SALE_QTY)}</C>'
                     + '<C>id=TOT_SALE_AMT             name="매출"           width=100    align=right    mask="###,###"    sumtext={subsum(TOT_SALE_AMT)}</C>'
                     + '</G>'
                     + '<FC>id=AVG_AMT                 name="일평균매가"       width=80    align=right    mask="###,###"      </FC>'
                     + '<C>id=STYLE_NAME               name="스타일코드"        width=90    align=left   </C>'
                     + '<C>id=COLOR_NAME               name="컬러명"           width=90    align=left   </C>'
                     + '<C>id=SIZE_NAME                name="사이즈"           width=90    align=left   </C>'
                     ;
...
function btn_Search() {
    ...
    TR_MAIN.Action="/dps/psal411.ps?goTo="+goTo+parameters;  
