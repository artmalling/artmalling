...
function doInit(){
	...
	// 컴퍼넌트 세팅
    initEmEdit(EM_SALE_DT_S,      "YYYYMM", PK);   // 실적 시작일
    initEmEdit(EM_SALE_DT_E,      "YYYYMM", PK);   // 실적 종료일
    initEmEdit(EM_BF_SALE_DT_S,   "YYYYMM", PK);   // 대비 시작일
    initEmEdit(EM_BF_SALE_DT_E,   "YYYYMM", PK);   // 대비 종료일
    ...
    EM_BF_SALE_DT_S.text = varBf_Year_Mon;
    EM_BF_SALE_DT_E.text = varBf_Year_Mon;
    ...
    registerUsingDataset("psal581","DS_O_MASTER" );
    
    
    // 이후 내용 17.05.12 수정 K,J,Y
    
    document.getElementById("EM_SALE_M").style.display = "none"; // 필요 없어서 숨김.
    document.getElementById("EM_BF_SALE_M").style.display = "none";
...
// 			         + '<FC>id=BF_TOT_SALE_AMT        name="(대비)총매출" width=100   align=right     mask="###,###"   </FC>'
			         ...
			         + '<C>id=PUMBUN_CD               name="브랜드"       width=90    align=right     Show=false   </C>'
			        ;
			         */
			         
		var hdrProperies = '<FC>id={currow}               name="NO"           width=30    align=center    </FC>'
				         + '<FC>id=STOR_NAME              name="점"           width=80    align=left      suppress=2 EditStyle=Lookup </FC>'
				         + '<FC>id=PART_NAME              name="파트"         width=100    align=center    suppress=2 </FC>'
				         + '<FC>id=PC_NAME                name="PC"          width=80   align=left      suppress=2 </FC>'
				         + '<FC>id=GUBUN                  name="구분"         width=80   align=left      </FC>'
				         + '<G> name="월매출"'
				         + '<FC>id=TOT_AMT   	      	  name="계"          width=100   align=right     mask="###,###"   </FC>'
				         + '<C>id=MONTH01				      name="1"         width=100   align=right     mask="###,###"   </C>'
				         + '<C>id=MONTH02       			  name="2"         width=100   align=right     mask="###,###"   </C>'
				         + '<C>id=MONTH03     			  name="3"         width=100   align=right     mask="###,###"   </C>'
				         + '<C>id=MONTH04     			  name="4"         width=100   align=right     mask="###,###"   </C>'
				         + '<C>id=MONTH05     			  name="5"         width=100   align=right     mask="###,###"   </C>'
				         + '<C>id=MONTH06      			  name="6"         width=100   align=right     mask="###,###"   </C>'
				         + '<C>id=MONTH07     			  name="7"         width=100   align=right     mask="###,###"   </C>'
				         + '<C>id=MONTH08     			  name="8"         width=100   align=right     mask="###,###"   </C>'
				         + '<C>id=MONTH09     			  name="9"         width=100   align=right     mask="###,###"   </C>'
				         + '<C>id=MONTH10			      	  name="10"        width=100   align=right     mask="###,###"   </C>'
				         + '<C>id=MONTH11				      name="11"        width=100   align=right     mask="###,###"   </C>'
				         + '<C>id=MONTH12       			  name="12"        width=100   align=right     mask="###,###"   </C>'
				         + '</G>'
				         //+ '<C>id=DAY13     			  name="13일"        width=100   align=right     mask="###,###"   </C>'
				         //+ '<C>id=DAY14     			  name="14일"        width=100   align=right     mask="###,###"   </C>'
				         //+ '<C>id=DAY15     			  name="15일"        width=100   align=right     mask="###,###"   </C>'
				         //+ '<C>id=DAY16      			  name="16일"        width=100   align=right     mask="###,###"   </C>'
				         //+ '<C>id=DAY17     			  name="17일"        width=100   align=right     mask="###,###"   </C>'
				         //+ '<C>id=DAY18     			  name="18일"        width=100   align=right     mask="###,###"   </C>'
				         //+ '<C>id=DAY19     			  name="19일"        width=100   align=right     mask="###,###"   </C>'
				         //+ '<C>id=DAY20			      	  name="20일"        width=100   align=right     mask="###,###"   </C>'
				         //+ '<C>id=DAY21				      name="21일"        width=100   align=right     mask="###,###"   </C>'
				         //+ '<C>id=DAY22       			  name="22일"        width=100   align=right     mask="###,###"   </C>'
				         //+ '<C>id=DAY23     			  name="23일"        width=100   align=right     mask="###,###"   </C>'
				         //+ '<C>id=DAY24     			  name="24일"        width=100   align=right     mask="###,###"   </C>'
				         //+ '<C>id=DAY25     			  name="25일"        width=100   align=right     mask="###,###"   </C>'
				         //+ '<C>id=DAY26      			  name="26일"        width=100   align=right     mask="###,###"   </C>'
				         //+ '<C>id=DAY27     			  name="27일"        width=100   align=right     mask="###,###"   </C>'
				         //+ '<C>id=DAY28     			  name="28일"        width=100   align=right     mask="###,###"   </C>'
				         //+ '<C>id=DAY29     			  name="29일"        width=100   align=right     mask="###,###"   </C>'
				         //+ '<C>id=DAY30			      	  name="30일"        width=100   align=right     mask="###,###"   </C>'
				         //+ '<C>id=DAY31			      	  name="31일"        width=100   align=right     mask="###,###"   </C>'
				         //+ '<C>id=WEEKDAYS_AMT	    	  name="평일계"       width=100   align=right     mask="###,###"   </C>'
				         //+ '<C>id=WEEKENDS_AMT	      	  name="주말계"       width=100   align=right     mask="###,###"   </C>'
				         + '<C>id=PC_CD               name="조회코드"     width=50    align=center  Show=false         </C>'
				        ;
...
function gridCreate2(strGrpCd){
	...
	var hdrProperies = '<FC>id={currow}               name="NO"           width=30    align=center    </FC>'
        + '<FC>id=STOR_NAME              name="점"           width=80    align=left      suppress=2 EditStyle=Lookup Show=false </FC>'
        + '<FC>id=PART_NAME              name="파트"         width=100    align=center    suppress=2 Show=false </FC>'
        + '<FC>id=PC_NAME                name="PC"          width=80   align=left      suppress=2 Show=false </FC>'
        + '<FC>id=PUMBUN_CD              name="브랜드코드"        width=80   align=left      suppress=2 </FC>'
        + '<FC>id=PUMBUN_NAME            name="브랜드명"          width=150   align=left      suppress=2 </FC>'
        + '<FC>id=GUBUN                  name="구분"         width=80   align=left      </FC>'
        + '<G> name="월매출"'
        + '<FC>id=TOT_AMT   	      	  name="계"          width=100   align=right     mask="###,###"   </FC>'
        + '<C>id=MONTH01				      name="1"         width=100   align=right     mask="###,###"   </C>'
...
function btn_Search() {
    ...
    TR_MAIN.Action="/dps/psal581.ps?goTo="+goTo+parameters;  
 ...
 */
 function searchDetail(){
	    ...
	    var strStrCd     = DS_O_MASTER.NameValue(DS_O_MASTER.RowPosition, "PC_CD");		//점
	    	strStrCd     = strStrCd.substring(0,2);
	    var strSearchCd  = DS_O_MASTER.NameValue(DS_O_MASTER.RowPosition, "PC_CD");
 		
	    if (strSearchCd.length >= 8 ) {
	    		strSearchCd  = strSearchCd.substring(0,8);	
	    	}
     ...
     TR_DETAIL.Action="/dps/psal581.ps?goTo="+goTo+parameters;  
...
function chkValidation(gbn){
    ...
    case "search" :
        ...
        if (isNull(EM_SALE_DT_E.text) ==true ) {
            showMessage(Information, OK, "USER-1003","대비기간"); 
            EM_SALE_DT_E.focus();
            return false;
        }
        //년월 자릿수, 공백 체크
        if (EM_SALE_DT_E.text.replace(" ","").length != 6 ) {
            showMessage(Information, OK, "USER-1027","대비기간","6");
            EM_SALE_DT_E.focus();
            return false;
        }
        if(!checkYYYYMM(EM_SALE_DT_E.text)){
            showMessage(Information, OK, "USER-1004","대비기간");
            EM_SALE_DT_E.focus();
            return false;
        }
...
<script language=JavaScript for=EM_SALE_DT_S event=onKillFocus()>
    ...
    //영업조회일 자릿수, 공백 체크
    if (EM_SALE_DT_S.text.replace(" ","").length != 6 ) {
        showMessage(Information, OK, "USER-1027","시작월","6");
        EM_SALE_DT_S.text = varToMon;
        return false;
    }
    //일자형식체크
    if (!checkYYYYMM(EM_SALE_DT_S.text) ) {
        showMessage(Information, OK, "USER-1069","시작월");
        EM_SALE_DT_S.text = varToMon;
        return false;
    }
return true;
...
<script language=JavaScript for=EM_SALE_DT_E event=onKillFocus()>
    ...
    //영업조회일 자릿수, 공백 체크
    if (EM_SALE_DT_E.text.replace(" ","").length != 6 ) {
        showMessage(Information, OK, "USER-1027","종료월","6");
        EM_SALE_DT_E.text = varToMon;
        return false;
    }
    //일자형식체크
    if (!checkYYYYMM(EM_SALE_DT_E.text) ) {
        showMessage(Information, OK, "USER-1069","종료월");
        EM_SALE_DT_E.text = varToMon;
        return false;
    }
return true;
         ...
         <tr>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0"
               ...
               <tr>
                  ...
                  <td width="210px" colspan="8"><comment id="_NSID_"> <object
                     id=EM_SALE_DT_S classid=<%=Util.CLSID_EMEDIT%> width=72
                     tabindex=1 align="absmiddle"> </object> </comment> <script> _ws_(_NSID_);</script>
                  <img src="/<%=dir%>/imgs/btn/date.gif" onclick="javascript:if(!EM_SALE_M.Enable) openCal('M',EM_SALE_DT_S);" align="absmiddle" />~
					<comment id="_NSID_"> <object
                     id=EM_SALE_DT_E classid=<%=Util.CLSID_EMEDIT%> width=72
                     tabindex=1 align="absmiddle"> </object> </comment> <script> _ws_(_NSID_);</script>
                  <img src="/<%=dir%>/imgs/btn/date.gif" onclick="javascript:if(!EM_SALE_M.Enable) openCal('M',EM_SALE_DT_E);" align="absmiddle" />
                  </td>   
               ...
               <tr>
                  ...
                  <td colspan="8"><comment id="_NSID_"> <object
                     ...
                     tabindex=1 align="absmiddle"> </object> </comment> <script> _ws_(_NSID_);</script>
                  <img src="/<%=dir%>/imgs/btn/date.gif" id="IMG_BF_SALE_DT_S" onclick="javascript:if(!EM_BF_SALE_M.Enable) openCal('M',EM_BF_SALE_DT_S);" align="absmiddle" />~
                     <comment id="_NSID_"> <object
                     id=EM_BF_SALE_DT_E classid=<%=Util.CLSID_EMEDIT%> width=72
                     tabindex=1 align="absmiddle"> </object> </comment> <script> _ws_(_NSID_);</script>
                  <img src="/<%=dir%>/imgs/btn/date.gif" id="IMG_BF_SALE_DT_E" onclick="javascript:if(!EM_BF_SALE_M.Enable) openCal('M',EM_BF_SALE_DT_E);" align="absmiddle" />
                  </td> 
