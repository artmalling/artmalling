...
function doInit(){
    ...
    */
    ...
    registerUsingDataset("psal577","DS_O_MASTER" );
...
function gridCreate4(){
    var hdrProperies = '<C>id=GROUP_NAME              name="구분"          width=90    align=center  suppress=1 readonly=true  '
                     ...
                     + '<C>id=POST_CMNTS              name="전주"          width=500   align=left    readonly=true </C>'
                     + '<C>id=PRE_CMNTS               name="금주"          width=500   align=left   readonly=true  </C>'                     
                     ;
...
function btn_Search() {
    ...
    TR_MAIN.Action="/dps/psal577.ps?goTo="+goTo+parameters;  
 ...
 */
 function searchDetail(){
	  ...
	  var strEmUnit 		= EM_UNIT.BindColVal;		 //단위
	    ...
	    TR_DETAIL.Action="/dps/psal577.ps?goTo="+goTo+parameters;  
...
function searchDetail2(){
     ...
     TR_DETAIL2.Action="/dps/psal577.ps?goTo="+goTo+parameters;  
...
function searchMaster2(){
     ...
     TR_MAIN2.Action="/dps/psal577.ps?goTo="+goTo+parameters;  
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
   ...
   <tr valign="top">
      <td>
      <b><h3>4. 주간주요업무</h3></b>- 각 부서별 내용란을 더블 클릭하여 보이지 않는 내용을 확인 할 수 있습니다. 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
         <tr valign="top">
            <td>
            <table width="100%" border="0" cellspacing="0" cellpadding="0"
