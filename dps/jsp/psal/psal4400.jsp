...
function doInit(){
    ...
    registerUsingDataset("psal440","DS_O_MASTER" );
    
}

function gridCreate1(){
    var hdrProperies = '<FC>id={currow}               name="NO"           width=30    align=center      sumtext="" SubSumText="" SubBgColor={decode(curlevel,2,"#FFFFE0",3,"#FFFACD",4,"#FFF7B1",5,"#FFF29A")}</FC>'
                     + '<FC>id=BIZ_TYPE               name="거래형태"       width=80    align=left       suppress=1  SubSumText={decode(curlevel,2,"",5,"거래형태소계")}  SubBgColor={decode(curlevel,2,"#FFFFE0",3,"#FFFACD",4,"#FFF7B1",5,"#FFF29A")}</FC>'
                     + '<G>                           name="팀"'
                     + '<FC>id=DEPT_CD                name="코드"       width=30    align=center        suppress=2   SubSumText="" SubBgColor={decode(curlevel,2,"#FFFFE0",3,"#FFFACD",4,"#FFF7B1",5,"#FFF29A")}</FC>'
                     + '<FC>id=DEPT_NAME              name="명"        width=80    align=left           suppress=2   SubSumText={decode(curlevel,5,"",4,"팀소계")}    SubBgColor={decode(curlevel,2,"#FFFFE0",3,"#FFFACD",4,"#FFF7B1",5,"#FFF29A")}</FC>'
                     + '</G>'
                     + '<G>                           name="파트"'
                     + '<FC>id=TEAM_CD                name="코드"       width=30    align=center        suppress=3   SubSumText="" SubBgColor={decode(curlevel,2,"#FFFFE0",3,"#FFFACD",4,"#FFF7B1",5,"#FFF29A")}</FC>'
                     + '<FC>id=TEAM_NAME              name="명"        width=80    align=left           suppress=3   SubSumText={decode(curlevel,4,"",3,"파트소계")}    SubBgColor={decode(curlevel,2,"#FFFFE0",3,"#FFFACD",4,"#FFF7B1",5,"#FFF29A")}</FC>'
                     + '</G>'
                     + '<G>                           name="PC"'
                     + '<FC>id=PC_CD                  name="코드"       width=30    align=center        suppress=4   SubSumText="" SubBgColor={decode(curlevel,2,"#FFFFE0",3,"#FFFACD",4,"#FFF7B1",5,"#FFF29A")}</FC>'
                     + '<FC>id=PC_NAME                name="명"        width=80    align=left           suppress=4   SubSumText={decode(curlevel,3,"",2,"PC소계")}    SubBgColor={decode(curlevel,2,"#FFFFE0",3,"#FFFACD",4,"#FFF7B1",5,"#FFF29A")}</FC>'
                     + '</G>'
                     + '<G>                           name="브랜드"'
                     + '<FC>id=PUMBUN_CD              name="코드"       width=60    align=center        suppress=5   SubSumText="" SubBgColor={decode(curlevel,2,"#FFFFE0",3,"#FFFACD",4,"#FFF7B1",5,"#FFF29A")}</FC>'
                     + '<FC>id=PUMBUN_NAME            name="명"        width=110    align=left           suppress=5   SubSumText=""    SubBgColor={decode(curlevel,2,"#FFFFE0",3,"#FFFACD",4,"#FFF7B1",5,"#FFF29A")}</FC>'
                     + '</G>'
                     + '<C>id=TOT_SALE_AMT            name="총매출"        width=100    align=right    mask="###,###"       sumtext=@sum SubBgColor={decode(curlevel,2,"#FFFFE0",3,"#FFFACD",4,"#FFF7B1",5,"#FFF29A")}</C>'
                     + '<C>id=REDU_AMT                name="할인"          width=100    align=right    mask="###,###"      sumtext=@sum SubBgColor={decode(curlevel,2,"#FFFFE0",3,"#FFFACD",4,"#FFF7B1",5,"#FFF29A")}</C>'
                     + '<C>id=NORM_SALE_AMT           name="매출"          width=100    align=right    mask="###,###"      sumtext=@sum SubBgColor={decode(curlevel,2,"#FFFFE0",3,"#FFFACD",4,"#FFF7B1",5,"#FFF29A")}</C>'
                     + '<C>id=DC_AMT                  name="에누리"        width=100    align=right    mask="###,###"       sumtext=@sum SubBgColor={decode(curlevel,2,"#FFFFE0",3,"#FFFACD",4,"#FFF7B1",5,"#FFF29A")}</FC>'
                     + '<C>id=NET_SALE_AMT            name="순매출"        width=100    align=right     mask="###,###"      sumtext=@sum SubBgColor={decode(curlevel,2,"#FFFFE0",3,"#FFFACD",4,"#FFF7B1",5,"#FFF29A")}</C>'
                     + '<C>id=SALE_PROF_AMT           name="이익액"        width=100    align=right     mask="###,###"      sumtext=@sum SubBgColor={decode(curlevel,2,"#FFFFE0",3,"#FFFACD",4,"#FFF7B1",5,"#FFF29A")}</C>'
    ...
    DS_O_MASTER.SubSumExpr  = "5:BIZ_TYPE, 4:DEPT_CD, 3:TEAM_CD, 2:PC_CD" ; 
...
function btn_Search() {
    ...
    TR_MAIN.Action="/dps/psal440.ps?goTo="+goTo+parameters;  
         ...
         <tr valign="top">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0"
               ...
               <tr>
                  <td width="100%">
                  <comment id="_NSID_"> <object
                     id=GD_MASTER width=100% height=750 classid=<%=Util.CLSID_GRID%> >
