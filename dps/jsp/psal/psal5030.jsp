...
function doInit(){
    ...
    registerUsingDataset("psal503","DS_O_MASTER" );
...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}                name="NO"                     width=30    align=center    </FC>'
                     ...
                     + '<FC>id=AMT                     name="중간입금 + 마감입금"        width=130    align=right    mask="###,###"    sumtext={subsum(AMT)}</FC>'
                     + '<FC>id=SYSTEM_AMT              name="영업관리 SYSTEM"          width=140    align=right     mask="###,###"   sumtext={subsum(SYSTEM_AMT)}</FC>'
                     + '<FC>id=POS_AMT                 name="POS SYSTEM계"            width=140    align=right     mask="###,###"   sumtext={subsum(POS_AMT)}</FC>'
                     + '<FC>id=SYSTEM_GAP_AMT          name="시스템 - (중간 + 마감입금)" width=150    align=right     mask="###,###"   sumtext={subsum(SYSTEM_GAP_AMT)}</FC>'
                     + '<FC>id=SYSTEM_POS_GAP          name="시스템 - POS"             width=130    align=right     mask="###,###"   sumtext={subsum(SYSTEM_POS_GAP)}</FC>'
                     ;
...
function btn_Search() {
    ...
    TR_MAIN.Action="/dps/psal503.ps?goTo="+goTo+parameters;  
...
function searchPosNo(strPosNo){
    ...
    TR_DETAIL.Action="/dps/psal503.ps?goTo="+goTo+parameters;  
