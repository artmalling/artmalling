...
function doInit(){
	...
	*/
    ...
    registerUsingDataset("psal580","DS_O_MASTER" );
...
// 			         + '<FC>id=BF_TOT_SALE_AMT        name="(대비)총매출" width=100   align=right     mask="###,###"   </FC>'
		...
		var hdrProperies = '<FC>id={currow}               name="NO"           width=30    align=center    </FC>'
				         ...
				         + '<C>id=DAY01				      name="1일"         width=100   align=right     mask="###,###"   </C>'
				         + '<C>id=DAY02       			  name="2일"         width=100   align=right     mask="###,###"   </C>'
				         + '<C>id=DAY03     			  name="3일"         width=100   align=right     mask="###,###"   </C>'
				         + '<C>id=DAY04     			  name="4일"         width=100   align=right     mask="###,###"   </C>'
				         + '<C>id=DAY05     			  name="5일"         width=100   align=right     mask="###,###"   </C>'
				         + '<C>id=DAY06      			  name="6일"         width=100   align=right     mask="###,###"   </C>'
				         + '<C>id=DAY07     			  name="7일"         width=100   align=right     mask="###,###"   </C>'
				         + '<C>id=DAY08     			  name="8일"         width=100   align=right     mask="###,###"   </C>'
				         + '<C>id=DAY09     			  name="9일"         width=100   align=right     mask="###,###"   </C>'
				         + '<C>id=DAY10			      	  name="10일"        width=100   align=right     mask="###,###"   </C>'
				         + '<C>id=DAY11				      name="11일"        width=100   align=right     mask="###,###"   </C>'
				         + '<C>id=DAY12       			  name="12일"        width=100   align=right     mask="###,###"   </C>'
...
function btn_Search() {
    ...
    TR_MAIN.Action="/dps/psal580.ps?goTo="+goTo+parameters;  
 ...
 */
 function searchDetail(){
     ...
     TR_DETAIL.Action="/dps/psal580.ps?goTo="+goTo+parameters;  
