...
<script LANGUAGE="JavaScript">
	...
	function doInit() {
		...
		var obj2   = document.getElementById("GD_MASTER2"); 
		obj2.style.height  = (parseInt(window.document.body.clientHeight)-top) + "px";
...
// 		var strCmprdt = searchCmpr();
		...
		registerUsingDataset("psal304", "DS_O_MASTER");
...
/* 대비구분의 상관 없이 대비일자 수정 가능하게 요청 처리자 : K.K.R (아트몰링) 2016.12.21 */
...
// 			EM_CMPR_DT_E1.Enable = "true";
	...
	function search1(){
		...
		TR_MAIN.Action = "/dps/psal304.ps?goTo=" + goTo + parameters;
	...
	function search2(){
		...
		TR_MAIN2.Action = "/dps/psal304.ps?goTo=" + goTo + parameters;
...
window.onresize = function(){
    ...
    if(EM_UNIT.BindColVal=="02"){
    	obj = document.getElementById("GD_MASTER");
	 }else{
							...
							<td>
								<table width="100%" border="0" cellpadding="0" cellspacing="0"
									...
									<tr>
										...
										<th width="70">대비구분</th>
										<td colspan="5" width="160"><comment id="_NSID_"> <object
