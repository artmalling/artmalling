...
function showMaster(){
    ...
    //
    TR_MAIN.Action  ="/dps/psal931.ps?goTo="+goTo+parameters;  
...
function sendData(){ 
    ...
    var strSendSeq = RD_SEND_SEQ.CodeValue
    //
    var goTo        = "sendData";    
    var action      = "O";     
    var parameters  = "&paramStrCd="   + encodeURIComponent(LC_COND_STR_CD.BindColVal)
    				...
    				+ "&strSendSeq="   + encodeURIComponent(strSendSeq);
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"> 
            ...
            <tr>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table">
                    <tr>
                        ...
                        <td class="FS11 red"><img src="/<%=dir%>/imgs/btn/send_pre_c.gif"
                            onclick="sendData();" align="absmiddle" /> * 저장후 1분 후에 전송처리 가능함.</td>
                    </tr>
			
					<tr>
						<th width="80">전송회차</th>
						<td colspan="5"><comment id="_NSID_"> <object
							id=RD_SEND_SEQ classid=<%=Util.CLSID_RADIO%>
							style="height: 20; width: 700" tabindex=1>
							<param name=Cols value="4">
							<param name=Format value="2^2차,3^3차,,4^4차,5^5차">
    ...
    <tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0"
            class="BD4A">
            <tr>
                <td><comment id="_NSID_"> <object id=GR_MASTER width="100%" height=484 classid=<%=Util.CLSID_GRID%> tabindex=1>
