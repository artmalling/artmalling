...
{     	
    ...
    // 바코드 생성
    strImgUrl = genBarcode(gstrBarcode);
    alert(strImgUrl);
    // 영수능 내용 생성
    genContent();
...
function skuErrorChk(vRow){ 
 ...
 function genContent() {
	  ...
	  //alert(strImgUrl.substr(9,30));
	 var strStrCd 	=  gstrBarcode.substr(10,2);
	 ...
	 if (DS_O_MASTER.CountRow != 0 ) {
		 ...
		 /* 바코드 이미지*/
		 strContent = strContent + "<img src='"+strImgUrl.substr(9,30)+"'>";
