...
function doInit(){
    ...
    */
    ...
    registerUsingDataset("psal574","DS_IO_MASTER" );
    registerUsingDataset("psal574","DS_IO_DETAIL" );
...
function EMCreate(){
     ...
     TR_EMC.Action="/dps/psal574.ps?goTo="+goTo+parameters;  
...
function EMCreate2(){
    ...
    TR_EMC2.Action="/dps/psal574.ps?goTo="+goTo+parameters;  
...
function btn_Search() {
    ...
    TR_MAIN.Action="/dps/psal574.ps?goTo="+goTo+parameters;  
 ...
 */
 function searchDetail(){
	  ...
	  var strEmUnit 		= EM_UNIT.BindColVal;		 //단위
	    ...
	    TR_DETAIL.Action="/dps/psal574.ps?goTo="+goTo+parameters;  
...
function searchDetail2(){
     ...
     TR_DETAIL2.Action="/dps/psal574.ps?goTo="+goTo+parameters;  
...
function searchMaster2(){
     ...
     TR_MAIN2.Action="/dps/psal574.ps?goTo="+goTo+parameters;  
        	...
        	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table"> 
			   <tr>
				<th width="12%" style = "text-align:center">구분</th>
					<td width="44%"  style = "text-align:center">전월</td>
					<td width="44%" colspan=7 style = "text-align:center">당월</td>
			   </tr>
			   <tr>
