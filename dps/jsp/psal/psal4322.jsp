<!-- 
/*******************************************************************************
 * 시스템명 : 영업관리 > 매출관리 > 도면매출 > 도면매출정보(층) - 일별매출정보
 * 작 성 일 : 2010.06.30
 * 작 성 자 : 정진영
 * 수 정 자 : 
 * 파 일 명 : psal4322.jsp
...
function searchDay(){    
    ...
    var total = DS_DAY_INFO.CountRow;
    /*
    if(total < 1){
    	return;
    }*/
    ...
    var iframeHeight = total==0?1:total * 40 ;
   
    viewChart('CHART_001',"1",iframeWidth,iframeHeight,"총매출","TOT_SALE_AMT","SALE_DT",DS_DAY_INFO, GD_DAY_INFO,"일별매출");
} 
        ...
        <td class="PB03"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="" class="title">
              ...
              <span id="title1" class="PL03">일별매출정보</span>
            </td>
        ...
        <td class="PT01 PB03"><table width="100%" border="0" cellspacing="0" cellpadding="0" >
          <tr>
            <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table" style='border-top:0px;border-left:0px;border-right:0px;'>
              <tr>
                <td id=GRID_INFO  style='letter-spacing:0.0ex;border-top:0px;border-left:0px;border-right:0px;' class="sub_title PB03 " > 일별매출</td>
              </tr>
              <tr valign="top" >
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="BD4A">
                  <tr>
                    <td>
                      <comment id="_NSID_">
                        <object id=GD_DAY_INFO width=100% height=200 classid=<%=Util.CLSID_GRID%>>
          ...
          <tr>
            <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table" style='border-top:0px;border-left:0px;border-right:0px;'>
              <tr>
                <td id=GRAPH_INFO style='letter-spacing:0.0ex;border-top:0px;border-left:0px;border-right:0px;' class="sub_title PB03 " > 일별매출 그래프</td>
              </tr>
              <tr valign="top" >
