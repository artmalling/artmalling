<!-- 
/*******************************************************************************
 * 시스템명 : 영업관리 > 매출관리 > POS정산 > OK캐쉬백포인트적립현황
 * 작 성 일 : 2010.04.08
 * 작 성 자 : 이정식
 * 수 정 자 : 
 * 파 일 명 : psal5520.jsp
...
function gridCreate(){
    ...
    var hdrProperies = '<C>id={currow}    width=30  align=center name="NO"</C>'
                     ...
                     + '<C>id=STR_NAME     width=90  align=center name="점구분"  suppress=1</C>'
                     + '<C>id=SALE_DT     width=80  align=center name="매출일자" suppress=2 mask="XXXX/XX/XX" SUMTEXT="합계" </C>'
                     + '<G>name="합계"'
                     + '<C>id=TOT_CNT     width=70  align=right  name="건수" SUMTEXT=@SUM</C>'
                     + '<C>id=TOT_AMT     width=90  align=right  name="매출금액" SUMTEXT=@SUM</C>'
                     + '<C>id=TOT_POINT     width=90  align=right  name="포인트(당사)" SUMTEXT=@SUM</C>'
                     + '<C>id=TOT_POINT_SK     width=90  align=right  name="포인트(SK)" SUMTEXT=@SUM</C>'
                     + '<C>id=TOT_BRCH_FEE     width=90  align=right  name="가맹점수수료" SUMTEXT=@SUM</C>'
                     + '</G>'
                     + '<G>name="OK캐쉬백 포인트 적립"'
                     + '<C>id=OCC_CNT     width=70  align=right  name="건수" SUMTEXT=@SUM</C>'
                     + '<C>id=OCC_AMT     width=90  align=right  name="매출금액" SUMTEXT=@SUM</C>'
                     + '<C>id=OCC_POINT     width=90  align=right  name="포인트" SUMTEXT=@SUM</C>'
                     + '<C>id=BRCH_FEE     width=90  align=right  name="가맹점수수료" SUMTEXT=@SUM</C>'
                     + '</G>'
                     + '<G>name="OK캐쉬백 포인트 적립취소"'
                     + '<C>id=RTN_CNT     width=70  align=right  name="건수" SUMTEXT=@SUM</C>'
                     + '<C>id=RTN_AMT     width=90  align=right  name="매출금액" SUMTEXT=@SUM</C>'
                     + '<C>id=RTN_POINT   width=90  align=right  name="포인트" SUMTEXT=@SUM</C>'
    ...
    var hdrProperies1 = '<C>id={currow}    width=35  align=center name="NO"</C>'
                      ...
                      + '<C>id=MSG_01       width=140 align=center name="메세지" show=true</C>'
                      + '<C>id=APPR_DT     	width=100 align=center  name="승인일자"</C>'
...
function btn_Search() {
    ...
    var parameters = "&strStoreCd="      + LC_STR_CD.BindColVal              //점구분코드
                   ...
                   ;
    DS_OK_SAL_MST.DataID = "/dps/psal552.ps?goTo="+goTo+parameters;
    DS_OK_SAL_MST.Reset();
}
...
function subQuery(row){
    ...
    DS_OK_SAL_DTL.DataID = "/dps/psal552.ps?goTo="+goTo+parameters;
    DS_OK_SAL_DTL.Reset();
}
