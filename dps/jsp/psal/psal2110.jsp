...
function doInit(){
	...
	*/
    ...
    registerUsingDataset("psal211","DS_O_MASTER" );
}
...
function btn_Search() {
    ...
    TR_MAIN.Action="/dps/psal211.ps?goTo="+goTo+parameters;  
 ...
 */
 function searchDetail(){
	    ...
	    var strBrandCd   = DS_O_MASTER.NameValue(DS_O_MASTER.RowPosition, "PUMBUN_CD");
	    var strSelFlag   = RD_GUBUN.CodeValue;        // 원단위 구분
     ...
     TR_DETAIL.Action="/dps/psal211.ps?goTo="+goTo+parameters;  
