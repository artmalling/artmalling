...
function doInit(){
    ...
    registerUsingDataset("psal212","DS_O_MASTER,DS_HS_MG" );
    LC_STR_CD.Focus();
}
...
function btn_Search() {
    ...
    TR_MAIN.Action="/dps/psal212.ps?goTo="+goTo+parameters;  
...
function btn_Save() {
    ...
    var goTo       = "save";    
    var action     = "I";  
    TR_SAVE.Action="/dps/psal212.ps?goTo="+goTo+parameters;  
