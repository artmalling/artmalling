...
// 	obj.style.height  = (parseInt(window.document.body.clientHeight)-top) + "px";
    ...
    registerUsingDataset("psal436","DS_O_MASTER" );
    
    
    var strUsrId   = '<c:out value="${sessionScope.sessionInfo.USER_ID}" />';		// 로그인 사번
	//alert(strUsrId);
	if (strUsrId!="17010138"&&strUsrId!='17021201'&&strUsrId!='17021202'&&strUsrId!="fkl") {
...
function btn_Search() {
    ...
    TR_MAIN.Action="/dps/psal436.ps?goTo="+goTo+parameters;  
...
function search_Detail() {
    ...
    TR_DETAIL.Action="/dps/psal436.ps?goTo="+goTo+parameters;  
...
function searchPoint() {
    ...
    if (DS_O_POINT.CountRow > 0) {
    	...
    	var cust_name 	= " - 회 원 명 : " + DS_O_POINT.NameValue(1, "CUST_NAME");
...
function openReciept(obj, rownum) {
    ...
    var returnVal = window.showModalDialog("/dps/psal436.ps?goTo=popUpList",
            arrArg,
         ...
         <tr>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0"
               ...
               <tr>
                  ...
                  <th>승인번호</th>
                  <td ><comment id="_NSID_"> <object
                     id=EM_APPRNO classid=<%=Util.CLSID_EMEDIT%> width=150
                     tabindex=1 align="absmiddle"> </object> </comment> <script> _ws_(_NSID_);</script>
                  </td>
              </tr>
              ...
              <tr>
                  ...
                  <td colspan="5"><comment id="_NSID_"> <object
                     ...
                     align="absmiddle"> </object> </comment><script>_ws_(_NSID_);</script>
		                    　　　　　　* 적립내용 확인 <a id=SEARCH_POINT> <img src="/<%=dir%>/imgs/btn/detail_search_s.gif"  onclick="javascript:searchPoint();"  align="absmiddle" />
		                    <font color="red">※ 확인하고자 하는 영수증 선택 후 돋보기 클릭.</font></a>
                     </td>   
               </tr>
            </table>
            </td>
         ...
         <tr valign="top">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0"
               ...
               <tr>
                  <td width="100%">
                  <comment id="_NSID_"> <object
                     id=GD_MASTER width=100% height=280 classid=<%=Util.CLSID_GRID%> tabindex=1>
