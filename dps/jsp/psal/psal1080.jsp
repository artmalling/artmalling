...
function doInit(){
    ...
    registerUsingDataset("psal108","DS_O_DETAIL,DS_IO_MASTER" );
...
function btn_Search() {
    ...
    TR_MAIN.Action="/dps/psal108.ps?goTo="+goTo+parameters;  
 ...
 */
 ...
 function btn_Conf() {
     ...
     TR_MAIN.Action="/dps/psal108.ps?goTo=save";
...
function searchDetail(){
    ...
    TR_DETAIL.Action="/dps/psal108.ps?goTo="+goTo+parameters;  
