<!-- 
/*******************************************************************************
 * 시스템명 : 영업관리 > 매출관리 > POS 정산 > 거래별 매출내역 현황(쿠폰상세)
 * 작 성 일 : 2012.06.27
 * 작 성 자 : DHL
 * 수 정 자 : 
 * 파 일 명 : psal5430.jsp
...
function btn_Search() {
    ...
    */
    ...
    IFrame.location.href="/dps/jsp/psal/psal5431.jsp?"+parameters;
}
...
function btn_Print() {
	    ...
	    */
	    ...
	    var parameters = "&strStrCd="  + strStrCd              //점코드
	                   ...
	                   ; 
                   ;
    window.open("/dps/jsp/psal/psal5431.jsp?"+parameters,"OZREPORT", 1000, 700);	 
}
						...
						<tr>
							<td><table width="100%" border="0" cellpadding="0"
									...
									<tr>
										...
										<td><comment id="_NSID_"> <object id=EM_POSNO
