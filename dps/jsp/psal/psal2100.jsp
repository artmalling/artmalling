...
function doInit(){
    ...
    registerUsingDataset("psal210","DS_IO_MASTER,DS_IO_DETAIL" );
...
function btn_Search() {
    ...
    TR_MAIN.Action="/dps/psal210.ps?goTo="+goTo+parameters;  
...
function btn_Save() {
    ...
    TR_MAIN.Action = "/dps/psal210.ps?goTo=save"+parameters;
 ...
 */
 ...
 function btn_Conf() {
	...
	// 저장할 데이터 없는 경우
     ...
     TR_MAIN.Action="/dps/psal210.ps?goTo=saveconf"+parameters;
...
function searchDetail(){
    ...
    TR_DETAIL.Action="/dps/psal210.ps?goTo="+goTo+parameters;  
