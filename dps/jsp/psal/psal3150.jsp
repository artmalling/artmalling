...
function doInit(){
    ...
    registerUsingDataset("psal315","DS_O_MASTER" );
    
}

function gridCreate1(){
    var hdrProperies = '<FC>id={currow}			name="NO"		width=30    align=center    </FC>'
    	             //+ '<FC>id=DEPT_NAME		name="팀"		width=80    align=center	Show=true suppress=1	SubSumText={decode(curlevel,1,"","")} SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}</FC>'
    	             + '<FG>					name="팀"'
                     ...
                     + '<FC>id=DEPT_NAME   	    name="명"		width=80    align=left		suppress=2		SubSumText={decode(curlevel,2,"팀소계","")} SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}</FC>'
                     + '</FG>'
        			 + '<FG>					name="파트"'
                     ...
                     + '</FG>'
                     + '<FG>					name="협력사"'
                     + '<FC>id=VEN_CD			name="코드"		width=60    align=center	suppress=3		SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}</FC>'
                     + '<FC>id=ACC_VEN_NAME		name="명"		width=130    align=left		suppress=3		SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}</FC>'
                     + '</FG>'
    	             + '<FC>id=BRD_NAME 		name="브랜드"	width=110   align=left		SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}	</FC>'    	             
    	             + '<C>id=SALE_TOTAL 		name="합계"		width=100   align=right		mask="###,###"    gte_columntype="number:0:true" gte_Summarytype="number:0:true"	value={round(SALE_TOTAL/submax(UNIT))} 	sumtext={round(subsum(SALE_TOTAL)/UNIT)} 	SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}	</C>'
    	             + '<FC>id=SALE9 			name="09:00"    width=100    align=right		mask="###,###"    gte_columntype="number:0:true" gte_Summarytype="number:0:true"	value={round(SALE9/submax(UNIT))}			sumtext={round(subsum(SALE9)/UNIT)}  		SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}	</FC>'
    	             + '<FC>id=SALE10 			name="10:00"    width=100    align=right		mask="###,###"    gte_columntype="number:0:true" gte_Summarytype="number:0:true"	value={round(SALE10/submax(UNIT))}		sumtext={round(subsum(SALE10)/UNIT)}		SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}	</FC>'
    	             + '<FC>id=SALE11 			name="11:00"    width=100    align=right		mask="###,###"    gte_columntype="number:0:true" gte_Summarytype="number:0:true"	value={round(SALE11/submax(UNIT))}		sumtext={round(subsum(SALE11)/UNIT)} 		SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}	</FC>'
    	             + '<FC>id=SALE12 			name="12:00"    width=100    align=right		mask="###,###"    gte_columntype="number:0:true" gte_Summarytype="number:0:true"	value={round(SALE12/submax(UNIT))}		sumtext={round(subsum(SALE12)/UNIT)} 		SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}	</FC>'
    	             + '<FC>id=SALE13 			name="13:00"    width=100    align=right		mask="###,###"    gte_columntype="number:0:true" gte_Summarytype="number:0:true"	value={round(SALE13/submax(UNIT))}		sumtext={round(subsum(SALE13)/UNIT)} 		SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}	</FC>'
    	             + '<FC>id=SALE14 			name="14:00"    width=100    align=right		mask="###,###"    gte_columntype="number:0:true" gte_Summarytype="number:0:true"	value={round(SALE14/submax(UNIT))}		sumtext={round(subsum(SALE14)/UNIT)} 		SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}	</FC>'
    	             + '<FC>id=SALE15 			name="15:00"    width=100    align=right		mask="###,###"    gte_columntype="number:0:true" gte_Summarytype="number:0:true"	value={round(SALE15/submax(UNIT))}		sumtext={round(subsum(SALE15)/UNIT)} 		SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}	</FC>'
    	             + '<FC>id=SALE16 			name="16:00"    width=100    align=right		mask="###,###"    gte_columntype="number:0:true" gte_Summarytype="number:0:true"	value={round(SALE16/submax(UNIT))}		sumtext={round(subsum(SALE16)/UNIT)} 		SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}	</FC>'
    	             + '<FC>id=SALE17 			name="17:00"    width=100    align=right		mask="###,###"    gte_columntype="number:0:true" gte_Summarytype="number:0:true"	value={round(SALE17/submax(UNIT))}		sumtext={round(subsum(SALE17)/UNIT)} 		SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}	</FC>'
    	             + '<FC>id=SALE18 			name="18:00"    width=100    align=right		mask="###,###"    gte_columntype="number:0:true" gte_Summarytype="number:0:true"	value={round(SALE18/submax(UNIT))}		sumtext={round(subsum(SALE18)/UNIT)} 		SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}	</FC>'
    	             + '<FC>id=SALE19 			name="19:00"    width=100    align=right		mask="###,###"    gte_columntype="number:0:true" gte_Summarytype="number:0:true"	value={round(SALE19/submax(UNIT))}		sumtext={round(subsum(SALE19)/UNIT)} 		SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}	</FC>'
    	             + '<FC>id=SALE20 			name="20:00"    width=100    align=right		mask="###,###"    gte_columntype="number:0:true" gte_Summarytype="number:0:true"	value={round(SALE20/submax(UNIT))}		sumtext={round(subsum(SALE20)/UNIT)} 		SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}	</FC>'
    	             + '<FC>id=SALE21 			name="21:00"    width=100    align=right		mask="###,###"    gte_columntype="number:0:true" gte_Summarytype="number:0:true"	value={round(SALE21/submax(UNIT))}		sumtext={round(subsum(SALE21)/UNIT)} 		SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}	</FC>'
    	             + '<FC>id=SALE22 			name="22:00"    width=100    align=right		mask="###,###"    gte_columntype="number:0:true" gte_Summarytype="number:0:true"	value={round(SALE22/submax(UNIT))}		sumtext={round(subsum(SALE22)/UNIT)} 		SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}	</FC>'
    	             + '<FC>id=SALE23 			name="23:00"    width=100    align=right		mask="###,###"    gte_columntype="number:0:true" gte_Summarytype="number:0:true"	value={round(SALE23/submax(UNIT))}		sumtext={round(subsum(SALE23)/UNIT)} 		SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1")}	</FC>'
...
function btn_Search() {
    ...
    TR_MAIN.Action="/dps/psal315.ps?goTo="+goTo+parameters;  
         ...
         <tr>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0"
               ...
               <tr>
                  ...
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type=checkbox id=chkbox>소계출력  
                  </td>
                  <td colspan="5">
