...
function doInit(){
    ...
    registerUsingDataset("psal449","DS_O_MASTER" );
    
}

function gridCreate1(flag){
	// 단품별 조회
	if (flag == '0') {
    var hdrProperies = '<FC>id={currow}                name="NO"		width=30	align=center	SubSumText="" SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1",4,"#FFF29A",5,"#FFF29A")}</FC>'
                     ...
                     + '<FG>                           name="브랜드"'
                     + '<FC>id=PUMBUN_CD               name="코드"		width=50    align=center	suppress=1			SubSumText=""		SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1",4,"#FFF29A",5,"#FFF29A")}</FC>'
                     + '<FC>id=PUMBUN_NAME             name="명"			width=120   align=left		suppress=1			SubSumText="합계"	SubSumText={decode(curlevel,2,"",1,"브랜드별소계")} SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1",4,"#FFF29A",5,"#FFF29A")}</FC>'
                     + '</FG>'
                     + '<FG>                           name="단품"'
                     + '<FC>id=SKU_CD                  name="코드"		width=100    align=center	SubSumText=""		SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1",4,"#FFF29A",5,"#FFF29A")}</FC>'
                     + '<FC>id=SKU_NAME                name="명"			width=120    align=left		SubSumText="합계"	SubSumText={decode(curlevel,2,"",1,"브랜드별소계")} SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1",4,"#FFF29A",5,"#FFF29A")}</FC>'
                     + '</FG>'
                     + '<FC>id=SALE_QTY                name="판매수량"  width=90    align=right		mask="###,###"		sumtext={subsum(SALE_QTY)}										SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1",4,"#FFF29A",5,"#FFF29A")}</FC>'
                     + '<FC>id=TOT_SALE_AMT            name="총매출"		width=100    align=right		mask="###,###"		sumtext={subsum(TOT_SALE_AMT)}										SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1",4,"#FFF29A",5,"#FFF29A")}</FC>'
                     + '<FC>id=REDU_AMT                name="할인"		width=100    align=right		mask="###,###"		sumtext={subsum(REDU_AMT)}											SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1",4,"#FFF29A",5,"#FFF29A")}</FC>'
                     + '<FC>id=SALE_AMT                name="매출"		width=100    align=right		mask="###,###"		sumtext={subsum(SALE_AMT)}											SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1",4,"#FFF29A",5,"#FFF29A")}</FC>'
                     + '<FC>id=DC_AMT                  name="에누리"		width=100    align=right		mask="###,###"		sumtext={subsum(DC_AMT)}											SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1",4,"#FFF29A",5,"#FFF29A")}</FC>'
                     + '<FC>id=NET_SALE_AMT            name="순매출"		width=100    align=right		mask="###,###"		sumtext={subsum(NET_SALE_AMT)}										SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1",4,"#FFF29A",5,"#FFF29A")}</FC>'
                     ;
	} else if (flag == '1') {
    // 일자별 단품별 조회 
    var hdrProperies = '<FC>id={currow}                name="NO"		width=30	align=center	SubSumText="" SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1",4,"#FFF29A",5,"#FFF29A")}</FC>'
                     + '<FC>id=STR_CD                  name="점"			width=100	align=center	Show=false</FC>'
                     + '<FC>id=SALE_DT                 name="일자"		width=80    align=center	suppress=2			mask="XXXX/XX/XX"	SubSumText={decode(curlevel,1,"",5,"일자별소계")} SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1",4,"#FFF29A",5,"#FFF29A")}  </FC>'
                     + '<FG>                           name="브랜드"'
                     + '<FC>id=PUMBUN_CD               name="코드"		width=50    align=center	suppress=1			SubSumText=""		SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1",4,"#FFF29A",5,"#FFF29A")}</FC>'
                     + '<FC>id=PUMBUN_NAME             name="명"			width=120   align=left		suppress=1			SubSumText="합계"	SubSumText={decode(curlevel,2,"",1,"브랜드별소계")} SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1",4,"#FFF29A",5,"#FFF29A")}</FC>'
                     + '</FG>'
	    ...
	    var hdrProperies = '<FC>id={currow}                name="NO"		width=30	align=center	SubSumText="" SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1",4,"#FFF29A",5,"#FFF29A")}</FC>'
	                     ...
	                     + '<FC>id=PUMBUN_NAME             name="명"			width=120   align=left		SubSumText="합계"	SubSumText={decode(curlevel,2,"",1,"브랜드별소계")} SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1",4,"#FFF29A",5,"#FFF29A")}</FC>'
	                     + '</FG>'
	                     + '<FC>id=SALE_QTY                name="판매수량"  width=90    align=right		mask="###,###"		sumtext={subsum(SALE_QTY)}										SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1",4,"#FFF29A",5,"#FFF29A")}</FC>'
	                     + '<FC>id=TOT_SALE_AMT            name="총매출"		width=100    align=right		mask="###,###"		sumtext={subsum(TOT_SALE_AMT)}										SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1",4,"#FFF29A",5,"#FFF29A")}</FC>'
	                     + '<FC>id=REDU_AMT                name="할인"		width=100    align=right		mask="###,###"		sumtext={subsum(REDU_AMT)}											SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1",4,"#FFF29A",5,"#FFF29A")}</FC>'
	    ...
	    var hdrProperies = '<FC>id={currow}                name="NO"		width=30	align=center	SubSumText="" SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1",4,"#FFF29A",5,"#FFF29A")}</FC>'
	                     + '<FC>id=STR_CD                  name="점"			width=100	align=center	Show=false</FC>'
	                     + '<FC>id=SALE_DT                 name="일자"		width=80    align=center	suppress=1			mask="XXXX/XX/XX"	SubSumText={decode(curlevel,1,"",5,"일자별소계")} SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1",4,"#FFF29A",5,"#FFF29A")}  </FC>'
	                     + '<FG>                           name="브랜드"'
	                     + '<FC>id=PUMBUN_CD               name="코드"		width=50    align=center	suppress=2			SubSumText=""		SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1",4,"#FFF29A",5,"#FFF29A")}</FC>'
	                     + '<FC>id=PUMBUN_NAME             name="명"			width=120   align=left		suppress=2			SubSumText="합계"	SubSumText={decode(curlevel,2,"",1,"브랜드별소계")} SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1",4,"#FFF29A",5,"#FFF29A")}</FC>'
	                     + '</FG>'
	                     + '<FC>id=SALE_QTY                name="판매수량"  width=90    align=right		mask="###,###"		sumtext={subsum(SALE_QTY)}										SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1",4,"#FFF29A",5,"#FFF29A")}</FC>'
	                     + '<FC>id=TOT_SALE_AMT            name="총매출"		width=100    align=right		mask="###,###"		sumtext={subsum(TOT_SALE_AMT)}										SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1",4,"#FFF29A",5,"#FFF29A")}</FC>'
	                     + '<FC>id=REDU_AMT                name="할인"		width=100    align=right		mask="###,###"		sumtext={subsum(REDU_AMT)}											SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD",3,"#FFF7B1",4,"#FFF29A",5,"#FFF29A")}</FC>'
...
function btn_Search() {
    ...
    var strSkuCd        = EM_SKU_CD.text;            //단품코드
    var strDisp         = RD_DISP_FLAG.CodeValue;    //조회구분
    
    // 조회구분이 단품별, 또는 일자별 단품인 경우 브랜드 코드 필수 입력항목으로 지정한다.왜냐..데이타가 많으니깐..
    if (strDisp == "0" || strDisp == "1") {
    	if (strPumbunCd == "" && strSkuCd == "") {
			showMessage(INFORMATION, OK, "USER-1000","단품별 또는 일자별 단품별 조회시에는 브랜드코드 또는 단품코드를 반드시 입력하십시오.");
			return;
    	}
    }
    ...
    TR_MAIN.Action="/dps/psal449.ps?goTo="+goTo+parameters;  
...
function btn_Excel() {
    ...
    if (RD_DISP_FLAG.CodeValue == '0') {strDisp = '단품별'}
    if (RD_DISP_FLAG.CodeValue == '1') {strDisp = '일자별단품별'}
    if (RD_DISP_FLAG.CodeValue == '2') {strDisp = '브랜드별'}
    if (RD_DISP_FLAG.CodeValue == '3') {strDisp = '일자별브랜드별'}
...
if(EM_PUMBUN_CD.text.length != 0){    
    setStrPbnNmWithoutPop( "DS_O_PUMBUN_CD", EM_PUMBUN_CD, EM_PUMBUN_NAME, 'Y', '', '', '', '', '', '', '', '', '');
}
</script>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0"
               ...
               <tr>
                  ...
                  <td colspan="3"><comment id="_NSID_"> <object id=EM_PUMBUN_CD
                      ...
                      onclick="javascript:strPbnPop(EM_PUMBUN_CD,EM_PUMBUN_NAME, 'Y', '', '', '', '', '', '', '', '1'); EM_PUMBUN_CD.focus();"
              ...
              <tr>
		          ...
		          <td colspan="3" width="270">
		            <comment id="_NSID_">
		              <object id=EM_SKU_CD classid=<%= Util.CLSID_EMEDIT %> width=110 tabindex=1 align="absmiddle"></object>
		            </comment><script>_ws_(_NSID_);</script>
		            <img src="/<%=dir%>/imgs/btn/detail_search_s.gif" onclick="javascipt:setSkuCode('POP');" align="absmiddle" />
		            <comment id="_NSID_">
		              <object id=EM_SKU_NAME classid=<%= Util.CLSID_EMEDIT %> width=120 tabindex=1 align="absmiddle"></object>
		            </comment><script>_ws_(_NSID_);</script>
		          </td>
                  <th>조회구분</th>
                  <td colspan="3">
                    <comment id="_NSID_">
                    <object id=RD_DISP_FLAG classid=<%=Util.CLSID_RADIO%> tabindex=1 style="height:20; width:300">
                    <param name=Cols    value="4">
                    <param name=Format  value="0^단품,1^일자별단품,2^브랜드,3^일자별브랜드">
