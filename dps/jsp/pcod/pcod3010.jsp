...
function doInit(){
    ...
    registerUsingDataset("pcod301","DS_IO_DETAIL, DS_IO_MASTER" );
}
...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}     name="NO"         width=25   align=center   edit="none"</FC>'
                     ...
                     + '<C>id=PUMBUN_NAME   name="명"       width=110   align=left   edit="none" </C>'
                     + '</FG>'
...
function btn_Save() {
    ...
    TR_MAIN.Action="/dps/pcod301.pc?goTo=save"+parameters;
 ...
 */
 function searchMaster(){
    ...
    TR_MAIN.Action="/dps/pcod301.pc?goTo="+goTo+parameters;  
 ...
 */
 function searchDetail(){
     ...
     TR_DETAIL.Action="/dps/pcod301.pc?goTo="+goTo+parameters;  
 ...
 */
 function searchDetail2(){
     ...
     TR_DETAIL2.Action="/dps/pcod301.pc?goTo="+goTo+parameters;  
...
function searchMgInfo(vMgFlag){
	...
	TR_SEARCH.Action   = "/dps/pcod301.pc?goTo=" + goTo + parameters;
...
function searchPumbunCheck(vPumbunCd){
	...
	TR_SEARCH2.Action   = "/dps/pcod301.pc?goTo=" + goTo + parameters;
