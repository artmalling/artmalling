...
function btn_Search() {
    ...
    var action     = "O";
    TR_MAIN.Action="/dps/pcod507.pc?goTo="+goTo;  
...
function btn_Excel() {
   ...
   //openExcel2(GD_MASTER, "신선단품조회", parameters, true );
   openExcel5(GD_MASTER, "신선단품조회", parameters, true , "",g_strPid );
...
function setPumbunCdCombo(evnflag){
    ...
    if( evnflag == "POP" ){
        result = strPbnPop2(codeObj,nameObj,'Y','','','','','','','','1','2');
         
    }else if( evnflag == "NAME" ){
        result = setStrPbnNmWithoutPop("DS_SEARCH_NM",codeObj,nameObj,"Y",1,'','','','','','','','1','2');
...
//변경된 내역이 없으면 무시
    ...
    setStrSkuNmWithoutPop( "DS_O_SKU_CD", this, EM_O_SKU_NM , 'Y' , '0','','',EM_O_PUMBUN_CD.Text,'','','','','2');
</script>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
                        ...
                        <td><comment id="_NSID_"> <object id=EM_O_SKU_CD
                            ...
                            src="/<%=dir%>/imgs/btn/detail_search_s.gif" class="PR03"
                            onclick="javascript:strSkuPop(EM_O_SKU_CD,EM_O_SKU_NM,'Y','','',EM_O_PUMBUN_CD.Text,'','','','','2'); EM_O_SKU_CD.Focus();"
