...
function doInit(){
    ...
    getEtcCode("DS_I_FLOR_CD",  "D", "P061", "N");
...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}        name="NO"           width=30   align=center </FC>'
                     ...
                     + '</FG>' 
                     + '<FG>                 name="팀"'
                     + '<FC>id=DEPT_CD       name="코드"         width=40   align=center </FC>' 
                     + '<FC>id=DEPT_NAME       name="명"         width=80   align=left </FC>'
                     + '</FG>' 
                     + '<FG>                 name="파트"'
                     ...
                     + '</FG>' 
                     + '<FG>                 name="코너"'
                     + '<FC>id=CORNER_CD     name="코드"          width=40   align=center </FC>' 
                     + '<FC>id=CORNER_NAME     name="명"          width=80   align=left </FC>'
                     + '</FG>' 
                     + '<FC>id=ORG_FLAG_NAME   name="조직구분"      width=110  align=left </FC>'
                     
                     // MARIO OUTLET START
                     //+ '<FG>id=S_ORG           name="인사조직"'
                     //+ '<FC>id=SAP_ORG_CD      name="코드"          width=90   align=center </FC>'
                     //+ '<FC>id=SAP_ORG_NAME    name="명"            width=100   align=left </FC>'  
                     //+ '</FG>'                   
                     // MARIO OUTLET END
                     
                     + '<FG>id=B_ORG           name="이전조직"'
                     + '<FC>id=BF_ORG_CD       name="코드"          width=90   align=center </FC>'
                     + '<FC>id=BF_ORG_NAME     name="명"            width=100   align=left </FC>' 
                     + '</FG>'                   
                     + '<FC>id=MNG_ORG_YN      name="관리조직;여부"   width=60  align=center </FC>'
                     + '<FC>id=FLOR_CD         name="층"            width=60  align=left   EditStyle=Lookup    Data="DS_I_FLOR_CD:CODE:NAME"</FC>'
                     + '<FC>id=EMP_CNT         name="직영;인원수"     width=60  align=right </FC>'
...
function btn_Search() {
    ...
    TR_MAIN.Action="/dps/pcod003.pc?goTo="+goTo+parameters;  
...
function btn_Excel() {
	...
	//openExcel2(GD_MASTER, "조직조회", parameters, true );
	openExcel5(GD_MASTER, "조직조회", parameters, true , "",g_strPid );
