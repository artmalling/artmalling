...
function doInit(){
    ...
    registerUsingDataset("pcod201","DS_MASTER,DS_PBNPMK,DS_STRPBN,DS_PBNVENEMP" );
...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}     name="NO"         width=30   align=center</FC>'
                     ...
                     + '<FC>id=PUMBUN_NAME  name="명"       width=110  align=left</FC>'
                     + '</FG>'
                     + '<FG>                name="협력사" '
                     + '<FC>id=VEN_CD       name="코드"     width=55   align=center</FC>'
                     + '<FC>id=VEN_NAME     name="명"       width=110  align=left</FC>'
                     + '</FG>';
...
function gridCreate3(){
    var hdrProperies = '<FC>id={currow}    name="NO"         width=30   align=center</FC>'
                     ...
                     + '<FG>name="전화번호"  '
                     + '<FC>id=PHONE1_NO      name="지역"   Edit="Numeric" edit={IF(FLAG=1,"false","true")}   width=40   align=left</FC>'
                     + '<FC>id=PHONE2_NO      name="국번"   Edit="Numeric" edit={IF(FLAG=1,"false","true")}  width=40   align=left</FC>'
                     + '<FC>id=PHONE3_NO      name="번호"   Edit="Numeric" edit={IF(FLAG=1,"false","true")}  width=40   align=left</FC>'
                     + '</FG>'
                     + '<FG>name="*휴대전화"  '
                     + '<FC>id=HP1_NO      name="통신사"   Edit="Numeric" edit={IF(FLAG=1,"false","true")}  width=40   align=left</FC>'
                     + '<FC>id=HP2_NO      name="국번"     Edit="Numeric" edit={IF(FLAG=1,"false","true")}  width=40   align=left</FC>'
                     + '<FC>id=HP3_NO      name="번호"    Edit="Numeric"  edit={IF(FLAG=1,"false","true")}  width=40   align=left</FC>'
                     + '</FG>'
                     + '<FC>id=EMAIL    name="*이메일"       width=140 edit={IF(FLAG=1,"false","true")} edit="AlphaEtc" align=left</FC>'
                     + '<FC>id=SMEDI_ID    name="스마일 EDI ID"  width=100   edit={IF(FLAG=1,"false","true")}  edit="AlphaNum"  align=left</FC>'
...
function gridCreate4(){
    var hdrProperies = '<FC>id={currow}     name="NO"         width=25   align=center</FC>'
                     ...
                     + '<FC>id=TAG_FLAG      name="*택구분"     width=85   align=left  EditStyle=Lookup  Data="DS_I_TAG_FLAG:CODE:NAME" </FC>'
...
function btn_Save() {
    ...
    if(DS_MASTER.IsUpdated){
        ...
        btnSaveClick = true;
        TR_MAIN.Action="/dps/pcod201.pc?goTo=savePbnmst";
        ...
        btnSaveClick = true;
        TR_MAIN.Action="/dps/pcod201.pc?goTo=saveDetail"+parameters;
...
function searchMaster(){
    ...
    var action     = "O";
    TR_SUB.Action="/dps/pcod201.pc?goTo="+goTo;  
...
function searchPbnpmk(){
    ...
    var action     = "O";     
    var parameters = "&strPumbunCd="+encodeURIComponent(strPumbunCd);
    TR_MAIN.Action="/dps/pcod201.pc?goTo="+goTo+parameters;  
...
function btn_send_pbn_emg(){
	    ...
	    if( showMessage(QUESTION, YESNO, "USER-1204") == 1 ){
	    	...
	    	TR_MAIN.Action = "/dps/pcod201.pc?goTo=sendpbnemg"+parameters;
...
function btn_send_pmk_emg(){
	    ...
	    if( showMessage(QUESTION, YESNO, "USER-1204") == 1 ){
	    	...
	    	TR_MAIN.Action = "/dps/pcod201.pc?goTo=sendpmkemg"+parameters;
	        TR_MAIN.KeyValue="SERVLET(O:DS_MASTER=DS_MASTER)"; //조회는 O
	    	TR_MAIN.Post();        
	    }
}
	...
	<tr valign="top">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr valign="top">
				...
				<td class="PL10" >
				<div id=TAB_MAIN width="100%" height=460 TitleWidth=90 TitleAlign="center" TitleGap=3 >
...
<td>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr class="PT10">
						<td class="FS11 red">※ 협력사의 기본 담당자는 수정 할 수 없습니다.</td>
					</tr>
					<tr class="PT05">
						<td class="FS11 red">※ EDI 사용 업체의 경우 EDI담당자 정보가 있어야 EDI 사용자
						정보 SMS 전송이 가능 합니다.</td>
					</tr>
					<tr class="PT05">
						<td class="FS11 red">※ 스마일EDI 사용 업체의 경우 정산 담당자 정보가 있어야
