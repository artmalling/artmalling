<%@ page language="java" contentType="text/html;charset=euc-kr" import="common.util.Util, kr.fujitsu.ffw.util.Date2"  %>
...
<link href="/dps/css/mds.css" rel="stylesheet" type="text/css">
<script language="javascript"  src="/dps/js/common.js" type="text/javascript"></script>
<script language="javascript"  src="/dps/js/global.js" type="text/javascript"></script>
<script language="javascript"  src="/dps/js/gauce.js"   type="text/javascript"></script>
<script language="javascript"  src="/dps/js/message.js" type="text/javascript"></script>
...
//
  ...
  var   usrCd  = '<c:out value="${sessionScope.sessionInfo.USER_ID}" />';       // 
  ...
  function window_close(args){
    if ((DEBUG || strErrorType == "SERVER" || strMsgCode == "SCRIPT-1001") && args == 2){
        // 헤더 초기화
        DS_I_MAILFORM.setDataHeader('usrCd:STRING(9),name:STRING(50),sndMail:STRING(50),tel:STRING(50),filePath:STRING(200),fileName:STRING(200),rcvMail:STRING(100),suggestOne:STRING(1000)');
        //TRANSACTION 초기화 
        initTR(TR_MAIN, "0");
     ...
     // 데이타셋 셋팅.
        ...
        DS_I_MAILFORM.NameValue(DS_I_MAILFORM.RowPosition, "usrCd"      ) = usrCd;
        DS_I_MAILFORM.NameValue(DS_I_MAILFORM.RowPosition, "name"       ) = usrNm;
        DS_I_MAILFORM.NameValue(DS_I_MAILFORM.RowPosition, "sndMail"    ) = "script@error.com";
        ...
        //
        //TR_MAIN.Action="/dps/tcom007.tc?goTo=sendSuggestEmail";
              ...
              <tr valign="middle">
                <td height="25" align="center" valign="middle">
                  <table width="100%" heigth="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td align="center">
                        <img id=BUTTON_ONE src='/dps/imgs/bg/blank.gif' onClick="window_close(1);" style=" margin-top:4px;">
                        <img id=BUTTON_TWO src='/dps/imgs/bg/blank.gif' onClick="window_close(2);" style=" margin-top:4px;">
                        <img id=BUTTON_THREE src='/dps/imgs/bg/blank.gif' onClick="window_close(3);" style=" margin-top:4px;">
                      </td>
                    </tr>
                  </table>
                </td>
...
<script language="JavaScript">
  switch (strIcon.toUpperCase()){
    case INFORMATION :
      ...
      ICON.src = '/dps/imgs/comm/ms02.gif';
      break;
    case STOPSIGN :
      strHeader = strHeader + "에러";       
      ICON.src = '/dps/imgs/comm/ms04.gif';
      break;
    case EXCLAMATION :
      strHeader = strHeader + "확인";       
      ICON.src = '/dps/imgs/comm/ms03.gif';
      break;
    case QUESTION :
      strHeader = strHeader + "질문";       
      ICON.src = '/dps/imgs/comm/ms01.gif';
      break;
    case NONE :
      strHeader = strHeader + "";     
      IICON.src = '';
  ...
  switch(strButton){
    case OK :
      BUTTON_ONE.src = '/dps/imgs/btn/confirm.gif';
      break;
    case OKCANCEL :
      BUTTON_ONE.src = '/dps/imgs/btn/confirm.gif';
      BUTTON_TWO.src = '/dps/imgs/btn/cancel.gif';
      break;
    case YESNO : 
      BUTTON_ONE.src = '/dps/imgs/btn/yes.gif';
      BUTTON_TWO.src = '/dps/imgs/btn/no.gif';
      break;
    case YESNOCANCEL :
      BUTTON_ONE.src = '/dps/imgs/btn/yes.gif';
      BUTTON_TWO.src = '/dps/imgs/btn/no.gif';
      BUTTON_THREE.src = '/dps/imgs/btn/cancel.gif';
      break;
    case RETRYCANCEL :
      BUTTON_ONE.src = '/dps/imgs/btn/btn_retry.gif';
      BUTTON_TWO.src = '/dps/imgs/btn/cancel.gif';
      break;
    case ABORTRETRYIGNORE :
      BUTTON_ONE.src = '/dps/imgs/btn/btn_abort.gif';
      BUTTON_TWO.src = '/dps/imgs/btn/btn_retry.gif';
      BUTTON_THREE.src = '/dps/imgs/btn/cancel.gif';
      break;
    default :
       break;
  ...
  if (DEBUG || strErrorType == "SERVER" || strMsgCode == "SCRIPT-1001"){
    ...
    BUTTON_TWO.src = '/dps/imgs/btn/btn_err_send.gif';
  }
