<!-- 
/*******************************************************************************
 * 시스템명 : 영업관리 > 재고수불 > 재고실사> 브랜드별재고실사집계표
 * 작 성 일 : 2010.05.04
 * 작 성 자 : 이재득
 * 수 정 자 : 
 * 파 일 명 : pstk211.jsp
 * 버    전 : 1.0 (버전은 1.0부터 시작하며 0.1씩 증가)
 * 개    요 : 브랜드별 실사재고 집계표 현황을 보여준다.
 * 이    력 :
 *        2010.05.04 (이재득) 작성
 ******************************************************************************/
-->
...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}       name="NO"                width=30     align=center    edit=none  sumtext="" SubBgColor=#FFFFE0</FC>'
    	             ...
    	             + '<FC>id=PUMBUN_CD      name="브랜드코드"          width=70    align=center  edit=none  SubBgColor=#FFFFE0 </FC>' 
    	             + '<FC>id=PUMBUN_NAME    name="브랜드명"            width=120    align=left  edit=none   SubBgColor=#FFFFE0</FC>' 
                     + '<FC>id=STK_YM         name="실사년월"          width=85    align=left  edit=none    show="false"</FC>'
                     + '<FG> name="장부재고" '
                     + '<FC>id=STK_QTY        name="수량"              width=70    align=right  edit=none   sumtext=@sum  SubBgColor=#FFFFE0</FC>'
                     + '<FC>id=STK_AMT        name="금액"              width=110    align=right  edit=none   sumtext=@sum  SubBgColor=#FFFFE0</FC>'
                     + '</FG> ' 
                     + '<FG> name="실사재고합계" '
                     + '<FC>id=SRVY_QTY       name="수량"              width=70    align=right  edit=none   sumtext=@sum  SubBgColor=#FFFFE0</FC>'
                     + '<FC>id=SRVY_SALE_AMT  name="금액"              width=110    align=right  edit=none   sumtext=@sum  SubBgColor=#FFFFE0</FC>'
                     + '</FG> ' 
                     + '<FG> name="매출" '
                     ...
                     + '<FC>id=LOST_AMT       name="금액"              width=110    align=right  edit=none   sumtext=@sum  SubBgColor=#FFFFE0</FC>'
                     + '</FG> '
                     + '<FC>id=LOSS_RATE      name="LOSS율"            width=50    align=right  edit=none   subsumtext="" sumtext=""   SubBgColor=#FFFFE0</FC>'                     
                     + '<FC>id=LOSS_ADD_AMT   name="인정LOSS;초과금액"  width=90    align=right  edit=none     sumtext=@sum  SubBgColor=#FFFFE0</FC>'; 
...
function gridCreate2(){
    var hdrProperies = '<FC>id={currow}          name="NO"             width=30    align=center  edit=none  sumtext=""  SubBgColor=#FFFFE0</FC>'    	                            
                     + '<FC>id=PUMMOK_CD         name="품목코드"        width=70    align=center  edit=none  sumtext=""  Suppress="1" SubBgColor=#FFFFE0</FC>'
                     + '<FC>id=PUMMOK_NAME       name="품목명"          width=90    align=left    edit=none  sumtext=""  Suppress="1" SubBgColor=#FFFFE0</FC>'
                     + '<FG> name="마진코드" '
                     + '<FC>id=EVENT_FLAG        name="행사구분"        width=55    align=center  edit=none   SubBgColor=#FFFFE0</FC>'
                     + '<FC>id=EVENT_RATE        name="행사율"          width=50    align=center  edit=none   SubBgColor=#FFFFE0</FC>'
                     + '<FC>id=MG_RATE           name="마진율"          width=50    align=center  edit=none   SubBgColor=#FFFFE0</FC>'
                     + '</FG> ' 
                     + '<FG> name="장부재고" '
                     + '<FC>id=STK_QTY            name="수량"           width=70    align=right  edit=none   sumtext=@sum  SubBgColor=#FFFFE0</FC>'
                     + '<FC>id=STK_AMT            name="금액"           width=110    align=right  edit=none   sumtext=@sum  SubBgColor=#FFFFE0</FC>'
                     + '</FG> ' 
                     + '<FG> name="실사재고" '                     
                     + '<FC>id=SRVY_QTY          name="정상수량"        width=70    align=right  edit=none   sumtext=@sum  SubBgColor=#FFFFE0</FC>'
                     + '<FC>id=SRVY_SALE_AMT     name="정상금액"        width=90    align=right  edit=none   sumtext=@sum  SubBgColor=#FFFFE0</FC>'
                     + '</FG> ' 
                     + '<FG> name="차이" '
                     + '<FC>id=LOSS_QTY          name="수량"            width=70    align=right  edit=none   sumtext=@sum  SubBgColor=#FFFFE0</FC>'
                     + '<FC>id=LOST_AMT          name="금액"            width=110    align=right  edit=none   sumtext=@sum  SubBgColor=#FFFFE0</FC>'
                     + '</FG> '
                     + '<FC>id=LOSS_RATE         name="LOSS율"          width=55    align=right  edit=none   subsumtext="" sumtext=""   SubBgColor=#FFFFE0</FC>';
...
function btn_Search() { 
    ...
    TR_MAIN.Action="/dps/pstk211.pt?goTo="+goTo+parameters;  
 ...
 **/
 function searchDetail() {
     ...
     var parameters = "&strStrCd="+encodeURIComponent(strStrCd)
                    ...
                    + "&strPumbunCd="+encodeURIComponent(strPumbunCd)
                    + "&strStkDt="+encodeURIComponent(strStkDt);
     TR_SUB.Action="/dps/pstk211.pt?goTo="+goTo+parameters;  
    ...
    <tr>
        ...
        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table">
          <tr>
            ...
            <td width="165"><comment id="_NSID_"> <object id=LC_O_DEPT_CD tabindex=1
     ...
     <td class="PB03">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="BD4A">
            <tr>
                <td>
                    <comment id="_NSID_">
                        <OBJECT id=GD_DETAIL width=100% height=220 classid=<%=Util.CLSID_GRID%>>
