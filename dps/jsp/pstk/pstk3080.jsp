<!-- 
/*******************************************************************************
 * 시스템명 : 영업관리 > 재고수불 > 재고실사> 기간브랜드별손익명세서
 * 작 성 일 : 2011.05.06
 * 작 성 자 : 이재득
 * 수 정 자 : 
 * 파 일 명 : pstk308.jsp
 * 버    전 : 1.0 (버전은 1.0부터 시작하며 0.1씩 증가)
 * 개    요 : 브랜드별 기간 합계의 손익명세서를 보여준다.
 * 이    력 :
 *        2011.05.06 (이재득) 작성
 ******************************************************************************/
-->
...
<loginChk:islogin />
<%
	String dir = BaseProperty.get("context.common.dir");// PID 확인을 위한
...
function gridCreate1(){
    var hdrProperies = '<COLUMNINFO>' 
					...
					/*
                     + '       <COLUMN id="TOP_BUY_TOT_SALE_AMT"   >'
                     + '           <HEADER left="1760" top="0" right="2160" bottom="20" text="매출" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '       </COLUMN>'  
                     ...
                     + '           <HEADER left="1860" top="40" right="1960" bottom="60" text="에누리(세제외)" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="1860" top="20" right="1960" bottom="40" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'
                     + '       </COLUMN>'

                     + '       <COLUMN id="NETSALEAMT" refcolid="SALE_NET_SALE_AMT" >'
                     + '           <HEADER left="1960" top="20" right="2060" bottom="40" text="순매출액" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="1960" top="0" right="2060" bottom="20" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'
                     + '       </COLUMN>'
       
                     + '       <COLUMN id="SALEVATAMT"  refcolid="SALE_VAT_AMT" >'
                     + '           <HEADER left="1960" top="40" right="2060" bottom="60" text="매출부가세" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="1960" top="20" right="2060" bottom="40" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'
                     + '       </COLUMN>'
                    ...
                    */
                     ...
                     + '           <HEADER left="2540" top="0" right="2640" bottom="60" text="매출원가" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="2540" top="0" right="2640" bottom="40" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'                           
                     + '       </COLUMN>'
                     
                     
                     + '       <COLUMN id="LMMC_PROFIT_AMT" refcolid="LM_MC_PROFIT_AMT" >'
                     + '           <HEADER left="2640" top="0" right="2740" bottom="60" text="상품매출이익" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="2640" top="0" right="2740" bottom="40" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'                           
                     + '       </COLUMN>'
                    
                     + '       <COLUMN id="NETSALE_PROFIT_RATE" refcolid="NETSALE_PROFIT_RATE" >'
                     + '           <HEADER left="2740" top="0" right="2840" bottom="60" text="순매출이익율" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="2740" top="0" right="2840" bottom="40" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,###.000"/>'                           
                     + '       </COLUMN>'
                 
                     + '       <COLUMN id="LM_COST_AMT" refcolid="LM_COST_AMT" >'
                     + '           <HEADER left="2840" top="0" right="2940" bottom="60" text="매입원가" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="2840" top="0" right="2940" bottom="40" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'                           
                     + '       </COLUMN>'

                     + '       <COLUMN id="STKCOSTAMT" refcolid="DW_STK_COST_AMT" >'
                     + '           <HEADER left="2940" top="0" right="3040" bottom="60" text="원가재고" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="2940" top="0" right="3040" bottom="40" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'                           
                     + '       </COLUMN>'
                     
                     
                     + '       <COLUMN id="STKCYCLE_RATE" refcolid="STK_CYCLE_RATE" >'
                     + '           <HEADER left="3040" top="0" right="3140" bottom="60" text="회전율" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="3040" top="0" right="3140" bottom="40" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,###.000"/>'                             
                     + '       </COLUMN>'
...
function btn_Search() { 
    ...
    TR_MAIN.Action="/dps/pstk308.pt?goTo="+goTo+parameters;  
...
function btn_Excel() {	 
    ...
    //openExcelM(GD_MASTER, "기간브랜드별손익명세서", parameters, true );
    openExcelM2(GD_MASTER, "기간브랜드별손익명세서", parameters, true ,g_strPid );
...
function btn_Print() {
	...
	window.open("/dps/pstk308.pt?goTo=print"+params,"OZREPORT", 1000, 700);
}
