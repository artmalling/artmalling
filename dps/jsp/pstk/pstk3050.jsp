<!-- 
/*******************************************************************************
 * 시스템명 : 영업관리 > 재고수불 > 재고실사> 조직별장부재고조회
 * 작 성 일 : 2010.05.06
 * 작 성 자 : 이재득
 * 수 정 자 : 
 * 파 일 명 : pstk305.jsp
 * 버    전 : 1.0 (버전은 1.0부터 시작하며 0.1씩 증가)
 * 개    요 : 조직별 장부재고 현황을 보여준다.
 * 이    력 :
 *        2010.05.06 (이재득) 작성
 ******************************************************************************/
-->
...
function gridCreate1(){
    var hdrProperies = '<COLUMNINFO>' 
                     ...
                     + '           <HEADER left="420" top="0" right="420" bottom="0" text="년월" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="420" top="0" right="420" bottom="0" align="leftCenter" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEWSUMMARY  text=""  bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0"/>' 
                     + '       </COLUMN>'
                     ...
                     + '           <HEADER left="1570" top="0" right="1860" bottom="20" text="매입합계" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '       </COLUMN>'  
                     ...
                     + '           <HEADER left="1660" top="20" right="1760" bottom="60" text="점출부가세" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="1660" top="0" right="1760" bottom="40" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'
                     ...
                     + '           <HEADER left="1760" top="20" right="1860" bottom="40" text="점출액(세제외)" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     ...
                     + '           <HEADER left="1760" top="40" right="1860" bottom="60" text="점출차액(세제외)" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="1760" top="20" right="1860" bottom="40" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'
                     + '           <VIEWSUMMARY  text="@GFSUM(BUY_TOT_EX_VAT_PROFIT_AMT)"  bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0"/>' 
                     + '       </COLUMN>' 
                     
                     + '       <COLUMN id="TOP_BUY_TOT_SALE_AMT"   >'
                     + '           <HEADER left="1860" top="0" right="2160" bottom="20" text="매출" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '       </COLUMN>'  
                     
                     + '       <COLUMN id="SALEAMT" refcolid="SALE_SALE_AMT" >'
                     + '           <HEADER left="1860" top="20" right="1960" bottom="40" text="총매출액(세포함)" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     ...
                     + '           <HEADER left="1860" top="40" right="1960" bottom="60" text="에누리(세포함)" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     ...
                     + '           <HEADER left="1960" top="20" right="2060" bottom="40" text="총매출액(세제외)" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="1960" top="0" right="2060" bottom="20" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'
                     ...
                     + '           <HEADER left="1960" top="40" right="2060" bottom="60" text="순매출" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     ...
                     + '           <HEADER left="2060" top="20" right="2160" bottom="40" text="순매출부가세" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="2060" top="0" right="2160" bottom="20" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'
                     ...
                     + '           <HEADER left="2060" top="40" right="2160" bottom="60" text="세제외순매출액" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="2060" top="20" right="2160" bottom="40" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'
                     + '           <VIEWSUMMARY  text="@GFSUM(SALE_NET_SALE_AMT)"  bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0"/>' 
                     + '       </COLUMN>'
                     
					/*
                     + '       <COLUMN id="TOP_BUY_TOT_SALE_AMT"   >'
                     + '           <HEADER left="1860" top="0" right="2260" bottom="20" text="매출" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '       </COLUMN>'  
                     ...
                     + '           <HEADER left="1960" top="40" right="2060" bottom="60" text="에누리(세제외)" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="1960" top="20" right="2060" bottom="40" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'
                     ...
                     + '           <HEADER left="2060" top="20" right="2160" bottom="40" text="순매출액(세제외)" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="2060" top="0" right="2160" bottom="20" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'
                     + '           <VIEWSUMMARY  text="@GFSUM(SALE_NET_SALE_AMT)"  bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0"/>' 
                     + '       </COLUMN>'
       
                     + '       <COLUMN id="SALEVATAMT"  refcolid="SALE_VAT_AMT" >'
                     + '           <HEADER left="2060" top="40" right="2160" bottom="60" text="순매출부가세" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="2060" top="20" right="2160" bottom="40" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'
                     + '           <VIEWSUMMARY  text="@GFSUM(SALE_VAT_AMT)"  bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0"/>' 
                     + '       </COLUMN>'

                     + '       <COLUMN id="SALEPROFITAMT" refcolid="SALE_PROFIT_AMT" >'
                     + '           <HEADER left="2160" top="20" right="2260" bottom="40" text="매출이익액" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="2160" top="0" right="2260" bottom="20" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'
                     ...
                     + '           <HEADER left="2160" top="40" right="2260" bottom="60" text="매출이익율" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="2160" top="20" right="2260" bottom="40" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'
                     + '           <VIEWSUMMARY  text=""  bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0"/>' 
                     + '       </COLUMN>'
                     */
                     
                     + '       <COLUMN id="TOP_BASE_AMT"   >'
                     + '           <HEADER left="2160" top="0" right="2440" bottom="20" text="월말재고" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '       </COLUMN>'
                     
                     + '       <COLUMN id="LASTSALE_AMT" refcolid="DW_SALE_AMT" >'
                     + '           <HEADER left="2160" top="20" right="2250" bottom="40" text="점출액" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="2160" top="0" right="2250" bottom="20" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'
                     ...
                     + '           <HEADER left="2160" top="40" right="2250" bottom="60" text="점출차액" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="2160" top="20" right="2250" bottom="40" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'
                     ...
                     + '           <HEADER left="2250" top="20" right="2340" bottom="60" text="점출부가세" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="2250" top="0" right="2340" bottom="40" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'
                     ...
                     + '           <HEADER left="2340" top="20" right="2440" bottom="40" text="점출액(세제외)" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="2340" top="0" right="2440" bottom="20" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'                            
                     ...
                     + '           <HEADER left="2340" top="40" right="2440" bottom="60" text="점출차액(세제외)" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="2340" top="20" right="2440" bottom="40" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'                           
                     ...
                     //+ '           <HEADER left="2440" top="0" right="2540" bottom="60" text="재고원가" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     //+ '           <VIEW left="2440" top="0" right="2540" bottom="40" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'                           
                     ...
                     + '           <HEADER left="2440" top="0" right="2540" bottom="60" text="세제외점출차익율" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     ...
                     + '           <HEADER left="2540" top="0" right="2640" bottom="60" text="원가율" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="2540" top="0" right="2640" bottom="40" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,###.000"/>'                           
                     + '           <VIEWSUMMARY bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0"/>' 
                     + '       </COLUMN>'

                     + '       <COLUMN id="SALECOST" refcolid="SALE_COST_AMT" >'
                     + '           <HEADER left="2640" top="0" right="2730" bottom="60" text="매출원가" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="2640" top="0" right="2730" bottom="40" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'                           
                     ...
                     + '           <HEADER left="2930" top="0" right="3020" bottom="60" text="매입원가" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="2930" top="0" right="3020" bottom="40" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'                           
                     ...
                     + '           <HEADER left="3020" top="0" right="3110" bottom="60" text="원가재고" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="3020" top="0" right="3110" bottom="40" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'                           
                     + '           <VIEWSUMMARY text="@GFSUM(DW_STK_COST_AMT)"   bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0"/>' 
                     + '       </COLUMN>'
                     
                     + '       <COLUMN id="STKCYCLE_RATE" refcolid="STK_CYCLE_RATE" >'
                     + '           <HEADER left="3110" top="0" right="3200" bottom="60" text="회전율" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="3110" top="0" right="3200" bottom="40" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,###.000"/>'                             
                     + '           <VIEWSUMMARY  text=""  bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0"/>' 
                     + '       </COLUMN>'
                     + '     </COLUMNINFO>';
...
function btn_Search() { 
    ...
    TR_MAIN.Action="/dps/pstk305.pt?goTo="+goTo+parameters;  
...
function btn_Excel() {	 
    ...
    //openExcelM(GD_MASTER, "조직별손익명세서", parameters, true );
    openExcelM2(GD_MASTER, "조직별손익명세서", parameters, true );,g_strPid );
...
function btn_Print() {
	...
	window.open("/dps/pstk305.pt?goTo=print"+params,"OZREPORT", 1000, 700);
}
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="BD4A">
            <tr>
                <td>
                  ...
                  id=GD_MASTER width=100% height=482 classid=<%=Util.CLSID_MGRID%>>
