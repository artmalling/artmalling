...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}         name="NO"               width=30     align=center   edit=none  sumtext="" SubSumText=""  SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</FC>'
    	             ...
    	             + '<FC>id=PUMMOK_CD        name="품목코드"          width=80     align=center  edit=none  SubSumText=""  SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</FC>'
                     ...
                     + '<FC>id=MODEL_NO         name="브랜드단품코드"     width=120     align=center  edit=none  SubSumText=""  SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")} </FC>'
                     + '<FC>id=SKU_CD           name="단품코드"          width=120     align=center  edit=none  SubSumText=""  SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</FC>'
                     ...
                     + '<FC>id=BASE_COST 		name="금액"              width=110     align=right  edit=none   sumtext=@sum  SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</FC>'
                     //+ '<FC>id=BASE_AMT         name="판매가"              width=110     align=right  edit=none   sumtext=@sum  SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</FC>'
                     + '</FG> ' 
                     + '<FG> name="매입 (②)" '
                     + '<FC>id=BUY_QTY      	name="수량"              width=70     align=right  edit=none   sumtext=@sum  SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</FC>'
                     + '<FC>id=BUY_COST			name="금액"              width=110     align=right  edit=none   sumtext=@sum  SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</FC>'
                     //+ '<FC>id=BUY_TOT_SALE_AMT name="판매가"              width=110     align=right  edit=none   sumtext=@sum  SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</FC>'
                     + '</FG> ' 
                     + '<FG> name="매출 (③)" '
                     + '<FC>id=SALE_COST_PRC    name="매출(평균)단가"     width=110     align=right  edit=none   	SubSumText=0			SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</FC>'
                     + '<FC>id=SALE_QTY         name="수량"              width=70     align=right  edit=none   sumtext=@sum  SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</FC>'
                     + '<FC>id=SALE_COST	    name="금액"              width=110     align=right  edit=none   sumtext=@sum  SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</FC>'
                     + '</FG> '
                     + '<FG> name="재고조정 (④)" '
                     + '<FC>id=STK_ADJ_QTY      name="수량"              width=70     align=right  edit=none   sumtext=@sum  SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</FC>'
                     + '<FC>id=STK_ADJ_COST		name="금액"              width=110     align=right  edit=none   sumtext=@sum  SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</FC>'
                     + '</FG> '
                     + '<FG> name="기말재고 (①+②-③-④)" '
                     + '<FC>id=SRVY_E_QTY       name="수량"              width=70     align=right  edit=none   sumtext=@sum  SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</FC>'
                     + '<FC>id=SRVY_E_COST      name="금액"              width=110     align=right  edit=none   sumtext=@sum  SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</FC>'
                     //+ '<FC>id=SRVY_E_AMT       name="판매가"              width=110     align=right  edit=none   sumtext=@sum  SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</FC>'
                     + '</FG> '
...
function btn_Search() { 
    ...
    TR_MAIN.Action="/dps/pstk114.pt?goTo="+goTo+parameters;  
        ...
        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table">
          ...
          <tr>
            ...
            <td >
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;<input type=checkbox id=chkbox checked>소계출력  
            </td>
