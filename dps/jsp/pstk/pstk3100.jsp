<!-- 
/*******************************************************************************
 * 시스템명 : 영업관리 > 재고수불 > 재고실사> 기간단품별손익명세서
 * 작 성 일 : 2011.06.24
 * 작 성 자 : 이재득
 * 수 정 자 : 
 * 파 일 명 : pstk310.jsp
 * 버    전 : 1.0 (버전은 1.0부터 시작하며 0.1씩 증가)
 * 개    요 : 단품별 기간 손익명세서를 보여준다.
 * 이    력 :
 *        2011.06.24 (이재득) 작성
 ******************************************************************************/
-->
...
function gridCreate1(){
    var hdrProperies = '<COLUMNINFO>' 
                     ...
                     + '       <COLUMN id="TOP_SKUCD"   >'
                     + '           <HEADER left="0" top="0" right="180" bottom="20" text="단품" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '       </COLUMN>'
                     
                     + '       <COLUMN id="SKUCD" refcolid="SKU_CD" >'
                     + '           <HEADER left="0" top="20" right="100" bottom="60" text="코드" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="0" top="0" right="100" bottom="40" edit="" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '       </COLUMN>'    
                     
                     + '       <COLUMN id="SKUNAME" refcolid="SKU_NAME" >'
                     + '           <HEADER left="100" top="20" right="180" bottom="60" text="명" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="100" top="0" right="180" bottom="40" align="LeftCenter" edit="" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '       </COLUMN>'  
...
//////////////                     
                     ...
                     + '           <HEADER left="2340" top="0" right="2450" bottom="60" text="세제외점출차익율" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="2340" top="0" right="2450" bottom="40" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,###.000"/>'                           
                     + '       </COLUMN>'
                    ...
                    /*
                     + '       <COLUMN id="TOP_BUY_TOT_SALE_AMT"   >'
                     + '           <HEADER left="1390" top="0" right="1670" bottom="20" text="매입합계" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '       </COLUMN>'  
                     ...
                     + '       <COLUMN id="BUYVAT_SALE_AMT" refcolid="BUY_TOT_TAX_AMT" >'
                     + '           <HEADER left="1480" top="20" right="1570" bottom="60" text="점출부가세" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="1480" top="0" right="1570" bottom="40" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'
                     + '           <VIEWSUMMARY  text="@GFSUM(BUY_TOT_TAX_AMT)"  bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0"/>' 
                     + '       </COLUMN>'
                     
                     + '       <COLUMN id="BUYEX_VAT_SALE_AMT" refcolid="BUY_TOT_EX_VAT_SALE_AMT" >'
                     + '           <HEADER left="1570" top="20" right="1670" bottom="40" text="점출액(세제외)" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="1570" top="0" right="1670" bottom="20" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'
                     + '           <VIEWSUMMARY  text="@GFSUM(BUY_TOT_EX_VAT_SALE_AMT)"  bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0"/>' 
                     + '       </COLUMN>'
                     
                     + '       <COLUMN id="BUYEX_VAT_STR_GAP_AMT" refcolid="BUY_TOT_EX_VAT_PROFIT_AMT" >'
                     + '           <HEADER left="1570" top="40" right="1670" bottom="60" text="점출차액(세제외)" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="1570" top="20" right="1670" bottom="40" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'
                     + '           <VIEWSUMMARY  text="@GFSUM(BUY_TOT_EX_VAT_PROFIT_AMT)"  bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0"/>' 
                     + '       </COLUMN>' 
                     ...
                     + '       <COLUMN id="TOP_BUY_TOT_SALE_AMT"   >'
                     + '           <HEADER left="1670" top="0" right="2070" bottom="20" text="매출" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '       </COLUMN>'  
                     
                     + '       <COLUMN id="SALEAMT" refcolid="SALE_SALE_AMT" >'
                     + '           <HEADER left="1670" top="20" right="1770" bottom="40" text="총매출액(세포함)" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="1670" top="0" right="1770" bottom="20" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'
                     + '           <VIEWSUMMARY  text="@GFSUM(SALE_SALE_AMT)"  bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0"/>' 
                     + '       </COLUMN>'
       
                     + '       <COLUMN id="DCAMT"  refcolid="SALE_DC_AMT" >'
                     + '           <HEADER left="1670" top="40" right="1770" bottom="60" text="에누리(세포함)" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="1670" top="20" right="1770" bottom="40" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'
                     + '           <VIEWSUMMARY  text="@GFSUM(SALE_DC_AMT)"  bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0"/>' 
                     + '       </COLUMN>'

                     + '       <COLUMN id="SALEEXVATAMT" refcolid="SALE_EX_VAT_AMT" >'
                     + '           <HEADER left="1770" top="20" right="1870" bottom="40" text="총매출액(세제외)" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="1770" top="0" right="1870" bottom="20" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'
                     ...
                     + '           <HEADER left="1770" top="40" right="1870" bottom="60" text="에누리(세제외)" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="1770" top="20" right="1870" bottom="40" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'
                     + '           <VIEWSUMMARY  text="@GFSUM(SALE_EX_VAT_DC_AMT)"  bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0"/>' 
                     + '       </COLUMN>'

                     + '       <COLUMN id="NETSALEAMT" refcolid="SALE_NET_SALE_AMT" >'
                     + '           <HEADER left="1870" top="20" right="1970" bottom="40" text="순매출액" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="1870" top="0" right="1970" bottom="20" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'
                     + '           <VIEWSUMMARY  text="@GFSUM(SALE_NET_SALE_AMT)"  bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0"/>' 
                     + '       </COLUMN>'
       
                     + '       <COLUMN id="SALEVATAMT"  refcolid="SALE_VAT_AMT" >'
                     + '           <HEADER left="1870" top="40" right="1970" bottom="60" text="매출부가세" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="1870" top="20" right="1970" bottom="40" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'
                     ...
                     + '           <HEADER left="1970" top="20" right="2070" bottom="40" text="매출이익액" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="1970" top="0" right="2070" bottom="20" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'
                     ...
                     + '           <HEADER left="1970" top="40" right="2070" bottom="60" text="매출이익율" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="1970" top="20" right="2070" bottom="40" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'
                     + '           <VIEWSUMMARY  text=""  bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0"/>' 
                     + '       </COLUMN>'
                     
                     + '       <COLUMN id="TOP_BASE_AMT"   >'
                     + '           <HEADER left="2070" top="0" right="2450" bottom="20" text="월말재고" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '       </COLUMN>'
                     
                     + '       <COLUMN id="LASTSALE_AMT" refcolid="DW_SALE_AMT" >'
                     + '           <HEADER left="2070" top="20" right="2160" bottom="40" text="점출액" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="2070" top="0" right="2160" bottom="20" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'
                     + '           <VIEWSUMMARY  text="@GFSUM(DW_SALE_AMT)"  bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0"/>' 
                     + '       </COLUMN>'
       
                     + '       <COLUMN id="LAST_VAT_SALE_AMT"  refcolid="DW_PROFIT_AMT" >'
                     + '           <HEADER left="2070" top="40" right="2160" bottom="60" text="점출차액" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="2070" top="20" right="2160" bottom="40" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'
                     + '           <VIEWSUMMARY  text="@GFSUM(DW_PROFIT_AMT)"  bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0"/>' 
                     + '       </COLUMN>'
                     
                     + '       <COLUMN id="LASTVAT_SALE_AMT" refcolid="DW_TAX_AMT" >'
                     + '           <HEADER left="2160" top="20" right="2250" bottom="60" text="점출부가세" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="2160" top="0" right="2250" bottom="40" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'
                     + '           <VIEWSUMMARY  text="@GFSUM(DW_TAX_AMT)"  bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0"/>' 
                     + '       </COLUMN>'
                     
                     + '       <COLUMN id="LASTEX_VAT_SALE_AMT" refcolid="DW_EX_VAT_SALE_AMT" >'
                     + '           <HEADER left="2250" top="20" right="2350" bottom="40" text="점출액(세제외)" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="2250" top="0" right="2350" bottom="20" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'                            
                     + '           <VIEWSUMMARY  text="@GFSUM(DW_EX_VAT_SALE_AMT)"  bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0"/>' 
                     + '       </COLUMN>'
                     
                     + '       <COLUMN id="LASTEX_VAT_GAP_AMT" refcolid="DW_EX_VAT_PROFIT_AMT" >'
                     + '           <HEADER left="2250" top="40" right="2350" bottom="60" text="점출차액(세제외)" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="2250" top="20" right="2350" bottom="40" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'                           
                     ...
                     + '           <HEADER left="2350" top="20" right="2450" bottom="60" text="재고원가" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="2350" top="0" right="2450" bottom="40" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'                           
                     + '           <VIEWSUMMARY  text="@GFSUM(DW_STK_COST_AMT)"  bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0"/>' 
                     + '       </COLUMN>'

                     + '       <COLUMN id="EXVATPROFITAMT" refcolid="EX_VAT_PROFIT_AMT" >'
                     + '           <HEADER left="2450" top="0" right="2550" bottom="60" text="세제외점출차익율" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="2450" top="0" right="2550" bottom="40" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,###.000"/>'                           
                     + '           <VIEWSUMMARY  bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0"/>' 
                     + '       </COLUMN>'
                     */
                     
                     + '       <COLUMN id="COSTRATE" refcolid="COST_RATE" >'
                     + '           <HEADER left="2450" top="0" right="2550" bottom="60" text="원가율" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="2450" top="0" right="2550" bottom="40" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,###.000"/>'                           
                     + '           <VIEWSUMMARY bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0"/>' 
                     + '       </COLUMN>'
                     
                     + '       <COLUMN id="SALECOST" refcolid="SALE_COST_AMT" >'
                     + '           <HEADER left="2550" top="0" right="2650" bottom="60" text="매출원가" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="2550" top="0" right="2650" bottom="40" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'                           
                     ...
                     + '           <HEADER left="2650" top="0" right="2750" bottom="60" text="상품매출이익" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="2650" top="0" right="2750" bottom="40" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'                           
                     ...
                     + '           <HEADER left="2750" top="0" right="2850" bottom="60" text="순매출이익율" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="2750" top="0" right="2850" bottom="40" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,###.000"/>'                           
                     + '           <VIEWSUMMARY  bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0"/>' 
                     + '       </COLUMN>'
                     
                     + '       <COLUMN id="LM_COST_AMT" refcolid="LM_COST_AMT" >'
                     + '           <HEADER left="2850" top="0" right="2950" bottom="60" text="매입원가" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="2850" top="0" right="2950" bottom="40" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'                           
                     ...
                     + '           <HEADER left="2950" top="0" right="3050" bottom="60" text="원가재고" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="2950" top="0" right="3050" bottom="40" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'                           
                     + '           <VIEWSUMMARY text="@GFSUM(DW_STK_COST_AMT)"   bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0"/>' 
                     + '       </COLUMN>'

                     + '       <COLUMN id="STKCYCLE_RATE" refcolid="STK_CYCLE_RATE" >'
                     + '           <HEADER left="3050" top="0" right="3150" bottom="60" text="회전율" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="3050" top="0" right="3150" bottom="40" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,###.000"/>'                             
                     + '           <VIEWSUMMARY  text=""  bgcolor="#b9d9ea" align="RightCenter" displayformat="#,##0"/>' 
                     + '       </COLUMN>'
...
function btn_Search() { 
    ...
    TR_MAIN.Action="/dps/pstk310.pt?goTo="+goTo+parameters;  
...
function btn_Excel() {	 
    ...
    openExcelM(GD_MASTER, "단품별손익명세서", parameters, true );
    GD_MASTER.Focus();
...
function btn_Print() {
	...
	window.open("/dps/pstk310.pt?goTo=print"+params,"OZREPORT", 1000, 700);
}
    ...
    <tr>
        ...
        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table">
          <tr>
            ...
            <th class="point" width="60">팀</th>
            <td width="195"><comment id="_NSID_"> <object id=LC_O_DEPT_CD
                classid=<%= Util.CLSID_LUXECOMBO %> height=100 width=195 tabindex=1
                align="absmiddle"> </object> </comment><script>_ws_(_NSID_);</script></td>
            <th class="point" width="60">파트</th>
            <td><comment id="_NSID_"> <object id=LC_O_TEAM_CD
                classid=<%= Util.CLSID_LUXECOMBO %> height=100 width=205 tabindex=1
                align="absmiddle"> </object> </comment><script>_ws_(_NSID_);</script></td> 
          </tr>
          <tr>
            <th class="point" width="60">PC</th>
            ...
            <td>
                ...
                <comment id="_NSID_">
                      <object id=EM_O_PUMBUN_NAME classid=<%=Util.CLSID_EMEDIT%>  width=120 tabindex=1>
                      </object>
                </comment><script> _ws_(_NSID_);</script>                
            </td>
          </tr>
          <tr>
            ...
            <td colspan="3">
                <comment id="_NSID_">
                      <object id=EM_O_SKU_CD classid=<%=Util.CLSID_EMEDIT%>  width=165 tabindex=1>
                      </object>
                </comment><script> _ws_(_NSID_);</script>
                <img src="/<%=dir%>/imgs/btn/detail_search_s.gif" class="PR03" onclick="javascript: setSkuCdPopup('POP')" align="absmiddle" />
                <comment id="_NSID_">
                      <object id=EM_O_SKU_NAME classid=<%=Util.CLSID_EMEDIT%>  width=210 tabindex=1>
                      </object>
                </comment><script> _ws_(_NSID_);</script>                
            </td>   
            <th>매입구분</th> 
          ...
          <tr>
            <th>과세구분</th> 
            <td colspan="5"><comment id="_NSID_"> <object id=LC_TAX_FLAG
                classid=<%= Util.CLSID_LUXECOMBO %> height=100 width=165 tabindex=1
                align="absmiddle"> </object> </comment><script>_ws_(_NSID_);</script></td>        
          </tr>
      </table></td>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="BD4A">
            <tr>
                <td>
                  ...
                  id=GD_MASTER width=100% height=432 classid=<%=Util.CLSID_MGRID%>>
