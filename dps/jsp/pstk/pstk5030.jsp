<!-- 
/*******************************************************************************
 * 시스템명 : 영업관리 > 재고수불 > 수불손익> 매입/수불회계전표생성
 * 작 성 일 : 2010.05.11
 * 작 성 자 : 김경은
 * 수 정 자 : 
 * 파 일 명 : pstk503.jsp
 ...
 */
 ...
 function doInit(){
     ...
     initComboStyle(LC_SEND_FLAG,DS_IO_SEND_FLAG,  "CODE^0^30,NAME^0^140", 1, NORMAL);    // 회계전송구분
 ...
 *************************************************************************/
 ...
 function checkValidation(Gubun) {
  ...
  function CloseCheck(){
     ...
     TR_VALCHECK.Action="/dps/pstk503.pt?goTo=valCheck"; 
 ...
 function process(){
	  ...
	  //변경또는 신규 내용을 저장하시겠습니까?
        if( showMessage(QUESTION, YESNO, "USER-1204") == 1 ){    // validation 체크
            TR_MAIN.Action="/dps/pstk503.pt?goTo=save&strFlag=save"; 
