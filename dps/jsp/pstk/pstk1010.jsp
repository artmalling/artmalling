...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}       name="NO"                width=30     align=center    edit=none  sumtext="" </FC>'
    	             ...
    	             + '<FC>id=DEPT_CD           name="팀"              width=90    align=center  edit=none   show="false"</FC>'    	             
                     + '<FC>id=TEAM_CD           name="파트코드"            width=50    align=center edit=none   </FC>'
                     + '<FC>id=TEAM_NAME         name="파트명"              width=100    align=left  edit=none   sumtext="" </FC>'                     
                     + '<FC>id=PC_CD             name="PC코드"            width=50    align=center  edit=none  </FC>'
                     + '<FC>id=PC_NAME           name="PC명"              width=100    align=left  edit=none   </FC>'                     
                     + '<FG> name="기초재고" '
                     + '<FC>id=BASE_QTY          name="수량"              width=70    align=right  edit=none   sumtext=@sum  </FC>'
                     + '<FC>id=BASE_AMT          name="금액"              width=110    align=right  edit=none   sumtext=@sum  </FC>'
                     + '</FG> ' 
                     + '<FG> name="당일매입" '
                     + '<FC>id=BUY_TOT_QTY_SDAY       name="수량"              width=70    align=right  edit=none   sumtext=@sum  </FC>'
                     + '<FC>id=BUY_TOT_SALE_AMT_SDAY  name="금액"              width=120    align=right  edit=none   sumtext=@sum  </FC>'
                     + '</FG> ' 
                     + '<FG> name="당일매출" '
                     + '<FC>id=SALE_QTY_SDAY          name="수량"              width=70    align=right  edit=none   sumtext=@sum  </FC>'
                     + '<FC>id=SALE_SALE_AMT_SDAY     name="금액"              width=120    align=right  edit=none   sumtext=@sum  </FC>'
                     + '</FG> '
                     
                     + '<FG> name="누계매입" '
                     + '<FC>id=BUY_TOT_QTY       name="수량"              width=70    align=right  edit=none   sumtext=@sum  </FC>'
                     + '<FC>id=BUY_TOT_SALE_AMT  name="금액"              width=120    align=right  edit=none   sumtext=@sum  </FC>'
                     + '</FG> ' 
                     + '<FG> name="누계매출" '
                     + '<FC>id=SALE_QTY          name="수량"              width=70    align=right  edit=none   sumtext=@sum  </FC>'
                     + '<FC>id=SALE_SALE_AMT     name="금액"              width=120    align=right  edit=none   sumtext=@sum  </FC>'
                     + '</FG> '
                     
                     + '<FG> name="재고조정" '
                     + '<FC>id=STK_ADJ_QTY       name="수량"              width=70    align=right  edit=none   sumtext=@sum  </FC>'
                     + '<FC>id=STK_ADJ_SALE_AMT  name="금액"              width=120    align=right  edit=none   sumtext=@sum  </FC>'
                     + '</FG> '
                     + '<FG> name="기말재고" '
                     + '<FC>id=SRVY_E_QTY        name="수량"              width=70    align=right  edit=none   sumtext=@sum  </FC>'
                     + '<FC>id=SRVY_E_AMT        name="금액"              width=120    align=right  edit=none   sumtext=@sum  </FC>'
                     + '</FG> ';   
                     
    initGridStyle(GD_MASTER, "common", hdrProperies, true);
                     
    GD_MASTER.ViewSummary = "1";     
    GD_MASTER.ColumnProp("TEAM_NAME", "sumtext")        = "합계";
}

function gridCreate2(){
    var hdrProperies = '<FC>id={currow}          name="NO"              width=30     align=center    edit=none  sumtext=""</FC>' 
    	             + '<FC>id=TEAM_CD           name="파트코드"          width=65    align=center  edit=none  show="false"</FC>'
                     + '<FC>id=TEAM_NAME         name="파트명"            width=100    align=left  edit=none  show="false"</FC>' 
                     + '<FC>id=PC_CD             name="PC코드"          width=65    align=center  edit=none  show="false"</FC>'
                     + '<FC>id=PC_NAME           name="PC명"            width=100    align=left  edit=none  show="false"</FC>' 
                     + '<FC>id=PUMBUN_CD         name="브랜드코드"        width=80    align=center  edit=none  sumtext=""</FC>'
                     + '<FC>id=PUMBUN_NAME       name="브랜드명"          width=150    align=left  edit=none  sumtext=""</FC>' 
                     + '<FG> name="기초재고" '
                     + '<FC>id=BASE_QTY          name="수량"              width=70    align=right  edit=none   sumtext=@sum  </FC>'
                     + '<FC>id=BASE_AMT          name="금액"              width=110    align=right  edit=none   sumtext=@sum  </FC>'
                     + '</FG> ' 
...
function btn_Search() { 
    ...
    TR_MAIN.Action="/dps/pstk101.pt?goTo="+goTo+parameters;  
...
function btn_Excel() {
    ...
    //openExcelS(GD_DETAIL, "조직별장부재고조회", parameters, true );
    openExcel5(GD_DETAIL, "조직별장부재고조회", parameters, true , "",g_strPid );
 ...
 **/
 function searchDetail() {
     ...
     var parameters = "&strStrCd="+encodeURIComponent(strStrCd)
                     ...
                     +"&strStkEDt="+encodeURIComponent(strStkEDt)
                     +"&strStkYm="+encodeURIComponent(strStkYm);  
     TR_SUB.Action="/dps/pstk101.pt?goTo="+goTo+parameters;  
     ...
     <td class="PB03">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="BD4A">
            <tr>
                <td>
                    <comment id="_NSID_">
                        <OBJECT id=GD_DETAIL width=100% height=243 classid=<%=Util.CLSID_GRID%>>
