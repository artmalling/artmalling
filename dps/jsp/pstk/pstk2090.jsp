...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}          name="NO"              width=30     align=center    edit=none  sumtext=""</FC>'                     
                     ...
                     + '<FC>id=LOSS_COST_AMT     name="금액"            width=110    align=right  edit=none   sumtext=@sum</FC>'
                     + '<FC>id=LOSS_RATE         name="율"              width=50    align=right  edit=none     sumtext=@sum</FC>'
                     + '</FG> ' ; 
...
function gridCreate2(){
    var hdrProperies = '<FC>id={currow}          name="NO"              width=30    align=center    edit=none  sumtext=""   SubBgColor=#FFFFE0</FC>'  
                     ...
                     + '<FC>id=SKU_NAME          name="단품명"          width=90    align=left   edit=none  sumtext=""      SubBgColor=#FFFFE0</FC>'
                     + '<FC>id=STR_CD            name="점"              width=85    align=center edit=none  show="false"</FC>'                     
                     + '<FC>id=STK_YM            name="실사년월"        width=85    align=center edit=none  show="false"</FC>'
                     + '<FG> name="기초재고" '
                     ...
                     + '<FC>id=LOSS_RATE         name="율"              width=55    align=right  edit=none   sumtext=@sum  SubBgColor=#FFFFE0 DisplayFormat ="#,###.##" value={(LOSS_COST_AMT/JB_AMT)*100} </FC>'
                     + '</FG> ' ;
...
function btn_Search() { 
    ...
    TR_MAIN.Action="/dps/pstk209.pt?goTo="+goTo+parameters;  
 ...
 **/
 function searchDetail() {
     ...
     var parameters = "&strStrCd="+encodeURIComponent(strStrCd)
                    ...
                    +"&strStkDt="+encodeURIComponent(strStkDt)
                    + "&strPumbunCd="+encodeURIComponent(strPumbunCd);
     TR_SUB.Action="/dps/pstk209.pt?goTo="+goTo+parameters;  
