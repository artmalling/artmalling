<!-- 
/*******************************************************************************
 * 시스템명 : 영업관리 > 재고수불 > 재고실사> 기간수불장현황(단품)
 * 작 성 일 : 2010.05.19
 * 작 성 자 : 이재득
 * 수 정 자 : 
 * 파 일 명 : pstk302.jsp
 * 버    전 : 1.0 (버전은 1.0부터 시작하며 0.1씩 증가)
 * 개    요 : 단품별 기간별 수불장 현황을 보여준다.
 * 이    력 :
 *        2010.05.19 (이재득) 작성
 ******************************************************************************/
-->
...
function doInit(){
	...
	//Master 그리드 세로크기자동조정  2013-07-17
	 var obj   = document.getElementById("GD_SKUDAYQTY"); 
	obj.style.height  = (parseInt(window.document.body.clientHeight)-top) + "px";
	 var obj   = document.getElementById("GD_SKUDAYAMT"); 
	obj.style.height  = (parseInt(window.document.body.clientHeight)-top) + "px";
    ...
    DS_SKUDAYQTY.setDataHeader('<gauce:dataset name="H_SEL_SKUQTY"/>');
    DS_SKUDAYAMT.setDataHeader('<gauce:dataset name="H_SEL_SKUAMT"/>');
...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}                 name="NO"         width=30    align=center  sumtext=""  edit=none</FC>'
				     ...
				     if(RD_DAY_FLAG.CodeValue == "A"){
				   	   hdrProperies +=
				       '<FC>id=STK_DT                   name="일자"       width=80    align=center  sumtext=""  edit=none mask="XXXX/XX/XX"</FC>'
				       ;
				     }
    ...
    initGridStyle(GD_SKUDAYQTY, "common", hdrProperies, true);
    GD_SKUDAYQTY.ViewSummary = "1";    
    GD_SKUDAYQTY.ColumnProp("SKU_CD", "sumtext")        = "합계";
}
...
function gridCreate2(){
    var hdrProperies = '<COLUMNINFO>' 
                     ...
                     + '       <COLUMN id="PUMMOKNAME"  refcolid="PUMBUN_NAME" >'
                     + '           <SUPPRESS>              <REFCOLID>PUMBUN_CD</REFCOLID>           </SUPPRESS>'
                     + '           <HEADER left="60" top="0" right="190" bottom="60" text="브랜드명" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="60" top="0" right="190" bottom="40" align="leftCenter" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEWSUMMARY  text=""  bgcolor="#b9d9ea"/>'                      
                     + '       </COLUMN>'
                     
                     + '       <COLUMN id="SKUCD" refcolid="SKU_CD" >'
                     + '           <SUPPRESS>              <REFCOLID>SKU_CD</REFCOLID>           </SUPPRESS>'
                     + '           <HEADER left="190" top="0" right="290" bottom="60" text="단품" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="190" top="0" right="290" bottom="40" edit="" borderstyle="Line" bordercolor="#cacaca"/>'
    ...
    if(RD_DAY_FLAG.CodeValue == "A"){
        hdrProperies +=
                     ...
                     + '           <SUPPRESS>              <REFCOLID>SKU_CD</REFCOLID>           </SUPPRESS>'
                     + '           <HEADER left="290" top="0" right="410" bottom="60" text="단품명" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="290" top="0" right="410" bottom="40" align="leftCenter" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEWSUMMARY  text=""  bgcolor="#b9d9ea"/>' 
                     + '       </COLUMN>'
                     + '       <COLUMN id="STKDT"  refcolid="STK_DT" >'
                     + '           <HEADER left="410" top="0" right="490" bottom="60" text="일자" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '           <VIEW left="410" top="0" right="490" bottom="40" borderstyle="Line" bordercolor="#cacaca" displayformat="XXXX/XX/XX"/>'
                     + '           <VIEWSUMMARY  text=""  bgcolor="#b9d9ea"/>' 
                     + '       </COLUMN>'
                     ;
                     

    } else if(RD_DAY_FLAG.CodeValue == "B"){
        hdrProperies +=
	                    '       <COLUMN id="SKUNAME"  refcolid="SKU_NAME" >'
                      + '           <SUPPRESS>              <REFCOLID>SKU_CD</REFCOLID>           </SUPPRESS>'
                      + '           <HEADER left="290" top="0" right="490" bottom="60" text="단품명" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                      + '           <VIEW left="290" top="0" right="490" bottom="40" align="leftCenter" borderstyle="Line" bordercolor="#cacaca"/>'
                      + '           <VIEWSUMMARY  text=""  bgcolor="#b9d9ea"/>' 
                      + '       </COLUMN>'
                      ;
    }
        ...
        hdrProperies += 
                     ...
                     + '           <HEADER left="490" top="0" right="580" bottom="20" text="매입" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '       </COLUMN>'
                     ...
                     + '           <HEADER left="580" top="0" right="670" bottom="20" text="반품" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '       </COLUMN>'
                     ...
                     + '           <HEADER left="670" top="0" right="760" bottom="20" text="대입" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '       </COLUMN>'
                     ...
                     + '           <HEADER left="760" top="0" right="850" bottom="20" text="대출" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '       </COLUMN>'
                     ...
                     + '           <HEADER left="850" top="0" right="940" bottom="20" text="점입" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '       </COLUMN>'
                     ...
                     + '           <HEADER left="940" top="0" right="1030" bottom="20" text="점출" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '       </COLUMN>'
                     ...
                     + '           <HEADER left="1030" top="0" right="1120" bottom="20" text="매가인상하" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '       </COLUMN>'
                     
                     + '       <COLUMN id="SALEPRCUPBFAMT" refcolid="SALE_PRC_UP_BF_AMT" >'
                     + '           <HEADER left="1030" top="20" right="1120" bottom="40" text="매가인하" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     ...
                     + '           <HEADER left="1030" top="40" right="1120" bottom="60" text="매가인상" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     ...
                     + '           <HEADER left="1120" top="0" right="1210" bottom="20" text="총매출" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     + '       </COLUMN>'
                     
                     + '       <COLUMN id="SALESALEAMT" refcolid="SALE_SALE_AMT" >'
                     + '           <HEADER left="1120" top="20" right="1210" bottom="40" text="총매출" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     ...
                     + '           <HEADER left="1120" top="40" right="1210" bottom="60" text="에누리" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
                     ...
                     if(RD_DAY_FLAG.CodeValue == "A"){
	                     ...
	                     + '           <HEADER left="1300" top="0" right="1390" bottom="20" text="기말재고" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
	                     + '       </COLUMN>'
	                     
	                     + '       <COLUMN id="SRVYEAMT" refcolid="SRVY_E_AMT" >'
	                     + '           <HEADER left="1300" top="20" right="1390" bottom="60" text="점출액" bgcolor="#eaeef4" borderstyle="Line" bordercolor="#cacaca"/>'
	                     + '           <VIEW left="1300" top="0" right="1390" bottom="40" edit="" borderstyle="Line" bordercolor="#cacaca" align="RightCenter" displayformat="#,##0"/>'
    ...
    initMGridStyle(GD_SKUDAYAMT, "common", hdrProperies);
    DS_SKUDAYAMT.UseChangeInfo = true;  
    GD_SKUDAYAMT.ViewSummary = 1;             
}
...
function btn_Excel() {
	...
	switch(getTabItemSelect("TAB_MAIN")){
    case 1:
    	//openExcelM(GD_SKUDAYAMT, "기간수불장현황(단품)", parameters, true );
    	openExcelM2(GD_SKUDAYAMT, "기간수불장현황(단품)", parameters, true ,g_strPid );

    	GD_SKUDAYAMT.Focus();
        break;
    case 2:
    	//openExcel2(GD_SKUDAYQTY, "기간수불장현황(단품)", parameters, true );
    	openExcel5(GD_SKUDAYQTY, "기간수불장현황(단품)", parameters, true , "",g_strPid );
...
function btn_Print() {
    ...
    var params   = "&strStrCd="+strStrCd
                 ...
                 ;
    window.open("/dps/pstk302.pt?goTo=print"+params,"OZREPORT", 1000, 700);
}
 ...
 **/
 function searchSkuAmt(){
	 ...
	 DS_SKUDAYAMT.ClearData();
	 //DS_SKUDAYQTY.ClearData();
	 gridCreate2();
     ...
     TR_MAIN.Action="/dps/pstk302.pt?goTo="+goTo+parameters;  
     TR_MAIN.KeyValue="SERVLET("+action+":DS_SKUDAYAMT=DS_SKUDAYAMT)"; //조회는 O
     TR_MAIN.Post();
        
     //조회후 결과표시
     setPorcCount("SELECT", GD_SKUDAYAMT);
  }
 ...
 **/
 function searchSkuQty(){
     ...
     var strSlipFlag   = RD_TAX_FLAG.CodeValue;
     var strDayFlag    = RD_DAY_FLAG.CodeValue;
     var strPummokCd   = EM_O_PUMMOK_CD.Text;
     var strBuyFlag    = LC_BUY_FLAG.BindColVal;
     
     if(strDayFlag == "A"){
    	 GD_SKUDAYQTY.ColumnProp('DAY_WEEK','show')= "TRUE";         
     }else{
    	 GD_SKUDAYQTY.ColumnProp('DAY_WEEK','show')= "FALSE";         
     }
     ...
     TR_MAIN.Action="/dps/pstk302.pt?goTo="+goTo+parameters;  
     TR_MAIN.KeyValue="SERVLET("+action+":DS_SKUDAYQTY=DS_SKUDAYQTY)"; //조회는 O
     TR_MAIN.Post();
        
     //조회후 결과표시
     setPorcCount("SELECT", GD_SKUDAYQTY);
  }
...
<script language=JavaScript for=GD_SKUDAYQTY event=OnClick(row,colid)>
    sortColId( eval(this.DataID), row, colid);
</script>
<!-- Grid oneClick event 처리 -->
<script language=JavaScript for=GD_SKUDAYAMT event=OnClick(row,colid)>
    sortColId( eval(this.DataID), row, colid);
</script>
<!--*************************************************************************-->
<!--* C. 가우스 이벤트 처리 끝                                               *-->
...
<!-- ===============- Output용 -->
<comment id="_NSID_">
<object id="DS_SKUDAYAMT" classid=<%= Util.CLSID_DATASET %>></object>
</comment>
<script>_ws_(_NSID_);</script>
<comment id="_NSID_">
<object id="DS_SKUDAYQTY" classid=<%= Util.CLSID_DATASET %>></object>
</comment>
<script>_ws_(_NSID_);</script>
<comment id="_NSID_">
    ...
    <tr>
        ...
        <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table">
          <tr>
            ...
            <td width="180">
                 <comment id="_NSID_">
                    <object id=LC_O_STR_CD classid=<%= Util.CLSID_LUXECOMBO %> width=170 tabindex=1 align="absmiddle">
                    </object>
                </comment><script>_ws_(_NSID_);</script>
            </td>
            <th class="point" width="70">팀</th>
            <td width="180"><comment id="_NSID_"> <object id=LC_O_DEPT_CD
          ...
          <tr>
            ...
            <td width="180"><comment id="_NSID_"> <object id=LC_O_PC_CD
                classid=<%= Util.CLSID_LUXECOMBO %> height=100 width=170 tabindex=1
                align="absmiddle"> </object> </comment><script>_ws_(_NSID_);</script></td>
            <th width="70" class="point">기간</th>
            <td colspan="2"><comment id="_NSID_"> <object
                id=EM_APP_S_DT classid=<%=Util.CLSID_EMEDIT%> width=80 tabindex=1
            ...
            <td>
                <comment id="_NSID_">
                    <object id=RD_TAX_FLAG classid=<%=Util.CLSID_RADIO%> tabindex=1 style="height:20; width:140">
          ...
          <tr>
            ...
            <td width="180">
                ...
                <comment id="_NSID_">
                      <object id=EM_O_PUMBUN_NAME classid=<%=Util.CLSID_EMEDIT%>  width=90 tabindex=1>
                      </object>
                </comment><script> _ws_(_NSID_);</script>                
            </td>
            <th width="70">단품</th>
            <td colspan=2>
                <comment id="_NSID_">
                      <object id=EM_O_SKU_CD classid=<%=Util.CLSID_EMEDIT%>  width=90 tabindex=1>
                      </object>
                </comment><script> _ws_(_NSID_);</script>
                <img src="/<%=dir%>/imgs/btn/detail_search_s.gif" class="PR03" onclick="javascript: setSkuCdPopup('POP')" align="absmiddle" />
                <comment id="_NSID_">
                      <object id=EM_O_SKU_NAME classid=<%=Util.CLSID_EMEDIT%>  width=110 tabindex=1>
                      </object>
                </comment><script> _ws_(_NSID_);</script>                
            </td> 
            <td>
                <comment id="_NSID_">
                    <object id=RD_DAY_FLAG classid=<%=Util.CLSID_RADIO%> tabindex=1 style="height:20; width:140">
                    <param name=Cols    value="2">
        ...
        <tr>
          <td valign="top"  class="PT05">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="BD4A" >
              <tr>
                <td width="100%">
                  ...
                  id=GD_SKUDAYAMT width=100% height=400 classid=<%=Util.CLSID_MGRID%>>
                     <param name="DataID" value="DS_SKUDAYAMT">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="BD4A" >
              <tr>
                <td>
                  <comment id="_NSID_"><object id=GD_SKUDAYQTY width="100%" height=400 classid=<%=Util.CLSID_GRID%>>
                    <param name="DataID" value="DS_SKUDAYQTY">
