...
function gridCreate1(){
    var hdrProperies = '<FC>id={currow}         name="NO"               width=30     align=center   edit=none  sumtext="" SubSumText=""  SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</FC>'
                     ...
                     + '<FC>id=BASE_AMT         name="금액"              width=110     align=right  edit=none   sumtext=@sum  SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</FC>'
                     + '</FG> ' 
                     + '<FG> name="매입" '
                     + '<FC>id=BUY_TOT_QTY      name="수량"              width=70     align=right  edit=none   sumtext=@sum  SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</FC>'
                     + '<FC>id=BUY_TOT_SALE_AMT name="금액"              width=110     align=right  edit=none   sumtext=@sum  SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</FC>'
                     + '</FG> ' 
                     + '<FG> name="매출" '
                     + '<FC>id=SALE_QTY         name="수량"              width=70     align=right  edit=none   sumtext=@sum  SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</FC>'
                     + '<FC>id=SALE_SALE_AMT    name="금액"              width=110     align=right  edit=none   sumtext=@sum  SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</FC>'
                     + '</FG> '
                     + '<FG> name="재고조정" '
                     + '<FC>id=STK_ADJ_QTY      name="수량"              width=70     align=right  edit=none   sumtext=@sum  SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</FC>'
                     + '<FC>id=STK_ADJ_SALE_AMT name="금액"              width=110     align=right  edit=none   sumtext=@sum  SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</FC>'
                     + '</FG> '
                     + '<FG> name="기말재고" '
                     + '<FC>id=SRVY_E_QTY       name="수량"              width=70     align=right  edit=none   sumtext=@sum  SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</FC>'
                     + '<FC>id=SRVY_E_AMT       name="금액"              width=110     align=right  edit=none   sumtext=@sum  SubBgColor={decode(curlevel,1,"#FFFFE0",2,"#FFFACD")}</FC>'
                     + '</FG> '
...
function btn_Search() { 
    ...
    TR_MAIN.Action="/dps/pstk112.pt?goTo="+goTo+parameters;  
