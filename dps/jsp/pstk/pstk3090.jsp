<!-- 
/*******************************************************************************
 * 시스템명 : 영업관리 > 재고수불 > 재고실사> 단품별손익명세서
 * 작 성 일 : 2011.06.22
 * 작 성 자 : 이재득
 * 수 정 자 : 
 * 파 일 명 : pstk309.jsp
 * 버    전 : 1.0 (버전은 1.0부터 시작하며 0.1씩 증가)
 * 개    요 : 단품별 월 손익명세서를 보여준다.
 * 이    력 :
 *        2011.06.22 (이재득) 작성
 ******************************************************************************/
-->
...
function btn_Search() { 
    ...
    TR_MAIN.Action="/dps/pstk309.pt?goTo="+goTo+parameters;  
...
function btn_Print() {
	...
	window.open("/dps/pstk309.pt?goTo=print"+params,"OZREPORT", 1000, 700);
}
