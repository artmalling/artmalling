      ...
      <td colspan="3" valign="bottom">
          ...
          <!-- 커뮤니티 ECMN, 발주/매일 EORD, 영업실적 ESAL, 대금정보 EPAY, 임대정보 EREN, 약속관리 EPRM, 구인/구직 EJOB, 정보수정 ECTM -->
           <c:if test="${ sessionScope.sessionInfo2.SUB_MENU == 'ECMN'}">
           	   <img src="/edi/imgs/comm/left_title01.gif" width="173" height="42" /></td>
          </c:if>
          <c:if test="${ sessionScope.sessionInfo2.SUB_MENU == 'EORD'}">
              <img src="/edi/imgs/comm/left_title02.gif" width="173" height="42" /></td>
          </c:if>
          <c:if test="${ sessionScope.sessionInfo2.SUB_MENU == 'ESAL'}">
              <img src="/edi/imgs/comm/left_title03.gif" width="173" height="42" /></td>
          </c:if>
          <c:if test="${ sessionScope.sessionInfo2.SUB_MENU == 'EPAY'}">
              <img src="/edi/imgs/comm/left_title04.gif" width="173" height="42" /></td>
          </c:if>
          <c:if test="${ sessionScope.sessionInfo2.SUB_MENU == 'EREN'}">
              <img src="/edi/imgs/comm/left_title05.gif" width="173" height="42" /></td>
          </c:if>
          <c:if test="${ sessionScope.sessionInfo2.SUB_MENU == 'EPRO'}">
              <img src="/edi/imgs/comm/left_title06.gif" width="173" height="42" /></td>
          </c:if>
          <c:if test="${ sessionScope.sessionInfo2.SUB_MENU == 'EJOB'}">
              <img src="/edi/imgs/comm/left_title07.gif" width="173" height="42" /></td>
          </c:if>
          <c:if test="${ sessionScope.sessionInfo2.SUB_MENU == 'ECTM'}">
              <img src="/edi/imgs/comm/left_title08.gif" width="173" height="42" /></td>
          </c:if>
      </tr>
      <tr>
