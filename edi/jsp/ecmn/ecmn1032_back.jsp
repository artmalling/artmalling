<!-- 
/*******************************************************************************
 * 시스템명 :  경영지원 > EDI 협력사 > 커뮤니티 > 법률자문 Q&A 리스트 
 * 작 성 일 : 2011.04.14
 * 작 성 자 : 오형규
 * 수 정 자 : 
 * 파 일 명 : ecmn1021.jsp
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td class="title">
                                ...
                                <span id="title1" class="PL03">법률자문Q&A상세조회</span>
                            </td>
                            <td>
                            ...
                            <td>
                                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table">
                                    <tr>
                                        ...
                                        <td width="450"><input  type="text" name="title" id="title" size="70" onkeyup="checkByteLength(this, 50);"  /></td>
                                        <th width="80">등록자</th>
