        ...
        <div class="R_box">
        	<div class="login_box01">          
                  <div class="box01_01">
                            <dl>
                              <!--<dt></dt>-->
                                <dd class="r_01"><select name="strcd" id="strcd" class="edi_login2_input2" tabindex="1"></select></dd>
                              <!--<dt></dt>-->
                                <dd class="r_01"><input type="text" name="userid" id="userid" class="edi_login2_input" onblur="blandNm(); loginGb();" onkeypress="onlyNumber2();" tabindex="2">
						<input type="hidden" name="org" id="org" /></dd>
                              <!--<dt></dt>-->
                                <dd class="r_01"><input type="password" name="pwd" id="pwd" class="edi_login2_input" onKeyDown="javascript:enter();" tabindex="3"></dd>
                            </dl>
                  </div>
                  <div class="box01_02"><a href="javascript:chk()" tabindex="4"><img src="<%=dir%>/imgs/login/btn_login.gif" width="113" height="98" ></a></div>
            </div>
       	    <div class="login_box03"><div class="link_box"><div class="link_01"><a href="#" target="_blank" ><img src="<%=dir%>/imgs/login/link_04.gif" alt="홈페이지" /></a></div></div></div>      
	  </div>
   </div>
</div>
<!-- login box E-->
