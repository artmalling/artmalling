...
function doinit(){
    ...
    if(gb=="1"){
    	getPumbunCombo(g_strcd, vencd, "pumbumCd", "Y", pumbunCd);             //점별 브랜드
    }else{
    	getPumbunCombo(g_strcd, vencd, "pumbumCd", "N", pumbunCd);             //점별 브랜드
    }
       ...
       if( rowsNode.length > 0 ){
    	   ...
    	   for( i = 0; i < rowsNode.length; i++ ){
    		   ...
    		   //net_sale_amtSum	+= Number(NET_SALE_AMT);
	    		   ...
	    		   content += "<td width='79'  class='r4' id='5tdId"+i+"'>"+convAmt(SALE_QTY)		+"</td>";
		   ...
		   content += "<td width='79'  class='r4' id='5tdId"+i+"'>"+convAmt(sale_qtySum)		+"</td>";
      ...
      <tr>
        ...
        <td><table border="0" align="right" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td><img src="<%=dir%>/imgs/btn/excel.gif" width="61" height="22" id="excel" onclick="javascript: excelExport('기간별판매정보','TBL',pumbunCd);"/></td>
