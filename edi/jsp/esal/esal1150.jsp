     ...
     if(strMst.readyState==4)
     {
          if(strMst.status == 200)
          {
            ...
            //   alert(eval(str)[0].STR_CD);
              var content = "";
              content += "<table width='510' cellspacing='0' cellpadding='0' border='0' class='g_table'>";
             ...
             // 조회된 데이터가 없을땐 그리드를 그리지 않고 return
              ...
              for( i = 0; i < strMst.length; i++ ){   
                  ...
                  content += "<td width='80'   class='r1' id='2tdId"+i+"'>"+getDateFormat(strMst[i].ENTR_DT) +"</td>";
                  content += "<td width='80'   class='r1' id='3tdId"+i+"'>"+strMst[i].REG_ID+"</td>"; 
                  content += "<td width='120'  class='r1' id='4tdId"+i+"'>"+strMst[i].PUMBUN_NAME+"</td>"; 
                  content += "<td width='70'   class='r1' id='5tdId"+i+"'>"+convAmt(strMst[i].TOT_CNT)+"</td>";  
                  content += "<td width='60'   class='r1' id='6tdId"+i+"'>"+convAmt(strMst[i].DI_CNT0)+"</td>"; 
                  content += "<td width='60'   class='r1' id='7tdId"+i+"'>"+convAmt(strMst[i].DI_CNT1)+"</td>"; 
                  content += "</tr>";   
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="396" class="title"><img src="<%=dir%>/imgs/comm/title_head.gif" width="15" height="13" align="absmiddle" class="PR05"/>회원등록현황</td>
        <td><table border="0" align="right" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td><img src="<%=dir%>/imgs/btn/excel.gif" width="61" height="22" id="excel" onclick="javascript:chBak(0); excelExport('회원등록현황','TBL',pumbunCd);"/></td>
        ...
        <td><div id="topTitle" style="width:815px;overflow:hidden;">
                <table width="510" cellpadding="0" cellspacing="0" border="0" class="g_table" >
                    <tr>
                        ...
                        <th width="70">총 가입고객</th>
                        <th width="60">적립2000</th>
                        <th width="60">할인2000</th>
                    </tr>
                </table>
            </div>        
        </td>
