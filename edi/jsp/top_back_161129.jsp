...
function goMain() {
	top.window.status='';
	top.document.title = "마리오아울렛 EDI시스템";
		...
		<td height="20" valign="bottom">
			<table border="0" align="right" cellpadding="0" cellspacing="0" >
				<tr>
					...
					<td class="top_tx PT03">
						<a href="javascript:helpWindowOpen();" onfocus="this.blur();"><img src="/edi/imgs/comm/top_help.gif" valign="absmiddle" />도움말</a>
					</td>
					<td class="PR20"></td>
				</tr>
			</table>
	...
	<tr>
		<td height="27" valign="bottom" class="PB02">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="170" >
						<img id="hiddenMenu" onClick="hide_menu();" src="/edi/imgs/comm/top_menu_hidden.gif" width="79" height="19" hspace="2" />
					</td>
				</tr>
			</table>
		</td>
