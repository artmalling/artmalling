...
var strCheck_Slipno = "";      //마스터 선택 클릭시 배열(전표번호) 
var strCnt = 0          //마스터 선택 갯수 체크
...
function btn_Sch(){
    ...
    if( document.getElementById("venCd").value == "" ){
...
function getSearch(){
	 ...
	 var pubumCd = document.getElementById("pumbunCd").value;                           //브랜드코드
     ...
     if(strMst.readyState==4)
     {
          if(strMst.status == 200)
          {
              ...
              if( strMst == undefined ) { 
                  ...
                  var de_content = "<table width='815' border='0' cellspacing='0' cellpadding='0' class='g_table'></table>";
             ...
             var de_content = "<table width='815' border='0' cellspacing='0' cellpadding='0' class='g_table'></table>";
              ...
              if( strMst.length > 0 ){
            	  ...
            	  for( i = 0; i < strMst.length; i++ ){
                      ...
                      content += "<td width='35' class='r1' id='2tdId"+i+"' ><input type='checkbox' name='chBox' id='chBox' ></td>";
                      ...
                      if( strMst[i].TAG_PRT_YN == "Y" ){
                    	  content += "<td width='60' class='r3' id='7tdId"+i+"'>발행</td>";  
                      }else if( strMst[i].TAG_PRT_YN == "N" ){
                    	  content += "<td width='60' class='r3' id='7tdId"+i+"'>미발행</td>";
                      }
        	 ...
        	 if( strDtl.length > 0 ){
        		 ...
        		 if( g_SkuFlag == "1" ){  //단품
        			 ...
        			 for( i = 0; i < strDtl.length; i++ ){
                         ...
                         de_content += "<td width='40' class='r1' id='1tdId2"+i+"' >"+(i+1)+"</td>";
                         de_content += "<td width='115' class='r3' id='2tdId2"+i+"' >"+strDtl[i].PUMBUN_NM+"</td>";
                         de_content += "<td width='195' class='r3' id='3tdId2"+i+"' >"+strDtl[i].SKU_NM+"</td>";
                         de_content += "<td width='95' class='r4' id='4tdId2"+i+"' >"+strDtl[i].ORD_UNIT_CD+"개</td>";
                         de_content += "<td width='75' class='r4' id='5tdId2"+i+"' >"+convAmt(strDtl[i].ORD_QTY)+"</td>";
                         de_content += "<td width='95' class='r4' id='6tdId2"+i+"' >"+convAmt(strDtl[i].NEW_SALE_PRC)+"</td>";
                         de_content += "<td width='145' class='r4' id='7tdId2"+i+"' >"+convAmt(strDtl[i].NEW_SALE_AMT)+"</td>";
                         de_content += "</tr>";
        			 ...
        			 for( i = 0; i < strDtl.length; i++ ){
                         ...
                         de_content += "<td width='40' class='r1' id='1tdId2"+i+"' >"+(i+1)+"</td>";
                         de_content += "<td width='115' class='r3' id='2tdId2"+i+"' >"+strDtl[i].PUMBUN_NM+"</td>";
                         de_content += "<td width='195' class='r3' id='3tdId2"+i+"' >"+strDtl[i].PUMMOK_NM+"</td>";
                         de_content += "<td width='95' class='r4' id='4tdId2"+i+"' >"+strDtl[i].ORD_UNIT_CD+"개</td>";
                         de_content += "<td width='75' class='r4' id='5tdId2"+i+"' >"+convAmt(strDtl[i].ORD_QTY)+"</td>";
                         de_content += "<td width='95' class='r4' id='6tdId2"+i+"' >"+convAmt(strDtl[i].NEW_SALE_PRC)+"</td>";
                         de_content += "<td width='145' class='r4' id='7tdId2"+i+"' >"+convAmt(strDtl[i].NEW_SALE_AMT)+"</td>";
 ...
 * return값 : void
 */  
function pumbunSelPop(strVenCd, strStrCd, strPumbunCd, strPumbunNm, strGbn){
 ...
 * return값 : void
 */ 
function getPbmbunPop(strPumbunCd, strPumbunNm){ 
   ...
   // var strPumbun = document.getElementById("pumbunCd").value;
    ...
    var rtnList = pumbunSelPop(strVenCd, strStrCd, strPumbunCd, strPumbunNm, "", "", "", "N");
     ...
     if(rtnList != null){
         ...
         if( returnList.length == 1 ){
            ...
            document.getElementById("pumbunCd").value = returnValue[0];
            document.getElementById("pumbumNm").value = returnValue[1]; 
    	 ...
    	 if(strPumbunCd.length < 6){  //브랜드코드가 6자리 미만 입력시 선택 안하고 팝업 닫으면 브랜드코드, 브랜드명 초기화
             ...
             document.getElementById("pumbumNm").value = "";
    	 }
     }
} 
...
function pumbun() {
    ...
    var strPumbunNm = document.getElementById("pumbumNm").value;
    var strStrCd = document.getElementById("strcd").value;
    var strVenCd = document.getElementById("venCd").value;
    var strGb = "1";
	    ...
	    var param = "&goTo=getPumbunBlur" + "&strStrCd="       + strStrCd
	      ...
	      //  alert(rowsNode.length);
	        if( rowsNode.length < 1 ){ 
	        	getPbmbunPop(strPumbunCd, strPumbunNm);
	        }
	        else {
	        
	            document.getElementById("pumbunCd").value = rowsNode[0].childNodes[0].childNodes[0].nodeValue == "null" ? "" : rowsNode[0].childNodes[0].childNodes[0].nodeValue;
	            document.getElementById("pumbumNm").value = rowsNode[0].childNodes[1].childNodes[0].nodeValue == "null" ? "" : rowsNode[0].childNodes[1].childNodes[0].nodeValue;   
	        } 
	        </ajax:callback> 
	}
	else {
    ...
    var rtnList = venSelPop(strVenCd, strVenNm, strStrCd, "", "", "N");
     ...
     if(rtnList != null){
         ...
         if( returnList.length == 1 ){
            ...
            document.getElementById("venCd").value = returnValue[0];
            document.getElementById("venNm").value = returnValue[1]; 
            
         }
     } 
     else { 
         if(strVenCd.length < 6){  //협력사 코드가 6자리 미만 입력시 선택 안하고 팝업 닫으면 협력사코드, 협력사명 초기화
             document.getElementById("venCd").value = "";
             document.getElementById("venNm").value = "";
         }
     }
} 
...
function ven() { 
	    var strStrCd = document.getElementById("strcd").value; 
        var strVenCd = document.getElementById("venCd").value; 
        var strVenNm = document.getElementById("venNm").value; 
	        ...
	        var param = "&goTo=getVenBlur" + "&strStrCd="       + strStrCd
	          ...
	          //  alert(rowsNode.length);
	            if( rowsNode.length < 1 ){ 
	                ...
	                document.getElementById("venCd").value = rowsNode[0].childNodes[0].childNodes[0].nodeValue == "null" ? "" : rowsNode[0].childNodes[0].childNodes[0].nodeValue;
	                document.getElementById("venNm").value = rowsNode[0].childNodes[1].childNodes[0].nodeValue == "null" ? "" : rowsNode[0].childNodes[1].childNodes[0].nodeValue;   
	            } 
	            </ajax:callback> 
	    }
	    else {
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="396" class="title"><img src="<%=dir%>/imgs/comm/title_head.gif" width="15" height="13" align="absmiddle" class="PR05" show="false" />택발행(택발행대행업체)</td>
      ...
      <tr>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="s_table">
          <tr>
            ...
            <td width="100"><input type="text"  name="strnm" id="strnm" style="width: 100;" maxlength="10" value="<%=strNm%>" disabled="disabled" /><input type="hidden" name="strcd" id="strcd"  ></td>
            <th width="80" class="POINT">협력사코드</th>
            <td width="200">
                <input type="text" name="venCd" id="venCd" size="10"  maxlength="6" align="absmiddle" onkeydown='if(event.keyCode == 13 || event.keyCode == 9){ clear_text(this,"1"); ven(); }' onblur="clear_text(this,'1');"  onkeyup="clear_text(this,'1');" />
                <img src="<%=dir%>/imgs/btn/detail_search_s.gif"  align="absmiddle" onclick="getVenPop(document.getElementById('venCd').value, document.getElementById('venNm').value);" /> 
                <input type="text" name="venNm" id="venNm" size="15"  align="absmiddle" onkeydown='if(event.keyCode == 13|| event.keyCode == 9){ clear_text(this,"2"); ven(); }' onblur="clear_text(this,'2');"   /> 
            </td>
            <th width="80">브랜드코드</th> 
            <td>
                <input type="text" name="pumbunCd" id="pumbunCd" size="10"   maxlength="6" align="absmiddle" onkeydown='if(event.keyCode == 13|| event.keyCode == 9){ clear_text(this,"3"); pumbun(); }' onblur="clear_text(this,'3');" onkeyup="clear_text(this,'3');"  />
                <img src="<%=dir%>/imgs/btn/detail_search_s.gif"  align="absmiddle" onclick="getPbmbunPop(document.getElementById('pumbunCd').value, document.getElementById('pumbumNm').value);" /> 
                <input type="text" name="pumbumNm" id="pumbumNm" size="15"  align="absmiddle"  onkeydown='if(event.keyCode == 13|| event.keyCode == 9){ clear_text(this,"4"); pumbun(); }' onblur="clear_text(this,'4');"  /> 
            </td>
          </tr>
          <tr>
            <th>전표상태</th>
            <td>
                <select id="Sel_slip_proc_falg" name="Sel_slip_proc_falg" style="width: 100;">
                        
                </select>
            </td>
            <th >전표구분</th>
            <td>
                <select id="in_slip_flag" name="in_slip_flag" style="width: 98;">
          ...
          <tr>
              ...
              <td> 
                  <select id="in_tag_flag" name="in_tag_flag" style="width: 100;">
                  </select>
              </td>
