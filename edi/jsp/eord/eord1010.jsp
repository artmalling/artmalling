 ...
 */ 
 ...
 //   alert("rowIndex : " + rowIndex);
     ...
     td10.style.width = "85";
     td10.className = "r1";
     td10.innerHTML = "<input type='text' name='d_new_sale_prc' id='d_new_sale_prc"+rowIndex+"' size='11' onkeypress='javascript:onlyNumber();' style='text-align:right;IME-MODE: disabled' maxlength='9' value='0' onkeydown=' if(event.keyCode == 13){ calDetail2("+rowIndex+");  } ' onblur='javascript:calDetail2("+rowIndex+");'/>";  // add_row("+rowIndex+"); //onblur='javascript: calDetail2("+rowIndex+");'  
 ...
 function checkValidation(gbun){
     ...
     if( gbun == "Save" ){       
         ...
         if( tr_cnt > 0 ){
             ...
             var PumMokNms   = document.getElementsByName("d_pummok_nm");
             ...
             for( i = 0; i < PmkSrtCds.length; i++ ){
                 ...
                 if( PumMokNms[i].value == "" ){
                     showMessage(INFORMATION, OK, "USER-1003", "품목명");
                     document.getElementsByName("d_pummok_nm")[i].focus();
                     return false;
                 }
