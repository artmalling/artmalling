...
public class ECmn106DAO extends AbstractDAO {
    ...
    public String getMaster(ActionForm form) throws Exception {
        ...
        try {
            ...
            sql.setString(2, strHP1);
            sql.setString(3, strHP2);
            sql.setString(4, strHP3);
            
            list = select2List(sql);  

            if (list.size() > 0 ) {
    			String cols= ""+
				"CUST_ID,CUST_NAME,BIRTH_DT,HP,ACCPT,ENTR_DT,DI"; 
