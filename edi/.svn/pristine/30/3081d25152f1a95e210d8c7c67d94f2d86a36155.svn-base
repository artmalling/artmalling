...
*****************************************************************************/
%>
<%@ page language="java" contentType="text/html;charset=utf-8" import="ecom.util.Util, 
...
<%
    ...
    String loginInfo = "EORD102" + "  "    //Util.getPId(request)
...
<object id="ZTransferX" width="0" height="0" CLASSID="CLSID:C7C7225A-9476-47AC-B0B0-FF3B79D55E67" codebase="http://<%=ozSvrIP%>:<%=ozSvrPort%>/oz/ozviewer/ZTransferX.CAB#version=2,2,2,0">
...
%>
        ...
        paramTag[paramTag.length] = '<param name="<%=child%>connection.args2"  value="IMG_URL=http://<%=ozSvrIP%>:<%=ozSvrPort%>/edi/imgs/report/CI.gif">';
<%
