...
public class ECmn102Action extends DispatchAction {
	/*
	 * Java Pattern 에서 지원하는 logger를 사용할 수 있도록 객체를 선언
	 */
	private Logger logger = Logger.getLogger(ECmn102Action.class);
	...
	public ActionForward save(ActionMapping mapping, ActionForm form,
		...
		try{
			...
			if( "save".equals(form.getParam("strFlag")) ){
				sb = dao.save(form);
			}else if( "insert".equals(form.getParam("strFlag")) ){
				sb = dao.insert(form);
			}else {
				sb = dao.delete(form);
